...
export default function DeleteTransactionDialog({ disabled }: { disabled: boolean }) {
    return <Dialog>
        <DialogTrigger disabled={disabled} title='Delete transaction'
        ...
        <DialogContent className="bg-secondary">
            <DialogHeader>
                ...
                <DialogDescription>
                    This transactoin will be marked as deleted. Are you sure you want to proceed?
                </DialogDescription>
            </DialogHeader>
