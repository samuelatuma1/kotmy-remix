    ...
    return (<div data-show={show} ref={mobileNav}
        ...
        <header className='wrapper py-5'>
            <div className='flex justify-between items-center' >
                <Link to={'/'} onClick={onClose} aria-label='home'><Svg src={icons.logoIcon} width={128} height={52} /></Link>
            ...
            <nav className=''>
                <ul className='grid gap-6 my-12 text-xl font-bold'>
                    ...
                    <li><NavLink onClick={onClose} to="/leaderboard/orders" className=''>Leaderboard</NavLink></li>
