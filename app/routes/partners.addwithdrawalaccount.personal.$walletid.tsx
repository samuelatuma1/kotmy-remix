...
export async function loader ({request, params}: LoaderFunctionArgs){
    ...
    let {error, data, authRequired} = await walletRepo.getBusinessWalletById(walletid, request);
     if(authRequired){
        redirect("/login")
    }
    ...
    console.log("Partner wallets", {walletAccount, walletCurrencyBanks: walletCurrencyBanksResponse})
