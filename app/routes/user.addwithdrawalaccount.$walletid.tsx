        ...
        <Form method="post" className="mt-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Personal account</h3>
              <p className="text-gray-500 leading-relaxed max-w-[280px]">
                Add any bank account of you or your loved one. You would pay a one time fee that would be taken from your earnings 
              </p>
              <input type="radio" name="accountType" value="personal" className="hidden" checked={selectedType === "personal"} readOnly />
            </div>
