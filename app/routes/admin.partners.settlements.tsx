  ...
  return (
    ...
    >
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-2">
        ...
        <div className="rounded-2xl bg-slate-50 px-4 py-3">
          <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">Business ID</div>
          <div className="mt-1 truncate text-sm font-semibold text-slate-900">{settlement.business_id}</div>
        </div>
      </div>
    </article>
  );
