...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1761891025078.8977";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1785922888987.4575";
}
var rolesEnum = /* @__PURE__ */ ((rolesEnum2) => {
  rolesEnum2["admin"] = "admin";
  rolesEnum2["sales rep"] = "sales rep";
  rolesEnum2["content manager"] = "content manager";
  rolesEnum2["contestant manager"] = "contestant manager";
  rolesEnum2["manage user"] = "manage user";
  return rolesEnum2;
})(rolesEnum || {});
var useUserManager = () => {
  const [userStore, setUserStore] = useAtom(userAtom);
  const setUserStoreManager = (newUser, persist) => {
    ...
    try {
      if (!userStore) {
        ...
        if (storedUser) {
          ...
          newUser.is_partner_account = newUser.business_id ? true : newUser.is_partner_account;
          setUserStore(newUser);
          return newUser;
        }
      }
  ...
  const hasAcceptedRole = (user, acceptedRoles = []) => {
...
//# sourceMappingURL=/build/_shared/chunk-DOOVVW3X.js.map
