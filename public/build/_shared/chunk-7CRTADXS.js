...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1760080481935.6265";
}
function Stages({
  row
}) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "p-6", children: [
    ...
    selectedStage ? /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(EditStageForm, { stage: selectedStage, contestId: row.original.id, closeForm: row.getToggleExpandedHandler() }, selectedStage._id, false, {
      fileName: "app/components/admin/contest/EditStageForm.tsx",
      lineNumber: 41,
      columnNumber: 24
    }, this) : null
...
function EditStageForm({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form, { method: "POST", className: "text-primary text-xs flex flex-col gap-4", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("fieldset", { className: "py-4 grid grid-cols-4 gap-3 border-b", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(FormControl, { as: "input", id: "start_date", name: "start_date", labelText: "Stage Start Date", type: "date", defaultValue: parseDateForInput(stage.start_date) }, void 0, false, {
        fileName: "app/components/admin/contest/EditStageForm.tsx",
        lineNumber: 53,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(FormControl, { as: "input", id: "end_date", name: "end_date", labelText: "Stage End Date", type: "date", defaultValue: parseDateForInput(stage.end_date) }, void 0, false, {
        fileName: "app/components/admin/contest/EditStageForm.tsx",
        lineNumber: 54,
        columnNumber: 9
      }, this),
...
//# sourceMappingURL=/build/_shared/chunk-7CRTADXS.js.map
