...
import {
  ContestantSlider
} from "/build/_shared/chunk-OM6EOTOF.js";
import {
  ContestGuidelines
...
import {
  TallyVoteDialog
} from "/build/_shared/chunk-E27HUZ53.js";
import {
  socialIcons
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1765086751360.5984";
}
function RegistrationForm({
  ...
  if (!user) {
    ...
    return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "w-full max-w-xl bg-white border rounded-3xl shadow-lg flex flex-col items-center justify-center gap-6 py-12 px-6 sm:px-12 text-center", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("p", { className: "text-gray-700 text-base max-w-md", children: "You must be signed in to register for this contest. Please sign in to continue and unlock the registration form." }, void 0, false, {
        fileName: "app/components/public/contests/RegistrationForm.tsx",
        lineNumber: 50,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Button, { element: "button", onClick: () => navigate(`/login?redirectTo=${encodeURIComponent(fullPath)}`), className: "mt-2 px-8 py-3 text-lg rounded-lg font-bold bg-accent text-white hover:bg-accent/90 transition", children: "Sign In" }, void 0, false, {
        fileName: "app/components/public/contests/RegistrationForm.tsx",
        lineNumber: 51,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("p", { className: "text-sm text-gray-400 mt-2", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "underline text-accent cursor-pointer", onClick: () => navigate(`/signup?redirectTo=${encodeURIComponent(fullPath)}`), children: "Sign up here" }, void 0, false, {
          fileName: "app/components/public/contests/RegistrationForm.tsx",
          lineNumber: 52,
          columnNumber: 82
        }, this)
...
_s4(RegistrationForm, "dtZigM37yBu76I7/B79l33FBDIM=", false, function() {
...
//# sourceMappingURL=/build/_shared/chunk-KHMMDDSP.js.map
