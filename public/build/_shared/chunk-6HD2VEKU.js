...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1785086295354.6887";
}
function StatusTag({
  status,
  className,
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: (0, import_classnames.default)(`w-fit px-4 pl-7 py-1.5 rounded-md text-sm capitalize font-satoshi-medium flex items-center ${className}`, {
    ...
    "bg-gold-soft text-brand-metallicGold": color === "yellow",
    "bg-red-100 text-red-700": color === "red",
    "bg-secondary text-brand-charcoal": color === "gray"
...
//# sourceMappingURL=/build/_shared/chunk-6HD2VEKU.js.map
