...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1785086281068.3586";
}
function Button({
  children,
  element,
  ...
  const Comp = element;
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Comp, { ...props, className: (0, import_classnames.default)(`py-4 px-8 text-lg border border-brand-pink rounded-md font-black whitespace-nowrap leading-4 text-center ${className}`, {
...
//# sourceMappingURL=/build/_shared/chunk-AXEZ6O7K.js.map
