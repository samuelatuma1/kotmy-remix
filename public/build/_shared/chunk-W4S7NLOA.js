...
var admin_avatar_default = "/build/_assets/admin-avatar-CLG5XP6B.svg";
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1757765166845.7937";
}
var icons = {
  ...
  avatarIcon: `${admin_avatar_default}#img`,
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/reusables/Svg.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1757765166867.414";
}
function Svg({
  src,
  width = "1.2em",
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("svg", { onClick, className, width, height, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("use", { width: use_width, height: "100%", href: src }, void 0, false, {
...
//# sourceMappingURL=/build/_shared/chunk-W4S7NLOA.js.map
