...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1784754779636.8013";
}
...
function TallyVoteDialog({
  ...
  const walletVoteContext = stageContestants?.walletVoteContext;
  ...
  const isWalletSubmitDisabled = !user || walletVoteContext?.authRequired || !hasWallet || !remark.trim() || validVoteQuantity < 1 || payableAmount < 1 || !hasSufficientBalance || isWalletSubmitting;
  ...
  const renderUnauthenticatedWalletView = () => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "space-y-5 p-6", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "rounded-2xl border border-slate-200 bg-slate-50 p-5 text-center", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("p", { className: "mt-2 text-sm leading-6 text-slate-600", children: "You need to be signed in to vote from your wallet. Sign in now or return to the start menu to choose a different payment method." }, void 0, false, {
        fileName: "app/components/public/contests/TallyVoteDialog.tsx",
        lineNumber: 169,
        columnNumber: 17
      }, this)
  ...
  const renderWalletFlow = () => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "space-y-5 p-6", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "rounded-2xl border border-slate-200 bg-slate-50 p-4", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("p", { className: "text-xs font-semibold uppercase tracking-[0.2em] text-slate-500", children: "Contestant" }, void 0, false, {
        fileName: "app/components/public/contests/TallyVoteDialog.tsx",
        lineNumber: 185,
    ...
    walletVoteContext?.authRequired ? renderUnauthenticatedWalletView() : !hasWallet ? /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "rounded-2xl border border-amber-200 bg-amber-50 p-5", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(walletFetcher.Form, { method: "post", className: "space-y-4", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(FormControl, { as: "textarea", id: "remark", name: "remark", labelText: "Remark", labelClassNames: "text-left", required: true, value: remark, onChange: (event) => setRemark(event.currentTarget.value), placeholder: "Tell us why you're voting" }, void 0, false, {
          fileName: "app/components/public/contests/TallyVoteDialog.tsx",
          lineNumber: 242,
          columnNumber: 25
        }, this),
...
_s(TallyVoteDialog, "E9n9HSmjdGoH2mvNEFBhOr4k9O0=", false, function() {
  return [useRouteLoaderData, useFetcher, useUserManager, useNavigate, useLocation];
});
_c5 = TallyVoteDialog;
var _c5;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1784488499989.0554";
}
...
function GivaahVoteDialog({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Dialog, { open, onOpenChange: setOpen, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(DialogContent, { className: "max-w-2xl border-slate-200 bg-white p-0 shadow-[0_24px_70px_rgba(15,23,42,0.16)]", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "space-y-5 p-6", children: [
...
//# sourceMappingURL=/build/_shared/chunk-WU2325A7.js.map
