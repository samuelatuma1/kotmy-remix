...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1785868608511.457";
}
function AutoplayCarousel({
  ...
  (0, import_react.useEffect)(() => {
    ...
    container.current?.style.setProperty("--timing", `${slideDuration ?? soln * 18}s`);
    console.log({
      soln,
      containerWidth,
      trackWidth
...
//# sourceMappingURL=/build/_shared/chunk-ZBDUUSMF.js.map
