...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1786802643981.9495";
}
var navs = [{
  label: "Home",
  icon: icons.adminHomeIcon,
...
function AdminNavigation({
  ...
  const mainComponent = /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "flex justify-between items-center border border-brand-grey rounded-lg p-2 text-sm cursor-pointer line-clamp-1 hover:outline outline-1 outline-brand-pink", children: [
    "System default",
  ...
  return show ? /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("header", { className: "bg-white border-r border-brand-grey hidden sm:flex flex-col justify-between min-w-[280px]", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("nav", { className: "py-6", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("ul", { className: "grid gap-2 font-bold", children: navs.map((navItem) => /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("li", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(NavLink, { to: navItem.url, className: ({
        isActive
      }) => `${isActive ? "text-brand-pink bg-secondary border-brand-pink" : "border-transparent text-brand-charcoal"} flex gap-3 items-center px-6 py-3 font-semibold border-l-4 hover:bg-secondary ${!hasAcceptedRole(user, navItem.acceptedRoles ?? []) ? " hidden " : ""}`, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)($1bf158f521e1b1b4$export$a766cd26d0d69044, { type: "single", collapsible: true, className: "w-full mt-2", children: navsWSubs.map((item) => /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)($1bf158f521e1b1b4$export$d99097c13d4dac9f, { value: item.label, className: "group", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)($1bf158f521e1b1b4$export$94e939b1f85bdd73, { className: cn("border-l-4 border-transparent group w-full flex gap-3 items-center justify-between px-6 py-3 font-semibold hover:bg-secondary", {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("aside", { className: "border-t  px-6 py-3", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Toggletip, { mainComponent, childContainerClass: "bottom-[110%] left-0 bg-white p-2 border border-brand-grey text-xs whitespace-nowrap", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("span", { className: "p-2 flex items-center gap-2 hover:bg-secondary rounded-lg font-satoshi-medium", children: "System default" }, void 0, false, {
          fileName: "app/components/admin/AdminNav.tsx",
          lineNumber: 160,
          columnNumber: 21
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("span", { className: "p-2 flex items-center gap-2 hover:bg-secondary rounded-lg font-satoshi-medium", children: "Light" }, void 0, false, {
          fileName: "app/components/admin/AdminNav.tsx",
          lineNumber: 161,
          columnNumber: 21
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("span", { className: "p-2 flex items-center gap-2 hover:bg-secondary rounded-lg font-satoshi-medium", children: "Dark" }, void 0, false, {
          fileName: "app/components/admin/AdminNav.tsx",
          lineNumber: 162,
          columnNumber: 21
        }, this)
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1785922416117.338";
}
...
_s3(AdminToolbar, "ObOnkbmW+8fAFLHciJ7llJSysyg=", false, function() {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1785086371111.3408";
}
function PrimaryHeader({
  toggleNav
}) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("header", { className: "h-[85px] hidden sm:flex justify-between items-center gap-4 px-6 py-3 bg-white border-b border-brand-grey", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex gap-6", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("button", { onClick: toggleNav, title: "Toggle Menu", className: "flex items-center justify-center rounded p-2 px-1 hover:outline outline-brand-pink", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Svg, { src: icons.adminHamburgerIcon, width: 40, height: 24 }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Link, { to: "/", className: "text-brand-navy flex items-center gap-6 whitespace-nowrap font-satoshi-black", children: [
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1785037079884.2803";
}
var meta = () => {
  return [{
    title: "KOTMY | Admin"
...
function Layout({
  ...
  _s4();
  const [showNav, setShowNav] = (0, import_react10.useState)(false);
...
//# sourceMappingURL=/build/routes/admin-W7HQTLYI.js.map
