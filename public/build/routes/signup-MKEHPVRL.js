...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1786287437158.9912";
}
...
_s(useSignupController, "t/LOtB7r8ZUPjBKOoMcNZ2vLNNQ=", false, function() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", { className: "bg-secondary p-4 flex flex-col", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { className: "grow flex flex-col justify-center items-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Form, { method: "POST", encType: "multipart/form-data", className: "w-full max-w-md p-4 sm:p-8 bg-white border rounded-3xl flex flex-col gap-3", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-center text-sm text-gray-600", children: [
        ...
        " ",
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/terms", className: "text-primary underline font-medium", children: "Terms and Conditions" }, void 0, false, {
          fileName: "app/routes/signup.tsx",
          lineNumber: 126,
          columnNumber: 13
        }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "my-2 flex flex-col gap-3", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(FormControl, { as: "input", id: "referred_by_code", name: "referred_by_code", placeholder: "Enter referral code (optional)", labelText: "Referral code", icon: icons.avatarIcon, defaultValue: referredByCode }, void 0, false, {
          fileName: "app/routes/signup.tsx",
          lineNumber: 136,
          columnNumber: 13
        }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("label", { className: "flex items-start gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", { type: "checkbox", name: "terms_acknowledged", required: true, className: "mt-1 h-4 w-4 rounded border-slate-300 text-primary focus:ring-primary" }, void 0, false, {
          fileName: "app/routes/signup.tsx",
          lineNumber: 146,
          columnNumber: 13
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { children: [
          ...
          " ",
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/terms", className: "font-semibold text-primary underline", children: "Terms and Conditions" }, void 0, false, {
            fileName: "app/routes/signup.tsx",
            lineNumber: 149,
            columnNumber: 15
          }, this),
...
_s2(Signup, "uvJp/RaJ4BunB8YPlJ43vuB4ANY=", false, function() {
  return [useSignupController, useSearchParams];
});
_c = Signup;
var _c;
...
//# sourceMappingURL=/build/routes/signup-MKEHPVRL.js.map
