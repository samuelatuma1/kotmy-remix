...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/partners.wallet.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1787177198940.4043";
}
...
function WalletPage() {
  ...
  if (!activeData)
    return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "p-8", children: "No wallets found." }, void 0, false, {
      fileName: "app/routes/partners.wallet.tsx",
      lineNumber: 255,
      columnNumber: 27
    }, this);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "p-8 max-w-7xl mx-auto bg-[#F9FAFB] min-h-screen", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-white rounded-3xl p-8 border border-gray-100 shadow-sm mb-8", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-col sm:flex-row gap-3 mt-8", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: `/partners/withdraw/${wallet._id}`, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { className: "bg-[#312E81] text-white px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:opacity-90 transition-opacity w-full sm:w-auto", children: "\u2197 Withdraw" }, void 0, false, {
          fileName: "app/routes/partners.wallet.tsx",
          lineNumber: 293,
          columnNumber: 12
        }, this) }, void 0, false, {
        ...
        wallet.business_withdrawal_pin_set ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: `/partners/addwithdrawalaccount/${wallet._id}`, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "Add withdrawal account" }, void 0, false, {
          fileName: "app/routes/partners.wallet.tsx",
          lineNumber: 299,
          columnNumber: 15
        }, this) }, void 0, false, {
...
//# sourceMappingURL=/build/routes/partners.wallet-KCJDRV4B.js.map
