import {
  CategoryInputs,
  StageInputs
} from "/build/_shared/chunk-REXOZGM4.js";
import {
  Select
...
import {
  useFilePreview
} from "/build/_shared/chunk-B3C7PCFE.js";
import {
  RoundCta_default
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1769412131833.5088";
}
function EditContestForm({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Form, { className: "max-w-[700px] mx-auto grid gap-6 sm:gap-12 text-sm", method: "post", encType: "multipart/form-data", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("fieldset", { className: "grid gap-3 sm:gap-6 sm:grid-cols-2", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("legend", { className: "text-lg mb-4 font-bold", children: "Contestants and Referrals Earnings (Can only be edited before contest starts)" }, void 0, false, {
        fileName: "app/components/admin/tournament/EditContestForm.tsx",
        lineNumber: 83,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(FormControl, { as: "input", type: "number", step: 1, max: 100, min: 0, labelText: "Contestant Share Percentage", id: "contestant_share_percent", name: "contestant_share_percent", defaultValue: contest.tally_vote_split_earnings.contestant_share_percent, readOnly: contest.status !== "yet_to_start" }, void 0, false, {
        fileName: "app/components/admin/tournament/EditContestForm.tsx",
        lineNumber: 84,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(FormControl, { as: "input", type: "number", labelText: "Minimum amount for affiliate to earn", id: "min_for_referral_earning", name: "min_for_referral_earning", defaultValue: contest.tally_vote_split_earnings.min_for_referral_earning, readOnly: contest.status !== "yet_to_start" }, void 0, false, {
        fileName: "app/components/admin/tournament/EditContestForm.tsx",
        lineNumber: 85,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(FormControl, { as: "input", type: "number", labelText: "Amount affiliate would earn from minimum", id: "referral_bonus_from_min", name: "referral_bonus_from_min", defaultValue: contest.tally_vote_split_earnings.referral_bonus_from_min, readOnly: contest.status !== "yet_to_start" }, void 0, false, {
        fileName: "app/components/admin/tournament/EditContestForm.tsx",
        lineNumber: 86,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(FormControl, { as: "input", type: "number", step: 1, max: 100, min: 0, labelText: "Affiliate percentage earnings after minimum", id: "referral_percent_after_min", name: "referral_percent_after_min", defaultValue: contest.tally_vote_split_earnings.referral_percent_after_min, readOnly: contest.status !== "yet_to_start" }, void 0, false, {
        fileName: "app/components/admin/tournament/EditContestForm.tsx",
        lineNumber: 87,
        columnNumber: 17
      }, this)
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1775371143560.0557";
}
...
//# sourceMappingURL=/build/routes/admin.contests.$contestId._index-QW3LA2XM.js.map
