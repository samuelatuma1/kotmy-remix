...
// app/routes/partners.addwithdrawalaccount.partner.$walletid.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/partners.addwithdrawalaccount.partner.$walletid.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1787177211002.1414";
}
var UserIcon = () => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-4 h-4 bg-white rounded-full mt-[-4px]" }, void 0, false, {
  fileName: "app/routes/partners.addwithdrawalaccount.partner.$walletid.tsx",
  lineNumber: 53,
  columnNumber: 7
}, this) }, void 0, false, {
  fileName: "app/routes/partners.addwithdrawalaccount.partner.$walletid.tsx",
...
function AccountTypePage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "min-h-screen bg-white flex flex-col items-center justify-center px-4 py-12", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "max-w-4xl w-full text-center", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Form, { method: "post", className: "mt-16", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 mb-12", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { onClick: () => updateSelectAccountType("partner"), className: `relative cursor-pointer transition-all duration-300 rounded-[40px] p-10 flex flex-col items-center text-center border-2 
...
//# sourceMappingURL=/build/routes/partners.addwithdrawalaccount.partner.$walletid-TPKD3HI3.js.map
