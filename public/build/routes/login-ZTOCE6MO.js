...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1785909612717.9167";
}
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", { className: "h-dvh bg-secondary p-4 flex flex-col", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { className: "grow flex flex-col justify-center items-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Form, { method: "POST", className: "w-full max-w-md p-4 sm:p-8 bg-white border rounded-3xl flex flex-col gap-3", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-center text-sm mt-2", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/signup", className: "text-primary underline", children: "Register" }, void 0, false, {
          fileName: "app/routes/login.tsx",
          lineNumber: 146,
          columnNumber: 90
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center justify-between gap-3 text-sm", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/forgotpassword", className: "text-primary underline", children: "Forgot Password?" }, void 0, false, {
          fileName: "app/routes/login.tsx",
          lineNumber: 154,
          columnNumber: 21
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/signup", className: "text-primary underline sm:hidden", children: "Register" }, void 0, false, {
          fileName: "app/routes/login.tsx",
          lineNumber: 155,
          columnNumber: 21
        }, this)
...
//# sourceMappingURL=/build/routes/login-ZTOCE6MO.js.map
