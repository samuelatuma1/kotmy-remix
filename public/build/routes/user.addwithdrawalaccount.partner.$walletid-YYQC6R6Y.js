...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/user.addwithdrawalaccount.partner.$walletid.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1771061934024.5195";
}
...
//# sourceMappingURL=/build/routes/user.addwithdrawalaccount.partner.$walletid-YYQC6R6Y.js.map
