...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1785086048744.4792";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1785086329387.7366";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1786802740135.26";
}
var primaryNavs = [{
  label: "Contests",
  icon: icons.adminHomeIcon,
  url: "/user/all-tournaments"
}, {
  label: "Winners",
  ...
  subitems: [{
    ...
    label: "Contestant Profiles",
    url: "/user/contestantprofiles"
  }, {
    label: "My Profile",
    url: "/user/profile"
  }, {
    ...
    label: "My Givaah Credits",
    url: "/user/givaah-credits"
  }, {
    label: "My Orders",
    url: "/user/orders"
  }]
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1786802751932.1436";
}
var navs = [{
  label: "Home",
  icon: icons.adminHomeIcon,
...
function UserNavigation({
  ...
  return show ? /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("header", { className: "bg-white border-r border-brand-grey hidden sm:flex flex-col justify-between min-w-[280px] h-full", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("aside", { className: "border-t border-brand-grey px-6 py-3", children: [
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1785037079884.7905";
}
var meta = () => {
  return [{
    title: "KOTMY | Admin"
...
//# sourceMappingURL=/build/routes/user-KT2KXVH6.js.map
