...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/user.addwithdrawalaccount.personal.$walletid.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1772375570424.1106";
}
...
//# sourceMappingURL=/build/routes/user.addwithdrawalaccount.personal.$walletid-VJIUPBXF.js.map
