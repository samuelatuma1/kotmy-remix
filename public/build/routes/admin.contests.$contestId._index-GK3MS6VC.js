import {
  CategoryInputs,
  StageInputs
} from "/build/_shared/chunk-24XDRNMO.js";
import {
  Select
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1760080481937.2842";
}
function EditContestForm({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Form, { className: "max-w-[700px] mx-auto grid gap-6 sm:gap-12 text-sm", method: "post", encType: "multipart/form-data", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("fieldset", { className: "grid gap-3 sm:gap-6 sm:grid-cols-2", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(FormControl, { as: "input", type: "date", labelText: "Registration Deadline", id: "reg_deadline", name: "reg_deadline", defaultValue: parseDateForInput(contest.reg_deadline), required: true }, void 0, false, {
        fileName: "app/components/admin/tournament/EditContestForm.tsx",
        lineNumber: 70,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(FormControl, { as: "input", type: "date", labelText: "Contest Start Date", id: "start_date", name: "start_date", defaultValue: parseDateForInput(contest.start_date), required: true }, void 0, false, {
        fileName: "app/components/admin/tournament/EditContestForm.tsx",
        lineNumber: 71,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(FormControl, { as: "input", type: "date", labelText: "Contest End Date", id: "end_date", name: "end_date", defaultValue: parseDateForInput(contest.end_date), required: true }, void 0, false, {
        fileName: "app/components/admin/tournament/EditContestForm.tsx",
        lineNumber: 72,
        columnNumber: 17
      }, this),
...
//# sourceMappingURL=/build/routes/admin.contests.$contestId._index-GK3MS6VC.js.map
