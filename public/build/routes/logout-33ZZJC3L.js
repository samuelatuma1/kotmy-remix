import {
  useUserManager
} from "/build/_shared/chunk-6B4B2FMH.js";
import {
  Link2 as Link,
  useSearchParams
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1761799526320.164";
}
...
function Logout() {
  _s2();
  useLogoutController();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", { className: "h-dvh bg-secondary p-4 flex flex-col justify-center items-center", children: [
...
//# sourceMappingURL=/build/routes/logout-33ZZJC3L.js.map
