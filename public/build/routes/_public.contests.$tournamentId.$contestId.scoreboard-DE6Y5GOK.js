import {
  ...
  TallyVoteDialog,
  VoteLink_default
} from "/build/_shared/chunk-2J36IDU7.js";
...
import {
  ContestTimer
} from "/build/_shared/chunk-FSE6OMSF.js";
import {
  Button
...
import "/build/_shared/chunk-LRNROA4B.js";
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1784482683693.2693";
}
function MobileScoreboard({
  ...
  const [signInPrompt, setSignInPrompt] = (0, import_react3.useState)(false);
  const {
    getUserStoreManager
  } = useUserManager();
  ...
  return signInPrompt ? /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "w-full max-w-xl bg-white border rounded-3xl shadow-lg flex flex-col items-center justify-center gap-6 py-12 px-6 sm:px-12 text-center", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("p", { className: "text-sm text-gray-400 mt-2", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("span", { className: "underline text-accent cursor-pointer", onClick: () => navigate(`/signup?redirectTo=${encodeURIComponent(path)}`), children: "Sign up here" }, void 0, false, {
        fileName: "app/components/public/contests/MobileScoreboard.tsx",
        lineNumber: 71,
        columnNumber: 90
      }, this)
    ...
    lineNumber: 58,
    columnNumber: 25
  }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "grid gap-6 sm:hidden", children: contestants.map((contestant) => /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("article", { className: "bg-secondary border border-primary rounded-xl p-3 w-full", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "grid grid-cols-3 gap-3", children: [
      socialMediaType === "kotmy" ? /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(fetcher.Form, { method: "POST", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(VoteLink_default, { className: "w-full", type: socialMediaType, onClick: () => {
          const user = getUserStoreManager();
          if (!user) {
            setSignInPrompt(true);
          }
        }, url: contestant.social_media_url, count: numberSlang(contestant.vote.social_media) }, void 0, false, {
          fileName: "app/components/public/contests/MobileScoreboard.tsx",
          lineNumber: 91,
          columnNumber: 33
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(GivaahVoteDialog, { contestant }, void 0, false, {
        fileName: "app/components/public/contests/MobileScoreboard.tsx",
        lineNumber: 99,
        columnNumber: 25
      }, this)
...
_s2(MobileScoreboard, "PUO0DZTa2u7pJStgXc1TJW7Jih8=", false, function() {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1785100656674.4512";
}
function ScoreboardTable({
  ...
  _s3();
  const fetcher = useFetcher();
  const [signInPrompt, setSignInPrompt] = (0, import_react5.useState)(false);
  const {
    getUserStoreManager
  } = useUserManager();
  const navigate = useNavigate();
  ...
  return signInPrompt ? (
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "w-full flex items-center justify-center py-12", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "w-full max-w-xl bg-white border rounded-3xl shadow-lg flex flex-col items-center justify-center gap-6 py-10 px-6 sm:px-12 text-center", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("p", { className: "text-gray-700 text-base max-w-md", children: "Voting for your favourite contestant requires you to sign in" }, void 0, false, {
        fileName: "app/components/public/contests/ScoreboardTable.tsx",
        lineNumber: 61,
        columnNumber: 21
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "w-full sm:w-auto flex flex-col sm:flex-row gap-3 items-center mt-2", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Button, { element: "button", onClick: () => setSignInPrompt(false), className: "w-full sm:w-auto justify-center items-center gap-2 px-6 py-3 rounded-lg font-medium border border-gray-200 bg-white text-gray-700 hover:bg-gray-50 transition", children: "Go back" }, void 0, false, {
          fileName: "app/components/public/contests/ScoreboardTable.tsx",
          lineNumber: 63,
          columnNumber: 25
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Button, { element: "button", onClick: () => navigate(`/login?redirectTo=${encodeURIComponent(path)}`), className: "w-full sm:inline-flex sm:w-auto justify-center items-center gap-2 px-6 py-3 rounded-lg font-semibold bg-accent text-white hover:bg-accent/90 transition", children: "Sign In" }, void 0, false, {
          fileName: "app/components/public/contests/ScoreboardTable.tsx",
          lineNumber: 66,
          columnNumber: 25
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("p", { className: "text-sm text-gray-400 mt-2", children: [
        "Don't have an account? ",
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("button", { type: "button", className: "underline text-accent", onClick: () => navigate(`/signup?redirectTo=${encodeURIComponent(path)}`), children: "Sign up here" }, void 0, false, {
          fileName: "app/components/public/contests/ScoreboardTable.tsx",
          lineNumber: 72,
          columnNumber: 86
        }, this)
  ...
  ) : /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("table", { className: "w-full table-auto hidden sm:table", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("thead", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("tr", { className: "border-b border-secondary", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("th", { className: "text-left uppercase text-sm font-satoshi-bold px-6 py-3", children: "votes (SM, Prize back, givaah)" }, void 0, false, {
        fileName: "app/components/public/contests/ScoreboardTable.tsx",
        lineNumber: 81,
        columnNumber: 21
      }, this),
      show_bonus && /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(import_jsx_dev_runtime4.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("th", { className: "text-left uppercase text-sm font-satoshi-bold px-6 py-3", children: "SMB" }, void 0, false, {
          fileName: "app/components/public/contests/ScoreboardTable.tsx",
          lineNumber: 84,
          columnNumber: 29
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("th", { className: "text-left uppercase text-sm font-satoshi-bold px-6 py-3", children: "TB" }, void 0, false, {
          fileName: "app/components/public/contests/ScoreboardTable.tsx",
          lineNumber: 85,
          columnNumber: 29
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("th", { className: "text-left uppercase text-sm font-satoshi-bold px-6 py-3", children: "GB" }, void 0, false, {
          fileName: "app/components/public/contests/ScoreboardTable.tsx",
          lineNumber: 86,
          columnNumber: 29
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("th", { className: "text-left uppercase text-sm font-satoshi-bold px-6 py-3", children: "JB" }, void 0, false, {
          fileName: "app/components/public/contests/ScoreboardTable.tsx",
          lineNumber: 87,
          columnNumber: 29
        }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("tbody", { children: contestants.map((contestant) => /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("tr", { className: "border-b border-secondary", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("td", { className: "px-6 py-3 font-satoshi-medium max-w-[300px]  trunc_ uppercase", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: " trunc_ uppercase grow", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("td", { className: "px-6 py-3 grid grid-cols-2 gap-2", children: [
        socialMediaType === "kotmy" ? /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(fetcher.Form, { method: "POST", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(VoteLink_default, { className: "w-full", type: socialMediaType, onClick: () => {
            const user = getUserStoreManager();
            if (!user) {
              setSignInPrompt(true);
            }
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(GivaahVoteDialog, { contestant }, void 0, false, {
          fileName: "app/components/public/contests/ScoreboardTable.tsx",
          lineNumber: 129,
          columnNumber: 29
        }, this)
      ...
      show_bonus && /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(import_jsx_dev_runtime4.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("td", { className: "px-6 py-3", children: contestant.vote.social_media_bonus }, void 0, false, {
          fileName: "app/components/public/contests/ScoreboardTable.tsx",
          lineNumber: 133,
          columnNumber: 33
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("td", { className: "px-6 py-3", children: contestant.vote.tally_bonus }, void 0, false, {
          fileName: "app/components/public/contests/ScoreboardTable.tsx",
          lineNumber: 136,
          columnNumber: 33
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("td", { className: "px-6 py-3", children: contestant.vote.givaah_bonus }, void 0, false, {
          fileName: "app/components/public/contests/ScoreboardTable.tsx",
          lineNumber: 139,
          columnNumber: 33
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("td", { className: "px-6 py-3", children: contestant.vote.judge_bonus }, void 0, false, {
          fileName: "app/components/public/contests/ScoreboardTable.tsx",
          lineNumber: 142,
          columnNumber: 33
        }, this)
...
_s3(ScoreboardTable, "PUO0DZTa2u7pJStgXc1TJW7Jih8=", false, function() {
  return [useFetcher, useUserManager, useNavigate, useLocation];
});
_c4 = ScoreboardTable;
var _c4;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1785510079871.4841";
}
function Scoreboard() {
  _s4();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("main", { className: "grow", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("section", { className: "sm:bg-white", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "wrapper my-16", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex flex-col sm:flex-row justify-between sm:items-center gap-y-4 gap-x-6 sm:gap-x-8 py-6 flex-wrap", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex flex-wrap gap-4", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Link, { to: `/contests/${contest.tournament_unique_id}/${contest.id}`, className: "w-fit text-accent font-bold hover:underline underline-offset-4", children: "See contestants" }, void 0, false, {
            fileName: "app/routes/_public.contests.$tournamentId.$contestId.scoreboard.tsx",
            lineNumber: 109,
            columnNumber: 29
          }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(ScoreboardTable, { contestants: stage?.contestants ?? [], socialMediaType: stage?.rates.social_media.type ?? "kotmy", show_bonus: stage?.enable_bonus ?? false }, void 0, false, {
        fileName: "app/routes/_public.contests.$tournamentId.$contestId.scoreboard.tsx",
        lineNumber: 112,
        columnNumber: 21
      }, this),
...
//# sourceMappingURL=/build/routes/_public.contests.$tournamentId.$contestId.scoreboard-DE6Y5GOK.js.map
