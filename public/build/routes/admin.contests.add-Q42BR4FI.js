...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1769412131833.49";
}
function CreateContestForm({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Form, { className: "max-w-[700px] mx-auto my-8 grid gap-6 sm:gap-12 text-sm", method: "post", encType: "multipart/form-data", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("fieldset", { className: "grid gap-3 sm:gap-6 sm:grid-cols-2", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("legend", { className: "text-lg mb-4 font-bold", children: "Contestants and Referrals Earnings" }, void 0, false, {
        fileName: "app/components/admin/tournament/CreateContestForm.tsx",
        lineNumber: 58,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(FormControl, { as: "input", type: "number", step: 1, max: 100, min: 0, labelText: "Contestant Share Percentage", id: "contestant_share_percent", name: "contestant_share_percent", defaultValue: 50, required: true }, void 0, false, {
        fileName: "app/components/admin/tournament/CreateContestForm.tsx",
        lineNumber: 59,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(FormControl, { as: "input", type: "number", labelText: "Minimum amount for affiliate to earn", id: "min_for_referral_earning", name: "min_for_referral_earning", defaultValue: 3e3, required: true }, void 0, false, {
        fileName: "app/components/admin/tournament/CreateContestForm.tsx",
        lineNumber: 60,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(FormControl, { as: "input", type: "number", labelText: "Amount affiliate would earn from minimum", id: "referral_bonus_from_min", name: "referral_bonus_from_min", defaultValue: 500, required: true }, void 0, false, {
        fileName: "app/components/admin/tournament/CreateContestForm.tsx",
        lineNumber: 61,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(FormControl, { as: "input", type: "number", step: 1, max: 100, min: 0, labelText: "Affiliate percentage earnings after minimum", id: "referral_percent_after_min", name: "referral_percent_after_min", defaultValue: 1, required: true }, void 0, false, {
        fileName: "app/components/admin/tournament/CreateContestForm.tsx",
        lineNumber: 62,
        columnNumber: 17
      }, this)
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1775369977103.918";
}
function AddContest() {
  _s2();
  const {
...
//# sourceMappingURL=/build/routes/admin.contests.add-Q42BR4FI.js.map
