import {
  ContestCard
} from "/build/_shared/chunk-OVVTIZRK.js";
import {
  require_contest
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1785102598354.296";
}
function Results() {
  _s();
  const {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", { className: "grow", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("header", { className: "wrapper my-10 sm:my-14", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "overflow-hidden rounded-[2rem] border border-brand-grey bg-white shadow-[0_18px_60px_rgba(14,42,77,0.08)]", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "grid gap-8 lg:grid-cols-[1.1fr_0.9fr]", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "relative overflow-hidden bg-gradient-to-br from-brand-navy via-brand-navy to-brand-pink px-6 py-10 text-white sm:px-8 sm:py-12 lg:px-10 lg:py-14", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-stretch p-6 sm:p-8 lg:p-10", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex w-full flex-col justify-between rounded-[1.75rem] border border-brand-grey bg-secondary p-5 shadow-[0_10px_30px_rgba(14,42,77,0.05)] sm:p-6", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-6 grid gap-3 sm:grid-cols-2", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(HeroStat, { label: "Contests", value: String(contests.items.length) }, void 0, false, {
            fileName: "app/routes/_public.results._index.tsx",
            lineNumber: 91,
            columnNumber: 19
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(HeroStat, { label: "Mode", value: "White-first" }, void 0, false, {
            fileName: "app/routes/_public.results._index.tsx",
            lineNumber: 92,
            columnNumber: 19
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(HeroStat, { label: "Rankings", value: "Celebrated" }, void 0, false, {
            fileName: "app/routes/_public.results._index.tsx",
            lineNumber: 93,
            columnNumber: 19
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(HeroStat, { label: "Style", value: "Premium" }, void 0, false, {
            fileName: "app/routes/_public.results._index.tsx",
            lineNumber: 94,
            columnNumber: 19
          }, this)
...
//# sourceMappingURL=/build/routes/_public.results._index-3KCY42CZ.js.map
