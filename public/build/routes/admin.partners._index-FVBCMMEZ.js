...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1777175794235.7087";
}
var statusColors = {
...
function PartnersIndex() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", { className: "w-full overflow-y-auto p-6", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "sm:hidden grid gap-4 my-6", children: partnersRes.items && partnersRes.items.length > 0 ? partnersRes.items.map((partner) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "rounded-xl border border-gray-100 bg-white shadow-sm p-4 flex flex-col gap-2", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex gap-2 mt-3", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { className: "bg-green-600 text-white px-3 py-1 rounded-lg text-xs font-semibold flex-1", children: "Approve" }, void 0, false, {
          fileName: "app/routes/admin.partners._index.tsx",
          lineNumber: 103,
          columnNumber: 17
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { className: "bg-red-500 text-white px-3 py-1 rounded-lg text-xs font-semibold flex-1", children: "Reject" }, void 0, false, {
          fileName: "app/routes/admin.partners._index.tsx",
          lineNumber: 104,
          columnNumber: 17
        }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "hidden sm:block w-full overflow-x-auto", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("table", { className: "w-full table-auto border rounded-xl overflow-hidden", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("tbody", { children: partnersRes.items && partnersRes.items.length > 0 ? partnersRes.items.map((partner) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("tr", { className: "border-b last:border-b-0 hover:bg-gray-50", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("td", { className: "px-4 py-3", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { className: "bg-green-600 text-white px-3 py-1 rounded-lg text-xs font-semibold mr-2", children: "Approve" }, void 0, false, {
            fileName: "app/routes/admin.partners._index.tsx",
            lineNumber: 140,
            columnNumber: 21
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { className: "bg-red-500 text-white px-3 py-1 rounded-lg text-xs font-semibold", children: "Reject" }, void 0, false, {
            fileName: "app/routes/admin.partners._index.tsx",
            lineNumber: 141,
            columnNumber: 21
          }, this)
...
//# sourceMappingURL=/build/routes/admin.partners._index-FVBCMMEZ.js.map
