...
// app/global.css
var global_default = "/build/_assets/global-42HJREBE.css";
...
async function loader11({ request }) {
  ...
  return referralBoardRes.authRequired ? redirect9("/login") : json12({ wallets: walletsResponse.data, referralBoardRes: referralBoardRes.data, query });
}
...
import { Link as Link10, useActionData as useActionData3, useLoaderData as useLoaderData10, useFetcher as useFetcher6 } from "@remix-run/react";
import { useState as useState20, useMemo as useMemo2, useEffect as useEffect14 } from "react";
...
async function loader12({ request }) {
  ...
  return console.log("CLOSER", wallets), json13({ wallets });
}
async function action7({ request }) {
  ...
  return console.log("WALLET RESP", walletResp, wallets), json13({ wallets });
}
function useWalletController() {
  let { wallets } = useLoaderData10(), { setUserStoreManager, getUserStoreManager } = useUserManager(), [user, setUser] = useState20(null);
  console.log(wallets);
  let [activeWalletId, setActiveWalletId] = useState20(
  ...
  let activeData = useMemo2(() => wallets.find((w) => w.wallet._id === activeWalletId) || null, [activeWalletId, wallets]), formatCurrency = (amount, currency) => new Intl.NumberFormat("en-US", {
    style: "currency",
    currency
  }).format(amount), [searchOpen, setSearchOpen] = useState20(!1), fetcher = useFetcher6(), isSubmitting = fetcher.state === "submitting", actionData = useActionData3(), [walletsState, setWalletsState] = useState20(wallets);
  return useEffect14(() => {
    (fetcher.data?.wallets ?? actionData?.wallets) || setWalletsState(wallets);
  }, [wallets, fetcher.data, actionData]), useEffect14(() => {
...
function WalletPage() {
  ...
  if (!activeData)
    return /* @__PURE__ */ jsx57("div", { className: "p-8", children: "No wallets found." });
  ...
  return /* @__PURE__ */ jsxs44("div", { className: "p-8 max-w-7xl mx-auto bg-[#F9FAFB] min-h-screen", children: [
    /* @__PURE__ */ jsx57("h1", { className: "text-2xl font-semibold mb-6", children: "Wallet" }),
    /* @__PURE__ */ jsxs44("div", { className: "bg-white rounded-3xl p-8 border border-gray-100 shadow-sm mb-8", children: [
      /* @__PURE__ */ jsxs44("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxs44("div", { className: "flex items-center gap-2 text-gray-500", children: [
          /* @__PURE__ */ jsx57("span", { className: "text-sm", children: "Wallet balances" }),
          /* @__PURE__ */ jsx57("button", { className: "hover:bg-gray-100 p-1 rounded-full", children: "\u{1F441}\uFE0F" })
        ] }),
        /* @__PURE__ */ jsx57(
          "select",
          {
            ...
            children: walletsState.map((w) => /* @__PURE__ */ jsxs44("option", { value: w.wallet._id, children: [
      ...
      /* @__PURE__ */ jsx57("div", { className: "flex justify-between items-start", children: /* @__PURE__ */ jsxs44("div", { children: [
        /* @__PURE__ */ jsx57("div", { className: "text-4xl font-bold mb-1", children: formatCurrency(wallet.withdrawable_balance, wallet.wallet_currency) }),
        /* @__PURE__ */ jsx57("div", { className: "text-gray-400 text-sm", children: wallet.wallet_name })
      ] }) }),
      /* @__PURE__ */ jsxs44("div", { className: "flex flex-col sm:flex-row gap-3 mt-8", children: [
        /* @__PURE__ */ jsx57(Link10, { to: `/user/withdraw/${wallet._id}`, children: /* @__PURE__ */ jsx57("button", { className: "bg-[#312E81] text-white px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:opacity-90 transition-opacity w-full sm:w-auto", children: "\u2197 Withdraw" }) }),
        user?.withdrawal_pin_set ? /* @__PURE__ */ jsx57(Link10, { to: `/user/addwithdrawalaccount/${wallet._id}`, children: /* @__PURE__ */ jsx57("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "Add withdrawal account" }) }) : /* @__PURE__ */ jsx57(Link10, { to: "/user/setwithdrawalpin", children: /* @__PURE__ */ jsx57("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "+ Set withdrawal PIN" }) }),
        /* @__PURE__ */ jsx57("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "\u21C4 Transfer to another wallet" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs44("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxs44("div", { className: "flex items-center justify-between mb-3", children: [
        /* @__PURE__ */ jsx57("h2", { className: "text-lg font-medium text-gray-700", children: "Search" }),
        /* @__PURE__ */ jsxs44(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsx57("span", { children: searchOpen ? "Hide" : "Show" }),
              /* @__PURE__ */ jsx57(
                "svg",
                {
                  ...
                  children: /* @__PURE__ */ jsx57("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M19 9l-7 7-7-7" })
                }
              )
            ]
          }
      ...
      /* @__PURE__ */ jsx57("div", { className: `transition-all ${searchOpen ? "overflow-scroll max-h-96" : "overflow-hidden max-h-0"}`, children: /* @__PURE__ */ jsx57("div", { className: "bg-white border border-gray-100 rounded-xl p-4 shadow-sm", children: /* @__PURE__ */ jsxs44(fetcher.Form, { method: "post", className: "grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm", children: [
        /* @__PURE__ */ jsxs44("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx57("span", { className: "mb-1", children: "Transaction type" }),
          /* @__PURE__ */ jsxs44("select", { id: "transaction_type", name: "transaction_type", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx57("option", { value: "", children: "All transaction types" }),
            /* @__PURE__ */ jsx57("option", { value: "credit", children: "Credit" }),
            /* @__PURE__ */ jsx57("option", { value: "debit", children: "Debit" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs44("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx57("span", { className: "mb-1", children: "Status" }),
          /* @__PURE__ */ jsxs44("select", { id: "status", name: "status", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx57("option", { value: "", children: "Any status" }),
            /* @__PURE__ */ jsx57("option", { value: "pending", children: "Pending" }),
            /* @__PURE__ */ jsx57("option", { value: "completed", children: "Completed" }),
            /* @__PURE__ */ jsx57("option", { value: "void", children: "Void" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs44("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx57("span", { className: "mb-1", children: "Min amount" }),
          /* @__PURE__ */ jsx57("input", { id: "min_amount", name: "min_amount", type: "number", step: "0.01", placeholder: "Min amount", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs44("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx57("span", { className: "mb-1", children: "Max amount" }),
          /* @__PURE__ */ jsx57("input", { id: "max_amount", name: "max_amount", type: "number", step: "0.01", placeholder: "Max amount", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs44("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx57("span", { className: "mb-1", children: "From date" }),
          /* @__PURE__ */ jsx57("input", { id: "min_created_at", name: "min_created_at", type: "date", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs44("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx57("span", { className: "mb-1", children: "To date" }),
          /* @__PURE__ */ jsx57("input", { id: "max_created_at", name: "max_created_at", type: "date", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs44("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx57("span", { className: "mb-1", children: "Payment method" }),
          /* @__PURE__ */ jsxs44("select", { id: "payment_method", name: "payment_method", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx57("option", { value: "", children: "Any payment method" }),
            /* @__PURE__ */ jsx57("option", { value: "flutterwave", children: "Flutterwave" }),
            /* @__PURE__ */ jsx57("option", { value: "bank", children: "Bank" }),
            /* @__PURE__ */ jsx57("option", { value: "paystack", children: "Paystack" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs44("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx57("span", { className: "mb-1", children: "Contest code" }),
          /* @__PURE__ */ jsx57("input", { id: "contest_code", name: "contest_code", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsx57("input", { type: "hidden", name: "wallet_id", value: wallet._id }),
        /* @__PURE__ */ jsx57("div", { className: "sm:col-span-3 flex justify-end mt-2", children: /* @__PURE__ */ jsx57("button", { type: "submit", disabled: isSubmitting, className: "px-4 py-2 bg-[#312E81] text-white rounded-lg text-sm disabled:opacity-50", children: isSubmitting ? "Searching..." : "Search" }) })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxs44("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxs44("div", { className: "flex items-center gap-2 text-gray-600 mb-4", children: [
        /* @__PURE__ */ jsx57("span", { children: "\u{1F4C1}" }),
        /* @__PURE__ */ jsxs44("h2", { className: "font-medium", children: [
          "Recent wallet activity (",
          wallet.wallet_currency,
          ")"
        ] })
      ] }),
      /* @__PURE__ */ jsxs44("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-12 mb-8 border-b border-gray-100 pb-6", children: [
        /* @__PURE__ */ jsx57(
          MetricItem,
          {
      ...
      /* @__PURE__ */ jsx57("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs44("table", { className: "w-full text-left text-sm", children: [
        /* @__PURE__ */ jsx57("thead", { children: /* @__PURE__ */ jsxs44("tr", { className: "text-gray-400 border-b", children: [
          /* @__PURE__ */ jsx57("th", { className: "pb-4 font-medium", children: "S/N" }),
          /* @__PURE__ */ jsx57("th", { className: "pb-4 font-medium", children: "Date" }),
          /* @__PURE__ */ jsx57("th", { className: "pb-4 font-medium", children: "Ref ID" }),
          /* @__PURE__ */ jsx57("th", { className: "pb-4 font-medium", children: "Narration" }),
          /* @__PURE__ */ jsx57("th", { className: "pb-4 font-medium", children: "Beneficiary name" }),
          /* @__PURE__ */ jsx57("th", { className: "pb-4 font-medium", children: "Type" }),
          /* @__PURE__ */ jsx57("th", { className: "pb-4 font-medium", children: "Amount" })
        ] }) }),
        /* @__PURE__ */ jsx57("tbody", { className: "divide-y", children: pagedLedgers.items.map((item, idx) => /* @__PURE__ */ jsxs44("tr", { className: "hover:bg-gray-50/50 transition-colors", children: [
          /* @__PURE__ */ jsx57("td", { className: "py-4 text-gray-500", children: idx + 1 }),
          /* @__PURE__ */ jsxs44("td", { className: "py-4 text-gray-900 leading-tight", children: [
            new Date(item.completed_at || "").toLocaleDateString(),
            /* @__PURE__ */ jsx57("div", { className: "text-xs text-gray-400", children: new Date(item.completed_at || "").toLocaleTimeString() })
          ] }),
          /* @__PURE__ */ jsx57("td", { className: "py-4 text-gray-600 font-mono text-xs", children: item.payment_ref }),
          /* @__PURE__ */ jsx57("td", { className: "py-4 text-gray-600 max-w-xs", children: item.description }),
          /* @__PURE__ */ jsx57("td", { className: "py-4 text-gray-600 truncate", children: item.wallet_name }),
          /* @__PURE__ */ jsx57("td", { className: "py-4 uppercase text-xs font-semibold", children: item.entry_type }),
          /* @__PURE__ */ jsx57("td", { className: "py-4", children: /* @__PURE__ */ jsxs44("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx57("span", { className: `font-semibold ${item.entry_type === "credit" ? "text-green-600" : "text-gray-900"}`, children: formatCurrency(item.amount, item.currency) }),
            /* @__PURE__ */ jsx57(StatusBadge, { status: item.status })
          ] }) })
        ] }, item._id)) })
      ] }) }),
      /* @__PURE__ */ jsxs44("div", { className: "mt-6 flex justify-between items-center text-sm text-gray-500", children: [
        ...
        /* @__PURE__ */ jsx57(Pagination, { lastKey: pagedLedgers.last_key_id, pageSize: pagedLedgers.items_per_page, firstKey: pagedLedgers.first_key_id })
      ] })
    ] })
  ] });
}
function MetricItem({ label, value, tooltip = !1 }) {
  return /* @__PURE__ */ jsxs44("div", { children: [
    /* @__PURE__ */ jsxs44("div", { className: "text-xs text-gray-400 flex items-center gap-1 mb-1", children: [
      label,
      " ",
      tooltip && /* @__PURE__ */ jsx57("span", { className: "bg-gray-200 rounded-full w-3 h-3 text-[8px] flex items-center justify-center text-white", children: "i" })
    ] }),
    /* @__PURE__ */ jsx57("div", { className: "text-lg font-bold text-gray-800", children: value })
  ] });
}
function StatusBadge({ status }) {
  ...
  return /* @__PURE__ */ jsxs44("span", { className: `px-2 py-0.5 rounded-full text-[10px] font-medium border flex items-center gap-1 ${styles[status] || ""}`, children: [
    icons2[status],
    " ",
    status
  ] });
...
import { useLoaderData as useLoaderData11, useNavigate as useNavigate10 } from "@remix-run/react";
...
function Select2({ children, containerClass, className, label, ...selectProps }) {
  return /* @__PURE__ */ jsxs45("label", { className: "font-bold", children: [
    label,
    /* @__PURE__ */ jsx58("div", { className: `border hover:border-primary rounded-lg font-normal overflow-hidden ${containerClass}`, children: /* @__PURE__ */ jsx58("select", { className: `bg-transparent focus:outline-none p-3 mr-2 cursor-pointer w-[98%] ${className}`, ...selectProps, children }) })
  ] });
}
...
function CategoryInputs({ categories }) {
  let [newCategory, setNewCategory] = useState21(""), [catogories, setCategories] = useState21(categories ?? []);
  ...
  return /* @__PURE__ */ jsxs46("div", { children: [
    /* @__PURE__ */ jsx59("span", { className: "font-bold", children: "Categories" }),
    /* @__PURE__ */ jsxs46("fieldset", { className: "grid gap-3 sm:gap-6 sm:grid-cols-3 border border-secondary p-3 rounded-lg", children: [
      catogories.map((category) => /* @__PURE__ */ jsxs46("div", { className: "p-3 rounded-lg border border-secondary flex items-center", children: [
        /* @__PURE__ */ jsx59("input", { type: "text", className: "grow pointer-events-none bg-transparent", name: "category", defaultValue: category }),
        /* @__PURE__ */ jsx59("button", { type: "button", children: /* @__PURE__ */ jsx59(
          Svg,
          {
            src: icons.closeIcon,
            width: ".9em",
      ...
      /* @__PURE__ */ jsxs46("div", { className: "flex max-sm:flex-col gap-3 sm:gap-6 sm:items-end sm:col-span-3", children: [
        /* @__PURE__ */ jsx59(FormControl, { as: "input", placeholder: "Enter new category", id: "new_catogory", value: newCategory, onChange: (e) => setNewCategory(e.target.value) }),
        /* @__PURE__ */ jsxs46(
          "button",
          {
            type: "button",
...
function StageInputs({ stages }) {
  ...
  return /* @__PURE__ */ jsxs47("div", { children: [
    /* @__PURE__ */ jsxs47("span", { className: "font-bold", children: [
      "Stages ",
      /* @__PURE__ */ jsx60("span", { className: "font-normal", children: "(weights must sum up to 100%)" })
    ] }),
    /* @__PURE__ */ jsxs47("div", { className: "grid gap-4 border border-secondary p-3 rounded-lg", children: [
      stagesState.map((stage, index) => /* @__PURE__ */ jsxs47("div", { className: "flex gap-4 items-end", children: [
        /* @__PURE__ */ jsxs47("fieldset", { className: "grow grid gap-3 sm:gap-6 sm:grid-cols-3", children: [
          /* @__PURE__ */ jsx60(FormControl, { as: "input", type: "number", labelText: "Stage", id: `Stage_${index + 1}`, value: stage.stage, onChange: (e) => dispatch2({ type: "edit_stage_number", stageNumber: stage.stage, value: +e.target.value }) }),
          /* @__PURE__ */ jsx60(FormControl, { as: "input", type: "number", labelText: "Stage Weight (%)", id: `weight_${index + 1}`, name: `weight_${index + 1}`, value: stage?.weight ?? 0, min: 0, onChange: (e) => dispatch2({ type: "edit_stage_weight", stageNumber: stage.stage, value: +e.target.value }) }),
          /* @__PURE__ */ jsx60(Select2, { label: "Social Media", id: `social_media_${index + 1}`, name: `social_media_${index + 1}`, className: "capitalize", value: stage?.rates?.social_media.type ?? "", onChange: (e) => dispatch2({ type: "edit_sm_type", stageNumber: stage.stage, value: e.target.value }), children: socials.map((social) => /* @__PURE__ */ jsx60("option", { value: social, children: social }, social)) }),
          stage._id ? /* @__PURE__ */ jsx60("input", { type: "hidden", name: `stage_${index + 1}_id`, value: stage._id }) : null
        ] }),
        stage._id ? /* @__PURE__ */ jsx60("button", { type: "submit", className: "m-4", title: "delete stage", name: "intent", value: stage._id, children: /* @__PURE__ */ jsx60(Svg, { src: icons.closeIcon, width: ".9em", className: "hover:text-red-400" }) }) : /* @__PURE__ */ jsx60("button", { type: "button", className: "m-4", value: stage._id, onClick: () => dispatch2({ type: "remove", stageNumber: stage.stage }), children: /* @__PURE__ */ jsx60(Svg, { src: icons.closeIcon, width: ".9em", className: "hover:text-red-400" }) })
      ] }, stage.stage)),
      /* @__PURE__ */ jsxs47(
        "button",
        {
    ...
    /* @__PURE__ */ jsx60("input", { type: "hidden", name: "no_of_stages", value: stagesState.length })
  ] });
}
...
function EditContestForm({ tournaments, contest }) {
  let [fileList, setFileList] = useState22(null), { filePreview, clearFilePreview, fileName } = useFilePreview(fileList);
  return console.log(contest), /* @__PURE__ */ jsxs48(Form10, { className: "max-w-[700px] mx-auto grid gap-6 sm:gap-12 text-sm", method: "post", encType: "multipart/form-data", children: [
    /* @__PURE__ */ jsx61("h1", { className: "text-2xl font-bold text-primary", children: "Contest Details" }),
    /* @__PURE__ */ jsxs48("div", { className: "flex items-center gap-x-5", children: [
      filePreview ? /* @__PURE__ */ jsx61("img", { className: "w-20 h-20 rounded-lg object-cover", src: filePreview, alt: "chosen image" }) : /* @__PURE__ */ jsx61("img", { className: "w-20 h-20 rounded-lg object-cover", src: contest.image || no_image_default, alt: "Contest banner" }),
      /* @__PURE__ */ jsxs48("div", { className: "flex flex-col items-start gap-2 max-xs:text-xs", children: [
        /* @__PURE__ */ jsxs48("label", { htmlFor: "image", className: "border-2 border-secondary text-primary cursor-pointer font-semibold py-2 px-4 rounded-lg", children: [
          "Change Photo",
          /* @__PURE__ */ jsx61("input", { id: "image", name: "image", type: "file", onChange: (e) => {
            setFileList(e.currentTarget.files);
          }, className: "hidden" })
        ] }),
        /* @__PURE__ */ jsxs48("span", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx61("span", { children: fileName || "PNG, JPG (max. 1440x900px)" }),
          fileName ? /* @__PURE__ */ jsx61(Svg, { src: icons.closeIcon, onClick: clearFilePreview, className: "text-red-600 cursor-pointer" }) : null
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs48("fieldset", { className: "grid gap-3 sm:gap-6 sm:grid-cols-2", children: [
      /* @__PURE__ */ jsxs48(Select2, { name: "tournament", id: "tournament", label: "Tournament", className: "uppercase", defaultValue: contest.tournament_unique_id, required: !0, children: [
        /* @__PURE__ */ jsx61("option", { value: "", children: "Select a tournament" }),
        tournaments.map((tournament) => /* @__PURE__ */ jsx61("option", { value: tournament.id, children: tournament.id }, tournament.id))
      ] }),
      /* @__PURE__ */ jsx61(FormControl, { as: "input", labelText: "Contest Name", placeholder: "Enter contest name", id: "name", name: "name", defaultValue: contest.name, required: !0 }),
      /* @__PURE__ */ jsx61(FormControl, { as: "textarea", rows: 3, labelClassNames: "sm:col-span-2", labelText: "Contest Description", placeholder: "Enter contest description", id: "description", name: "description", defaultValue: contest.desc, required: !0 }),
      /* @__PURE__ */ jsx61(FormControl, { as: "input", labelText: "Unique Contest ID", placeholder: "Enter unique ID", id: "uniqueId", name: "uniqueId", defaultValue: contest.id, required: !0 }),
      /* @__PURE__ */ jsx61(FormControl, { as: "input", type: "datetime-local", labelText: "Registration Deadline", id: "reg_deadline", name: "reg_deadline", defaultValue: parseDateTimeForInput(contest.reg_deadline), required: !0 }),
      /* @__PURE__ */ jsx61(FormControl, { as: "input", type: "datetime-local", labelText: "Contest Start Date", id: "start_date", name: "start_date", defaultValue: parseDateTimeForInput(contest.start_date), required: !0 }),
      /* @__PURE__ */ jsx61(FormControl, { as: "input", type: "datetime-local", labelText: "Contest End Date", id: "end_date", name: "end_date", defaultValue: parseDateTimeForInput(contest.end_date), required: !0 }),
      /* @__PURE__ */ jsx61(FormControl, { as: "textarea", rows: 2, labelText: "Contest Prizes", labelClassNames: "sm:col-span-2", placeholder: "Enter contest prizes", id: "prizes", name: "prizes", defaultValue: contest.prizes, required: !0 })
    ] }),
    /* @__PURE__ */ jsx61(CategoryInputs, { categories: Object.values(contest.categories) }),
    /* @__PURE__ */ jsx61(StageInputs, { stages: contest.stages }, contest.stages.length),
    /* @__PURE__ */ jsxs48("fieldset", { className: "grid gap-3 sm:gap-6 sm:grid-cols-2", children: [
      /* @__PURE__ */ jsx61("legend", { className: "text-lg mb-4 font-bold", children: "Contestants and Referrals Earnings (Can only be edited before contest starts)" }),
      /* @__PURE__ */ jsx61(FormControl, { as: "input", type: "number", step: 1, max: 100, min: 0, labelText: "Contestant Share Percentage", id: "contestant_share_percent", name: "contestant_share_percent", defaultValue: contest.tally_vote_split_earnings.contestant_share_percent, readOnly: contest.status !== "yet_to_start" }),
      /* @__PURE__ */ jsx61(FormControl, { as: "input", type: "number", labelText: "Minimum amount for affiliate to earn", id: "min_for_referral_earning", name: "min_for_referral_earning", defaultValue: contest.tally_vote_split_earnings.min_for_referral_earning, readOnly: contest.status !== "yet_to_start" }),
      /* @__PURE__ */ jsx61(FormControl, { as: "input", type: "number", labelText: "Amount affiliate would earn from minimum", id: "referral_bonus_from_min", name: "referral_bonus_from_min", defaultValue: contest.tally_vote_split_earnings.referral_bonus_from_min, readOnly: contest.status !== "yet_to_start" }),
      /* @__PURE__ */ jsx61(FormControl, { as: "input", type: "number", step: 1, max: 100, min: 0, labelText: "Affiliate percentage earnings after minimum", id: "referral_percent_after_min", name: "referral_percent_after_min", defaultValue: contest.tally_vote_split_earnings.referral_percent_after_min, readOnly: contest.status !== "yet_to_start" })
    ] }),
    /* @__PURE__ */ jsxs48("fieldset", { className: "grid gap-6", children: [
      /* @__PURE__ */ jsx61("legend", { className: "text-lg mb-4 font-bold", children: "Submission Guidelines" }),
      /* @__PURE__ */ jsx61(FormControl, { as: "textarea", rows: 4, labelText: "Submission Requirements", placeholder: "Enter text here...", id: "sub_req", name: "sub_req", defaultValue: contest.sub_req, required: !0 }),
      /* @__PURE__ */ jsx61(FormControl, { as: "textarea", rows: 4, labelText: "Terms & Conditions", placeholder: "Enter text here...", id: "tnc", name: "tnc", defaultValue: contest.terms_cond, required: !0 }),
      /* @__PURE__ */ jsx61(FormControl, { as: "textarea", rows: 4, labelText: "Additional Information", placeholder: "Enter text here...", id: "add_info", name: "add_info", defaultValue: contest.add_info, required: !0 })
    ] }),
    /* @__PURE__ */ jsxs48("div", { className: "flex max-sm:flex-col justify-end gap-3 sm:gap-6", children: [
      /* @__PURE__ */ jsx61(Cta_default, { element: "button", type: "reset", onClick: clearFilePreview, className: "px-8 py-2 rounded-lg font-medium border-secondary hover:border-slate-400 text-primary", variant: "outline", children: "Reset Form" }),
      /* @__PURE__ */ jsx61(Cta_default, { element: "button", type: "submit", name: "contestId", value: contest._id, className: "px-8 py-2 rounded-lg font-medium", children: "Edit Contest" })
    ] })
  ] });
}
...
async function loader13({ params, request }) {
  ...
  if (error) {
    ...
    return redirect11("/admin/contests", { headers });
  }
  return json14({ tournaments, contest });
}
async function action8({ request }) {
  ...
  if (formData.get("intent")) {
    ...
    if (error2) {
      ...
      return json14({ error: error2 }, { headers: headers2 });
    }
    return json14({ data: "deleted" });
  }
  ...
  if (data) {
    ...
    return redirect11("/admin/contests", { headers: headers2 });
  } else if (error) {
    console.log(JSON.stringify(error));
    let { headers: headers2 } = await setToast({ request, toast: `error::${error.detail}::${Date.now()}` });
    return json14({ error }, { headers: headers2 });
  }
  let { headers } = await setToast({ request, toast: `error::Sorry, this contest no longer exists::${Date.now()}` });
  return redirect11("/admin/contests", { headers });
}
function EditContest() {
  let { tournaments, contest } = useLoaderData11(), navigate = useNavigate10();
  return /* @__PURE__ */ jsxs49("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs49("div", { className: "flex items-center mb-8 sm:mb-16 gap-4", children: [
      /* @__PURE__ */ jsx62(RoundCta_default, { icon: icons.arrowPrevIcon, className: "hover:bg-[#F7F7F8] text-primary", onClick: () => navigate(-1) }),
      /* @__PURE__ */ jsx62("span", { className: "font-black text-primary", children: "Edit Contest" })
    ] }),
    /* @__PURE__ */ jsx62(EditContestForm, { contest, tournaments })
  ] });
}
...
import { useLoaderData as useLoaderData12, useFetcher as useFetcher7, useActionData as useActionData4 } from "@remix-run/react";
  ...
  return /* @__PURE__ */ jsxs50(Dialog, { children: [
    /* @__PURE__ */ jsx63(
      DialogTrigger,
      {
        ...
        children: /* @__PURE__ */ jsx63(Svg, { src: icons.checkIcon, className: "w-3" })
      }
    ),
    /* @__PURE__ */ jsxs50(DialogContent, { className: "bg-secondary", children: [
      /* @__PURE__ */ jsxs50(DialogHeader, { children: [
        /* @__PURE__ */ jsx63(DialogTitle, { children: "Verify this transaction" }),
        /* @__PURE__ */ jsx63(DialogDescription, { children: "This transaction will be marked as verified. Are you sure you want to proceed?" })
      ] }),
      /* @__PURE__ */ jsx63(DialogFooter, { className: "flex justify-end gap-6", children: /* @__PURE__ */ jsx63(Cta_default, { element: "button", type: "submit", className: "px-3 py-2 rounded-md font-bold min-w-[90px] text-white", children: "Proceed" }) })
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs51(Dialog, { children: [
    /* @__PURE__ */ jsx64(
      DialogTrigger,
      {
        ...
        children: /* @__PURE__ */ jsx64(Svg, { src: icons.doubleArrowDiagonalIcon, className: "w-3" })
      }
    ),
    /* @__PURE__ */ jsxs51(DialogContent, { className: "bg-secondary", children: [
      /* @__PURE__ */ jsxs51(DialogHeader, { children: [
        /* @__PURE__ */ jsx64(DialogTitle, { children: "Revoke this transaction" }),
        /* @__PURE__ */ jsx64(DialogDescription, { children: "This transactoin will be marked as revoked. Are you sure you want to proceed?" })
      ] }),
  ...
  return /* @__PURE__ */ jsxs52(Dialog, { children: [
    /* @__PURE__ */ jsx65(
      DialogTrigger,
      {
        ...
        children: /* @__PURE__ */ jsx65(Svg, { src: icons.trashIcon, className: "w-3" })
      }
    ),
    /* @__PURE__ */ jsxs52(DialogContent, { className: "bg-secondary", children: [
      /* @__PURE__ */ jsxs52(DialogHeader, { children: [
        /* @__PURE__ */ jsx65(DialogTitle, { children: "Delete this transaction" }),
        /* @__PURE__ */ jsx65(DialogDescription, { children: "This transactoin will be marked as deleted. Are you sure you want to proceed?" })
      ] }),
...
function TallyTableActions({ table }) {
  ...
  return /* @__PURE__ */ jsxs53("div", { className: "flex gap-4 items-center px-3 mb-3", children: [
    /* @__PURE__ */ jsx66(VerifyTransactionDialog, { disabled: !canVerify }),
    /* @__PURE__ */ jsx66(RevokeTransactionDialog, { disabled: !canRevoke }),
    /* @__PURE__ */ jsx66(DeleteTransactionDialog, { disabled: !rowsSelected })
  ] });
}

// app/routes/admin.transactions.tally-votes.tsx
import { Fragment as Fragment9, jsx as jsx67, jsxs as jsxs54 } from "react/jsx-runtime";
async function loader14({ request }) {
  ...
  return res.authRequired ? redirect12("/login") : { data: res.data, error: res.error, authRequired: res.authRequired, ongoingContests: ongoingContests.data ?? [] };
}
async function action9({ request }) {
  ...
  if (!formData.get("contest_id"))
    return json15({ error: { detail: "Please use a valid contest" }, data: null });
  let payload = {
    email: formData.get("email") ?? "",
  ...
  return json15({ error, data, authRequired });
}
function AddTallyDialog({ ongoingContests }) {
  let fetcher = useFetcher7(), actionData = useActionData4(), [open, setOpen] = useState23(!1), isSubmitting = fetcher.state === "submitting", responseError = fetcher.data?.error ?? actionData?.error, errorMessage = responseError?.detail?.toString?.() ?? responseError?.toString?.() ?? null;
  return useEffect15(() => {
  ...
  }, [fetcher.data, actionData]), /* @__PURE__ */ jsxs54(Dialog, { open, onOpenChange: setOpen, children: [
    /* @__PURE__ */ jsxs54(
      DialogTrigger,
      {
        ...
        children: [
          /* @__PURE__ */ jsx67(Svg, { src: icons.addIcon, width: ".9em" }),
          "Add Payment"
        ]
      }
    ),
    /* @__PURE__ */ jsx67(DialogContent, { className: "bg-secondary", children: /* @__PURE__ */ jsxs54(DialogHeader, { children: [
      /* @__PURE__ */ jsx67(DialogTitle, { children: "Add Tally Transaction" }),
      /* @__PURE__ */ jsxs54(DialogDescription, { children: [
        errorMessage && /* @__PURE__ */ jsx67("div", { className: "mb-3 p-3 rounded-md bg-red-50 text-red-700 text-sm", children: errorMessage }),
        /* @__PURE__ */ jsxs54(fetcher.Form, { method: "POST", className: "text-primary text-xs flex flex-col gap-4", children: [
          /* @__PURE__ */ jsxs54("fieldset", { className: "py-4 grid sm:grid-cols-3 gap-3", children: [
            /* @__PURE__ */ jsx67(FormControl, { as: "input", id: "email", name: "email", labelText: "Sender Email (Optional)" }),
            /* @__PURE__ */ jsx67(FormControl, { as: "input", id: "phone_number", name: "phone_number", labelText: "Sender Phone (Optional)" }),
            /* @__PURE__ */ jsx67(FormControl, { as: "input", id: "name", name: "name", labelText: "Sender Name" }),
            /* @__PURE__ */ jsxs54(Select2, { label: "Contest", name: "contest_id", children: [
              /* @__PURE__ */ jsx67("option", { value: "", children: "Select a contest" }),
              (ongoingContests ?? []).map(
                (c) => /* @__PURE__ */ jsx67("option", { value: c._id, children: c.name })
              )
            ] }),
            /* @__PURE__ */ jsxs54(Select2, { label: "Bank Status", name: "gateway_status", children: [
              /* @__PURE__ */ jsx67("option", { value: "successful", children: "Successful" }),
              /* @__PURE__ */ jsx67("option", { value: "pending", children: "Pending" }),
              /* @__PURE__ */ jsx67("option", { value: "failed", children: "Failed" })
            ] }),
            /* @__PURE__ */ jsx67(FormControl, { as: "input", id: "contestant_code", name: "contestant_code", labelText: "Contestant Code" }),
            /* @__PURE__ */ jsx67(FormControl, { as: "input", type: "number", id: "amount", name: "amount", labelText: "Amount (NGN)", min: 0, defaultValue: 0 }),
            /* @__PURE__ */ jsx67(FormControl, { as: "input", type: "number", id: "fee", name: "fee", labelText: "Fee (NGN)", min: 0, defaultValue: 0 }),
            /* @__PURE__ */ jsx67(FormControl, { as: "input", id: "bank_ref", name: "bank_ref", labelText: "Transaction Reference" })
          ] }),
          /* @__PURE__ */ jsx67("div", { className: "flex justify-end gap-6", children: /* @__PURE__ */ jsx67(Cta_default, { element: "button", type: "submit", disabled: isSubmitting, className: "px-3 py-2 rounded-md font-bold min-w-[90px] text-white", "aria-busy": isSubmitting, children: isSubmitting ? "Submitting..." : "Submit" }) })
        ] })
      ] })
    ] }) })
  ] });
...
function TallyVotes() {
  let { data, error, authRequired, ongoingContests } = useLoaderData12(), transactions = data?.items ?? [], lastKey = data?.last_key_id, pageSize = data?.items_per_page ?? 10, firstKey = data?.first_key_id;
  return /* @__PURE__ */ jsxs54("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs54("section", { className: "flex max-sm:flex-col gap-10 justify-between sm:items-center mb-6 sm:mb-16", children: [
      /* @__PURE__ */ jsx67("h1", { className: "text-2xl font-black text-primary", children: "Tally Votes" }),
      /* @__PURE__ */ jsx67(AddTallyDialog, { ongoingContests })
    ] }),
    /* @__PURE__ */ jsx67("section", { className: "my-12", children: /* @__PURE__ */ jsx67(TallyTransactionsTable, { data: transactions, lastKey: lastKey ?? "", pageSize, firstKey: firstKey ?? "" }) })
  ] });
}
var numberFormatterOptions2 = { style: "currency", currency: "NGN" }, dateOptions2 = {
  ...
  {
    id: "select",
    header: ({ table }) => /* @__PURE__ */ jsx67("div", { className: "flex place-content-center", children: /* @__PURE__ */ jsx67(
      Checkbox,
      {
        className: "h-4 w-4",
        "aria-label": "Select all",
    ...
    cell: ({ row }) => /* @__PURE__ */ jsx67("div", { className: "flex place-content-center", children: /* @__PURE__ */ jsx67(
      Checkbox,
      {
        className: "h-4 w-4",
        "aria-label": "Select row",
  ...
  },
  {
    ...
    header: ({ column }) => /* @__PURE__ */ jsx67(DataTableColumnHeader, { column, title: "trx ref" })
  },
  {
    accessorKey: "customer",
    header: ({ column }) => /* @__PURE__ */ jsx67(DataTableColumnHeader, { column, title: "sender" }),
    cell: ({ getValue }) => getValue().email
  },
  {
    accessorKey: "contestant_code",
    header: ({ column }) => /* @__PURE__ */ jsx67(DataTableColumnHeader, { column, title: "code" })
  },
  {
    accessorKey: "number_of_votes",
    header: ({ column }) => /* @__PURE__ */ jsx67(DataTableColumnHeader, { column, title: "votes" })
  },
  {
    accessorKey: "amount",
    header: ({ column }) => /* @__PURE__ */ jsx67(DataTableColumnHeader, { className: "whitespace-nowr", column, title: "amount" }),
    cell: ({ getValue }) => numberFormatter(getValue(), numberFormatterOptions2)
  },
  {
    accessorKey: "app_fee",
    header: ({ column }) => /* @__PURE__ */ jsx67(DataTableColumnHeader, { className: "whitespace-nowr", column, title: "fee" }),
    cell: ({ getValue }) => numberFormatter(getValue(), numberFormatterOptions2)
  },
  {
    accessorKey: "created_at",
    header: ({ column }) => /* @__PURE__ */ jsx67(DataTableColumnHeader, { column, title: "date" }),
    cell: ({ getValue }) => /* @__PURE__ */ jsxs54("span", { children: [
      /* @__PURE__ */ jsx67("span", { className: "block", children: formatDate(new Date(getValue()), dateOptions2) }),
      /* @__PURE__ */ jsx67("span", { className: "block", children: formatDate(new Date(getValue()), timeOptions2) })
    ] })
  },
  {
    accessorKey: "payment_status",
    header: ({ column }) => /* @__PURE__ */ jsx67(DataTableColumnHeader, { column, title: "status" }),
    cell: ({ getValue }) => {
      let status = getValue();
      return /* @__PURE__ */ jsx67(StatusTag, { status, color: status === "PENDING" ? "yellow" : status === "SUCCESS" ? "green" : status === "REFUNDED" ? "red" : "gray" });
    }
  }
];
function TallyTransactionsTable({ data, lastKey, pageSize, firstKey }) {
  return /* @__PURE__ */ jsxs54(Fragment9, { children: [
    /* @__PURE__ */ jsx67("div", { className: "w-full overflow-x-auto", children: /* @__PURE__ */ jsx67(DataTable, { data, columns: columns3, className: "text-xs", TableActions: TallyTableActions }) }),
    /* @__PURE__ */ jsx67(Pagination, { lastKey, pageSize, firstKey })
  ] });
}
...
import { Form as Form11, useActionData as useActionData5, useLoaderData as useLoaderData13 } from "@remix-run/react";
...
async function loader15({ request, params }) {
  let cookieHeader = request.headers.get("Cookie") ?? "";
  console.log({ cookieHeader }), cookieHeader || redirect13("/login");
  ...
  return authRequired && redirect13("/login"), { error, data, authRequired };
}
async function action10({ request }) {
  ...
  return authRequired && redirect13("/login"), json16({ error, authRequired, data });
}
function useRegistrationFormController() {
  let { error, data } = useLoaderData13(), actionData = useActionData5();
  console.log({ data });
  let [contest, setContest] = useState24(), [stage, setStage] = useState24(), [contestant, setContestant] = useState24();
  return error && toast({
    variant: "destructive",
    title: "An error occured",
    description: error?.detail.toString() ?? "Error occured"
...
function RegistrationForm2() {
  ...
  return contest ? /* @__PURE__ */ jsxs55("section", { children: [
    /* @__PURE__ */ jsx68("header", { className: "wrapper my-16 grid md:grid-cols-2 justify-between gap-6 md:gap-8", children: /* @__PURE__ */ jsx68("div", { className: "flex flex-col justify-around", children: /* @__PURE__ */ jsxs55("div", { className: "max-w-2xl", children: [
      /* @__PURE__ */ jsx68("h1", { className: "text-accent text-2xl lg:text-4xl font-satoshi-black max-w-3xl mb-3", children: contest.name }),
      /* @__PURE__ */ jsx68("p", { className: "font-satoshi-medium", children: contest.desc })
    ] }) }) }),
    /* @__PURE__ */ jsx68("section", { className: "sm:wrapper my-16", children: /* @__PURE__ */ jsxs55("div", { className: "flex flex-col sm:flex-row justify-between items-start gap-6 sm:gap-8", children: [
      /* @__PURE__ */ jsx68(ContestGuidelines, { contest }),
      /* @__PURE__ */ jsxs55(Form11, { method: "POST", encType: "multipart/form-data", className: "bg-secondary p-[5%] sm:p-10 sm:rounded-3xl flex flex-col w-full max-w-xl gap-6", children: [
        /* @__PURE__ */ jsxs55("p", { className: "text-2xl font-satoshi-bold", children: [
          "Welcome, ",
        ...
        /* @__PURE__ */ jsx68("img", { src: contestant?.image_url || no_image_default, alt: "kid smiling", className: "w-full rounded-3xl h-[350px] object-cover" }),
        /* @__PURE__ */ jsxs55("div", { className: "grid gap-6 lg:grid-cols-2", children: [
          /* @__PURE__ */ jsx68(
            FormControl,
            {
              as: "input",
        ...
        /* @__PURE__ */ jsxs55("div", { className: "grid gap-6 lg:grid-cols-2", children: [
          /* @__PURE__ */ jsxs55("label", { htmlFor: "gender", className: "font-bold flex flex-col", children: [
            "Gender",
            /* @__PURE__ */ jsxs55(Select, { name: "sex", required: !0, defaultValue: contestant?.contestant_biodata?.sex, children: [
              /* @__PURE__ */ jsx68(SelectTrigger, { className: "h-10 font-normal rounded-lg shadow-none hover:border-accent", children: /* @__PURE__ */ jsx68(SelectValue, { placeholder: "Gender" }) }),
              /* @__PURE__ */ jsxs55(SelectContent, { children: [
                /* @__PURE__ */ jsx68(SelectItem, { value: "MALE", className: "focus:bg-blue-700/25", children: "Male" }),
                /* @__PURE__ */ jsx68(SelectItem, { value: "FEMALE", className: "focus:bg-blue-700/25", children: "Female" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxs55("label", { htmlFor: "state_of_residence", className: "font-bold flex flex-col", children: [
            "State of Residence",
            /* @__PURE__ */ jsxs55(Select, { name: "state_of_residence", required: !0, defaultValue: contestant?.contestant_biodata?.state_of_residence, children: [
              /* @__PURE__ */ jsx68(SelectTrigger, { className: "h-10 font-normal rounded-lg shadow-none hover:border-accent", children: /* @__PURE__ */ jsx68(SelectValue, { placeholder: "Select a state" }) }),
              /* @__PURE__ */ jsx68(SelectContent, { children: Object.entries(nigerianStates).map(([key, val]) => /* @__PURE__ */ jsx68(SelectItem, { value: key, className: "focus:bg-blue-700/25", children: val }, key)) })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs55("div", { className: "grid gap-6 lg:grid-cols-2", children: [
          ...
          /* @__PURE__ */ jsxs55("label", { htmlFor: "category", className: "font-bold flex flex-col", children: [
            "Category",
            /* @__PURE__ */ jsxs55(Select, { name: "category", required: !!contest.categories.length, defaultValue: contestant?.category, children: [
              /* @__PURE__ */ jsx68(SelectTrigger, { className: "h-10 font-normal rounded-lg shadow-none hover:border-accent", children: /* @__PURE__ */ jsx68(SelectValue, { placeholder: "Select a category" }) }),
              /* @__PURE__ */ jsx68(SelectContent, { children: contest.categories.map((category) => /* @__PURE__ */ jsx68(SelectItem, { value: category, className: "focus:bg-blue-700/25", children: category }, category)) })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsx68(DragnDrop, { labelText: "Upload Image", name: "media", multiple: !0, required: !1 }),
        /* @__PURE__ */ jsx68("input", { type: "hidden", name: "contestId", value: contest._id }),
        /* @__PURE__ */ jsx68("input", { type: "hidden", name: "contestantId", value: contestant?._id }),
        /* @__PURE__ */ jsx68(Button, { element: "button", type: "submit", name: "intent", value: "register", className: "md:self-end", children: "Update contestant details" })
      ] })
    ] }) })
  ] }) : /* @__PURE__ */ jsx68("div", { children: " Not found" });
}
...
import { json as json17, redirect as redirect14 } from "@remix-run/node";
import { Link as Link12, useLoaderData as useLoaderData14, useNavigate as useNavigate11 } from "@remix-run/react";
  ...
  return /* @__PURE__ */ jsxs56(Dialog, { children: [
    /* @__PURE__ */ jsx69(
      DialogTrigger,
      {
        ...
        children: /* @__PURE__ */ jsx69(Svg, { src: icons.trashIcon, className: "w-3" })
      }
    ),
    /* @__PURE__ */ jsxs56(DialogContent, { className: "bg-secondary p-0 gap-0", children: [
      /* @__PURE__ */ jsxs56(DialogHeader, { children: [
        /* @__PURE__ */ jsxs56(DialogTitle, { className: "p-4 flex gap-3", children: [
          ...
          /* @__PURE__ */ jsxs56("p", { children: [
            /* @__PURE__ */ jsx69("span", { className: "block", children: "Delete contest" }),
            /* @__PURE__ */ jsx69("span", { className: "font-normal text-base text-admin-pry", children: "Confirm the deletion of this contest" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs56(DialogDescription, { className: "border-y p-4", children: [
          /* @__PURE__ */ jsxs56("span", { className: "text-primary mb-2 block", children: [
            "Are you sure you want to delete ",
            contest.name,
            " contest?"
          ] }),
          /* @__PURE__ */ jsx69("span", { className: "text-admin-pry", children: "This action is irreversible and will permanently delete this contest." })
        ] })
      ] }),
      /* @__PURE__ */ jsx69(DialogFooter, { className: "flex justify-end gap-6 p-4", children: /* @__PURE__ */ jsxs56(fetcher.Form, { method: "post", children: [
        ...
        /* @__PURE__ */ jsx69(DialogClose, { type: "submit", name: "intent", value: "delete", className: "bg-red-500 px-10 py-2 rounded-md font-bold min-w-[90px] text-white", children: "Proceed" })
      ] }) })
    ] })
  ] });
}
...
function MigrateStageDialog({ contest, disabled }) {
  ...
  return /* @__PURE__ */ jsxs57(Dialog, { children: [
    /* @__PURE__ */ jsx70(DialogTrigger, { asChild: !0, children: /* @__PURE__ */ jsx70(RoundCta_default, { disabled: cannotMigrate, icon: icons.doubleArrowRightIcon, className: "border-indigo-700 bg-indigo-100 text-indigo-700", title: "Migrate stage" }) }),
    /* @__PURE__ */ jsxs57(DialogContent, { className: "bg-secondary p-0 gap-0", children: [
      /* @__PURE__ */ jsxs57(DialogHeader, { children: [
        /* @__PURE__ */ jsxs57(DialogTitle, { className: "p-4 flex gap-3", children: [
          ...
          /* @__PURE__ */ jsxs57("p", { children: [
            /* @__PURE__ */ jsx70("span", { className: "block", children: "Migrate stage" }),
            /* @__PURE__ */ jsx70("span", { className: "font-normal text-base text-admin-pry", children: "Confirm migration to the next stage" })
          ] })
        ] }),
        /* @__PURE__ */ jsx70(DialogDescription, { className: "border-y p-4", children: /* @__PURE__ */ jsxs57("span", { className: "text-primary block", children: [
      ...
      /* @__PURE__ */ jsx70(DialogFooter, { className: "flex justify-end gap-6 p-4", children: /* @__PURE__ */ jsxs57(fetcher.Form, { method: "post", children: [
        /* @__PURE__ */ jsx70("input", { type: "hidden", name: "from", value: stages[0]?._id }),
        /* @__PURE__ */ jsx70("input", { type: "hidden", name: "to", value: stages[1]?._id }),
        /* @__PURE__ */ jsx70(DialogClose, { type: "submit", name: "intent", value: "migrate", className: "bg-accent px-10 py-2 rounded-md font-bold min-w-[90px] text-white", children: "Proceed" })
      ] }) })
    ] })
  ] });
}
...
function ContestTableActions({ rowData }) {
  ...
  return /* @__PURE__ */ jsxs58("div", { className: "flex gap-4 items-center", children: [
    /* @__PURE__ */ jsx71(RoundCta_default, { icon: icons.contestantsIcon, element: "link", to: linkToContestants, "aria-disabled": !linkToContestants, className: "border-green-500 bg-green-50 text-green-500", title: "View current stage" }),
    /* @__PURE__ */ jsx71(RoundCta_default, { icon: icons.editIcon, element: "link", to: `/admin/contests/${rowData.id}`, className: "border-[#262626] bg-[#F7F7F8] text-primary", title: "Edit contest" }),
    /* @__PURE__ */ jsxs58(fetcher.Form, { method: "post", children: [
      /* @__PURE__ */ jsx71("input", { type: "hidden", name: "contestId", value: rowData._id }),
      /* @__PURE__ */ jsx71(RoundCta_default, { icon: icons.viewIcon, name: "intent", value: "toggle_registration", className: "border-yellow-700 bg-yellow-100 text-yellow-700", "aria-disabled": fetcher.state != "idle", title: "Open/Close registration" })
    ] }),
    /* @__PURE__ */ jsx71(MigrateStageDialog, { contest: rowData }),
    /* @__PURE__ */ jsx71(DeleteContestDialog, { contest: rowData })
  ] });
}

// app/components/admin/contest/EditStageForm.tsx
import { useState as useState25 } from "react";
import { Form as Form12, Link as Link11 } from "@remix-run/react";
...
function GradeInputs({ grade }) {
  ...
  return /* @__PURE__ */ jsxs59("div", { className: "flex gap-2", children: [
    /* @__PURE__ */ jsxs59("div", { className: "flex flex-col", children: [
      /* @__PURE__ */ jsx72("span", { className: "block font-bold", children: "Grade" }),
      /* @__PURE__ */ jsx72("span", { className: cn6(`h-full w-[40px] px-2 py-1 flex items-center justify-center bg-grade-${grd} rounded-md text-white font-black`), children: grd })
    ] }),
    /* @__PURE__ */ jsx72(FormControl, { as: "input", id: `min_${grd}`, name: `min_${grd}`, labelText: "Min. Score", type: "number", min: 0, defaultValue: min }),
    /* @__PURE__ */ jsx72(FormControl, { as: "input", id: `max_${grd}`, name: `max_${grd}`, labelText: "Max. Score", type: "number", min: 0, defaultValue: max })
  ] });
}
...
function Stages({ row }) {
  let [selectedStage, setSelectedStage] = useState25(row.original.stages[0] ?? null);
  return /* @__PURE__ */ jsxs60("div", { className: "p-6", children: [
    /* @__PURE__ */ jsx73("div", { className: "p-3 flex gap-2 border border-disabled bg-[#F6F8FA] rounded-md", children: row.original.stages.length ? row.original.stages.map((stage) => /* @__PURE__ */ jsxs60(
      Cta_default,
      {
        element: "button",
        variant: "outline",
      ...
      stage._id
    )) : /* @__PURE__ */ jsx73("span", { children: "There are no stages." }) }),
    selectedStage ? /* @__PURE__ */ jsxs60(Fragment10, { children: [
      /* @__PURE__ */ jsx73(EditStageForm, { stage: selectedStage, contestId: row.original.id, closeForm: row.getToggleExpandedHandler() }, selectedStage._id),
      /* @__PURE__ */ jsx73("hr", {}),
      /* @__PURE__ */ jsx73(ToggleStageBonus, { stage: selectedStage })
    ] }) : null
  ] });
}
function EditStageForm({ stage, contestId, closeForm }) {
  return /* @__PURE__ */ jsxs60(Form12, { method: "POST", className: "text-primary text-xs flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxs60("fieldset", { className: "py-4 grid grid-cols-4 gap-3 border-b", children: [
      /* @__PURE__ */ jsx73(FormControl, { as: "input", id: "start_date", name: "start_date", labelText: "Stage Start Date", type: "datetime-local", defaultValue: parseDateTimeForInput(stage.start_date) }),
      /* @__PURE__ */ jsx73(FormControl, { as: "input", id: "end_date", name: "end_date", labelText: "Stage End Date", type: "datetime-local", defaultValue: parseDateTimeForInput(stage.end_date) }),
      /* @__PURE__ */ jsx73(FormControl, { as: "input", id: "weight", name: "weight", labelText: "Stage Weight (%)", type: "number", min: 0, defaultValue: stage.weight }),
      /* @__PURE__ */ jsx73(FormControl, { as: "input", id: "success_count", name: "success_count", labelText: "Success Count", type: "number", min: 0, defaultValue: stage.success_count })
    ] }),
    /* @__PURE__ */ jsxs60("fieldset", { className: "pt-2 pb-4 grid grid-cols-4 gap-3 border-b", children: [
      /* @__PURE__ */ jsxs60("legend", { className: "font-bold text-sm text-admin-pry w-max", children: [
        "Stage Rates ",
        /* @__PURE__ */ jsx73("span", { className: "font-normal", children: "(must sum up to 100%)" })
      ] }),
      /* @__PURE__ */ jsx73(FormControl, { as: "input", id: "social_media_rate", name: "social_media_rate", labelText: "Social Media Rate (%)", type: "number", min: 0, defaultValue: stage.rates.social_media.amount }),
      /* @__PURE__ */ jsx73(FormControl, { as: "input", id: "tally_rate", name: "tally_rate", labelText: "Tally Rate (%)", type: "number", min: 0, defaultValue: stage.rates.tally }),
      /* @__PURE__ */ jsx73(FormControl, { as: "input", id: "givaah_rate", name: "givaah_rate", labelText: "Givaah Rate (%)", type: "number", min: 0, defaultValue: stage.rates.givaah }),
      /* @__PURE__ */ jsx73(FormControl, { as: "input", id: "judge_rate", name: "judge_rate", labelText: "Judge Rate (%)", type: "number", min: 0, defaultValue: stage.rates.judge }),
      /* @__PURE__ */ jsx73(FormControl, { as: "input", id: "social_media_bonus_rate", name: "social_media_bonus_rate", labelText: "Social Media Bonus Rate (%)", type: "number", min: 0, defaultValue: stage.rates.social_media_bonus }),
      /* @__PURE__ */ jsx73(FormControl, { as: "input", id: "tally_bonus_rate", name: "tally_bonus_rate", labelText: "Tally Bonus Rate (%)", type: "number", min: 0, defaultValue: stage.rates.tally_bonus }),
      /* @__PURE__ */ jsx73(FormControl, { as: "input", id: "givaah_bonus_rate", name: "givaah_bonus_rate", labelText: "Givaah Bonus Rate (%)", type: "number", min: 0, defaultValue: stage.rates.givaah_bonus }),
      /* @__PURE__ */ jsx73(FormControl, { as: "input", id: "judge_bonus_rate", name: "judge_bonus_rate", labelText: "Judge Bonus Rate (%)", type: "number", min: 0, defaultValue: stage.rates.judge_bonus })
    ] }),
    /* @__PURE__ */ jsxs60("fieldset", { className: "pt-2 py-4 grid grid-cols-2 gap-3 border-b", children: [
      /* @__PURE__ */ jsx73("legend", { className: "font-bold text-sm text-admin-pry", children: "Grades" }),
      Object.entries(stage.grade).map((grade) => /* @__PURE__ */ jsx73(GradeInputs, { grade }, grade[0]))
    ] }),
    /* @__PURE__ */ jsxs60("div", { className: "flex justify-between items-center gap-6", children: [
      /* @__PURE__ */ jsx73(Link11, { to: `${contestId}/${stage._id}`, className: "text-accent hover:text-accent/80 font-semibold", children: "View contestants" }),
      /* @__PURE__ */ jsxs60("div", { className: "flex justify-end gap-6", children: [
        /* @__PURE__ */ jsx73(
          Cta_default,
          {
            element: "button",
        ...
        /* @__PURE__ */ jsx73(Cta_default, { element: "button", type: "submit", name: "intent", value: "update_stage", className: "px-3 py-2 rounded-md font-bold min-w-[90px] text-white", children: "Submit" })
      ] })
    ] }),
    /* @__PURE__ */ jsx73("input", { type: "hidden", name: "social_media_type", value: stage.rates.social_media.type }),
    /* @__PURE__ */ jsx73("input", { type: "hidden", name: "stageId", value: stage._id })
  ] });
}
function ToggleStageBonus({ stage }) {
  let [enabled, setEnabled] = useState25(stage.enable_bonus), [time] = useState25(stage.bonus_reset_time || "00:00:00"), [hours, minutes] = time.split(":");
  return /* @__PURE__ */ jsxs60(Form12, { method: "POST", className: "text-primary text-xs flex flex-col gap-4 py-4", children: [
    /* @__PURE__ */ jsxs60("fieldset", { className: "py-4 grid grid-cols-4 gap-3", children: [
      /* @__PURE__ */ jsx73("legend", { className: "font-bold text-sm text-admin-pry w-max col-span-4", children: "Stage Bonus" }),
      /* @__PURE__ */ jsxs60("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx73("label", { htmlFor: "enable_bonus", className: "font-medium", children: "Enable Bonus" }),
        /* @__PURE__ */ jsx73(
          "input",
          {
            type: "checkbox",
      ...
      /* @__PURE__ */ jsx73(FormControl, { as: "input", id: "hours", name: "hours", labelText: "Reset Time (Hours)", type: "number", min: 0, max: 23, defaultValue: hours }),
      /* @__PURE__ */ jsx73(FormControl, { as: "input", id: "minutes", name: "minutes", labelText: "Reset Time (Minutes)", type: "number", min: 0, max: 59, defaultValue: minutes })
    ] }),
    /* @__PURE__ */ jsx73("div", { className: "flex justify-end gap-6", children: /* @__PURE__ */ jsx73(Cta_default, { element: "button", type: "submit", name: "intent", value: "toggle_stage_bonus", className: "px-3 py-2 rounded-md font-bold min-w-[90px] text-white", children: "Enable/Disable Bonus" }) }),
    /* @__PURE__ */ jsx73("input", { type: "hidden", name: "stage_id", value: stage._id })
  ] });
}

// app/components/admin/contest/ContestTable.tsx
import { Fragment as Fragment11, jsx as jsx74, jsxs as jsxs61 } from "react/jsx-runtime";
var columns4 = [
  {
    id: "expander",
    header: () => null,
    cell: ({ row }) => row.getCanExpand() ? /* @__PURE__ */ jsx74("button", { title: "expand row", onClick: row.getToggleExpandedHandler(), children: /* @__PURE__ */ jsx74(Svg, { src: icons.arrowDownIcon, className: row.getIsExpanded() ? "rotate-180" : "" }) }) : null
  },
  {
    accessorKey: "id",
    header: ({ column }) => /* @__PURE__ */ jsx74(DataTableColumnHeader, { column, title: "id" }),
    cell: ({ row }) => /* @__PURE__ */ jsx74("span", { className: "uppercase", children: row.getValue("id") })
  },
  {
    accessorKey: "name",
    header: ({ column }) => /* @__PURE__ */ jsx74(DataTableColumnHeader, { column, title: "contest" }),
    cell: ({ row }) => /* @__PURE__ */ jsx74("span", { className: "uppercase line-clamp-1", children: row.getValue("name") })
  },
  {
    accessorKey: "timeline",
    header: ({ column }) => /* @__PURE__ */ jsx74(DataTableColumnHeader, { column, title: "timeline" }),
    cell: ({ row }) => /* @__PURE__ */ jsxs61("p", { children: [
      /* @__PURE__ */ jsx74("span", { className: "block whitespace-nowrap", children: row.original.start_date.split(".")[0].replace("T", ", ") }),
      /* @__PURE__ */ jsx74("span", { className: "block whitespace-nowrap", children: row.original.end_date.split(".")[0].replace("T", ", ") })
    ] })
  },
  {
    accessorKey: "status",
    header: ({ column }) => /* @__PURE__ */ jsx74(DataTableColumnHeader, { column, title: "status" }),
    cell: ({ row }) => {
      let status = row.getValue("status").split("_").join(" ");
      return /* @__PURE__ */ jsx74(StatusTag, { status, color: status === "registering" ? "yellow" : status === "ongoing" ? "green" : status === "completed" ? "red" : "gray" });
    }
  },
  {
    id: "actions",
    header: "actions",
    cell: ({ row }) => /* @__PURE__ */ jsx74(ContestTableActions, { rowData: row.original })
  }
];
function ContestTable({ data, pagination }) {
  return /* @__PURE__ */ jsxs61(Fragment11, { children: [
    /* @__PURE__ */ jsx74("div", { className: "w-full overflow-x-auto", children: /* @__PURE__ */ jsx74(
      DataTable,
      {
        data,
        columns: columns4,
    ...
    pagination ? /* @__PURE__ */ jsxs61("div", { className: "max-sm:flex-col max-xs:text-xs sm:w-4/5 mx-auto flex gap-2 justify-between items-center my-5", children: [
      /* @__PURE__ */ jsxs61("label", { className: "flex gap-2", children: [
        "Rows per page",
        /* @__PURE__ */ jsx74("input", { type: "number", name: "rows", id: "rows", className: "w-10 pl-2 rounded-md border", defaultValue: 10 })
      ] }),
      /* @__PURE__ */ jsx74(Pagination, {})
    ] }) : null
  ] });
}

// app/components/reusables/ToggleTip.tsx
import { useEffect as useEffect17, useRef as useRef7, useState as useState26 } from "react";
...
function Toggletip({ mainComponent, children, mainContainerClass = "", childContainerClass = "" }) {
  let [open, setOpen] = useState26(!1), toggletip = useRef7(null);
  function handleOutsideClick(e) {
    e.target !== toggletip.current && !toggletip.current?.contains(e.target) && setOpen(!1);
  }
  return useEffect17(() => (document.addEventListener("click", handleOutsideClick), () => document.removeEventListener("click", handleOutsideClick)), []), /* @__PURE__ */ jsxs62(
    "div",
    {
      ref: toggletip,
      onClick: () => {
      ...
      children: [
        mainComponent,
        /* @__PURE__ */ jsx75("div", { className: `absolute min-w-full rounded-2xl z-10 ${open ? "" : "hidden"} ${childContainerClass}`, children })
      ]
    }
  );
}
...
async function loader16({ params, request }) {
  ...
  if (tournamentError || contestError) {
    ...
    return redirect14("/admin/tournaments", { headers });
  }
  return json17({ tournament, contests: contests2 });
}
function Tournament() {
  let { tournament, contests: contests2 } = useLoaderData14(), navigate = useNavigate11(), mainComponent = /* @__PURE__ */ jsx76(RoundCta_default, { icon: icons.optionsIcon, className: "border-disabled hover:border-primary" });
  return /* @__PURE__ */ jsxs63("main", { className: "w-full overflow-y-auto max-xs:p-3 p-6", children: [
    /* @__PURE__ */ jsx76("div", { className: "flex items-center mb-8 sm:mb-16 gap-4", children: /* @__PURE__ */ jsx76(RoundCta_default, { icon: icons.arrowPrevIcon, className: "hover:bg-[#F7F7F8] text-primary", onClick: () => navigate(-1) }) }),
    /* @__PURE__ */ jsxs63("section", { className: "flex items-start gap-4 sm:gap-6 max-w-xl mx-auto max-xs:text-sm", children: [
      /* @__PURE__ */ jsx76("img", { src: tournament.image ?? "", alt: "tournament banner", className: "max-xs:w-20 w-24 sm:w-[120px] aspect-square object-cover rounded-lg" }),
      /* @__PURE__ */ jsxs63("div", { className: "flex flex-col gap-4 sm:gap-6 justify-between", children: [
        /* @__PURE__ */ jsxs63("div", { className: "", children: [
          /* @__PURE__ */ jsx76("h1", { className: "text-primary font-satoshi-black uppercase line-clamp-1", children: tournament.name }),
          /* @__PURE__ */ jsx76("p", { className: "font-medium text-xs line-clamp-2", children: tournament.description })
        ] }),
        /* @__PURE__ */ jsxs63("div", { className: "flex gap-4 sm:gap-6 items-center", children: [
          /* @__PURE__ */ jsxs63(
            Cta_default,
            {
              element: "link",
              ...
              children: [
                /* @__PURE__ */ jsx76(Svg, { src: icons.addIcon, width: ".9em" }),
                "Add Contest"
              ]
            }
          ),
    ...
    /* @__PURE__ */ jsx76("section", { className: "my-12", children: /* @__PURE__ */ jsx76(ContestTable, { data: contests2 }) })
  ] });
}
...
async function loader17({ params }) {
  ...
  if (!contestId)
    return redirect15("/results");
  let { data: contest, error } = await getFinalResultForContest(contestId);
  return error && redirect15("/results"), { contest };
}
function ContestResult() {
  let { contest } = useLoaderData15();
  if (!contest)
    throw redirect15("/results");
  console.log(contest);
  ...
  return contest?.final_result_scores && (headings = contest.final_result_headings, table_results = contest.final_result_scores.map((res) => res.table_data)), /* @__PURE__ */ jsxs64("main", { className: "grow", children: [
    /* @__PURE__ */ jsxs64("header", { className: "wrapper my-16", children: [
      /* @__PURE__ */ jsxs64("h1", { className: "text-accent text-2xl lg:text-4xl lg:leading-snug font-satoshi-bold max-w-3xl uppercase mb-10", children: [
        contest.name,
        " Result Table"
      ] }),
      /* @__PURE__ */ jsxs64("div", { className: "grid gap-6 max-w-2xl", children: [
        /* @__PURE__ */ jsxs64("div", { className: "", children: [
          /* @__PURE__ */ jsx77("span", { className: "block font-satoshi-bold mb-1", children: "Status" }),
          /* @__PURE__ */ jsx77(StatusTag, { status: contest.status, color })
        ] }),
        /* @__PURE__ */ jsxs64("div", { className: "grid grid-cols-2 gap-14", children: [
          /* @__PURE__ */ jsxs64("div", { className: "", children: [
            /* @__PURE__ */ jsx77("span", { className: "block font-satoshi-bold mb-1", children: "Categories" }),
            /* @__PURE__ */ jsx77("span", { className: "block", children: contest.categories.join(", ") })
          ] }),
          /* @__PURE__ */ jsxs64("div", { className: "", children: [
            /* @__PURE__ */ jsx77("span", { className: "block font-satoshi-bold mb-1", children: "Stages" }),
            /* @__PURE__ */ jsx77("span", { className: "block", children: contest.no_of_stages ?? 0 })
          ] })
        ] }),
        /* @__PURE__ */ jsxs64("div", { className: "grid grid-cols-2 gap-14", children: [
          /* @__PURE__ */ jsxs64("div", { className: "", children: [
            /* @__PURE__ */ jsx77("span", { className: "block font-satoshi-bold mb-1", children: "Duration" }),
            /* @__PURE__ */ jsx77("span", { className: "block", children: "From May 23 to June 20" })
          ] }),
          /* @__PURE__ */ jsxs64("div", { className: "", children: [
            /* @__PURE__ */ jsx77("span", { className: "block font-satoshi-bold mb-1", children: "Prizes" }),
            /* @__PURE__ */ jsx77("span", { className: "block", children: contest.prizes })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx77("section", { className: "bg-white my-16", children: /* @__PURE__ */ jsxs64("div", { className: "wrapper py-6", children: [
      /* @__PURE__ */ jsxs64("div", { className: "flex flex-col md:flex-row-reverse gap-6 md:gap-8 justify-between md:items-center py-6", children: [
        /* @__PURE__ */ jsxs64("fieldset", { className: "flex gap-4 flex-wrap sm:justify-end", children: [
          /* @__PURE__ */ jsx77(Select2, { name: "stage", id: "stage", containerClass: "bg-secondary", children: /* @__PURE__ */ jsxs64("option", { value: "1", children: [
            contest.name.toUpperCase(),
            " - ",
            "FINAL RESULT TABLE"
          ] }) }),
          /* @__PURE__ */ jsx77(Select2, { name: "category", id: "category", containerClass: "bg-secondary", children: /* @__PURE__ */ jsx77("option", { value: "", children: "Sort by category" }) })
        ] }),
        /* @__PURE__ */ jsx77("span", { className: "whitespace-nowrap font-satoshi-bold", children: "SMV: SOCIAL MEDIA VOTES" })
      ] }),
      /* @__PURE__ */ jsx77("div", { className: "w-full overflow-x-auto", children: /* @__PURE__ */ jsxs64("table", { className: "w-full table-auto border border-secondary", children: [
        /* @__PURE__ */ jsx77("thead", { children: /* @__PURE__ */ jsxs64("tr", { children: [
          /* @__PURE__ */ jsx77("th", { className: "text-left uppercase font-satoshi-black border border-secondary px-6 py-4", children: "S/N" }),
          headings.map((heading) => /* @__PURE__ */ jsx77("th", { className: "text-left uppercase font-satoshi-black border border-secondary px-6 py-4", children: heading }, heading))
        ] }) }),
        /* @__PURE__ */ jsx77("tbody", { children: table_results.map((contestant, index) => /* @__PURE__ */ jsxs64("tr", { children: [
          /* @__PURE__ */ jsx77("td", { className: "border border-secondary px-6 py-4", children: index + 1 }),
          headings.map((heading) => /* @__PURE__ */ jsx77("td", { className: "border border-secondary px-6 py-4", children: contestant[heading] }, heading))
        ] }, index)) })
      ] }) }),
      /* @__PURE__ */ jsx77(Pagination, { className: "p-6" })
    ] }) })
  ] });
}
...
import { json as json19, redirect as redirect16 } from "@remix-run/node";
import { useLoaderData as useLoaderData16, useNavigate as useNavigate12 } from "@remix-run/react";
...
function EditTournamentForm({ tournament }) {
  let [fileList, setFileList] = useState27(null), { filePreview, clearFilePreview, fileName } = useFilePreview(fileList);
  return /* @__PURE__ */ jsxs65(Form13, { className: "max-w-xl mx-auto grid gap-6 sm:gap-12 text-sm", method: "post", encType: "multipart/form-data", children: [
    /* @__PURE__ */ jsx78("h1", { className: "text-xl xs:text-2xl font-bold text-primary", children: "Edit Tournament" }),
    /* @__PURE__ */ jsxs65("div", { className: "grid gap-3 sm:gap-6", children: [
      /* @__PURE__ */ jsxs65("div", { className: "flex items-center gap-x-5", children: [
        filePreview ? /* @__PURE__ */ jsx78("img", { className: "w-20 h-20 rounded-lg object-cover", src: filePreview, alt: "chosen image" }) : /* @__PURE__ */ jsx78("img", { className: "w-20 h-20 rounded-lg object-cover", src: tournament.image || no_image_default, alt: "Tournament banner" }),
        /* @__PURE__ */ jsxs65("div", { className: "flex flex-col items-start gap-2 max-xs:text-xs", children: [
          /* @__PURE__ */ jsxs65("label", { htmlFor: "image", className: "border-2 border-secondary text-primary cursor-pointer font-semibold py-2 px-4 rounded-lg", children: [
            "Change Photo",
            /* @__PURE__ */ jsx78("input", { id: "image", name: "image", type: "file", onChange: (e) => {
              setFileList(e.currentTarget.files);
            }, className: "hidden" })
          ] }),
          /* @__PURE__ */ jsxs65("span", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx78("span", { children: fileName || "PNG, JPG (max. 1440x900px)" }),
            fileName ? /* @__PURE__ */ jsx78(Svg, { src: icons.closeIcon, onClick: clearFilePreview, className: "text-red-600 cursor-pointer" }) : null
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx78(FormControl, { as: "input", labelText: "Tournament Name", placeholder: "Enter tournament name", id: "name", name: "name", defaultValue: tournament.name, required: !0 }),
      /* @__PURE__ */ jsx78(FormControl, { as: "input", labelText: "Tournament Unique ID", placeholder: "Enter unique ID", id: "uniqueId", name: "uniqueId", defaultValue: tournament.id, required: !0 }),
      /* @__PURE__ */ jsx78(FormControl, { as: "textarea", rows: 3, labelText: "Tournament Description", placeholder: "Enter tournament description", id: "description", name: "description", defaultValue: tournament.description, required: !0 })
    ] }),
    /* @__PURE__ */ jsxs65("div", { className: "flex max-sm:flex-col justify-end gap-3 sm:gap-6", children: [
      /* @__PURE__ */ jsx78(Cta_default, { element: "button", onClick: clearFilePreview, type: "reset", className: "px-8 py-2 rounded-lg font-medium border-secondary active:border-accent sm:hover:border-accent", variant: "outline", children: "Reset" }),
      /* @__PURE__ */ jsx78(Cta_default, { element: "button", type: "submit", name: "tournamentId", value: tournament._id, className: "px-8 py-2 rounded-lg font-medium", children: "Edit Tournament" })
    ] })
  ] });
}
...
async function action11({ request }) {
  ...
  if (data) {
    ...
    return redirect16("/admin/tournaments", { headers: headers2 });
  } else if (error) {
    let { headers: headers2 } = await setToast({ request, toast: `error::${error.detail}::${Date.now()}` });
...
function EditTournament() {
  let { tournament } = useLoaderData16(), navigate = useNavigate12();
  return /* @__PURE__ */ jsxs66("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs66("div", { className: "flex items-center mb-8 sm:mb-16 gap-4", children: [
      /* @__PURE__ */ jsx79(RoundCta_default, { icon: icons.arrowPrevIcon, className: "hover:bg-[#F7F7F8] text-primary", onClick: () => navigate(-1) }),
      /* @__PURE__ */ jsx79("span", { className: "font-black text-primary", children: "Edit Tournament" })
    ] }),
    /* @__PURE__ */ jsx79(EditTournamentForm, { tournament })
  ] });
}
...
function WinnerDetailsPage() {
  let { winner, error } = useLoaderData17(), description = `We Are Thrilled To Announce The Triumphant Winner Of Our Recent '${winner?.contest_name}'! Let's Take A Moment To Applaud The Outstanding Creativity And Talent That Graced Our Contest.`;
  return /* @__PURE__ */ jsx80("div", { className: "min-h-screen bg-[#EFEFFF] flex items-center justify-center p-4 sm:p-6 lg:p-8", children: /* @__PURE__ */ jsx80("div", { className: "max-w-6xl mx-auto bg-transparent", children: /* @__PURE__ */ jsxs67("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16", children: [
    /* @__PURE__ */ jsx80("div", { className: "w-full aspect-[3/4] overflow-hidden rounded-2xl shadow-xl order-2 md:order-1", children: /* @__PURE__ */ jsx80(
      "img",
      {
    ...
    /* @__PURE__ */ jsxs67("div", { className: "space-y-4 md:space-y-6 order-1 md:order-2", children: [
      /* @__PURE__ */ jsxs67("h1", { className: "text-3xl sm:text-4xl lg:text-4xl font-extrabold text-[#5B50FB] leading-tight", children: [
        winner?.contest_name,
        " Winner"
      ] }),
      /* @__PURE__ */ jsx80("p", { className: "text-base sm:text-lg text-gray-700 leading-relaxed", children: description }),
      /* @__PURE__ */ jsxs67("p", { className: "text-lg sm:text-xl font-bold text-gray-900", children: [
        "Grand Winner:",
        " ",
        /* @__PURE__ */ jsx80("span", { className: "text-gray-900", children: winner?.full_name }),
        " (",
        winner?.contest_name,
        ")"
      ] }),
      /* @__PURE__ */ jsxs67("p", { className: "text-sm italic text-gray-600 pt-2", children: [
        `Winner's Note: "`,
        winner?.remark,
        '"'
      ] })
...
function DeleteTournamentDialog({ tournament, disabled }) {
  ...
  return /* @__PURE__ */ jsxs68(Dialog, { children: [
    /* @__PURE__ */ jsx81(
      DialogTrigger,
      {
        disabled,
    ...
    /* @__PURE__ */ jsxs68(DialogContent, { className: "bg-secondary p-0 gap-0", children: [
      /* @__PURE__ */ jsxs68(DialogHeader, { children: [
        /* @__PURE__ */ jsxs68(DialogTitle, { className: "p-4 flex gap-3", children: [
          /* @__PURE__ */ jsx81("div", { className: "size-11 rounded-full bg-orange-100 flex items-center justify-center", children: /* @__PURE__ */ jsx81(Svg, { src: icons.questionIcon }) }),
          /* @__PURE__ */ jsxs68("p", { children: [
            /* @__PURE__ */ jsx81("span", { className: "block", children: "Delete tournament" }),
            /* @__PURE__ */ jsx81("span", { className: "font-normal text-base text-admin-pry", children: "Confirm the deletion of this tournament" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs68(DialogDescription, { className: "border-y p-4", children: [
          /* @__PURE__ */ jsxs68("span", { className: "text-primary mb-2 block", children: [
            "Are you sure you want to delete ",
            tournament.name,
            " tournament?"
          ] }),
          /* @__PURE__ */ jsx81("span", { className: "text-admin-pry", children: "This action is irreversible and will permanently delete this tournament." })
        ] })
      ] }),
      /* @__PURE__ */ jsx81(DialogFooter, { className: "flex justify-end gap-6 p-4", children: /* @__PURE__ */ jsxs68(fetcher.Form, { method: "post", children: [
        /* @__PURE__ */ jsx81("input", { type: "hidden", name: "tournamentId", value: tournament._id }),
        /* @__PURE__ */ jsx81(DialogClose, { type: "submit", name: "intent", value: "delete", className: "bg-red-500 px-10 py-2 rounded-md font-bold min-w-[90px] text-white", children: "Proceed" })
      ] }) })
    ] })
  ] });
}
...
function LayeredImages({ images, length = 5 }) {
  let remaining = images.length - length, lastLayer = remaining > 0 ? /* @__PURE__ */ jsxs69("div", { className: "w-8 aspect-square inline-flex justify-center items-center -ml-2 rounded-full ring-2 ring-white bg-tertiary text-accent font-semibold text-sm", children: [
    "+",
    remaining
  ] }) : null;
  return /* @__PURE__ */ jsxs69("div", { children: [
    images.slice(0, length).map((image, index) => typeof image == "string" ? /* @__PURE__ */ jsx82("img", { src: image || no_image_default, alt: "people smiling", className: "w-8 aspect-square inline-block -ml-2 first:ml-0 rounded-full object-cover ring-2 ring-white" }, index) : /* @__PURE__ */ jsx82("img", { src: image?.image || no_image_default, alt: "people smiling", className: "w-8 aspect-square inline-block -ml-2 first:ml-0 rounded-full object-cover ring-2 ring-white" }, index)),
    lastLayer
  ] });
}
...
function TournamentCard({ tournament, className }) {
  let mainComponent = /* @__PURE__ */ jsx83(RoundCta_default, { icon: icons.optionsIcon, className: "border-transparent hover:border-disabled" });
  return /* @__PURE__ */ jsxs70("aside", { className: cn("p-6 border border-disabled rounded-xl bg-white shadow overflow-hidden", className), children: [
    /* @__PURE__ */ jsxs70("div", { className: "flex gap-3 items-start justify-between max-xs:flex-wrap", children: [
      /* @__PURE__ */ jsx83("img", { src: tournament.image || no_image_default, alt: "children smiling", className: "w-24 aspect-square rounded-md object-cover" }),
      /* @__PURE__ */ jsxs70("div", { className: "self-center grow max-xs:order-1", children: [
        /* @__PURE__ */ jsx83("h3", { className: "text-primary font-satoshi-black uppercase line-clamp-1", children: tournament.name }),
        /* @__PURE__ */ jsx83("p", { className: "font-medium text-xs line-clamp-2", children: tournament.description })
      ] }),
      /* @__PURE__ */ jsxs70(
        Toggletip,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx83(DeleteTournamentDialog, { tournament })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsx83("hr", { className: "mt-4 mb-1" }),
    /* @__PURE__ */ jsxs70("span", { className: "text-primary text-sm font-satoshi-bold mb-3", children: [
      tournament.contests.length,
      " contests created"
    ] }),
    /* @__PURE__ */ jsxs70("div", { className: "grid gap-2 xs:flex justify-between items-center", children: [
      /* @__PURE__ */ jsx83(LayeredImages, { images: tournament.contests }),
      /* @__PURE__ */ jsxs70(Link13, { to: `/admin/tournaments/${tournament.id}`, className: "flex gap-2 items-center font-semibold hover:text-accent", children: [
        "View Contests ",
        /* @__PURE__ */ jsx83(Svg, { src: icons.arrowNextIcon })
      ] })
    ] })
  ] });
}
...
async function action12({ request }) {
  ...
  if (formData.get("intent") === "delete") {
    ...
    if (error) {
      ...
      return json20(error, { headers: headers2 });
    }
    let { headers } = await setToast({ request, toast: `success::The tournament has been deleted::${Date.now()}` });
    return json20(data, { headers });
  }
  return json20(null);
}
function Tournaments() {
  let { tournaments } = useLoaderData18(), numberOfContests = tournaments.reduce((total, tournament) => total + tournament.contests.length, 0);
  return /* @__PURE__ */ jsxs71("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs71("section", { className: "flex justify-between items-center mb-8 sm:mb-16", children: [
      /* @__PURE__ */ jsx84("h1", { className: "text-2xl font-black text-primary", children: "Tournaments" }),
      /* @__PURE__ */ jsxs71(Cta_default, { element: "link", to: "add", className: "hidden sm:flex gap-2 items-center rounded-lg px-3 py-2", children: [
        /* @__PURE__ */ jsx84(Svg, { src: icons.addIcon, width: ".9em" }),
        "Create Tournament"
      ] })
    ] }),
    /* @__PURE__ */ jsxs71("aside", { className: "sm:flex justify-evenly max-w-xl mx-auto gap-2 p-3 border rounded-md my-4 bg-[#F6F8FA] text-sm", children: [
      /* @__PURE__ */ jsxs71("div", { className: "flex gap-3 items-center", children: [
        /* @__PURE__ */ jsx84("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx84(Svg, { src: icons.adminTournamentIcon, className: "text-primary" }) }),
        /* @__PURE__ */ jsxs71("span", { className: "grid", children: [
          /* @__PURE__ */ jsx84("span", { className: "text-primary font-satoshi-black", children: tournaments.length }),
          /* @__PURE__ */ jsx84("span", { className: "", children: "Tournaments Created" })
        ] })
      ] }),
      /* @__PURE__ */ jsx84("div", { className: "max-sm:my-2 max-sm:border-t sm:border-r sm:h-10" }),
      /* @__PURE__ */ jsxs71("div", { className: "flex gap-3 items-center", children: [
        /* @__PURE__ */ jsx84("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx84(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
        /* @__PURE__ */ jsxs71("span", { className: "grid", children: [
          /* @__PURE__ */ jsx84("span", { className: "text-primary font-satoshi-black", children: numberOfContests }),
          /* @__PURE__ */ jsx84("span", { className: "", children: "Contests Created" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs71(Cta_default, { element: "link", to: "add", className: "flex sm:hidden gap-2 justify-center items-center rounded-lg px-3 py-2", children: [
      /* @__PURE__ */ jsx84(Svg, { src: icons.addIcon, width: ".9em" }),
      "Create Tournament"
    ] }),
    /* @__PURE__ */ jsx84("section", { className: "my-8 grid sm:grid-cols-2 gap-6", children: tournaments.map((tournament) => /* @__PURE__ */ jsx84(TournamentCard, { tournament }, tournament.id)) })
  ] });
}
...
async function loader21() {
  ...
  if (error)
    throw new Error(error.detail);
  return json21({ tournaments });
}
function Contests() {
  let { tournaments } = useLoaderData19();
  return /* @__PURE__ */ jsxs72("main", { className: "grow", children: [
    /* @__PURE__ */ jsx85("header", { className: "wrapper my-16", children: /* @__PURE__ */ jsx85("h1", { className: "text-2xl lg:text-4xl font-satoshi-medium max-w-3xl", children: "From Artistic Marvels to Captivating Moments. Unleash Your Talent and Win Big in Our Monthly and Yearly Contests!" }) }),
    /* @__PURE__ */ jsx85("section", { className: "wrapper my-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-12 justify-items-center", children: tournaments.map((tournament) => /* @__PURE__ */ jsx85(ContestCard, { contest: tournament, to: `/contests/${tournament.id}` }, tournament.id)) })
  ] });
}
...
import { json as json22, redirect as redirect17 } from "@remix-run/node";
...
function ToggleBtn({ onClick, on }) {
  return /* @__PURE__ */ jsx86("button", { onClick, className: cn8("rounded-xl p-0.5 w-[34px] flex items-center", {
    "bg-accent justify-end": on,
    "bg-[#DAE0E6]": !on
  }), children: /* @__PURE__ */ jsx86("div", { className: "bg-secondary w-4 h-4 rounded-full" }) });
}
...
function AdminUserCard({ user, className }) {
  let mainComponent = /* @__PURE__ */ jsx87("span", { className: "", children: /* @__PURE__ */ jsx87(Svg, { src: icons.optionsIcon }) });
  return /* @__PURE__ */ jsxs73("article", { className: cn("border rounded-lg shadow-sm p-3 text-xs font-satoshi-medium", className), children: [
    /* @__PURE__ */ jsxs73("div", { className: "flex gap-4 mb-3", children: [
      /* @__PURE__ */ jsxs73("p", { children: [
        /* @__PURE__ */ jsx87("span", { children: user.roles?.join(", ") }),
        " | ",
        /* @__PURE__ */ jsx87("span", { children: user.username })
      ] }),
      /* @__PURE__ */ jsxs73(
        Toggletip,
        {
          ...
          children: [
            /* @__PURE__ */ jsx87(RoundCta_default, { icon: icons.editIcon, element: "link", to: `/admin/accounts/${user._id}`, className: "border-[#262626] bg-[#F7F7F8] text-primary" }),
            /* @__PURE__ */ jsx87(RoundCta_default, { icon: icons.trashIcon, className: "border-red-500 bg-red-50 text-red-500" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxs73("div", { className: "flex gap-4 justify-between", children: [
      /* @__PURE__ */ jsxs73("div", { className: "flex gap-3 items-center", children: [
        /* @__PURE__ */ jsx87("span", { className: "p-1.5 border border-disabled rounded-full", children: /* @__PURE__ */ jsx87("img", { src: admin_avatar_default, alt: "cartoon head", width: 24, height: 24 }) }),
        /* @__PURE__ */ jsxs73("span", { className: "grid", children: [
          /* @__PURE__ */ jsx87("span", { className: "text-primary line-clamp-1", children: user.full_name }),
          /* @__PURE__ */ jsx87("span", { className: "line-clamp-1", children: user.email })
        ] })
      ] }),
      /* @__PURE__ */ jsxs73("span", { className: "flex gap-3 items-center", children: [
        /* @__PURE__ */ jsx87("span", { className: "max-xs:hidden", children: user.is_active ? "Enabled" : "Disabled" }),
...
async function loader22({ request }) {
  ...
  return pagedUsersRes.authRequired ? redirect17("/login") : json22({ headings, tableData: adminUsers, pagedUserData: pagedUsersRes.data, query });
}
function Accounts() {
  let { headings, tableData, pagedUserData, query } = useLoaderData20(), navigation = useNavigation4();
  return console.log(pagedUserData), /* @__PURE__ */ jsxs74("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs74("div", { className: "flex justify-between items-center mb-8 sm:mb-16", children: [
      /* @__PURE__ */ jsx88("h1", { className: "text-2xl font-black text-primary", children: "Admin Accounts" }),
      /* @__PURE__ */ jsxs74(Cta_default, { element: "link", to: "add", className: "hidden sm:flex gap-2 items-center rounded-lg px-3 py-2", children: [
        /* @__PURE__ */ jsx88(Svg, { src: icons.addIcon, width: ".9em" }),
        "Add User"
      ] })
    ] }),
    /* @__PURE__ */ jsxs74("div", { className: "flex flex-col gap-3 sm:flex-row justify-between sm:items-center my-8", children: [
      /* @__PURE__ */ jsx88("p", { className: "font-semibold", children: "Registered Admin Users" }),
      /* @__PURE__ */ jsxs74(Form14, { method: "get", className: "flex items-center gap-3", onSubmit: (e) => {
        try {
        ...
        /* @__PURE__ */ jsx88(FormControl, { as: "input", name: "searchUser", type: "search", placeholder: "Search user...", className: "text-sm xs:min-w-[280px]", defaultValue: query?.wild_card ?? "" }),
        /* @__PURE__ */ jsx88("input", { type: "hidden", name: "wild_card", defaultValue: query?.wild_card ?? "" }),
        /* @__PURE__ */ jsx88("button", { type: "submit", disabled: navigation.state === "submitting", className: "px-3 py-2 bg-[#312E81] text-white rounded-md text-sm", children: navigation.state === "submitting" ? "Searching..." : "Search" })
      ] }),
      /* @__PURE__ */ jsxs74(Cta_default, { element: "link", to: "add", className: "sm:hidden flex gap-2 items-center justify-center rounded-lg px-3 py-2", children: [
        /* @__PURE__ */ jsx88(Svg, { src: icons.addIcon, width: ".9em" }),
        "Add User"
      ] })
    ] }),
    /* @__PURE__ */ jsxs74("div", { className: "sm:hidden grid gap-4 my-6", children: [
      pagedUserData?.items.map((user) => /* @__PURE__ */ jsx88(AdminUserCard, { user }, user._id)),
      /* @__PURE__ */ jsx88(Pagination, { lastKey: pagedUserData?.last_key_id, pageSize: pagedUserData?.items_per_page, firstKey: pagedUserData?.first_key_id })
    ] }),
    /* @__PURE__ */ jsx88("div", { className: "hidden sm:block w-full overflow-x-auto", children: /* @__PURE__ */ jsxs74("table", { className: "w-full table-auto", children: [
      /* @__PURE__ */ jsx88("thead", { children: /* @__PURE__ */ jsxs74("tr", { className: "border-b border-secondary", children: [
        headings.map((heading) => /* @__PURE__ */ jsx88("th", { className: "text-left capitalize font-satoshi-black p-3", children: heading }, heading)),
        /* @__PURE__ */ jsx88("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Actions" })
      ] }) }),
      /* @__PURE__ */ jsx88("tbody", { children: pagedUserData?.items.map((user, index) => /* @__PURE__ */ jsxs74("tr", { className: "border-b border-secondary", children: [
        headings.map((heading) => heading === "access" ? /* @__PURE__ */ jsx88("td", { className: "p-3", children: /* @__PURE__ */ jsxs74("span", { className: "grid grid-cols-[76px_36px] items-center w-min", children: [
          user.is_active ? "Enabled" : "Disabled",
          /* @__PURE__ */ jsx88(ToggleBtn, { on: user.is_active })
        ] }) }, heading) : /* @__PURE__ */ jsx88("td", { className: "p-3", children: Array.isArray(user[heading]) ? user[heading].join(", ") : user[heading] }, heading)),
        /* @__PURE__ */ jsx88("td", { className: "p-3", children: /* @__PURE__ */ jsxs74("div", { className: "flex gap-4 items-center", children: [
          /* @__PURE__ */ jsx88(RoundCta_default, { icon: icons.editIcon, element: "link", to: user._id, className: "border-[#262626] bg-[#F7F7F8] text-primary" }),
          /* @__PURE__ */ jsx88(RoundCta_default, { icon: icons.trashIcon, className: "border-red-500 bg-red-50 text-red-500" })
        ] }) })
      ] }, index)) })
    ] }) }),
    /* @__PURE__ */ jsx88("div", { className: "hidden sm:flex justify-between items-center my-4", children: /* @__PURE__ */ jsx88(Pagination, { lastKey: pagedUserData?.last_key_id, pageSize: pagedUserData?.items_per_page, firstKey: pagedUserData?.first_key_id }) })
  ] });
}
...
async function loader23({ request, params }) {
  let cookieHeader = request.headers.get("Cookie") ?? "";
  console.log({ cookieHeader }), cookieHeader || redirect18("/login");
  let walletid = params.walletid;
  if (!walletid)
    return redirect18("/user/wallet");
  ...
  if (wallet.authRequired && redirect18("/login"), !wallet.data)
    return redirect18("/user/wallet");
...
function AddWithdrawalAccountPage2() {
  ...
  let inputClasses = `
    ...
    focus:border-slate-800 focus:ring-1 focus:ring-slate-800
  `;
  return /* @__PURE__ */ jsx89("div", { className: "min-h-screen bg-white flex flex-col items-center pt-16 px-4", children: /* @__PURE__ */ jsxs75("div", { className: "max-w-md w-full flex flex-col items-center", children: [
    /* @__PURE__ */ jsxs75("div", { className: "flex flex-col items-center mb-10 text-center", children: [
      /* @__PURE__ */ jsx89("div", { className: "w-24 h-24 rounded-full bg-slate-50 flex items-center justify-center mb-4 border border-slate-100", children: /* @__PURE__ */ jsx89("div", { className: "w-12 h-12 bg-slate-900 rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsx89(Svg, { src: icons.avatarIcon, className: "w-6 h-6 text-white" }) }) }),
      /* @__PURE__ */ jsx89("h1", { className: "text-2xl font-bold text-gray-900", children: "Withdraw " }),
      /* @__PURE__ */ jsx89("p", { className: "text-gray-500 mt-1 text-sm", children: "Enter details below" })
    ] }),
    withdrawalCharges ? /* @__PURE__ */ jsxs75(Form15, { method: "POST", className: "w-full flex flex-col max-w-md mx-auto", children: [
      /* @__PURE__ */ jsxs75("div", { className: "mb-6", children: [
        /* @__PURE__ */ jsx89("label", { className: "text-sm font-medium text-gray-500 mb-2 block", children: "You withdraw exactly" }),
        /* @__PURE__ */ jsxs75("div", { className: "flex items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsx89("div", { className: "flex items-center gap-2 px-4 py-2 bg-gray-50 border border-gray-200 rounded-full", children: /* @__PURE__ */ jsx89("span", { className: "font-bold text-gray-900", children: wallet?.wallet_currency || "USD" }) }),
          /* @__PURE__ */ jsx89(
            "input",
            {
              id: "amount",
        ...
        /* @__PURE__ */ jsxs75("p", { className: "text-sm text-gray-400 mt-2", children: [
          "Bal: ",
          wallet?.withdrawable_balance.toLocaleString() || "0.00"
        ] })
      ] }),
      /* @__PURE__ */ jsxs75("div", { className: "bg-[#F8F9FB] rounded-3xl p-6 border border-gray-100 flex flex-col gap-3", children: [
        /* @__PURE__ */ jsxs75("div", { className: "flex justify-between items-center text-sm", children: [
          /* @__PURE__ */ jsx89("span", { className: "text-gray-500", children: "Processing Fee:" }),
          /* @__PURE__ */ jsxs75("span", { className: "font-medium text-gray-900", children: [
            "- ",
            wallet?.wallet_currency,
            " ",
        ...
        /* @__PURE__ */ jsxs75("div", { className: "flex justify-between items-center text-sm", children: [
          /* @__PURE__ */ jsx89("span", { className: "text-gray-500", children: "Destination Account:" }),
          /* @__PURE__ */ jsx89("span", { className: "font-medium text-gray-900 text-right", children: withdrawalAccount?.bankname })
        ] }),
        /* @__PURE__ */ jsxs75("div", { className: "pt-3 mt-1 border-t border-gray-200 flex justify-between items-center", children: [
          /* @__PURE__ */ jsx89("span", { className: "text-sm text-gray-500 font-medium", children: "Total:" }),
          /* @__PURE__ */ jsxs75("span", { className: "text-lg font-bold text-gray-900", children: [
            wallet?.wallet_currency,
            " ",
            ((withdrawalCharges?.total_charge ?? 0) + amount).toLocaleString()
          ] })
        ] }),
        withdrawalCharges?.remark && /* @__PURE__ */ jsxs75("div", { className: "mt-2 bg-white/50 border border-gray-200 rounded-xl px-4 py-3 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs75("div", { className: "flex items-center gap-2 text-xs text-gray-500", children: [
            /* @__PURE__ */ jsx89("span", { className: "opacity-60", children: "\u2139\uFE0F" }),
            /* @__PURE__ */ jsx89("span", { children: withdrawalCharges.remark })
          ] }),
          /* @__PURE__ */ jsx89(ChevronDownIcon3, {}),
          " "
        ] })
      ] }),
      /* @__PURE__ */ jsxs75("div", { className: "mt-8 mb-6", children: [
        /* @__PURE__ */ jsx89("label", { className: "text-sm font-medium text-gray-500 mb-2 block", children: "Recipient details" }),
        /* @__PURE__ */ jsx89("div", { className: "flex justify-between items-end", children: /* @__PURE__ */ jsxs75("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ jsx89("span", { className: "text-lg font-bold text-gray-900 uppercase", children: withdrawalAccount?.name }),
          /* @__PURE__ */ jsx89("span", { className: "text-gray-500 text-sm", children: withdrawalAccount?.acct_number })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxs75("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs75("label", { className: "mb-2 block text-[15px] font-medium text-[#1A1A1A]", children: [
          "Withdrawal PIN",
          /* @__PURE__ */ jsx89("span", { className: "ml-0.5 text-red-500", children: "*" })
        ] }),
        /* @__PURE__ */ jsx89("div", { className: "relative", children: /* @__PURE__ */ jsx89(
          "input",
          {
            id: "withdrawal_pin",
            name: "withdrawal_pin",
        ...
        /* @__PURE__ */ jsxs75("div", { className: "flex flex-col gap-3", children: [
          /* @__PURE__ */ jsx89(
            Cta_default,
            {
              element: "button",
      ...
      /* @__PURE__ */ jsx89("input", { type: "hidden", name: "intent", value: "requestWithdrawal" }),
      /* @__PURE__ */ jsx89("input", { type: "hidden", name: "withdrawal_account_id", value: withdrawalAccount?._id || "" }),
      /* @__PURE__ */ jsx89("input", { type: "hidden", name: "wallet_id", value: `${wallet?._id}` })
    ] }) : /* @__PURE__ */ jsxs75(Form15, { method: "POST", className: "w-full flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxs75("div", { className: "relative", ref: dropdownRef, children: [
        /* @__PURE__ */ jsxs75("label", { className: "mb-2 block text-[15px] font-medium text-[#1A1A1A]", children: [
          "Select beneficiary",
          /* @__PURE__ */ jsx89("span", { className: "ml-0.5 text-red-500", children: "*" })
        ] }),
        ...
        /* @__PURE__ */ jsx89("div", { className: "absolute right-5 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400", children: /* @__PURE__ */ jsx89(ChevronDownIcon3, {}) }),
        isOpen && /* @__PURE__ */ jsx89("div", { className: "absolute z-50 w-full mt-2 bg-white border border-gray-200 rounded-2xl shadow-xl max-h-60 overflow-y-auto overflow-x-hidden", children: withdrawalAccounts ?? [].length > 0 ? (withdrawalAccounts ?? []).map((acct) => /* @__PURE__ */ jsxs75(
          "div",
          {
            className: "px-5 py-4 hover:bg-slate-50 cursor-pointer text-gray-900 border-b border-gray-50 last:border-none transition-colors",
            onClick: () => {
          ...
          acct._id
        )) : /* @__PURE__ */ jsx89("div", { className: "px-5 py-4 text-gray-400 italic", children: "No withdrawal account. Please add a withdrawal account to conitnue" }) })
      ] }),
      /* @__PURE__ */ jsx89("div", { className: "relative", children: /* @__PURE__ */ jsx89(
        "input",
        {
      ...
      /* @__PURE__ */ jsx89("input", { type: "hidden", name: "intent", value: "getCharge" }),
      /* @__PURE__ */ jsx89("input", { type: "hidden", name: "withdrawal_account_id", value: withdrawalAccount?._id || "", required: !0 }),
      /* @__PURE__ */ jsx89("input", { type: "hidden", name: "wallet_id", value: `${wallet?._id}` }),
      /* @__PURE__ */ jsx89(
        Cta_default,
        {
...
var ChevronDownIcon3 = () => /* @__PURE__ */ jsx89("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsx89("path", { d: "m6 9 6 6 6-6" }) });
...
function Results() {
  ...
  return /* @__PURE__ */ jsxs76("main", { className: "grow", children: [
    /* @__PURE__ */ jsx90("header", { className: "wrapper my-16", children: /* @__PURE__ */ jsx90("h1", { className: "text-accent text-2xl lg:text-4xl lg:leading-snug font-satoshi-bold max-w-3xl", children: "Congratulating the Extraordinary Talents That Stole the Spotlight!" }) }),
    /* @__PURE__ */ jsx90("section", { className: "wrapper", children: /* @__PURE__ */ jsxs76("div", { className: "p-2 rounded-full bg-secondary flex w-fit", children: [
      /* @__PURE__ */ jsx90("span", { className: "whitespace-nowrap text-xs sm:text-base p-3 sm:px-6 sm:py-4 rounded-full font-satoshi-medium bg-accent text-white", children: "All Contests" }),
      /* @__PURE__ */ jsx90("span", { className: "whitespace-nowrap text-xs sm:text-base p-3 sm:px-6 sm:py-4 rounded-full font-satoshi-medium", children: "Ongoing Contests" }),
      /* @__PURE__ */ jsx90("span", { className: "whitespace-nowrap text-xs sm:text-base p-3 sm:px-6 sm:py-4 rounded-full font-satoshi-medium", children: "Completed Contests" })
    ] }) }),
    /* @__PURE__ */ jsx90("section", { className: "wrapper my-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-12 justify-items-center", children: contests2.map((contest) => /* @__PURE__ */ jsx90(ContestCard, { contest, to: `/results/${contest.id}`, withTag: !0, withCategory: !0 }, contest.id)) }),
    /* @__PURE__ */ jsx90("div", { className: "wrapper my-20 flex justify-center", children: /* @__PURE__ */ jsx90(Button, { element: "button", variant: "outline", children: "See more results" }) })
  ] });
}
...
import { redirect as redirect19 } from "@remix-run/node";
...
function RolesFormControl({ roles, defaultRoles, ...props }) {
  ...
  return /* @__PURE__ */ jsxs77("fieldset", { ref: fieldset, ...props, className: "p-2 sm:p-4 rounded-lg bg-transparent border hover:border-primary sm:col-span-2", children: [
    /* @__PURE__ */ jsxs77("div", { "data-open": open, className: "flex justify-between data-[open=true]:pb-2 sm:data-[open=true]:pb-3 data-[open=true]:border-b", children: [
      /* @__PURE__ */ jsxs77("span", { className: "flex gap-2 items-center font-bold cursor-pointer grow", onClick: () => setOpen((prev) => !prev), children: [
        /* @__PURE__ */ jsx91(Svg, { src: icons.arrowDownIcon, className: open ? "" : "-rotate-90" }),
        "Roles"
      ] }),
      /* @__PURE__ */ jsxs77(
        Cta_default,
        {
          ...
          children: [
            /* @__PURE__ */ jsx91(Restore, { className: "text-inherit sm:hidden" }),
            /* @__PURE__ */ jsx91("span", { className: "hidden sm:inline", children: "Restore defaults" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsx91("div", { className: cn9("grid sm:grid-cols-3 gap-6 mt-4 sm:mx-3", { hidden: !open }), children: roles.map((role) => /* @__PURE__ */ jsx91(
      FormControl,
      {
        as: "input",
        type: "checkbox",
...
async function loader25({ params, request }) {
  ...
  if (!user || !user.data) {
    ...
    return redirect19("/admin/accounts", { headers });
  }
...
function EditAdminUser() {
  ...
  return /* @__PURE__ */ jsxs78("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs78("div", { className: "flex items-center mb-10 sm:mb-16 gap-4", children: [
      /* @__PURE__ */ jsx92(RoundCta_default, { icon: icons.arrowPrevIcon, className: "hover:bg-[#F7F7F8] text-primary", onClick: () => navigate(-1) }),
      /* @__PURE__ */ jsx92("h1", { className: "text-2xl font-black text-primary", children: "Edit User" })
    ] }),
    /* @__PURE__ */ jsxs78(Form16, { className: "sm:wrapper grid sm:grid-cols-2 gap-3 sm:gap-6 text-sm", method: "post", children: [
      /* @__PURE__ */ jsx92(FormControl, { as: "input", labelText: "First Name", className: "", placeholder: "Enter first name", id: "firstName", name: "firstName", defaultValue: user.full_name.split(" ")[0], required: !0 }),
      /* @__PURE__ */ jsx92(FormControl, { as: "input", labelText: "Last Name", className: "", placeholder: "Enter last name", id: "lastName", name: "lastName", defaultValue: user.full_name.split(" ")[1], required: !0 }),
      /* @__PURE__ */ jsx92(FormControl, { as: "input", labelText: "Email Address", className: "", placeholder: "Enter email address", id: "email", name: "email", defaultValue: user.email, required: !0 }),
      /* @__PURE__ */ jsx92(FormControl, { as: "input", labelText: "Username", className: "", placeholder: "Enter username", id: "username", name: "username", defaultValue: user.username, required: !0 }),
      /* @__PURE__ */ jsxs78(Select2, { label: "Assigned as Staff", id: "is_staff", name: "is_staff", defaultValue: user.is_staff ? "1" : "0", required: !0, children: [
        /* @__PURE__ */ jsx92("option", { value: "0", children: "False" }),
        /* @__PURE__ */ jsx92("option", { value: "1", children: "True" })
      ] }),
      /* @__PURE__ */ jsxs78(Select2, { label: "Set Active", id: "is_active", name: "is_active", defaultValue: user.is_active ? "1" : "0", required: !0, children: [
        /* @__PURE__ */ jsx92("option", { value: "0", children: "De-activate" }),
        /* @__PURE__ */ jsx92("option", { value: "1", children: "Activate" })
      ] }),
      /* @__PURE__ */ jsxs78(Select2, { label: "Has Admin Access", id: "has_admin_access", name: "has_admin_access", defaultValue: user.has_admin_access ? "1" : "0", required: !0, children: [
        /* @__PURE__ */ jsx92("option", { value: "0", children: "False" }),
        /* @__PURE__ */ jsx92("option", { value: "1", children: "True" })
      ] }),
      /* @__PURE__ */ jsx92(RolesFormControl, { roles: rolesNames, defaultRoles: user.roles }),
      /* @__PURE__ */ jsxs78("div", { className: "grid grid-cols-2 sm:flex justify-end gap-3 sm:gap-6 sm:col-span-2 mt-4", children: [
        /* @__PURE__ */ jsx92(Cta_default, { element: "button", type: "reset", className: "px-4 sm:px-8 py-2 rounded-lg font-medium border-secondary active:border-accent", variant: "outline", children: "Reset" }),
        /* @__PURE__ */ jsx92(Cta_default, { disabled: isSubmitting, element: "button", type: "submit", className: "px-4 sm:px-8 py-2 rounded-lg font-medium", children: isSubmitting ? "Updating admin user" : "Update admin user" })
      ] })
    ] })
  ] });
}
...
import { json as json25, redirect as redirect20 } from "@remix-run/node";
...
async function loader26({ request }) {
  ...
  let pagedUsersRes = await adminRepo.queryUsers(cookieHeader, query);
  return pagedUsersRes.authRequired ? redirect20("/login") : json25({ headings, tableData: adminUsers, pagedUserData: pagedUsersRes.data, query });
}
function Accounts2() {
  let { headings, tableData, pagedUserData, query } = useLoaderData24(), navigation = useNavigation7();
  return console.log(pagedUserData), /* @__PURE__ */ jsxs79("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs79("div", { className: "flex justify-between items-center mb-8 sm:mb-16", children: [
      /* @__PURE__ */ jsx93("h1", { className: "text-2xl font-black text-primary", children: "Admin Accounts" }),
    ...
    /* @__PURE__ */ jsxs79("div", { className: "flex flex-col gap-3 sm:flex-row justify-between sm:items-center my-8", children: [
      /* @__PURE__ */ jsx93("p", { className: "font-semibold", children: "Registered Admin Users" }),
      /* @__PURE__ */ jsxs79(Form17, { method: "get", className: "flex items-center gap-3", onSubmit: (e) => {
        try {
          let form = e.currentTarget, searchInput = form.elements.namedItem("searchUser"), hidden = form.elements.namedItem("wild_card");
          searchInput && hidden && (hidden.value = searchInput.value || "");
        } catch {
        ...
        /* @__PURE__ */ jsx93(FormControl, { as: "input", name: "searchUser", type: "search", placeholder: "Search user...", className: "text-sm xs:min-w-[280px]", defaultValue: query?.wild_card ?? "" }),
        /* @__PURE__ */ jsx93("input", { type: "hidden", name: "wild_card", defaultValue: query?.wild_card ?? "" }),
        /* @__PURE__ */ jsx93("button", { type: "submit", disabled: navigation.state === "submitting", className: "px-3 py-2 bg-[#312E81] text-white rounded-md text-sm", children: navigation.state === "submitting" ? "Searching..." : "Search" })
      ] }),
      /* @__PURE__ */ jsxs79(Cta_default, { element: "link", to: "add", className: "sm:hidden flex gap-2 items-center justify-center rounded-lg px-3 py-2", children: [
        /* @__PURE__ */ jsx93(Svg, { src: icons.addIcon, width: ".9em" }),
        "Add User"
      ] })
    ] }),
    /* @__PURE__ */ jsxs79("div", { className: "sm:hidden grid gap-4 my-6", children: [
      pagedUserData?.items.map((user) => /* @__PURE__ */ jsx93(AdminUserCard, { user }, user._id)),
      /* @__PURE__ */ jsx93(Pagination, { lastKey: pagedUserData?.last_key_id, pageSize: pagedUserData?.items_per_page, firstKey: pagedUserData?.first_key_id })
    ] }),
    /* @__PURE__ */ jsx93("div", { className: "hidden sm:block w-full overflow-x-auto", children: /* @__PURE__ */ jsxs79("table", { className: "w-full table-auto", children: [
      /* @__PURE__ */ jsx93("thead", { children: /* @__PURE__ */ jsxs79("tr", { className: "border-b border-secondary", children: [
        headings.map((heading) => /* @__PURE__ */ jsx93("th", { className: "text-left capitalize font-satoshi-black p-3", children: heading }, heading)),
        /* @__PURE__ */ jsx93("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Actions" })
      ] }) }),
      /* @__PURE__ */ jsx93("tbody", { children: pagedUserData?.items.map((user, index) => /* @__PURE__ */ jsxs79("tr", { className: "border-b border-secondary", children: [
        headings.map((heading) => heading === "access" ? /* @__PURE__ */ jsx93("td", { className: "p-3", children: /* @__PURE__ */ jsxs79("span", { className: "grid grid-cols-[76px_36px] items-center w-min", children: [
          user.is_active ? "Enabled" : "Disabled",
          /* @__PURE__ */ jsx93(ToggleBtn, { on: user.is_active })
        ] }) }, heading) : /* @__PURE__ */ jsx93("td", { className: "p-3", children: Array.isArray(user[heading]) ? user[heading].join(", ") : user[heading] }, heading)),
        /* @__PURE__ */ jsx93("td", { className: "p-3", children: /* @__PURE__ */ jsxs79("div", { className: "flex gap-4 items-center", children: [
          /* @__PURE__ */ jsx93(RoundCta_default, { icon: icons.editIcon, element: "link", to: user._id, className: "border-[#262626] bg-[#F7F7F8] text-primary" }),
          /* @__PURE__ */ jsx93(RoundCta_default, { icon: icons.trashIcon, className: "border-red-500 bg-red-50 text-red-500" })
        ] }) })
      ] }, index)) })
    ] }) }),
    /* @__PURE__ */ jsx93("div", { className: "hidden sm:flex justify-between items-center my-4", children: /* @__PURE__ */ jsx93(Pagination, { lastKey: pagedUserData?.last_key_id, pageSize: pagedUserData?.items_per_page, firstKey: pagedUserData?.first_key_id }) })
  ] });
}
...
function Contests2() {
  ...
  return /* @__PURE__ */ jsxs80("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs80("section", { className: "flex max-sm:flex-col gap-10 justify-between sm:items-center mb-6 sm:mb-16", children: [
      /* @__PURE__ */ jsx94("h1", { className: "text-2xl font-black text-primary", children: "Contests" }),
      /* @__PURE__ */ jsxs80(Cta_default, { element: "link", to: "add", className: "flex gap-2 items-center justify-center rounded-lg px-3 py-2", children: [
        /* @__PURE__ */ jsx94(Svg, { src: icons.addIcon, width: ".9em" }),
        "Create Contest"
      ] })
    ] }),
    /* @__PURE__ */ jsx94("section", { className: "my-6 sm:my-12", children: /* @__PURE__ */ jsx94(ContestTable, { data: contests2 }) })
  ] });
}
...
function CreateTournamentForm() {
  return /* @__PURE__ */ jsxs81(Form18, { className: "max-w-xl mx-auto grid gap-6 sm:gap-12", method: "post", encType: "multipart/form-data", children: [
    /* @__PURE__ */ jsx95("h1", { className: "text-xl xs:text-2xl font-bold text-primary", children: "Create New Tournament" }),
    /* @__PURE__ */ jsxs81("div", { className: "grid gap-3 sm:gap-6", children: [
      /* @__PURE__ */ jsx95(FormControl, { as: "input", labelText: "Tournament Name", placeholder: "Enter tournament name", id: "name", name: "name", required: !0 }),
      /* @__PURE__ */ jsx95(FormControl, { as: "input", labelText: "Tournament Unique ID", placeholder: "Enter unique ID", id: "uniqueId", name: "uniqueId", required: !0 }),
      /* @__PURE__ */ jsx95(FormControl, { as: "textarea", rows: 3, labelText: "Tournament Description", placeholder: "Enter tournament description", id: "description", name: "description", required: !0 }),
      /* @__PURE__ */ jsx95(DragnDrop, { labelText: "Tournament Image", name: "image" })
    ] }),
    /* @__PURE__ */ jsx95("div", { className: "flex justify-end gap-6", children: /* @__PURE__ */ jsx95(Cta_default, { element: "button", type: "submit", className: "px-8 py-2 rounded-lg font-medium max-sm:grow", children: "Create Tournament" }) })
  ] });
}
...
import { Form as Form19, Link as Link15, useActionData as useActionData8, useLoaderData as useLoaderData26 } from "@remix-run/react";
...
async function action17({ request }) {
  ...
  return console.log({ data, error, authRequired }), json28({ data, error, authRequired });
}
...
function useSetWithdrawalPinController() {
  let { setUserStoreManager, getUserStoreManager } = useUserManager(), [user, setUser] = useState30(null), actionData = useActionData8(), loader_ = useLoaderData26();
  return useEffect20(() => {
    let _user = getUserStoreManager();
  }, [getUserStoreManager]), {
    user,
...
function SetWithdrawalPin() {
  ...
  }, [actionData]), /* @__PURE__ */ jsxs83("div", { className: "flex min-h-screen items-center justify-center bg-white p-6 font-sans relative", children: [
    /* @__PURE__ */ jsx97(Link15, { to: "/user/wallet", className: "absolute top-4 right-4 text-gray-500 hover:text-gray-800", children: /* @__PURE__ */ jsx97(X, { size: 24 }) }),
    /* @__PURE__ */ jsxs83(Form19, { className: "w-full max-w-lg text-center", method: "POST", children: [
      /* @__PURE__ */ jsx97("input", { type: "hidden", name: "intent", value: "create-withdrawal-pin" }),
      /* @__PURE__ */ jsx97("div", { className: "mb-8 flex justify-center", children: /* @__PURE__ */ jsxs83("div", { className: "relative flex h-16 w-16 items-center justify-center rounded-full bg-[#E5E5EF]", children: [
        /* @__PURE__ */ jsx97("div", { className: "absolute h-24 w-24 rounded-full border border-slate-100" }),
        /* @__PURE__ */ jsx97("div", { className: "absolute h-32 w-32 rounded-full border border-slate-50/50" }),
        /* @__PURE__ */ jsx97(User, { className: "h-8 w-8 text-[#1A1A1A]", fill: "currentColor" })
      ] }) }),
      /* @__PURE__ */ jsx97("h1", { className: "mb-2 text-2xl font-bold tracking-tight text-[#1A1A1A]", children: "Set withdrawal PIN" }),
      /* @__PURE__ */ jsx97("p", { className: "mb-10 text-[15px] text-gray-500", children: "We sent a token to your email address. Please enter it below along with your desired withdrawal PIN." }),
      /* @__PURE__ */ jsxs83("div", { className: "text-left", children: [
        /* @__PURE__ */ jsxs83("label", { className: "mb-2 block text-[15px] font-medium text-[#1A1A1A]", children: [
          "token",
          /* @__PURE__ */ jsx97("span", { className: "ml-0.5 text-red-500", children: "*" })
        ] }),
        /* @__PURE__ */ jsx97("div", { className: "relative", children: /* @__PURE__ */ jsx97(
          "input",
          {
            type: "text",
            maxLength: 4,
...
function AllTournaments() {
  let { tournaments } = useLoaderData27();
  return /* @__PURE__ */ jsxs84("main", { className: "grow", children: [
    /* @__PURE__ */ jsx98("header", { className: "wrapper my-16", children: /* @__PURE__ */ jsx98("h1", { className: "text-2xl lg:text-4xl font-satoshi-medium max-w-3xl", children: "From Artistic Marvels to Captivating Moments. Unleash Your Talent and Win Big in Our Monthly and Yearly Contests!" }) }),
    /* @__PURE__ */ jsx98("section", { className: "wrapper my-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-12 justify-items-center", children: tournaments.map((tournament) => /* @__PURE__ */ jsx98(ContestCard, { contest: tournament, to: `/contests/${tournament.id}` }, tournament.id)) })
  ] });
}
...
import { Link as Link16, useLoaderData as useLoaderData28 } from "@remix-run/react";
import { json as json30, redirect as redirect23 } from "@remix-run/node";
...
async function loader30({ request }) {
  ...
  return console.log({ data, error }), authRequired ? redirect23("/login") : json30({ data, error, authRequired });
}
var PendingUploadCard = ({
  ...
  full_name,
  contestantId
}) => /* @__PURE__ */ jsx99(Link16, { to: `/user/contestant/${contestantId}`, className: "block transition-shadow", children: /* @__PURE__ */ jsxs85("article", { children: [
  /* @__PURE__ */ jsx99(
    "img",
    {
  ...
  /* @__PURE__ */ jsxs85("div", { className: "pt-4", children: [
    /* @__PURE__ */ jsxs85("p", { className: "text-xs font-semibold uppercase tracking-wide text-gray-500", children: [
      contest_name,
      /* @__PURE__ */ jsx99("br", {}),
      "stage ",
      stage
...
function useUserPendingsUploadController() {
  let { data, error, authRequired } = useLoaderData28(), [pendingUploads, setPendingUploads] = useState31([]);
  return error && toast({
    variant: "destructive",
    title: "An error occured",
    description: error?.detail.toString() ?? "Error occured"
...
function UserPendingsUpload() {
  ...
  return /* @__PURE__ */ jsx99("div", { className: "min-h-screen", children: /* @__PURE__ */ jsxs85("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8", children: [
    /* @__PURE__ */ jsx99("header", { className: "bg-[#817EFB] overflow-hidden rounded-3xl py-8 md:py-12 lg:py-16 px-5", children: /* @__PURE__ */ jsxs85("div", { className: "max-w-3xl mx-auto text-center", children: [
      /* @__PURE__ */ jsx99("h1", { className: "text-3xl md:text-4xl lg:text-5xl font-bold text-white", children: "Pending uploads" }),
      /* @__PURE__ */ jsx99("p", { className: "mt-4 text-base md:text-lg text-purple-100", children: "Please, we are expecting your uploads for the following stages" })
    ] }) }),
    /* @__PURE__ */ jsx99("main", { className: "py-12 md:py-16", children: /* @__PURE__ */ jsx99("div", { className: "grid grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-3", children: pendingUploads.map((pendingUpload, idx) => /* @__PURE__ */ jsx99(
      PendingUploadCard,
      {
...
import { Form as Form20, useActionData as useActionData9, useLoaderData as useLoaderData29, useNavigate as useNavigate17, useNavigation as useNavigation8 } from "@remix-run/react";
...
async function loader31({ request }) {
  ...
  let rolesResponse = await adminRepo.getAllRoles(cookieHeader);
  return rolesResponse.authRequired ? redirect24("/login") : { roles: rolesResponse.data, permissions };
}
...
function useAddAdminUser() {
  let { permissions: permissions2, roles } = useLoaderData29(), rolesNames = [];
  for (let roleName in roles)
    rolesNames.push(roleName);
  let isSubmitting = useNavigation8().state === "submitting", actionData = useActionData9();
  return useEffect22(() => {
    actionData?.error && (console.log(actionData.error), toast({
      variant: "destructive",
      title: "Create action failed",
...
function AddAdminUser() {
  ...
  return /* @__PURE__ */ jsxs86("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs86("div", { className: "flex items-center mb-10 sm:mb-16 gap-4", children: [
      /* @__PURE__ */ jsx100(RoundCta_default, { icon: icons.arrowPrevIcon, className: "hover:bg-[#F7F7F8] text-primary", onClick: () => navigate(-1) }),
      /* @__PURE__ */ jsx100("h1", { className: "text-2xl font-black text-primary", children: "Add User" })
    ] }),
    /* @__PURE__ */ jsxs86(Form20, { className: "sm:wrapper grid sm:grid-cols-2 gap-3 sm:gap-6 text-sm", method: "post", children: [
      /* @__PURE__ */ jsx100(FormControl, { as: "input", labelText: "First Name", className: "", placeholder: "Enter first name", id: "firstName", name: "firstName", required: !0 }),
      /* @__PURE__ */ jsx100(FormControl, { as: "input", labelText: "Last Name", className: "", placeholder: "Enter last name", id: "lastName", name: "lastName", required: !0 }),
      /* @__PURE__ */ jsx100(FormControl, { as: "input", labelText: "Email Address", className: "", placeholder: "Enter email address", id: "email", name: "email", required: !0 }),
      /* @__PURE__ */ jsx100(FormControl, { as: "input", labelText: "Username", className: "", placeholder: "Enter username", id: "username", name: "username", required: !0 }),
      /* @__PURE__ */ jsx100(FormControl, { as: "input", labelText: "Password", className: "", placeholder: "Enter username", id: "password", name: "password", required: !0 }),
      /* @__PURE__ */ jsxs86(Select2, { label: "Assign Staff", id: "is_staff", name: "is_staff", defaultValue: "1", required: !0, children: [
        /* @__PURE__ */ jsx100("option", { value: "0", children: "Disable" }),
        /* @__PURE__ */ jsx100("option", { value: "1", children: "Enable" })
      ] }),
      /* @__PURE__ */ jsxs86(Select2, { label: "Set Active", id: "is_active", name: "is_active", defaultValue: "1", required: !0, children: [
        /* @__PURE__ */ jsx100("option", { value: "0", children: "De-activate" }),
        /* @__PURE__ */ jsx100("option", { value: "1", children: "Activate" })
      ] }),
      /* @__PURE__ */ jsxs86(Select2, { label: "Has Admin access", id: "has_admin_access", name: "has_admin_access", defaultValue: "1", required: !0, children: [
        /* @__PURE__ */ jsx100("option", { value: "0", children: "False" }),
        /* @__PURE__ */ jsx100("option", { value: "1", children: "True" })
      ] }),
      /* @__PURE__ */ jsx100(RolesFormControl, { roles: rolesNames }),
      /* @__PURE__ */ jsxs86("div", { className: "grid grid-cols-2 sm:flex justify-end gap-3 sm:gap-6 sm:col-span-2 mt-4", children: [
        /* @__PURE__ */ jsx100(Cta_default, { element: "button", type: "reset", className: "px-4 sm:px-8 py-2 rounded-lg font-medium border-secondary active:border-accent", variant: "outline", children: "Reset" }),
        /* @__PURE__ */ jsx100(Cta_default, { disabled: isSubmitting, element: "button", type: "submit", className: "px-4 sm:px-8 py-2 rounded-lg font-medium", children: isSubmitting ? "Creating admin user" : "Create admin user" })
      ] })
    ] })
  ] });
}
...
import { useLoaderData as useLoaderData30, useNavigate as useNavigate18 } from "@remix-run/react";

// app/components/admin/tournament/CreateContestForm.tsx
import { Form as Form21, useSearchParams as useSearchParams3 } from "@remix-run/react";
...
function CreateContestForm({ tournaments }) {
  ...
  return /* @__PURE__ */ jsxs87(Form21, { className: "max-w-[700px] mx-auto my-8 grid gap-6 sm:gap-12 text-sm", method: "post", encType: "multipart/form-data", children: [
    /* @__PURE__ */ jsx101("h1", { className: "text-2xl font-bold text-primary", children: "Contest Details" }),
    /* @__PURE__ */ jsxs87("fieldset", { className: "grid gap-3 sm:gap-6 sm:grid-cols-2", children: [
      /* @__PURE__ */ jsxs87(Select2, { name: "tournament", id: "tournament", label: "Tournament", className: "uppercase", defaultValue: defaultTournament, required: !0, children: [
        /* @__PURE__ */ jsx101("option", { value: "", children: "Select a tournament" }),
        tournaments.map((tournament) => /* @__PURE__ */ jsx101("option", { value: tournament.id, children: tournament.id }, tournament.id))
      ] }),
      /* @__PURE__ */ jsx101(FormControl, { as: "input", labelText: "Contest Name", placeholder: "Enter contest name", id: "name", name: "name", required: !0 }),
      /* @__PURE__ */ jsx101(FormControl, { as: "textarea", rows: 3, labelClassNames: "sm:col-span-2", labelText: "Contest Description", placeholder: "Enter contest description", id: "description", name: "description", required: !0 }),
      /* @__PURE__ */ jsx101(FormControl, { as: "input", labelText: "Unique Contest ID", placeholder: "Enter unique ID", id: "uniqueId", name: "uniqueId", required: !0 }),
      /* @__PURE__ */ jsx101(FormControl, { as: "input", type: "datetime-local", labelText: "Registration Deadline", id: "reg_deadline", name: "reg_deadline", required: !0 }),
      /* @__PURE__ */ jsx101(FormControl, { as: "input", type: "datetime-local", labelText: "Contest Start Date", id: "start_date", name: "start_date", required: !0 }),
      /* @__PURE__ */ jsx101(FormControl, { as: "input", type: "datetime-local", labelText: "Contest End Date", id: "end_date", name: "end_date", required: !0 }),
      /* @__PURE__ */ jsx101(FormControl, { as: "textarea", rows: 2, labelText: "Contest Prizes", labelClassNames: "sm:col-span-2", placeholder: "Enter contest prizes", id: "prizes", name: "prizes", required: !0 }),
      /* @__PURE__ */ jsx101(DragnDrop, { className: "sm:col-span-2", name: "image", multiple: !1 })
    ] }),
    /* @__PURE__ */ jsx101(CategoryInputs, {}),
    /* @__PURE__ */ jsx101(StageInputs, {}),
    /* @__PURE__ */ jsxs87("fieldset", { className: "grid gap-3 sm:gap-6 sm:grid-cols-2", children: [
      /* @__PURE__ */ jsx101("legend", { className: "text-lg mb-4 font-bold", children: "Contestants and Referrals Earnings" }),
      /* @__PURE__ */ jsx101(FormControl, { as: "input", type: "number", step: 1, max: 100, min: 0, labelText: "Contestant Share Percentage", id: "contestant_share_percent", name: "contestant_share_percent", defaultValue: 50, required: !0 }),
      /* @__PURE__ */ jsx101(FormControl, { as: "input", type: "number", labelText: "Minimum amount for affiliate to earn", id: "min_for_referral_earning", name: "min_for_referral_earning", defaultValue: 3e3, required: !0 }),
      /* @__PURE__ */ jsx101(FormControl, { as: "input", type: "number", labelText: "Amount affiliate would earn from minimum", id: "referral_bonus_from_min", name: "referral_bonus_from_min", defaultValue: 500, required: !0 }),
      /* @__PURE__ */ jsx101(FormControl, { as: "input", type: "number", step: 1, max: 100, min: 0, labelText: "Affiliate percentage earnings after minimum", id: "referral_percent_after_min", name: "referral_percent_after_min", defaultValue: 1, required: !0 })
    ] }),
    /* @__PURE__ */ jsxs87("fieldset", { className: "grid gap-3 sm:gap-6", children: [
      /* @__PURE__ */ jsx101("legend", { className: "text-lg mb-4 font-bold", children: "Submission Guidelines" }),
      /* @__PURE__ */ jsx101(FormControl, { as: "textarea", rows: 4, labelText: "Submission Requirements", placeholder: "Enter text here...", id: "sub_req", name: "sub_req", required: !0 }),
      /* @__PURE__ */ jsx101(FormControl, { as: "textarea", rows: 4, labelText: "Terms & Conditions", placeholder: "Enter text here...", id: "tnc", name: "tnc", required: !0 }),
      /* @__PURE__ */ jsx101(FormControl, { as: "textarea", rows: 4, labelText: "Additional Information", placeholder: "Enter text here...", id: "add_info", name: "add_info", required: !0 })
    ] }),
    /* @__PURE__ */ jsx101("div", { className: "flex justify-end gap-6", children: /* @__PURE__ */ jsx101(Cta_default, { element: "button", type: "submit", className: "px-8 py-2 rounded-lg font-medium max-sm:grow", children: "Create Contest" }) })
  ] });
}
...
async function action19({ request }) {
  ...
  if (data) {
    ...
    return redirect25("/admin/contests", { headers: headers2 });
  }
  let { headers } = await setToast({ request, toast: `error::${error.detail}::${Date.now()}` });
  return json31(null, { headers });
}
function AddContest() {
  let { tournaments } = useLoaderData30(), navigate = useNavigate18();
  return /* @__PURE__ */ jsxs88("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs88("div", { className: "flex items-center mb-10 sm:mb-16 gap-4", children: [
      /* @__PURE__ */ jsx102(RoundCta_default, { icon: icons.arrowPrevIcon, className: "hover:bg-[#F7F7F8] text-primary", onClick: () => navigate(-1) }),
      /* @__PURE__ */ jsx102("span", { className: "font-black text-primary", children: "Create Contest" })
    ] }),
    /* @__PURE__ */ jsx102(CreateContestForm, { tournaments })
  ] });
}
...
import { Link as Link17, useLoaderData as useLoaderData31 } from "@remix-run/react";
...
async function loader33({ params }) {
...
var WinnerCard = ({
  ...
  full_name,
  id
}) => /* @__PURE__ */ jsx103(Link17, { to: `/winner/${id}`, className: "block transition-shadow", children: /* @__PURE__ */ jsxs89("article", { children: [
  /* @__PURE__ */ jsx103(
    "img",
    {
      src: image_url,
  ...
  /* @__PURE__ */ jsxs89("div", { className: "pt-4", children: [
    /* @__PURE__ */ jsx103("p", { className: "text-xs font-semibold uppercase tracking-wide text-gray-500", children: contest_name }),
    /* @__PURE__ */ jsx103("h3", { className: "mt-1 text-lg font-bold text-gray-900", children: full_name })
  ] })
] }) }), SearchIcon = (props) => /* @__PURE__ */ jsx103(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
function Winners() {
  let { winners, error } = useLoaderData31(), [searchWinners, setSearchWinners] = useState32(""), [winnersFiltered, setWinnersFiltered] = useState32(winners ?? []);
  return useEffect23(() => {
  ...
  }, [searchWinners, winners]), error ? /* @__PURE__ */ jsx103("h1", { className: "font-satoshi-bold text-4xl text-center", children: error.detail }) : /* @__PURE__ */ jsx103("div", { className: "min-h-screen", children: /* @__PURE__ */ jsxs89("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8", children: [
    /* @__PURE__ */ jsx103("header", { className: "bg-[#817EFB] overflow-hidden rounded-3xl py-8 md:py-12 lg:py-16 px-5", children: /* @__PURE__ */ jsxs89("div", { className: "max-w-3xl mx-auto text-center", children: [
      /* @__PURE__ */ jsx103("h1", { className: "text-3xl md:text-4xl lg:text-5xl font-bold text-white", children: "Meet Our Talented Contest Winners" }),
      /* @__PURE__ */ jsx103("p", { className: "mt-4 text-base md:text-lg text-purple-100", children: "A Glimpse of the Extraordinary Creations That Stole the Show" }),
      /* @__PURE__ */ jsxs89("div", { className: "mt-8 relative max-w-lg mx-auto", children: [
        /* @__PURE__ */ jsx103(
          "input",
          {
            type: "text",
        ...
        /* @__PURE__ */ jsx103("div", { className: "absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-auto", children: /* @__PURE__ */ jsx103(SearchIcon, { className: "h-5 w-5 text-gray-400" }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs89("main", { className: "py-12 md:py-16", children: [
      /* @__PURE__ */ jsx103("div", { className: "grid grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-3", children: winnersFiltered.map((winner, idx) => /* @__PURE__ */ jsx103(
        WinnerCard,
        {
      ...
      /* @__PURE__ */ jsx103("div", { className: "mt-12 md:mt-16 text-center", children: /* @__PURE__ */ jsx103(
        "button",
        {
          type: "button",
...
function ContactForm() {
  return /* @__PURE__ */ jsxs90("form", { className: "wrapper flex flex-col gap-6", children: [
    /* @__PURE__ */ jsxs90("div", { className: "grid gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsx104(
        FormControl,
        {
          as: "input",
    ...
    /* @__PURE__ */ jsx104(Button, { element: "button", className: "md:self-end", children: "Submit" })
  ] });
}
...
function WhyCard(props) {
  return /* @__PURE__ */ jsxs91("article", { className: `block p-8 text-white rounded-3xl ${props.backgroundColor}`, children: [
    /* @__PURE__ */ jsx105("div", { className: "p-6 mb-8 rounded-3xl bg-[#FFFFFF29] w-fit", children: /* @__PURE__ */ jsx105(Svg, { src: props.icon, width: 24, height: 24 }) }),
    /* @__PURE__ */ jsx105("h3", { className: "mb-4 text-2xl font-black", children: props.title }),
    /* @__PURE__ */ jsx105("p", { className: "font-bold", children: props.subtext })
  ] });
}
...
function SponsorsSlider() {
  return /* @__PURE__ */ jsx106(AutoplayCarousel, { children: /* @__PURE__ */ jsx106(CarouselItem, { children: /* @__PURE__ */ jsx106("img", { src: sponsor_logo_default, alt: "Zendesk" }) }) });
}

// app/routes/_public._index.tsx
import { jsx as jsx107, jsxs as jsxs92 } from "react/jsx-runtime";
function LandingPage() {
  return /* @__PURE__ */ jsxs92("main", { className: "snap-y", children: [
    /* @__PURE__ */ jsxs92("section", { className: "wrapper flex flex-col md:flex-row gap-16 xl:gap-24 md:items-center py-8 md:py-16", children: [
      /* @__PURE__ */ jsxs92("div", { className: "flex flex-col gap-6 sm:gap-8", children: [
        /* @__PURE__ */ jsxs92("h1", { className: "font-black text-4xl sm:text-5xl xl:text-[64px] leading-tight sm:leading-snug whitespace-nowrap", children: [
          "Capturing Moments",
          /* @__PURE__ */ jsx107("br", {}),
          "Creating ",
          /* @__PURE__ */ jsx107("span", { className: "text-accent", children: "Memories." })
        ] }),
        /* @__PURE__ */ jsx107("p", { className: "text-xl", children: "Join our monthly/yearly photo contests open to kids, both male and female aged 0-14 years and discover a world of imagination and inspiration." }),
        /* @__PURE__ */ jsxs92("div", { className: "flex gap-4 flex-wrap", children: [
          /* @__PURE__ */ jsx107(Button, { element: "button", className: "w-full sm:w-auto", children: "Join Now" }),
          /* @__PURE__ */ jsx107(Button, { element: "a", href: "/contests", className: "w-full sm:w-auto", variant: "outline", children: "Explore Contests" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs92("div", { className: "grid grid-cols-3 gap-8 xl:gap-9 w-full", children: [
        /* @__PURE__ */ jsxs92("div", { className: "flex flex-col gap-8 xl:gap-9", children: [
          /* @__PURE__ */ jsx107("img", { className: "aspect-3/7 object-cover rounded-full outline-dashed outline-offset-4 w-full", src: hero_1_default, alt: "kid smiling" }),
          /* @__PURE__ */ jsx107("img", { className: "aspect-3/4 rounded-full outline-dashed outline-offset-4 object-cover w-full", src: hero_2_default, alt: "kid smiling" })
        ] }),
        /* @__PURE__ */ jsxs92("div", { className: "flex flex-col gap-8 xl:gap-9 justify-center", children: [
          /* @__PURE__ */ jsx107("img", { className: "aspect-square rounded-full outline-dashed outline-offset-4 object-cover w-full", src: hero_3_default, alt: "kid smiling" }),
          /* @__PURE__ */ jsx107("img", { className: "aspect-3/7 rounded-full outline-dashed outline-offset-4 object-cover w-full", src: hero_4_default, alt: "kid smiling" })
        ] }),
        /* @__PURE__ */ jsx107("div", { className: "flex flex-col justify-center", children: /* @__PURE__ */ jsx107("img", { className: "aspect-3/7 rounded-full outline-dashed outline-offset-4 object-cover w-full", src: hero_5_default, alt: "kid smiling" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxs92("section", { className: "wrapper py-8 md:py-16", children: [
      /* @__PURE__ */ jsx107("h2", { className: "font-bold text-xl mb-4", children: "Who supports us" }),
      /* @__PURE__ */ jsx107(SponsorsSlider, {})
    ] }),
    /* @__PURE__ */ jsx107("section", { className: "py-8 md:py-16", children: /* @__PURE__ */ jsxs92("div", { className: "sm:wrapper bg-secondary md:px-24 py-16 md:py-28 flex flex-col md:flex-row justify-between items-center gap-16 sm:rounded-3xl", children: [
      /* @__PURE__ */ jsxs92("div", { className: "wrapper", children: [
        /* @__PURE__ */ jsxs92("div", { className: "mb-8", children: [
          /* @__PURE__ */ jsx107("p", { className: "font-black text-xl", children: "Our Vision" }),
          /* @__PURE__ */ jsx107("img", { className: "object-cover object-center", src: underline_default, alt: "underline", width: 100 })
        ] }),
        /* @__PURE__ */ jsxs92("h2", { className: "text-2xl sm:text-3xl font-black mb-6 leading-snug", children: [
          "Crafting ",
          /* @__PURE__ */ jsx107("span", { className: "text-accent", children: "Unforgettable" }),
          " Moments for Every Child's Special Day."
        ] }),
        /* @__PURE__ */ jsx107("p", { className: "font-medium", children: "To create uniquely memorable and exciting kid's birthdays, we strive to be entertaining, transparent, innovative, creative, exciting, efficient, and reliable in every aspect of our service." })
      ] }),
      /* @__PURE__ */ jsx107("div", { className: "wrapper", children: /* @__PURE__ */ jsx107("img", { className: "object-cover object-center w-full", src: birthday_present_default, alt: "wrapped gift" }) })
    ] }) }),
    /* @__PURE__ */ jsxs92("section", { className: "py-8 md:py-16 wrapper flex flex-col items-center", children: [
      /* @__PURE__ */ jsxs92("div", { className: "mb-6 sm:mb-16", children: [
        /* @__PURE__ */ jsx107("h2", { className: "font-satoshi-black text-2xl", children: "Why KOTMY?" }),
        /* @__PURE__ */ jsx107("img", { className: "object-fill w-[159px] h-5", src: underline_default, alt: "underline" })
      ] }),
      /* @__PURE__ */ jsx107("div", { className: "grid gap-6 lg:gap-12 sm:grid-cols-2 max-w-5xl", children: whyUsData.map((item) => /* @__PURE__ */ jsx107(WhyCard, { backgroundColor: item.bg, icon: item.icon, title: item.title, subtext: item.subtext }, item.title)) })
    ] }),
    /* @__PURE__ */ jsx107("section", { className: "py-8 md:py-16", children: /* @__PURE__ */ jsx107(ContestantSlider, { contestants: [{ id: "sdjc", image: hero_1_default }, { id: "adcn", image: hero_2_default }, { id: "kjsd", image: hero_3_default }] }) }),
    /* @__PURE__ */ jsx107("section", { className: "pt-4 sm:py-8 md:py-16", children: /* @__PURE__ */ jsxs92("div", { className: "sm:wrapper bg-[#817EFB] bg-pattern bg-cover bg-left text-secondary md:px-24 py-16 md:py-28 flex flex-col md:flex-row justify-between items-center gap-16 sm:rounded-3xl", children: [
      /* @__PURE__ */ jsxs92("div", { className: "wrapper", children: [
        /* @__PURE__ */ jsx107("h2", { className: "text-2xl sm:text-[40px] font-satoshi-black mb-6 leading-snug", children: "Refer A Friend And Earn Rewards" }),
        /* @__PURE__ */ jsx107("p", { className: "font-satoshi-medium mb-8", children: "Lorem ipsum dolor sit amet consectetur. Velit egestas auctor in amet dis sed sit egestas. Viverra morbi eget consectetur accumsan integer. Mi et etiam amet est egestas tellus quis." }),
        /* @__PURE__ */ jsx107("span", { className: "inline-block bg-[#E7E7E7] text-primary py-4 px-8 text-lg rounded-md font-black whitespace-nowrap", children: "COMING SOON" })
      ] }),
      /* @__PURE__ */ jsx107("div", { className: "wrapper bg-[#E7E7E7] rounded-3xl w-full aspect-square" })
    ] }) }),
    /* @__PURE__ */ jsx107("section", { id: "contact", className: "sm:py-8 md:py-16 sm:-scroll-m-4 md:-scroll-m-8 snap-start", children: /* @__PURE__ */ jsxs92("div", { className: "sm:wrapper bg-secondary md:px-24 py-16 md:py-28 flex flex-col md:flex-row justify-between gap-16 sm:rounded-3xl", children: [
      /* @__PURE__ */ jsxs92("div", { className: "wrapper flex flex-col gap-12", children: [
        /* @__PURE__ */ jsx107("h2", { className: "text-2xl sm:text-[40px] font-satoshi-black leading-tight", children: "Do you want to know more about the way we work?" }),
        /* @__PURE__ */ jsxs92("div", { className: "flex flex-col lg:flex-row gap-6", children: [
          /* @__PURE__ */ jsxs92("p", { children: [
            /* @__PURE__ */ jsx107("span", { className: "block font-satoshi-black mb-3", children: "Phone Us" }),
            /* @__PURE__ */ jsx107("span", { className: "font-satoshi-medium whitespace-nowrap", children: "+234 703 515 9093" })
          ] }),
          /* @__PURE__ */ jsxs92("p", { children: [
            /* @__PURE__ */ jsx107("span", { className: "block font-satoshi-black mb-3", children: "Email Us" }),
            /* @__PURE__ */ jsx107("span", { className: "font-satoshi-medium", children: "kidmonthyear@gmail.com" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs92("div", { children: [
          /* @__PURE__ */ jsx107("span", { className: "block font-satoshi-black mb-3", children: "Follow Us" }),
          /* @__PURE__ */ jsxs92("span", { className: "flex gap-4", children: [
            /* @__PURE__ */ jsx107(Svg, { src: icons.twitterXIcon, width: "24px", height: "24px" }),
            /* @__PURE__ */ jsx107(Svg, { src: icons.instagramIcon, width: "24px", height: "24px" }),
            /* @__PURE__ */ jsx107(Svg, { src: icons.facebookIcon, width: "24px", height: "24px" }),
            /* @__PURE__ */ jsx107(Svg, { src: icons.youtubeIcon, width: "24px", height: "24px" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx107(ContactForm, {})
    ] }) })
  ] });
}
...
import { json as json32, redirect as redirect26 } from "@remix-run/node";
...
function AdminSummary({ users }) {
  return /* @__PURE__ */ jsxs93("div", { className: "border rounded-xl overflow-hidden basis-3/5 max-w-xl", children: [
    /* @__PURE__ */ jsxs93("div", { className: "flex gap-2 xs:gap-4 justify-between items-center py-3 px-4 border-b", children: [
      /* @__PURE__ */ jsx108("h3", { className: "text-primary font-bold max-sm:text-xs", children: "Admin Accounts" }),
      /* @__PURE__ */ jsx108(
        Cta_default,
        {
          element: "link",
    ...
    /* @__PURE__ */ jsx108("div", { className: "px-4 grid", children: users.slice(0, 5).map((user) => /* @__PURE__ */ jsx108(AdminUserCard, { user, className: "border-0 shadow-none rounded-none border-b last:border-b-0" }, user._id)) })
  ] });
}
...
function ArticleSummary() {
  return /* @__PURE__ */ jsx109("div", { className: "basis-1/5 p-3" });
}

// app/components/admin/Aggregator.tsx
import { jsx as jsx110 } from "react/jsx-runtime";
function Aggregator({ className, children, ...props }) {
  return /* @__PURE__ */ jsx110("div", { className: "@container", children: /* @__PURE__ */ jsx110(
    "aside",
    {
      ...props,
      className: cn(
...
function AggregatorItem({ className, children, ...props }) {
  return /* @__PURE__ */ jsx110("div", { className: cn("flex gap-3 items-center text-nowrap min-w-48", className), ...props, children });
}
...
function ContestSummary({ contests: contests2 }) {
  ...
  return /* @__PURE__ */ jsxs94("div", { className: "border rounded-xl overflow-hidden grow", children: [
    /* @__PURE__ */ jsxs94("div", { className: "flex gap-2 xs:gap-4 justify-between items-center py-3 px-4 border-b", children: [
      /* @__PURE__ */ jsx111("h3", { className: "text-primary font-bold max-sm:text-xs", children: "Contests" }),
      /* @__PURE__ */ jsx111(
        Cta_default,
        {
          element: "link",
    ...
    /* @__PURE__ */ jsxs94("div", { className: "px-4", children: [
      /* @__PURE__ */ jsxs94(Aggregator, { className: "my-4", children: [
        /* @__PURE__ */ jsxs94(AggregatorItem, { children: [
          ...
          /* @__PURE__ */ jsxs94("span", { className: "grid", children: [
            /* @__PURE__ */ jsx111("span", { className: "text-primary font-satoshi-black", children: contests2.length }),
        ...
        /* @__PURE__ */ jsxs94(AggregatorItem, { className: "flex gap-3 items-center", children: [
          /* @__PURE__ */ jsx111("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx111(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs94("span", { className: "grid", children: [
            /* @__PURE__ */ jsx111("span", { className: "text-primary font-satoshi-black", children: ongoingCount }),
            /* @__PURE__ */ jsx111("span", { className: "", children: "Ongoing Contests" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs94(AggregatorItem, { className: "flex gap-3 items-center", children: [
          /* @__PURE__ */ jsx111("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx111(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs94("span", { className: "grid", children: [
            /* @__PURE__ */ jsx111("span", { className: "text-primary font-satoshi-black", children: yetToStartCount }),
            /* @__PURE__ */ jsx111("span", { className: "", children: "Yet To Start Contests" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs94(AggregatorItem, { className: "flex gap-3 items-center", children: [
          /* @__PURE__ */ jsx111("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx111(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs94("span", { className: "grid", children: [
            /* @__PURE__ */ jsx111("span", { className: "text-primary font-satoshi-black", children: closedCount }),
            /* @__PURE__ */ jsx111("span", { className: "", children: "Closed Contests" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx111(ContestTable, { data: contests2.slice(0, 5) })
    ] })
  ] });
}
...
function TournamentSummary({ tournaments }) {
  ...
  return /* @__PURE__ */ jsxs95("div", { className: "border rounded-xl overflow-hidden grow max-w-2xl", children: [
    /* @__PURE__ */ jsxs95("div", { className: "flex gap-2 xs:gap-4 justify-between items-center py-3 px-4 border-b", children: [
      /* @__PURE__ */ jsx112("h3", { className: "text-primary font-bold max-sm:text-xs", children: "Tournaments" }),
      /* @__PURE__ */ jsx112(
        Cta_default,
        {
          element: "link",
    ...
    /* @__PURE__ */ jsxs95("div", { className: "px-4 grid", children: [
      /* @__PURE__ */ jsxs95(Aggregator, { className: "mt-4", children: [
        /* @__PURE__ */ jsxs95(AggregatorItem, { children: [
          /* @__PURE__ */ jsx112("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx112(Svg, { src: icons.adminTournamentIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs95("span", { className: "grid", children: [
            /* @__PURE__ */ jsx112("span", { className: "text-primary font-satoshi-black", children: tournaments.length }),
            /* @__PURE__ */ jsx112("span", { className: "", children: "Tournaments Created" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs95(AggregatorItem, { className: "flex gap-3 items-center", children: [
          /* @__PURE__ */ jsx112("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx112(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs95("span", { className: "grid", children: [
            /* @__PURE__ */ jsx112("span", { className: "text-primary font-satoshi-black", children: numberOfContests }),
            /* @__PURE__ */ jsx112("span", { className: "", children: "Contests Created" })
          ] })
        ] })
      ] }),
      tournaments.slice(0, 2).map((tournament) => /* @__PURE__ */ jsx112(TournamentCard, { tournament, className: "border-0 shadow-none bg-transparent rounded-none border-b last:border-b-0" }, tournament.id))
    ] })
  ] });
}
...
function Home() {
  let { adminUsers: adminUsers3, tournaments, contests: contests2, transactions } = useLoaderData32();
  return /* @__PURE__ */ jsxs96("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs96("h1", { className: "grid font-medium text-primary", children: [
      /* @__PURE__ */ jsx113("span", { className: "text-xl sm:text-2xl font-satoshi-bold line-clamp-1", children: "Hello Admin" }),
      /* @__PURE__ */ jsx113("span", { className: "line-clamp-1", children: "Welcome back to KOTMY \u{1F44B}" })
    ] }),
    /* @__PURE__ */ jsxs96("section", { className: "my-6 grid sm:flex flex-wrap items-start gap-6", children: [
      /* @__PURE__ */ jsx113(AdminSummary, { users: adminUsers3 }),
      /* @__PURE__ */ jsx113(ArticleSummary, {}),
      /* @__PURE__ */ jsx113(TournamentSummary, { tournaments }),
      /* @__PURE__ */ jsx113(ContestSummary, { contests: contests2 })
    ] })
  ] });
}
...
import { useLoaderData as useLoaderData33, Form as Form22, useNavigation as useNavigation9 } from "@remix-run/react";
...
async function loader35({ request }) {
  ...
  return referralBoardRes.authRequired ? redirect27("/login") : json33({ wallets: walletsResponse.data, referralBoardRes: referralBoardRes.data, query });
}
function AffilliateLeaderBoard2() {
  let { wallets, referralBoardRes, query } = useLoaderData33(), navigation = useNavigation9();
  return console.log(referralBoardRes), /* @__PURE__ */ jsxs97("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsx114("p", { className: "font-semibold", children: "Affiliates leader board" }),
    /* @__PURE__ */ jsx114("div", { className: "flex flex-col gap-3 sm:flex-row justify-between sm:items-center my-8", children: /* @__PURE__ */ jsx114(Form22, { method: "get", onSubmit: (e) => {
      try {
      } catch {
      }
    }, className: "w-full bg-white border border-gray-100 rounded-xl p-4 shadow-sm", children: /* @__PURE__ */ jsxs97("div", { className: "grid grid-cols-1 sm:grid-cols-4 gap-3 items-end", children: [
      /* @__PURE__ */ jsxs97("label", { className: "flex flex-col text-xs text-gray-600", children: [
        /* @__PURE__ */ jsx114("span", { className: "mb-1", children: "From" }),
      ...
      /* @__PURE__ */ jsxs97("label", { className: "flex flex-col text-xs text-gray-600", children: [
        /* @__PURE__ */ jsx114("span", { className: "mb-1", children: "To" }),
      ...
      /* @__PURE__ */ jsxs97("label", { className: "flex flex-col text-xs text-gray-600", children: [
        /* @__PURE__ */ jsx114("span", { className: "mb-1", children: "Currency" }),
        /* @__PURE__ */ jsx114("select", { id: "wallet_id", name: "wallet_id", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: wallets.map((wallet) => /* @__PURE__ */ jsx114("option", { value: wallet.str_id, children: wallet.wallet_currency }, wallet.str_id)) })
      ] }),
      /* @__PURE__ */ jsx114("div", { className: "flex justify-end", children: /* @__PURE__ */ jsx114("button", { type: "submit", disabled: navigation.state === "submitting", className: "px-4 py-2 bg-[#312E81] text-white rounded-lg text-sm", children: navigation.state === "submitting" ? "Searching..." : "Search" }) })
    ] }) }) }),
    /* @__PURE__ */ jsx114("div", { className: "sm:block w-full overflow-x-auto", children: /* @__PURE__ */ jsxs97("table", { className: "w-full table-auto", children: [
      /* @__PURE__ */ jsx114("thead", { children: /* @__PURE__ */ jsxs97("tr", { className: "border-b border-secondary", children: [
        /* @__PURE__ */ jsx114("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Contestant Name" }),
        /* @__PURE__ */ jsx114("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Contestant Code" }),
        /* @__PURE__ */ jsx114("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Contest Name" }),
        /* @__PURE__ */ jsx114("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Reward Earned" })
      ] }) }),
      /* @__PURE__ */ jsx114("tbody", { children: referralBoardRes?.items.map((referrerBoard, index) => /* @__PURE__ */ jsxs97("tr", { className: "border-b border-secondary", children: [
        /* @__PURE__ */ jsx114("td", { className: "p-3", children: `${referrerBoard.contestant_biodata.first_name} ${referrerBoard.contestant_biodata.last_name}` }),
        /* @__PURE__ */ jsx114("td", { className: "p-3", children: referrerBoard.contestant_deets[0]?.code }),
        /* @__PURE__ */ jsx114("td", { className: "p-3", children: referrerBoard.current_contest.name }),
        /* @__PURE__ */ jsx114("td", { className: "p-3", children: `${referralBoardRes.summary?.currency} ${referrerBoard.total_earning.toLocaleString()}` })
      ] }, index)) })
    ] }) }),
    /* @__PURE__ */ jsx114("div", { className: "hidden sm:flex justify-between items-center my-4", children: /* @__PURE__ */ jsx114(Pagination, { lastKey: referralBoardRes?.last_key_id, pageSize: referralBoardRes?.items_per_page, firstKey: referralBoardRes?.first_key_id }) })
  ] });
}
...
function loader36() {
  return redirect28("/admin/overview");
}
...
import { Form as Form23, useLoaderData as useLoaderData34, useActionData as useActionData10, useNavigate as useNavigate19 } from "@remix-run/react";
import { json as json34, redirect as redirect29 } from "@remix-run/node";
import { useEffect as useEffect24, useRef as useRef10, useState as useState33 } from "react";
import { Fragment as Fragment12, jsx as jsx115, jsxs as jsxs98 } from "react/jsx-runtime";
async function loader37({ request }) {
  let cookieHeader = request.headers.get("Cookie");
  if (!cookieHeader)
    return redirect29("/login");
  let { data, error, authRequired } = await authServer.getMe(cookieHeader || "");
  return authRequired ? redirect29("/login") : json34({ data, error });
}
async function action20({ request }) {
  ...
  return json34({ data, error });
}
function useUserProfileController() {
  let { toast: toast5 } = useToast(), loaderData = useLoaderData34(), actionData = useActionData10(), navigate = useNavigate19(), [profile, setProfile] = useState33(loaderData?.data?.user_profile || null), [email, setEmail] = useState33(loaderData?.data?.email || ""), [referralCode, setReferralCode] = useState33(loaderData?.data?.referral_code || ""), [imagePreview, setImagePreview] = useState33(profile?.image_url), fileInputRef = useRef10(null);
  return useEffect24(() => {
...
function UserProfilePage() {
  ...
  return /* @__PURE__ */ jsx115("div", { className: "min-h-screen text-gray-900 bg-secondary flex flex-col items-center pt-24 pb-16", children: /* @__PURE__ */ jsxs98("div", { className: "max-w-2xl w-full px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxs98("div", { className: "flex flex-col items-center mb-8", children: [
      /* @__PURE__ */ jsx115("div", { className: "w-32 h-32 rounded-full overflow-hidden border-4 border-indigo-200 mb-4", children: isLoading ? /* @__PURE__ */ jsx115("div", { className: "w-full h-full bg-gray-200 animate-pulse" }) : imagePreview ? /* @__PURE__ */ jsx115("img", { src: imagePreview, alt: "Profile", className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsx115(Svg, { src: icons.avatarIcon, className: "w-full h-full" }) }),
      isLoading ? /* @__PURE__ */ jsxs98(Fragment12, { children: [
        /* @__PURE__ */ jsx115("div", { className: "h-8 w-40 bg-gray-200 rounded animate-pulse mb-2" }),
        /* @__PURE__ */ jsx115("div", { className: "h-5 w-56 bg-gray-200 rounded animate-pulse" })
      ] }) : /* @__PURE__ */ jsxs98(Fragment12, { children: [
        /* @__PURE__ */ jsxs98("h1", { className: "text-3xl font-bold text-gray-900", children: [
          profile?.first_name,
          " ",
          profile?.last_name
        ] }),
        /* @__PURE__ */ jsx115("p", { className: "text-lg text-gray-600", children: email })
      ] })
    ] }),
    isLoading ? /* @__PURE__ */ jsxs98("div", { className: "bg-white border rounded-3xl p-8 flex flex-col gap-6", children: [
      /* @__PURE__ */ jsx115("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx115("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx115("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx115("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx115("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx115("div", { className: "h-12 bg-gray-200 rounded animate-pulse" })
    ] }) : /* @__PURE__ */ jsxs98(Form23, { method: "POST", encType: "multipart/form-data", className: "bg-white border rounded-3xl p-8 flex flex-col gap-6", children: [
      /* @__PURE__ */ jsx115(FormControl, { as: "input", id: "first_name", name: "first_name", labelText: "First Name", defaultValue: profile?.first_name, icon: icons.avatarIcon, required: !0 }),
      /* @__PURE__ */ jsx115(FormControl, { as: "input", id: "last_name", name: "last_name", labelText: "Last Name", defaultValue: profile?.last_name, icon: icons.avatarIcon, required: !0 }),
      /* @__PURE__ */ jsx115(FormControl, { as: "input", id: "email", name: "email", labelText: "Email", defaultValue: email, icon: icons.avatarIcon, required: !0, readOnly: !0 }),
      /* @__PURE__ */ jsx115(FormControl, { as: "input", id: "status", name: "status", labelText: "Status", defaultValue: profile?.status, icon: icons.avatarIcon }),
      /* @__PURE__ */ jsx115(FormControl, { as: "input", id: "", name: "", labelText: "Referral code", defaultValue: referralCode, icon: icons.lockIcon, required: !0, readOnly: !0 }),
      /* @__PURE__ */ jsxs98("label", { htmlFor: "image", className: "flex items-center gap-2 text-sm font-medium text-gray-700", children: [
        /* @__PURE__ */ jsx115(Svg, { src: icons.avatarIcon, className: "w-4 h-4" }),
        "Profile Image"
      ] }),
      /* @__PURE__ */ jsx115(DragnDrop, { name: "image", labelText: "Upload Image", multiple: !1, required: !1 }),
      /* @__PURE__ */ jsx115(Cta_default, { element: "button", type: "submit", className: "rounded-lg p-3", children: "Update Profile" })
    ] })
  ] }) });
}
...
import { json as json35, redirect as redirect30 } from "@remix-run/node";
import { Link as Link18, useActionData as useActionData11, useLoaderData as useLoaderData35, useFetcher as useFetcher12 } from "@remix-run/react";
import { useState as useState34, useMemo as useMemo5, useEffect as useEffect25 } from "react";
...
async function action21({ request }) {
  ...
  let walletResp = await walletRepo.wallet_search(query, cookieHeader);
  if (walletResp.error)
    return json35({ error: walletResp.error }, { status: 400 });
  let ledgersResp = await walletRepo.getUserLedgersForWallet(cookieHeader, query);
  if (ledgersResp.error)
    return json35({ error: ledgersResp.error }, { status: 400 });
  ...
  return console.log("WALLET RESP", walletResp, wallets), json35({ wallets });
}
function useWalletController2() {
  let { wallets } = useLoaderData35(), { setUserStoreManager, getUserStoreManager } = useUserManager(), [user, setUser] = useState34(null), [activeWalletId, setActiveWalletId] = useState34(
    wallets.length > 0 ? wallets[0].wallet._id : null
  );
  useEffect25(() => {
    let _user = getUserStoreManager();
  ...
  let activeData = useMemo5(() => wallets.find((w) => w.wallet._id === activeWalletId) || null, [activeWalletId, wallets]), formatCurrency = (amount, currency) => new Intl.NumberFormat("en-US", {
    style: "currency",
    currency
  }).format(amount), [searchOpen, setSearchOpen] = useState34(!1), fetcher = useFetcher12(), isSubmitting = fetcher.state === "submitting", actionData = useActionData11(), [walletsState, setWalletsState] = useState34(wallets);
  return useEffect25(() => {
    (fetcher.data?.wallets ?? actionData?.wallets) || setWalletsState(wallets);
  }, [wallets, fetcher.data, actionData]), useEffect25(() => {
    let fw = fetcher.data?.wallets ?? actionData?.wallets;
    fw && Array.isArray(fw) && setWalletsState(fw);
  }, [fetcher.data, actionData]), {
    wallets,
...
function WalletPage2() {
  ...
  if (!activeData)
    return /* @__PURE__ */ jsx116("div", { className: "p-8", children: "No wallets found." });
  let activeDataLocal = walletsState.find((w) => w.wallet._id === activeData?.wallet._id) ?? activeData, { wallet, pagedLedgers } = activeDataLocal;
  return /* @__PURE__ */ jsxs99("div", { className: "p-8 max-w-7xl mx-auto bg-[#F9FAFB] min-h-screen", children: [
    /* @__PURE__ */ jsx116("h1", { className: "text-2xl font-semibold mb-6", children: "Wallet" }),
    /* @__PURE__ */ jsxs99("div", { className: "bg-white rounded-3xl p-8 border border-gray-100 shadow-sm mb-8", children: [
      /* @__PURE__ */ jsxs99("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxs99("div", { className: "flex items-center gap-2 text-gray-500", children: [
          /* @__PURE__ */ jsx116("span", { className: "text-sm", children: "Wallet balances" }),
          /* @__PURE__ */ jsx116("button", { className: "hover:bg-gray-100 p-1 rounded-full", children: "\u{1F441}\uFE0F" })
        ] }),
        /* @__PURE__ */ jsx116(
          "select",
          {
            ...
            value: wallet._id,
            onChange: (e) => setActiveWalletId(e.target.value),
            children: walletsState.map((w) => /* @__PURE__ */ jsxs99("option", { value: w.wallet._id, children: [
              w.wallet.wallet_currency,
              " - ",
              w.wallet.account_number
            ] }, w.wallet._id))
      ...
      /* @__PURE__ */ jsx116("div", { className: "flex justify-between items-start", children: /* @__PURE__ */ jsxs99("div", { children: [
        /* @__PURE__ */ jsx116("div", { className: "text-4xl font-bold mb-1", children: formatCurrency(wallet.withdrawable_balance, wallet.wallet_currency) }),
        /* @__PURE__ */ jsx116("div", { className: "text-gray-400 text-sm", children: wallet.wallet_name })
      ] }) }),
      /* @__PURE__ */ jsxs99("div", { className: "flex flex-col sm:flex-row gap-3 mt-8", children: [
        /* @__PURE__ */ jsx116(Link18, { to: `/user/withdraw/${wallet._id}`, children: /* @__PURE__ */ jsx116("button", { className: "bg-[#312E81] text-white px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:opacity-90 transition-opacity w-full sm:w-auto", children: "\u2197 Withdraw" }) }),
        user?.withdrawal_pin_set ? /* @__PURE__ */ jsx116(Link18, { to: `/user/addwithdrawalaccount/${wallet._id}`, children: /* @__PURE__ */ jsx116("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "Add withdrawal account" }) }) : /* @__PURE__ */ jsx116(Link18, { to: "/user/setwithdrawalpin", children: /* @__PURE__ */ jsx116("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "+ Set withdrawal PIN" }) }),
        /* @__PURE__ */ jsx116("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "\u21C4 Transfer to another wallet" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs99("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxs99("div", { className: "flex items-center justify-between mb-3", children: [
        /* @__PURE__ */ jsx116("h2", { className: "text-lg font-medium text-gray-700", children: "Search" }),
        /* @__PURE__ */ jsxs99(
          "button",
          {
            type: "button",
            ...
            "aria-expanded": searchOpen,
            children: [
              /* @__PURE__ */ jsx116("span", { children: searchOpen ? "Hide" : "Show" }),
              /* @__PURE__ */ jsx116(
                "svg",
                {
                  className: `w-4 h-4 transition-transform ${searchOpen ? "rotate-180" : ""}`,
                  ...
                  viewBox: "0 0 24 24",
                  xmlns: "http://www.w3.org/2000/svg",
                  children: /* @__PURE__ */ jsx116("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M19 9l-7 7-7-7" })
                }
              )
            ]
          }
      ...
      /* @__PURE__ */ jsx116("div", { className: `transition-all ${searchOpen ? "overflow-scroll max-h-96" : "overflow-hidden max-h-0"}`, children: /* @__PURE__ */ jsx116("div", { className: "bg-white border border-gray-100 rounded-xl p-4 shadow-sm", children: /* @__PURE__ */ jsxs99(fetcher.Form, { method: "post", className: "grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm", children: [
        /* @__PURE__ */ jsxs99("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx116("span", { className: "mb-1", children: "Transaction type" }),
          /* @__PURE__ */ jsxs99("select", { id: "transaction_type", name: "transaction_type", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx116("option", { value: "", children: "All transaction types" }),
            /* @__PURE__ */ jsx116("option", { value: "credit", children: "Credit" }),
            /* @__PURE__ */ jsx116("option", { value: "debit", children: "Debit" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs99("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx116("span", { className: "mb-1", children: "Status" }),
          /* @__PURE__ */ jsxs99("select", { id: "status", name: "status", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx116("option", { value: "", children: "Any status" }),
            /* @__PURE__ */ jsx116("option", { value: "pending", children: "Pending" }),
            /* @__PURE__ */ jsx116("option", { value: "completed", children: "Completed" }),
            /* @__PURE__ */ jsx116("option", { value: "void", children: "Void" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs99("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx116("span", { className: "mb-1", children: "Min amount" }),
          /* @__PURE__ */ jsx116("input", { id: "min_amount", name: "min_amount", type: "number", step: "0.01", placeholder: "Min amount", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs99("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx116("span", { className: "mb-1", children: "Max amount" }),
          /* @__PURE__ */ jsx116("input", { id: "max_amount", name: "max_amount", type: "number", step: "0.01", placeholder: "Max amount", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs99("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx116("span", { className: "mb-1", children: "From date" }),
          /* @__PURE__ */ jsx116("input", { id: "min_created_at", name: "min_created_at", type: "date", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs99("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx116("span", { className: "mb-1", children: "To date" }),
          /* @__PURE__ */ jsx116("input", { id: "max_created_at", name: "max_created_at", type: "date", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs99("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx116("span", { className: "mb-1", children: "Payment method" }),
          /* @__PURE__ */ jsxs99("select", { id: "payment_method", name: "payment_method", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx116("option", { value: "", children: "Any payment method" }),
            /* @__PURE__ */ jsx116("option", { value: "flutterwave", children: "Flutterwave" }),
            /* @__PURE__ */ jsx116("option", { value: "bank", children: "Bank" }),
            /* @__PURE__ */ jsx116("option", { value: "paystack", children: "Paystack" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs99("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx116("span", { className: "mb-1", children: "Contest code" }),
          /* @__PURE__ */ jsx116("input", { id: "contest_code", name: "contest_code", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsx116("input", { type: "hidden", name: "wallet_id", value: wallet._id }),
        /* @__PURE__ */ jsx116("div", { className: "sm:col-span-3 flex justify-end mt-2", children: /* @__PURE__ */ jsx116("button", { type: "submit", disabled: isSubmitting, className: "px-4 py-2 bg-[#312E81] text-white rounded-lg text-sm disabled:opacity-50", children: isSubmitting ? "Searching..." : "Search" }) })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxs99("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxs99("div", { className: "flex items-center gap-2 text-gray-600 mb-4", children: [
        /* @__PURE__ */ jsx116("span", { children: "\u{1F4C1}" }),
        /* @__PURE__ */ jsxs99("h2", { className: "font-medium", children: [
          "Recent wallet activity (",
          wallet.wallet_currency,
          ")"
        ] })
      ] }),
      /* @__PURE__ */ jsxs99("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-12 mb-8 border-b border-gray-100 pb-6", children: [
        /* @__PURE__ */ jsx116(
          MetricItem2,
          {
            label: "Net change this month",
      ...
      /* @__PURE__ */ jsx116("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs99("table", { className: "w-full text-left text-sm", children: [
        /* @__PURE__ */ jsx116("thead", { children: /* @__PURE__ */ jsxs99("tr", { className: "text-gray-400 border-b", children: [
          /* @__PURE__ */ jsx116("th", { className: "pb-4 font-medium", children: "S/N" }),
          /* @__PURE__ */ jsx116("th", { className: "pb-4 font-medium", children: "Date" }),
          /* @__PURE__ */ jsx116("th", { className: "pb-4 font-medium", children: "Ref ID" }),
          /* @__PURE__ */ jsx116("th", { className: "pb-4 font-medium", children: "Narration" }),
          /* @__PURE__ */ jsx116("th", { className: "pb-4 font-medium", children: "Beneficiary name" }),
          /* @__PURE__ */ jsx116("th", { className: "pb-4 font-medium", children: "Type" }),
          /* @__PURE__ */ jsx116("th", { className: "pb-4 font-medium", children: "Amount" })
        ] }) }),
        /* @__PURE__ */ jsx116("tbody", { className: "divide-y", children: pagedLedgers.items.map((item, idx) => /* @__PURE__ */ jsxs99("tr", { className: "hover:bg-gray-50/50 transition-colors", children: [
          /* @__PURE__ */ jsx116("td", { className: "py-4 text-gray-500", children: idx + 1 }),
          /* @__PURE__ */ jsxs99("td", { className: "py-4 text-gray-900 leading-tight", children: [
            new Date(item.completed_at || "").toLocaleDateString(),
            /* @__PURE__ */ jsx116("div", { className: "text-xs text-gray-400", children: new Date(item.completed_at || "").toLocaleTimeString() })
          ] }),
          /* @__PURE__ */ jsx116("td", { className: "py-4 text-gray-600 font-mono text-xs", children: item.payment_ref }),
          /* @__PURE__ */ jsx116("td", { className: "py-4 text-gray-600 max-w-xs", children: item.description }),
          /* @__PURE__ */ jsx116("td", { className: "py-4 text-gray-600 truncate", children: item.wallet_name }),
          /* @__PURE__ */ jsx116("td", { className: "py-4 uppercase text-xs font-semibold", children: item.entry_type }),
          /* @__PURE__ */ jsx116("td", { className: "py-4", children: /* @__PURE__ */ jsxs99("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx116("span", { className: `font-semibold ${item.entry_type === "credit" ? "text-green-600" : "text-gray-900"}`, children: formatCurrency(item.amount, item.currency) }),
            /* @__PURE__ */ jsx116(StatusBadge2, { status: item.status })
          ] }) })
        ] }, item._id)) })
      ] }) }),
      /* @__PURE__ */ jsxs99("div", { className: "mt-6 flex justify-between items-center text-sm text-gray-500", children: [
        ...
        /* @__PURE__ */ jsx116(Pagination, { lastKey: pagedLedgers.last_key_id, pageSize: pagedLedgers.items_per_page, firstKey: pagedLedgers.first_key_id })
      ] })
    ] })
  ] });
}
function MetricItem2({ label, value, tooltip = !1 }) {
  return /* @__PURE__ */ jsxs99("div", { children: [
    /* @__PURE__ */ jsxs99("div", { className: "text-xs text-gray-400 flex items-center gap-1 mb-1", children: [
      label,
      " ",
      tooltip && /* @__PURE__ */ jsx116("span", { className: "bg-gray-200 rounded-full w-3 h-3 text-[8px] flex items-center justify-center text-white", children: "i" })
    ] }),
    /* @__PURE__ */ jsx116("div", { className: "text-lg font-bold text-gray-800", children: value })
  ] });
}
function StatusBadge2({ status }) {
  ...
  return /* @__PURE__ */ jsxs99("span", { className: `px-2 py-0.5 rounded-full text-[10px] font-medium border flex items-center gap-1 ${styles[status] || ""}`, children: [
    icons2[status],
    " ",
    status
  ] });
...
function Footer() {
  return /* @__PURE__ */ jsx117("footer", { className: "border-t border-primary py-8", children: /* @__PURE__ */ jsxs100("div", { className: "wrapper flex flex-wrap gap-6 gap-x-12 justify-between font-bold", children: [
    /* @__PURE__ */ jsx117("nav", { className: "flex gap-6 items-center", children: /* @__PURE__ */ jsxs100("ul", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsx117("li", { children: /* @__PURE__ */ jsx117(Link19, { to: "/contests", children: "Contests" }) }),
      /* @__PURE__ */ jsx117("li", { children: /* @__PURE__ */ jsx117(Link19, { to: "/#contact", children: "Contact" }) }),
      /* @__PURE__ */ jsx117("li", { children: /* @__PURE__ */ jsx117(Link19, { to: "/winners", children: "Winners" }) }),
      /* @__PURE__ */ jsx117("li", { children: /* @__PURE__ */ jsx117(Link19, { to: "/results", children: "Results" }) })
    ] }) }),
    /* @__PURE__ */ jsx117("span", { children: "Privacy Policy" }),
    /* @__PURE__ */ jsx117("span", { className: "md:order-first", children: "KOTMY \xA9 2023  All rights reserved" })
  ] }) });
}

// app/components/public/Navigation.tsx
import { useEffect as useEffect27, useState as useState36 } from "react";
import { Link as Link21, NavLink as NavLink2, useLocation as useLocation8 } from "@remix-run/react";

// app/components/public/MobileNavigation.tsx
import { Link as Link20, NavLink, useLocation as useLocation7 } from "@remix-run/react";
import { useEffect as useEffect26, useRef as useRef11, useState as useState35 } from "react";
import { jsx as jsx118, jsxs as jsxs101 } from "react/jsx-runtime";
function MobileNavigation({ show, onClose }) {
  let { pathname } = useLocation7(), [user, setUser] = useState35(null), mobileNav = useRef11(null);
  ...
  return useEffect26(() => {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs101("header", { className: "wrapper py-5", children: [
          /* @__PURE__ */ jsxs101("div", { className: "flex justify-between items-center", children: [
            /* @__PURE__ */ jsx118(Link20, { to: "/", onClick: onClose, "aria-label": "home", children: /* @__PURE__ */ jsx118(Svg, { src: icons.logoIcon, width: 37, height: 36 }) }),
            /* @__PURE__ */ jsx118("button", { onClick: onClose, title: "close menu", className: "flex gap-1 items-center rounded p-2 hover:outline outline-primary", children: /* @__PURE__ */ jsx118(Svg, { src: icons.closeIcon, width: 24, height: 24, className: "sm:hidden" }) })
          ] }),
          /* @__PURE__ */ jsxs101("nav", { className: "", children: [
            /* @__PURE__ */ jsxs101("ul", { className: "grid gap-6 my-12 text-xl font-bold", children: [
              /* @__PURE__ */ jsx118("li", { children: /* @__PURE__ */ jsxs101(NavLink, { onClick: onClose, to: "/contests", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/contests") ? /* @__PURE__ */ jsx118(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Contests"
              ] }) }),
              /* @__PURE__ */ jsx118("li", { children: /* @__PURE__ */ jsxs101(NavLink, { onClick: onClose, to: "/winners", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/winners") ? /* @__PURE__ */ jsx118(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Winners"
              ] }) }),
              /* @__PURE__ */ jsx118("li", { children: /* @__PURE__ */ jsxs101(NavLink, { onClick: onClose, to: "/results", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/results") ? /* @__PURE__ */ jsx118(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Results"
              ] }) }),
              /* @__PURE__ */ jsx118("li", { children: /* @__PURE__ */ jsx118(NavLink, { onClick: onClose, to: "/login", className: "", children: user ? "My Profile" : "Sign In" }) })
            ] }),
            /* @__PURE__ */ jsx118(Button, { element: "a", onClick: onClose, href: "/signup", className: "block w-full sm:w-auto", children: "Join Now" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs101("aside", { className: "wrapper py-5", children: [
          /* @__PURE__ */ jsxs101("div", { className: "mb-12", children: [
            /* @__PURE__ */ jsx118("span", { className: "block font-satoshi-black mb-2", children: "Follow Us" }),
            /* @__PURE__ */ jsxs101("span", { className: "flex gap-4", children: [
          ...
          /* @__PURE__ */ jsxs101("div", { className: "flex gap-6 justify-between items-end font-satoshi-bold", children: [
            /* @__PURE__ */ jsx118("span", { className: "text-sm whitespace-nowrap", children: "KOTMY \xA9 2023  All rights reserved" }),
            /* @__PURE__ */ jsx118("span", { className: "text-xs whitespace-nowrap", children: "Privacy Policy" })
          ] })
        ] })
      ]
    }
...
function Navigation() {
  let { getUserStoreManager } = useUserManager(), [showNav, setShowNav] = useState36(!1), { pathname } = useLocation8(), [user, setUser] = useState36(null);
  return useEffect27(() => {
    let user2 = getUserStoreManager();
    setUser(user2);
  }, []), /* @__PURE__ */ jsxs102("header", { className: "flex justify-between items-center wrapper py-5", children: [
    /* @__PURE__ */ jsx119(Link21, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx119(Svg, { src: icons.logoIcon, className: "w-9 h-9 sm:w-16 sm:h-16" }) }),
    /* @__PURE__ */ jsxs102("nav", { className: "hidden md:flex gap-16 items-center", children: [
      /* @__PURE__ */ jsxs102("ul", { className: "flex gap-6 text-xl font-bold", children: [
        /* @__PURE__ */ jsx119("li", { children: /* @__PURE__ */ jsxs102(NavLink2, { to: "/contests", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/contests") ? /* @__PURE__ */ jsx119(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Contests"
        ] }) }),
        /* @__PURE__ */ jsx119("li", { children: /* @__PURE__ */ jsxs102(NavLink2, { to: "/winners", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/winners") ? /* @__PURE__ */ jsx119(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Winners"
        ] }) }),
        /* @__PURE__ */ jsx119("li", { children: /* @__PURE__ */ jsxs102(NavLink2, { to: "/results", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/results") ? /* @__PURE__ */ jsx119(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Results"
        ] }) }),
        /* @__PURE__ */ jsx119("li", { children: /* @__PURE__ */ jsx119(NavLink2, { to: "/login", className: "", children: user ? "My Profile" : "Sign In" }) })
      ] }),
      /* @__PURE__ */ jsx119(Button, { element: "a", href: "/signup", children: "Join Now" })
    ] }),
    /* @__PURE__ */ jsx119(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx119(Svg, { src: icons.hamburgerIcon, width: 40, height: 24 })
      }
    ),
    /* @__PURE__ */ jsx119(MobileNavigation, { onClose: () => {
      setShowNav(!1);
    }, show: showNav })
  ] });
}
...
function Index() {
  return /* @__PURE__ */ jsxs103("div", { className: "min-h-screen bg-primary flex flex-col", children: [
    /* @__PURE__ */ jsx120(Navigation, {}),
    /* @__PURE__ */ jsx120(Outlet3, {}),
    /* @__PURE__ */ jsx120(Footer, {})
  ] });
}
...
function Logout() {
  return useLogoutController(), /* @__PURE__ */ jsxs104("main", { className: "h-dvh bg-secondary p-4 flex flex-col", children: [
    /* @__PURE__ */ jsx121(Link22, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx121(Svg, { src: icons.logoIcon, className: "w-14 h-14 sm:w-16 sm:h-16 cursor-pointer" }) }),
    /* @__PURE__ */ jsxs104("main", { className: "h-dvh bg-secondary p-4 flex flex-col justify-center items-center", children: [
      /* @__PURE__ */ jsx121("h1", { className: "text-2xl font-satoshi-bold text-center", children: "You have been logged out" }),
      /* @__PURE__ */ jsx121(Link22, { to: "/login", className: "mt-4 text-center underline", children: "Login again" })
    ] })
  ] });
}
...
import { Form as Form25, Link as Link23, useActionData as useActionData12, useNavigate as useNavigate20, useSearchParams as useSearchParams5 } from "@remix-run/react";
...
async function action22({ request }) {
  ...
  return error ? { error: error.detail?.toString() || "An error occurred during login.", data: null } : headers?.["Set-Cookie"] ? (responseHeaders = { "Set-Cookie": headers?.["Set-Cookie"] }, json36({ data, error: null }, {
    headers: responseHeaders
  })) : json36({ error, data, headers });
}
function useSignupController() {
  let actionData = useActionData12(), [searchQuery] = useSearchParams5(), { setUserStoreManager } = useUserManager(), { toast: toast5 } = useToast(), navigate = useNavigate20();
  return useEffect29(() => {
    actionData?.error && (toast5({
      variant: "destructive",
...
function Signup() {
  ...
  return /* @__PURE__ */ jsxs105("main", { className: "bg-secondary p-4 flex flex-col", children: [
    /* @__PURE__ */ jsx122(Link23, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx122(Svg, { src: icons.logoIcon, className: "w-14 h-14 sm:w-16 sm:h-16" }) }),
    /* @__PURE__ */ jsx122("section", { className: "grow flex flex-col justify-center items-center", children: /* @__PURE__ */ jsxs105(Form25, { method: "POST", encType: "multipart/form-data", className: "w-full max-w-md p-4 sm:p-8 bg-white border rounded-3xl flex flex-col gap-3", children: [
      /* @__PURE__ */ jsx122("div", { className: "w-max mx-auto p-4 border border-disabled rounded-full bg-gradient-to-b from-slate-200 to-white", children: /* @__PURE__ */ jsx122("div", { className: "w-max p-4 border border-disabled rounded-full bg-white", children: /* @__PURE__ */ jsx122("img", { src: admin_avatar_default, alt: "person silhouette", width: 24, height: 24 }) }) }),
      /* @__PURE__ */ jsx122("h1", { className: "text-2xl font-satoshi-bold text-center", children: "Create your account" }),
      /* @__PURE__ */ jsx122("hr", {}),
      /* @__PURE__ */ jsxs105("p", { className: "text-center text-sm mt-2", children: [
        "Already have an account? ",
        /* @__PURE__ */ jsx122(Link23, { to: "/login", className: "text-primary underline", children: "Login" })
      ] }),
      /* @__PURE__ */ jsxs105("div", { className: "my-2 flex flex-col gap-3", children: [
        /* @__PURE__ */ jsx122(FormControl, { as: "input", id: "first_name", name: "first_name", placeholder: "First Name", labelText: "First Name", icon: icons.avatarIcon, required: !0 }),
        /* @__PURE__ */ jsx122(FormControl, { as: "input", id: "last_name", name: "last_name", placeholder: "Last Name", labelText: "Last Name", icon: icons.avatarIcon, required: !0 }),
        /* @__PURE__ */ jsx122(FormControl, { as: "input", id: "email", name: "email", placeholder: "Enter your email address", labelText: "Email", icon: icons.avatarIcon, required: !0 }),
        /* @__PURE__ */ jsx122(FormControl, { as: "input", id: "password", name: "password", placeholder: "Enter your password", labelText: "Password", type: "password", icon: icons.lockIcon, required: !0 }),
        /* @__PURE__ */ jsx122(FormControl, { as: "input", id: "status", name: "status", placeholder: "Status (optional)", labelText: "Status", icon: icons.avatarIcon }),
        /* @__PURE__ */ jsxs105("label", { htmlFor: "image", className: "flex items-center gap-2 text-sm font-medium text-gray-700", children: [
          /* @__PURE__ */ jsx122(Svg, { src: icons.avatarIcon, className: "w-4 h-4" }),
          "Profile Image"
        ] }),
        /* @__PURE__ */ jsx122(DragnDrop, { className: "sm:col-span-2", name: "image", multiple: !1, labelText: "Upload profile photo" })
      ] }),
      /* @__PURE__ */ jsx122(Cta_default, { element: "button", type: "submit", className: "rounded-lg p-3", children: "Sign Up" })
    ] }) })
  ] });
}
...
import { Outlet as Outlet4, useLocation as useLocation11 } from "@remix-run/react";
import { useEffect as useEffect32, useState as useState39 } from "react";

// app/components/admin/AdminMobileNavigation.tsx
import { NavLink as NavLink3, useLocation as useLocation9 } from "@remix-run/react";

// app/components/reusables/Accordion.tsx
import * as React13 from "react";
import * as AccordionPrimitive from "@radix-ui/react-accordion";
import { jsx as jsx123, jsxs as jsxs106 } from "react/jsx-runtime";
var Accordion = AccordionPrimitive.Root, AccordionItem = React13.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx123(
...
var AccordionTrigger = React13.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx123(AccordionPrimitive.Header, { className: "flex", children: /* @__PURE__ */ jsxs106(
  AccordionPrimitive.Trigger,
  {
    ...
    children: [
      children,
      /* @__PURE__ */ jsx123(Svg, { src: icons.arrowDownIcon, className: "shrink-0 transition-transform duration-200" })
    ]
  }
) }));
AccordionTrigger.displayName = AccordionPrimitive.Trigger.displayName;
var AccordionContent = React13.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx123(
  AccordionPrimitive.Content,
  {
    ref,
    className: "overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down",
    ...props,
    children: /* @__PURE__ */ jsx123("div", { className: cn("", className), children })
  }
));
AccordionContent.displayName = AccordionPrimitive.Content.displayName;

// app/components/admin/AdminMobileNavigation.tsx
import { useEffect as useEffect30, useRef as useRef12, useState as useState37 } from "react";
...
function AdminMobileNavigation({ show, onClose }) {
  ...
  let { getUserStoreManager, hasAcceptedRole } = useUserManager(), userRoles = getUserStoreManager()?.roles.map((r) => r.toLowerCase()) ?? [], [user, setUser] = useState37(null);
  useEffect30(() => {
  ...
  return /* @__PURE__ */ jsxs107(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs107("div", { className: "flex justify-between items-center py-4 px-6 border-b", children: [
          /* @__PURE__ */ jsx124("span", { className: "font-satoshi-bold", children: "NAVIGATION MENU" }),
          /* @__PURE__ */ jsx124(
            "button",
            {
              onClick: onClose,
              ...
              children: /* @__PURE__ */ jsx124(Svg, { src: icons.closeIcon })
            }
          )
        ] }),
        /* @__PURE__ */ jsxs107("div", { className: "flex flex-col justify-between grow", children: [
          /* @__PURE__ */ jsxs107("header", { children: [
            /* @__PURE__ */ jsxs107("nav", { "aria-label": "primary navigation", children: [
              /* @__PURE__ */ jsxs107("div", { className: "flex gap-3 items-center bg-white px-6 py-2 border-b", children: [
                ...
                /* @__PURE__ */ jsxs107("span", { className: "grid", children: [
                  /* @__PURE__ */ jsx124("span", { className: "block text-sm font-satoshi-bold", children: user?.fullName }),
                  /* @__PURE__ */ jsx124("span", { className: "block text-xs font-satoshi-medium", children: user?.email })
                ] })
              ] }),
              /* @__PURE__ */ jsx124(Accordion, { type: "single", collapsible: !0, className: "w-full py-2 border-b", children: /* @__PURE__ */ jsx124("ul", { className: "grid gap-2 font-bold", children: primaryNavs.map((navItem) => navItem.subitems ? /* @__PURE__ */ jsxs107(AccordionItem, { value: navItem.label, className: "group", children: [
                /* @__PURE__ */ jsx124(
                  AccordionTrigger,
                  {
                    ...
                    children: /* @__PURE__ */ jsxs107("span", { className: "flex gap-3 items-center", children: [
                      /* @__PURE__ */ jsx124(Svg, { src: navItem.icon }),
                      navItem.label
                    ] })
                  }
                ),
                /* @__PURE__ */ jsx124(AccordionContent, { children: /* @__PURE__ */ jsx124("ul", { className: "list-disc list-inside p-3 font-normal", children: navItem.subitems.map((subitem) => /* @__PURE__ */ jsx124("li", { className: `py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]${hasAcceptedRole(user, subitem.acceptedRoles ?? []) ? "" : " hidden "}`, children: /* @__PURE__ */ jsx124(
                  NavLink3,
                  {
                    to: subitem.url,
                    onClick: onClose,
              ...
              ] }, navItem.label) : /* @__PURE__ */ jsx124("li", { children: /* @__PURE__ */ jsxs107(
                NavLink3,
                {
            ...
            /* @__PURE__ */ jsx124("nav", { className: "my-1", "aria-label": "secondary navigation", children: /* @__PURE__ */ jsx124("ul", { className: "grid font-bold", children: secondaryNavs.map((navItem) => /* @__PURE__ */ jsx124("li", { children: /* @__PURE__ */ jsxs107(
              NavLink3,
              {
          ...
          /* @__PURE__ */ jsxs107("aside", { className: "border-t px-6 py-4", children: [
            /* @__PURE__ */ jsxs107("span", { className: "flex items-center gap-1 mb-4 font-satoshi-bold", children: [
...
function MobileHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs108("div", { className: "flex sm:hidden items-center gap-4 p-4 border-b", children: [
    /* @__PURE__ */ jsxs108(Link24, { to: "/", className: "text-accent flex items-center gap-3 sm:gap-6 whitespace-nowrap font-satoshi-black", children: [
    ...
    /* @__PURE__ */ jsx125(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx125(Svg, { src: icons.adminHamburgerIcon, width: 30, height: 24 })
      }
    )
  ] });
}
...
import { NavLink as NavLink4, useLocation as useLocation10 } from "@remix-run/react";
...
function AdminNavigation({ show }) {
  let { getUserStoreManager, hasAcceptedRole } = useUserManager(), userRoles = getUserStoreManager()?.roles.map((r) => r.toLowerCase()) ?? [], [user, setUser] = useState38(null), userRolesSet = new Set(userRoles);
  useEffect31(() => {
    setUser(getUserStoreManager());
  }, [getUserStoreManager]);
  ...
  let mainComponent = /* @__PURE__ */ jsxs109("div", { className: "flex justify-between items-center border  rounded-lg p-2 text-sm cursor-pointer line-clamp-1 hover:outline outline-1 outline-primary", children: [
    "System default",
    /* @__PURE__ */ jsx126(Svg, { src: icons.arrowDownIcon })
  ] });
  return show ? /* @__PURE__ */ jsxs109("header", { className: "bg-secondary border-r hidden sm:flex flex-col justify-between min-w-[280px]", children: [
    /* @__PURE__ */ jsxs109("nav", { className: "py-6", children: [
      /* @__PURE__ */ jsx126("span", { className: "inline-block mb-2 px-6 py-3 font-satoshi-bold", children: "Navigation Menu" }),
      /* @__PURE__ */ jsx126("ul", { className: "grid gap-2 font-bold", children: navs.map((navItem) => /* @__PURE__ */ jsx126("li", { children: /* @__PURE__ */ jsxs109(
        NavLink4,
        {
          to: navItem.url,
          ...
          children: [
            /* @__PURE__ */ jsx126(Svg, { src: navItem.icon }),
            navItem.label
          ]
        }
      ) }, navItem.label)) }),
      /* @__PURE__ */ jsx126(Accordion2, { type: "single", collapsible: !0, className: "w-full mt-2", children: navsWSubs.map((item) => /* @__PURE__ */ jsxs109(AccordionItem2, { value: item.label, className: "group", children: [
        /* @__PURE__ */ jsxs109(
          AccordionTrigger2,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs109("span", { className: "flex gap-3 items-center", children: [
                /* @__PURE__ */ jsx126(Svg, { src: item.icon }),
                item.label
              ] }),
              /* @__PURE__ */ jsx126(Svg, { src: icons.arrowDownIcon, className: "group-[[data-state=open]]:rotate-180 transition-transform duration-200" })
            ]
          }
        ),
        /* @__PURE__ */ jsx126(AccordionContent2, { children: /* @__PURE__ */ jsx126("ul", { className: "list-disc list-inside p-3", children: item.subitems.map((subitem) => /* @__PURE__ */ jsx126("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx126(
          NavLink4,
          {
            to: subitem.url,
    ...
    /* @__PURE__ */ jsxs109("aside", { className: "border-t  px-6 py-3", children: [
      /* @__PURE__ */ jsxs109("span", { className: "flex items-center gap-1 mb-2 font-satoshi-bold", children: [
        /* @__PURE__ */ jsx126(Svg, { src: icons.themeIcon }),
        "Theme"
      ] }),
      /* @__PURE__ */ jsxs109(
        Toggletip,
        {
          ...
          children: [
            /* @__PURE__ */ jsx126("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "System default" }),
            /* @__PURE__ */ jsx126("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Light" }),
            /* @__PURE__ */ jsx126("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Dark" })
          ]
        }
      )
    ] })
...
function AdminToolbar() {
      ...
      children: [
        /* @__PURE__ */ jsxs110("div", { className: "flex gap-3 items-center", children: [
          ...
          /* @__PURE__ */ jsxs110("span", { className: "grid", children: [
            /* @__PURE__ */ jsx127("span", { className: "block text-sm font-satoshi-bold", children: "Admin" }),
            /* @__PURE__ */ jsx127("span", { className: "block text-xs font-satoshi-medium", children: "admin@kotmy.com" })
          ] })
        ] }),
  ...
  return /* @__PURE__ */ jsxs110(
    Toggletip,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs110(Link25, { to: "/user/profile", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx127(Svg, { src: icons.profileIcon }),
          " Profile"
        ] }),
        /* @__PURE__ */ jsxs110(Link25, { to: "/logout", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
...
function PrimaryHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs111("header", { className: "h-[85px] hidden sm:flex justify-between items-center gap-4 px-6 py-3 bg-secondary border-b", children: [
    /* @__PURE__ */ jsxs111("div", { className: "flex gap-6", children: [
      ...
      /* @__PURE__ */ jsxs111(Link26, { to: "/", className: "text-accent flex items-center gap-6 whitespace-nowrap font-satoshi-black", children: [
...
function Layout({ children }) {
  ...
  }, []), /* @__PURE__ */ jsxs112("div", { className: "bg-tertiary text-admin-pry", children: [
    /* @__PURE__ */ jsx129(PrimaryHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx129(MobileHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx129(AdminMobileNavigation, { onClose: () => {
      setShowNav(!1);
    }, show: showNav }),
    /* @__PURE__ */ jsxs112("div", { className: "sm:flex sm:h-[calc(100vh-85px)]", children: [
      /* @__PURE__ */ jsx129(AdminNavigation, { show: showNav }),
      children
    ] })
  ] });
}
function AdminLayout() {
  return /* @__PURE__ */ jsx129(Layout, { children: /* @__PURE__ */ jsx129(Outlet4, {}) });
}
function ErrorBoundary2() {
  let { pathname } = useLocation11();
  return /* @__PURE__ */ jsx129(Layout, { children: /* @__PURE__ */ jsxs112("div", { className: "w-full max-sm:h-[calc(100dvh-73px)] p-5 m-auto lg:max-w-3xl grid place-content-center text-center gap-5", children: [
    /* @__PURE__ */ jsx129("h2", { className: "text-xl font-bold text-red-500", children: "Something went wrong" }),
    /* @__PURE__ */ jsx129("p", { children: "Apologies, something went wrong on our end. Please try again." }),
    /* @__PURE__ */ jsx129(Cta_default, { element: "link", to: pathname, className: "px-4 py-1 rounded-md", children: "Reload page" }),
    /* @__PURE__ */ jsx129(Cta_default, { element: "link", to: "/admin/overview", className: "px-4 py-1 rounded-md", children: "Back to Admin Home" })
  ] }) });
}
...
import { Form as Form26, Link as Link27, useActionData as useActionData13, useNavigate as useNavigate21, useSearchParams as useSearchParams6 } from "@remix-run/react";
...
async function action23({ request }) {
  ...
  let responseHeaders = {};
  return headers?.["Set-Cookie"] ? (responseHeaders = { "Set-Cookie": headers?.["Set-Cookie"] }, json37({ data, error: null }, {
    headers: responseHeaders
  })) : json37({ data, error: null });
}
function useLoginController() {
  let actionData = useActionData13(), [searchQuery] = useSearchParams6(), { setUserStoreManager, getUserStoreManager } = useUserManager(), { toast: toast5 } = useToast(), navigate = useNavigate21();
  return useEffect33(() => {
...
function Login() {
  ...
  return /* @__PURE__ */ jsxs113("main", { className: "h-dvh bg-secondary p-4 flex flex-col", children: [
    /* @__PURE__ */ jsx130(Link27, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx130(Svg, { src: icons.logoIcon, className: "w-14 h-14 sm:w-16 sm:h-16" }) }),
    /* @__PURE__ */ jsx130("section", { className: "grow flex flex-col justify-center items-center", children: /* @__PURE__ */ jsxs113(Form26, { method: "POST", className: "w-full max-w-md p-4 sm:p-8 bg-white border rounded-3xl flex flex-col gap-3", children: [
      /* @__PURE__ */ jsx130("div", { className: "w-max mx-auto p-4 border border-disabled rounded-full bg-gradient-to-b from-slate-200 to-white", children: /* @__PURE__ */ jsx130("div", { className: "w-max p-4 border border-disabled rounded-full bg-white", children: /* @__PURE__ */ jsx130("img", { src: admin_avatar_default, alt: "person silhouette", width: 24, height: 24 }) }) }),
      /* @__PURE__ */ jsx130("h1", { className: "text-2xl font-satoshi-bold text-center", children: "Enter your details to login" }),
      /* @__PURE__ */ jsx130("hr", {}),
      /* @__PURE__ */ jsxs113("p", { className: "text-center text-sm mt-2", children: [
        "Don't have an account yet? ",
        /* @__PURE__ */ jsx130(Link27, { to: "/signup", className: "text-primary underline", children: "Register" })
      ] }),
      /* @__PURE__ */ jsxs113("div", { className: "my-2 flex flex-col gap-3", children: [
        /* @__PURE__ */ jsx130(
          FormControl,
          {
            as: "input",
      ...
      /* @__PURE__ */ jsx130(Cta_default, { element: "button", type: "submit", className: "rounded-lg p-3", children: "Login" })
    ] }) })
  ] });
}
...
import { Link as Link28, useNavigate as useNavigate22 } from "@remix-run/react";
import { useEffect as useEffect34, useState as useState40 } from "react";
import { jsx as jsx131, jsxs as jsxs114 } from "react/jsx-runtime";
function UserToolbar() {
  let [user, setUser] = useState40(null), { getUserStoreManager } = useUserManager(), navigate = useNavigate22();
  useEffect34(() => {
    let currentUser = getUserStoreManager();
    currentUser || navigate("/login"), setUser(currentUser);
  }, []);
  let mainComponent = /* @__PURE__ */ jsxs114(
    "div",
    {
      tabIndex: 0,
      className: "relative p-2 rounded-full border flex items-center gap-4 cursor-pointer bg-tertiary hover:bg-[#EEF0FF]",
      children: [
        /* @__PURE__ */ jsxs114("div", { className: "flex gap-3 items-center", children: [
  ...
  return /* @__PURE__ */ jsxs114(
    Toggletip,
    {
      ...
      childContainerClass: "top-[110%] right-0 bg-tertiary p-2 border  text-xs whitespace-nowrap",
      children: [
        /* @__PURE__ */ jsxs114(Link28, { to: "/user/profile", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx131(Svg, { src: icons.profileIcon }),
          " Profile"
        ] }),
        /* @__PURE__ */ jsxs114(Link28, { to: "/logout", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx131(Svg, { src: icons.signoutIcon }),
          " Sign Out"
        ] })
      ]
    }
...
function UserPrimaryHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs115("header", { className: "h-[85px] hidden sm:flex justify-between items-center gap-4 px-6 py-3 bg-secondary border-b", children: [
    /* @__PURE__ */ jsxs115("div", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsx132(
        "button",
        {
          onClick: toggleNav,
          title: "Toggle Menu",
          className: "flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
          children: /* @__PURE__ */ jsx132(Svg, { src: icons.adminHamburgerIcon, width: 40, height: 24 })
        }
      ),
      /* @__PURE__ */ jsxs115(Link29, { to: "/", className: "text-accent flex items-center gap-6 whitespace-nowrap font-satoshi-black", children: [
        /* @__PURE__ */ jsx132(Svg, { src: icons.logoIcon, width: 37, height: 36 }),
        "KOTMY-USER"
      ] })
    ] }),
    /* @__PURE__ */ jsx132(FormControl, { as: "input", type: "search", className: "min-w-[280px] bg-white", placeholder: "Search..." }),
    /* @__PURE__ */ jsx132(UserToolbar, {})
  ] });
}
...
function UserMobileHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs116("div", { className: "flex sm:hidden items-center gap-4 p-4 border-b", children: [
    /* @__PURE__ */ jsxs116(Link30, { to: "/", className: "text-accent flex items-center gap-3 sm:gap-6 whitespace-nowrap font-satoshi-black", children: [
    ...
    /* @__PURE__ */ jsx133(
      "button",
      {
        ...
        title: "open Menu",
        className: "ml-auto flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
        children: /* @__PURE__ */ jsx133(Svg, { src: icons.adminHamburgerIcon, width: 30, height: 24 })
      }
    )
  ] });
}
...
import { NavLink as NavLink5, useLocation as useLocation12, useNavigate as useNavigate23 } from "@remix-run/react";
import { useEffect as useEffect35, useRef as useRef13, useState as useState41 } from "react";
...
function UserMobileNavigation({ show, onClose }) {
  let mobileNav = useRef13(null), [user, setUser] = useState41(null), navigate = useNavigate23(), { getUserStoreManager } = useUserManager();
  useEffect35(() => {
    let currentUser = getUserStoreManager();
        ...
        /* @__PURE__ */ jsxs117("div", { className: "flex flex-col justify-between grow", children: [
          /* @__PURE__ */ jsxs117("header", { children: [
            /* @__PURE__ */ jsxs117("nav", { "aria-label": "primary navigation", children: [
              ...
              /* @__PURE__ */ jsx134(Accordion, { type: "single", collapsible: !0, className: "w-full py-2 border-b", children: /* @__PURE__ */ jsx134("ul", { className: "grid gap-2 font-bold", children: primaryNavs2.map((navItem) => navItem.subitems ? /* @__PURE__ */ jsxs117(AccordionItem, { value: navItem.label, className: "group", children: [
                /* @__PURE__ */ jsx134(
                  AccordionTrigger,
                  {
                    className: cn("border-l-4 border-transparent px-6 py-3 font-semibold hover:bg-[#EEF0FF]", {
            ...
            /* @__PURE__ */ jsx134("nav", { className: "my-1", "aria-label": "secondary navigation", children: /* @__PURE__ */ jsx134("ul", { className: "grid font-bold", children: secondaryNavs2.map((navItem) => /* @__PURE__ */ jsx134("li", { children: /* @__PURE__ */ jsxs117(
              NavLink5,
              {
                className: "flex gap-3 items-center px-6 py-3 font-semibold border-l-4 hover:bg-[#EEF0FF] border-transparent",
                to: navItem.url,
...
function UserNavigation({ show }) {
  ...
  return show ? /* @__PURE__ */ jsxs118("header", { className: "bg-secondary border-r hidden sm:flex flex-col justify-between min-w-[280px] h-full", children: [
    /* @__PURE__ */ jsxs118("nav", { className: "py-6", children: [
      ...
      /* @__PURE__ */ jsx135("ul", { className: "grid gap-2 font-bold", children: navs2.map((navItem) => /* @__PURE__ */ jsx135("li", { children: /* @__PURE__ */ jsxs118(
        NavLink6,
        {
          to: navItem.url,
      ...
      /* @__PURE__ */ jsx135(Accordion3, { type: "single", collapsible: !0, className: "w-full mt-2", children: navsWSubs2.map((item) => /* @__PURE__ */ jsxs118(AccordionItem3, { value: item.label, className: "group", children: [
        /* @__PURE__ */ jsxs118(
          AccordionTrigger3,
          {
            className: cn("border-l-4 border-transparent group w-full flex gap-3 items-center justify-between px-6 py-3 font-semibold hover:bg-[#EEF0FF]", {
        ...
        /* @__PURE__ */ jsx135(AccordionContent3, { children: /* @__PURE__ */ jsx135("ul", { className: "list-disc list-inside p-3", children: item.subitems.map((subitem) => /* @__PURE__ */ jsx135("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx135(
          NavLink6,
          {
            to: subitem.url,
            className: ({ isActive }) => `${isActive ? "active" : ""}`,
...
function Layout2({ children }) {
  let [showNav, setShowNav] = useState42(!1);
  return useEffect36(() => {
    setShowNav(window.innerWidth >= 640);
  }, []), /* @__PURE__ */ jsxs119("div", { className: "bg-tertiary text-admin-pry", children: [
    /* @__PURE__ */ jsx136(UserPrimaryHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx136(UserMobileHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx136(UserMobileNavigation, { onClose: () => {
      setShowNav(!1);
    }, show: showNav }),
    /* @__PURE__ */ jsxs119("div", { className: "sm:flex sm:h-[calc(100vh-85px)]", children: [
      /* @__PURE__ */ jsx136(UserNavigation, { show: showNav }),
      /* @__PURE__ */ jsx136("div", { className: "flex-grow overflow-y-auto", children })
    ] })
  ] });
}
function UserLayout() {
  return /* @__PURE__ */ jsx136(Layout2, { children: /* @__PURE__ */ jsx136(Outlet5, {}) });
}
function ErrorBoundary3() {
  let { pathname } = useLocation14();
  return /* @__PURE__ */ jsx136(Layout2, { children: /* @__PURE__ */ jsxs119("div", { className: "w-full max-sm:h-[calc(100dvh-73px)] p-5 m-auto lg:max-w-3xl grid place-content-center text-center gap-5", children: [
