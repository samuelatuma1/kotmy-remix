...
function prepareContestantDTO(formData) {
  let payloadObj = {
    ...
    social_media_url: formData.get("name"),
    vote: {
...
var TOKEN2 = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2ZjFkYTc3MTU1MzE3NzdjMDMwZWI2NCIsImVtYWlsIjoiYXR1bWFzYW11ZWxva3BhcmEzQGdtYWlsLmNvbSIsImlzX3N0YWZmIjp0cnVlLCJpc19zdXBlcnVzZXIiOnRydWUsInJvbGVzIjpbXSwicGVybWlzc2lvbnMiOltdLCJleHAiOjE3NzExNzM0NDJ9.sHAuj-OTgwKuSpgrsY0vjPeHHnOJNzENSxmYIFo414k", ContestRepository = class {
  ...
  async createContest(contest, token = TOKEN2) {
    return contest.entries().forEach(([key, value]) => {
...
function prepareContestPayload(formData) {
  ...
  let payloadObj = {
    ...
    image: formData.get("image") || formData.get("image").size === 0 ? null : formData.get("image"),
...
function TournamentPage() {
  ...
  return /* @__PURE__ */ jsxDEV42("main", { className: "grow", children: [
    ...
    /* @__PURE__ */ jsxDEV42("section", { className: "wrapper", children: /* @__PURE__ */ jsxDEV42("div", { className: "p-2 rounded-full bg-secondary flex w-fit text-xs sm:text-base", children: [
      /* @__PURE__ */ jsxDEV42("span", { className: "whitespace-nowrap p-2 sm:px-4 sm:py-3 rounded-full font-satoshi-medium bg-accent text-white", children: "All KOTM" }, void 0, !1, {
        fileName: "app/routes/_public.contests.$tournamentId._index.tsx",
        lineNumber: 34,
        columnNumber: 21
      }, this),
      /* @__PURE__ */ jsxDEV42("span", { className: "whitespace-nowrap p-2 sm:px-4 sm:py-3 rounded-full font-satoshi-medium", children: "Ongoing" }, void 0, !1, {
        fileName: "app/routes/_public.contests.$tournamentId._index.tsx",
        lineNumber: 35,
        columnNumber: 21
      }, this),
      /* @__PURE__ */ jsxDEV42("span", { className: "whitespace-nowrap p-2 sm:px-4 sm:py-3 rounded-full font-satoshi-medium", children: "Registering" }, void 0, !1, {
        fileName: "app/routes/_public.contests.$tournamentId._index.tsx",
        lineNumber: 36,
        columnNumber: 21
      }, this),
      /* @__PURE__ */ jsxDEV42("span", { className: "whitespace-nowrap p-2 sm:px-4 sm:py-3 rounded-full font-satoshi-medium", children: "Completed" }, void 0, !1, {
        fileName: "app/routes/_public.contests.$tournamentId._index.tsx",
        lineNumber: 37,
        columnNumber: 21
      }, this)
    ...
    /* @__PURE__ */ jsxDEV42("section", { className: "wrapper my-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-12 justify-items-center", children: tournament.contests.map((contest) => /* @__PURE__ */ jsxDEV42(ContestCard, { contest, to: contest.id, withTag: !0 }, contest.id, !1, {
      fileName: "app/routes/_public.contests.$tournamentId._index.tsx",
      lineNumber: 42,
      columnNumber: 21
    }, this)) }, void 0, !1, {
...
import { useEffect as useEffect7, useRef as useRef5, useState as useState6 } from "react";
function useFilePreview(fileList) {
  let [filePreview, setFilePreview] = useState6(null), fileName = useRef5("");
  useEffect7(() => {
...
function EditContestantDialog({ disabled, contestant }) {
  let { stage } = useLoaderData5(), isKotmy = stage.rates.social_media.type === "kotmy", [files, setFiles] = useState7(null), { filePreview, clearFilePreview } = useFilePreview(files);
...
function CategoryInputs({ categories }) {
  let [newCategory, setNewCategory] = useState8(""), [catogories, setCategories] = useState8(categories ?? []);
...
function EditContestForm({ tournaments, contest }) {
  let [fileList, setFileList] = useState9(null), { filePreview, clearFilePreview, fileName } = useFilePreview(fileList);
  return /* @__PURE__ */ jsxDEV57(Form5, { className: "max-w-[700px] mx-auto grid gap-6 sm:gap-12 text-sm", method: "post", encType: "multipart/form-data", children: [
    ...
    /* @__PURE__ */ jsxDEV57("fieldset", { className: "grid gap-3 sm:gap-6 sm:grid-cols-2", children: [
      ...
      /* @__PURE__ */ jsxDEV57(FormControl, { as: "input", type: "date", labelText: "Registration Deadline", id: "reg_deadline", name: "reg_deadline", defaultValue: parseDateForInput(contest.reg_deadline), required: !0 }, void 0, !1, {
        fileName: "app/components/admin/tournament/EditContestForm.tsx",
        lineNumber: 51,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ jsxDEV57(FormControl, { as: "input", type: "date", labelText: "Contest Start Date", id: "start_date", name: "start_date", defaultValue: parseDateForInput(contest.start_date), required: !0 }, void 0, !1, {
        fileName: "app/components/admin/tournament/EditContestForm.tsx",
        lineNumber: 52,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ jsxDEV57(FormControl, { as: "input", type: "date", labelText: "Contest End Date", id: "end_date", name: "end_date", defaultValue: parseDateForInput(contest.end_date), required: !0 }, void 0, !1, {
        fileName: "app/components/admin/tournament/EditContestForm.tsx",
        lineNumber: 53,
        columnNumber: 17
      }, this),
...
function useRegistrationFormController() {
  ...
  console.log({ data });
  let [contest, setContest] = useState10(), [stage, setStage] = useState10(), [contestant, setContestant] = useState10();
  return error && toast({
    variant: "destructive",
...
function Stages({ row }) {
  let [selectedStage, setSelectedStage] = useState11(row.original.stages[0] ?? null);
...
function EditStageForm({ stage, contestId, closeForm }) {
  return /* @__PURE__ */ jsxDEV71(Form8, { method: "POST", className: "text-primary text-xs flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxDEV71("fieldset", { className: "py-4 grid grid-cols-4 gap-3 border-b", children: [
      /* @__PURE__ */ jsxDEV71(FormControl, { as: "input", id: "start_date", name: "start_date", labelText: "Stage Start Date", type: "date", defaultValue: parseDateForInput(stage.start_date) }, void 0, !1, {
        fileName: "app/components/admin/contest/EditStageForm.tsx",
        lineNumber: 42,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ jsxDEV71(FormControl, { as: "input", id: "end_date", name: "end_date", labelText: "Stage End Date", type: "date", defaultValue: parseDateForInput(stage.end_date) }, void 0, !1, {
        fileName: "app/components/admin/contest/EditStageForm.tsx",
        lineNumber: 43,
        columnNumber: 9
      }, this),
...
function Toggletip({ mainComponent, children, mainContainerClass = "", childContainerClass = "" }) {
  let [open, setOpen] = useState12(!1), toggletip = useRef6(null);
...
function EditTournamentForm({ tournament }) {
  let [fileList, setFileList] = useState13(null), { filePreview, clearFilePreview, fileName } = useFilePreview(fileList);
...
function PermissionsFormControl({ permissions: permissions2, defaultPermissions, ...props }) {
  let [open, setOpen] = useState14(!1), fieldset = useRef7(null);
...
function useUserPendingsUploadController() {
  let { data, error, authRequired } = useLoaderData21(), [pendingUploads, setPendingUploads] = useState15([]);
  return error && toast({
    variant: "destructive",
    title: "An error occured",
    description: error?.detail.toString() ?? "Error occured"
...
function CreateContestForm({ tournaments }) {
  ...
  return /* @__PURE__ */ jsxDEV95(Form13, { className: "max-w-[700px] mx-auto my-8 grid gap-6 sm:gap-12 text-sm", method: "post", encType: "multipart/form-data", children: [
    ...
    /* @__PURE__ */ jsxDEV95("fieldset", { className: "grid gap-3 sm:gap-6 sm:grid-cols-2", children: [
      ...
      /* @__PURE__ */ jsxDEV95(FormControl, { as: "input", type: "date", labelText: "Registration Deadline", id: "reg_deadline", name: "reg_deadline", required: !0 }, void 0, !1, {
        fileName: "app/components/admin/tournament/CreateContestForm.tsx",
        lineNumber: 27,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ jsxDEV95(FormControl, { as: "input", type: "date", labelText: "Contest Start Date", id: "start_date", name: "start_date", required: !0 }, void 0, !1, {
        fileName: "app/components/admin/tournament/CreateContestForm.tsx",
        lineNumber: 28,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ jsxDEV95(FormControl, { as: "input", type: "date", labelText: "Contest End Date", id: "end_date", name: "end_date", required: !0 }, void 0, !1, {
        fileName: "app/components/admin/tournament/CreateContestForm.tsx",
        lineNumber: 29,
        columnNumber: 17
      }, this),
...
function Winners() {
  let { winners, error } = useLoaderData24(), [searchWinners, setSearchWinners] = useState16(""), [winnersFiltered, setWinnersFiltered] = useState16(winners ?? []);
  return useEffect11(() => {
...
function TransactionSummary({ data }) {
  let years = Object.keys(data).reverse(), [selectedYear, setSelectedYear] = useState17(years[0]), yearData = data[selectedYear], colors = ["#6246EA", "#817EFB", "#A3A8FE"], doughnutData = {
    datasets: [{
      label: "Income",
...
function Navigation() {
  let [showNav, setShowNav] = useState18(!1), { pathname } = useLocation3();
...
function Layout({ children }) {
  let [showNav, setShowNav] = useState19(!1);
  return useEffect14(() => {
...
function UserToolbar() {
  let [user, setUser] = useState20(null), { getUserStoreManager } = useUserManager(), navigate = useNavigate11();
  useEffect16(() => {
...
import { useEffect as useEffect17, useRef as useRef10, useState as useState21 } from "react";
...
function UserMobileNavigation({ show, onClose }) {
  let mobileNav = useRef10(null), [user, setUser] = useState21(null), navigate = useNavigate12(), { getUserStoreManager } = useUserManager();
  useEffect17(() => {
    let currentUser = getUserStoreManager();
