...
}, reducer = (state, action32) => {
  switch (action32.type) {
    case "ADD_TOAST":
      return {
        ...state,
        toasts: [action32.toast, ...state.toasts].slice(0, TOAST_LIMIT)
      };
    case "UPDATE_TOAST":
      return {
        ...state,
        toasts: state.toasts.map(
          (t) => t.id === action32.toast.id ? { ...t, ...action32.toast } : t
        )
      };
    case "DISMISS_TOAST": {
      let { toastId } = action32;
    ...
    case "REMOVE_TOAST":
      return action32.toastId === void 0 ? {
        ...state,
        toasts: []
      } : {
        ...state,
        toasts: state.toasts.filter((t) => t.id !== action32.toastId)
      };
  }
}, listeners = [], memoryState = { toasts: [] };
function dispatch(action32) {
  memoryState = reducer(memoryState, action32), listeners.forEach((listener) => {
...
function Toaster() {
  ...
  return /* @__PURE__ */ jsxs(ToastProvider, { children: [
    toasts.map(function({ id, title, description, action: action32, ...props }) {
...
function reducer2(stages, action32) {
  return action32.type === "add" ? [...stages, {
    stage: (stages.at(-1)?.stage ?? 0) + 1,
    weight: 0,
    rates: { social_media: { type: "facebook", amount: 0 }, tally: 0, judge: 0, givaah: 0 }
  }] : action32.type === "remove" ? stages.filter((stage) => stage.stage !== action32.stageNumber || stage._id !== action32.value) : action32.type === "edit_sm_type" ? stages.map((stage) => stage.stage === action32.stageNumber ? { ...stage, rates: { ...stage.rates, social_media: { ...stage.rates.social_media, type: action32.value } } } : stage) : action32.type === "edit_stage_number" && !stages.some((stage) => stage.stage === action32.value) ? stages.map((stage) => stage.stage === action32.stageNumber ? { ...stage, stage: action32.value } : stage) : action32.type === "edit_stage_weight" ? stages.map((stage) => stage.stage === action32.stageNumber ? { ...stage, weight: action32.value } : stage) : stages;
}
...
import { Link as Link26, useActionData as useActionData16, useLoaderData as useLoaderData50, useFetcher as useFetcher16 } from "@remix-run/react";
import { useState as useState42, useMemo as useMemo6, useEffect as useEffect32 } from "react";
...
async function action29({ request }) {
  ...
  let walletResp = await walletRepo.wallet_search(query, cookieHeader);
  if (walletResp.error)
    return json49({ error: walletResp.error }, { status: 400 });
  let ledgersResp = await walletRepo.getUserLedgersForWallet(cookieHeader, query);
  if (ledgersResp.error)
    return json49({ error: ledgersResp.error }, { status: 400 });
  ...
  return console.log("WALLET RESP", walletResp, wallets), json49({ wallets });
}
function useWalletController2() {
  let { wallets } = useLoaderData50(), { setUserStoreManager, getUserStoreManager } = useUserManager(), [user, setUser] = useState42(null), [activeWalletId, setActiveWalletId] = useState42(
    wallets.length > 0 ? wallets[0].wallet._id : null
  );
  useEffect32(() => {
    let _user = getUserStoreManager();
  ...
  let activeData = useMemo6(() => wallets.find((w) => w.wallet._id === activeWalletId) || null, [activeWalletId, wallets]), formatCurrency = (amount, currency) => new Intl.NumberFormat("en-US", {
    style: "currency",
    currency
  }).format(amount), [searchOpen, setSearchOpen] = useState42(!1), fetcher = useFetcher16(), isSubmitting = fetcher.state === "submitting", actionData = useActionData16(), [walletsState, setWalletsState] = useState42(wallets);
  return useEffect32(() => {
    (fetcher.data?.wallets ?? actionData?.wallets) || setWalletsState(wallets);
  }, [wallets, fetcher.data, actionData]), useEffect32(() => {
    let fw = fetcher.data?.wallets ?? actionData?.wallets;
    fw && Array.isArray(fw) && setWalletsState(fw);
  }, [fetcher.data, actionData]), {
    wallets,
...
function WalletPage2() {
  ...
  if (!activeData)
    return /* @__PURE__ */ jsx131("div", { className: "p-8", children: "No wallets found." });
  let activeDataLocal = walletsState.find((w) => w.wallet._id === activeData?.wallet._id) ?? activeData, { wallet, pagedLedgers } = activeDataLocal;
  return /* @__PURE__ */ jsxs114("div", { className: "p-8 max-w-7xl mx-auto bg-[#F9FAFB] min-h-screen", children: [
    /* @__PURE__ */ jsx131("h1", { className: "text-2xl font-semibold mb-6", children: "Wallet" }),
    /* @__PURE__ */ jsxs114("div", { className: "bg-white rounded-3xl p-8 border border-gray-100 shadow-sm mb-8", children: [
      /* @__PURE__ */ jsxs114("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxs114("div", { className: "flex items-center gap-2 text-gray-500", children: [
          /* @__PURE__ */ jsx131("span", { className: "text-sm", children: "Wallet balances" }),
          /* @__PURE__ */ jsx131("button", { className: "hover:bg-gray-100 p-1 rounded-full", children: "\u{1F441}\uFE0F" })
        ] }),
        /* @__PURE__ */ jsx131(
          "select",
          {
            ...
            value: wallet._id,
            onChange: (e) => setActiveWalletId(e.target.value),
            children: walletsState.map((w) => /* @__PURE__ */ jsxs114("option", { value: w.wallet._id, children: [
              w.wallet.wallet_currency,
              " - ",
              w.wallet.account_number
            ] }, w.wallet._id))
      ...
      /* @__PURE__ */ jsx131("div", { className: "flex justify-between items-start", children: /* @__PURE__ */ jsxs114("div", { children: [
        /* @__PURE__ */ jsx131("div", { className: "text-4xl font-bold mb-1", children: formatCurrency(wallet.withdrawable_balance, wallet.wallet_currency) }),
        /* @__PURE__ */ jsx131("div", { className: "text-gray-400 text-sm", children: wallet.wallet_name })
      ] }) }),
      /* @__PURE__ */ jsxs114("div", { className: "flex flex-col sm:flex-row gap-3 mt-8", children: [
        /* @__PURE__ */ jsx131(Link26, { to: `/user/withdraw/${wallet._id}`, children: /* @__PURE__ */ jsx131("button", { className: "bg-[#312E81] text-white px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:opacity-90 transition-opacity w-full sm:w-auto", children: "\u2197 Withdraw" }) }),
        user?.withdrawal_pin_set ? /* @__PURE__ */ jsx131(Link26, { to: `/user/addwithdrawalaccount/${wallet._id}`, children: /* @__PURE__ */ jsx131("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "Add withdrawal account" }) }) : /* @__PURE__ */ jsx131(Link26, { to: "/user/setwithdrawalpin", children: /* @__PURE__ */ jsx131("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "+ Set withdrawal PIN" }) }),
        /* @__PURE__ */ jsx131("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "\u21C4 Transfer to another wallet" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs114("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxs114("div", { className: "flex items-center justify-between mb-3", children: [
        /* @__PURE__ */ jsx131("h2", { className: "text-lg font-medium text-gray-700", children: "Search" }),
        /* @__PURE__ */ jsxs114(
          "button",
          {
            type: "button",
            ...
            "aria-expanded": searchOpen,
            children: [
              /* @__PURE__ */ jsx131("span", { children: searchOpen ? "Hide" : "Show" }),
              /* @__PURE__ */ jsx131(
                "svg",
                {
                  className: `w-4 h-4 transition-transform ${searchOpen ? "rotate-180" : ""}`,
                  ...
                  viewBox: "0 0 24 24",
                  xmlns: "http://www.w3.org/2000/svg",
                  children: /* @__PURE__ */ jsx131("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M19 9l-7 7-7-7" })
                }
              )
            ]
          }
      ...
      /* @__PURE__ */ jsx131("div", { className: `transition-all ${searchOpen ? "overflow-scroll max-h-96" : "overflow-hidden max-h-0"}`, children: /* @__PURE__ */ jsx131("div", { className: "bg-white border border-gray-100 rounded-xl p-4 shadow-sm", children: /* @__PURE__ */ jsxs114(fetcher.Form, { method: "post", className: "grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm", children: [
        /* @__PURE__ */ jsxs114("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx131("span", { className: "mb-1", children: "Transaction type" }),
          /* @__PURE__ */ jsxs114("select", { id: "transaction_type", name: "transaction_type", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx131("option", { value: "", children: "All transaction types" }),
            /* @__PURE__ */ jsx131("option", { value: "credit", children: "Credit" }),
            /* @__PURE__ */ jsx131("option", { value: "debit", children: "Debit" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs114("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx131("span", { className: "mb-1", children: "Status" }),
          /* @__PURE__ */ jsxs114("select", { id: "status", name: "status", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx131("option", { value: "", children: "Any status" }),
            /* @__PURE__ */ jsx131("option", { value: "pending", children: "Pending" }),
            /* @__PURE__ */ jsx131("option", { value: "completed", children: "Completed" }),
            /* @__PURE__ */ jsx131("option", { value: "void", children: "Void" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs114("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx131("span", { className: "mb-1", children: "Min amount" }),
          /* @__PURE__ */ jsx131("input", { id: "min_amount", name: "min_amount", type: "number", step: "0.01", placeholder: "Min amount", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs114("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx131("span", { className: "mb-1", children: "Max amount" }),
          /* @__PURE__ */ jsx131("input", { id: "max_amount", name: "max_amount", type: "number", step: "0.01", placeholder: "Max amount", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs114("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx131("span", { className: "mb-1", children: "From date" }),
          /* @__PURE__ */ jsx131("input", { id: "min_created_at", name: "min_created_at", type: "date", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs114("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx131("span", { className: "mb-1", children: "To date" }),
          /* @__PURE__ */ jsx131("input", { id: "max_created_at", name: "max_created_at", type: "date", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs114("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx131("span", { className: "mb-1", children: "Payment method" }),
          /* @__PURE__ */ jsxs114("select", { id: "payment_method", name: "payment_method", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx131("option", { value: "", children: "Any payment method" }),
            /* @__PURE__ */ jsx131("option", { value: "flutterwave", children: "Flutterwave" }),
            /* @__PURE__ */ jsx131("option", { value: "bank", children: "Bank" }),
            /* @__PURE__ */ jsx131("option", { value: "paystack", children: "Paystack" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs114("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx131("span", { className: "mb-1", children: "Contest code" }),
          /* @__PURE__ */ jsx131("input", { id: "contest_code", name: "contest_code", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsx131("input", { type: "hidden", name: "wallet_id", value: wallet._id }),
        /* @__PURE__ */ jsx131("div", { className: "sm:col-span-3 flex justify-end mt-2", children: /* @__PURE__ */ jsx131("button", { type: "submit", disabled: isSubmitting, className: "px-4 py-2 bg-[#312E81] text-white rounded-lg text-sm disabled:opacity-50", children: isSubmitting ? "Searching..." : "Search" }) })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxs114("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxs114("div", { className: "flex items-center gap-2 text-gray-600 mb-4", children: [
        /* @__PURE__ */ jsx131("span", { children: "\u{1F4C1}" }),
        /* @__PURE__ */ jsxs114("h2", { className: "font-medium", children: [
          "Recent wallet activity (",
          wallet.wallet_currency,
          ")"
        ] })
      ] }),
      /* @__PURE__ */ jsxs114("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-12 mb-8 border-b border-gray-100 pb-6", children: [
        /* @__PURE__ */ jsx131(
          MetricItem2,
          {
            label: "Net change this month",
      ...
      /* @__PURE__ */ jsx131("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs114("table", { className: "w-full text-left text-sm", children: [
        /* @__PURE__ */ jsx131("thead", { children: /* @__PURE__ */ jsxs114("tr", { className: "text-gray-400 border-b", children: [
          /* @__PURE__ */ jsx131("th", { className: "pb-4 font-medium", children: "S/N" }),
          /* @__PURE__ */ jsx131("th", { className: "pb-4 font-medium", children: "Date" }),
          /* @__PURE__ */ jsx131("th", { className: "pb-4 font-medium", children: "Ref ID" }),
          /* @__PURE__ */ jsx131("th", { className: "pb-4 font-medium", children: "Narration" }),
          /* @__PURE__ */ jsx131("th", { className: "pb-4 font-medium", children: "Beneficiary name" }),
          /* @__PURE__ */ jsx131("th", { className: "pb-4 font-medium", children: "Type" }),
          /* @__PURE__ */ jsx131("th", { className: "pb-4 font-medium", children: "Amount" })
        ] }) }),
        /* @__PURE__ */ jsx131("tbody", { className: "divide-y", children: pagedLedgers.items.map((item, idx) => /* @__PURE__ */ jsxs114("tr", { className: "hover:bg-gray-50/50 transition-colors", children: [
          /* @__PURE__ */ jsx131("td", { className: "py-4 text-gray-500", children: idx + 1 }),
          /* @__PURE__ */ jsxs114("td", { className: "py-4 text-gray-900 leading-tight", children: [
            new Date(item.completed_at || "").toLocaleDateString(),
            /* @__PURE__ */ jsx131("div", { className: "text-xs text-gray-400", children: new Date(item.completed_at || "").toLocaleTimeString() })
          ] }),
          /* @__PURE__ */ jsx131("td", { className: "py-4 text-gray-600 font-mono text-xs", children: item.payment_ref }),
          /* @__PURE__ */ jsx131("td", { className: "py-4 text-gray-600 max-w-xs", children: item.description }),
          /* @__PURE__ */ jsx131("td", { className: "py-4 text-gray-600 truncate", children: item.wallet_name }),
          /* @__PURE__ */ jsx131("td", { className: "py-4 uppercase text-xs font-semibold", children: item.entry_type }),
          /* @__PURE__ */ jsx131("td", { className: "py-4", children: /* @__PURE__ */ jsxs114("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx131("span", { className: `font-semibold ${item.entry_type === "credit" ? "text-green-600" : "text-gray-900"}`, children: formatCurrency(item.amount, item.currency) }),
            /* @__PURE__ */ jsx131(StatusBadge2, { status: item.status })
          ] }) })
        ] }, item._id)) })
      ] }) }),
      /* @__PURE__ */ jsxs114("div", { className: "mt-6 flex justify-between items-center text-sm text-gray-500", children: [
        ...
        /* @__PURE__ */ jsx131(Pagination, { lastKey: pagedLedgers.last_key_id, pageSize: pagedLedgers.items_per_page, firstKey: pagedLedgers.first_key_id })
      ] })
    ] })
  ] });
}
function MetricItem2({ label, value, tooltip = !1 }) {
  return /* @__PURE__ */ jsxs114("div", { children: [
    /* @__PURE__ */ jsxs114("div", { className: "text-xs text-gray-400 flex items-center gap-1 mb-1", children: [
      label,
      " ",
      tooltip && /* @__PURE__ */ jsx131("span", { className: "bg-gray-200 rounded-full w-3 h-3 text-[8px] flex items-center justify-center text-white", children: "i" })
    ] }),
    /* @__PURE__ */ jsx131("div", { className: "text-lg font-bold text-gray-800", children: value })
  ] });
}
function StatusBadge2({ status }) {
  ...
  return /* @__PURE__ */ jsxs114("span", { className: `px-2 py-0.5 rounded-full text-[10px] font-medium border flex items-center gap-1 ${styles[status] || ""}`, children: [
    icons2[status],
    " ",
    status
  ] });
...
import { Link as Link27, useNavigate as useNavigate25 } from "@remix-run/react";
...
function PartnerToolbar() {
  ...
  return /* @__PURE__ */ jsxs115(
    Toggletip,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs115(Link27, { to: "/user/profile", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx132(Svg, { src: icons.profileIcon }),
          " Profile"
        ] }),
        /* @__PURE__ */ jsxs115(Link27, { to: "/logout", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx132(Svg, { src: icons.signoutIcon }),
          " Sign Out"
        ] })
      ]
    }
...
function PartnerPrimaryHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs116("header", { className: "h-[85px] hidden sm:flex justify-between items-center gap-4 px-6 py-3 bg-secondary border-b", children: [
    /* @__PURE__ */ jsxs116("div", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsx133(
        "button",
        {
          onClick: toggleNav,
          ...
          children: /* @__PURE__ */ jsx133(Svg, { src: icons.adminHamburgerIcon, width: 40, height: 24 })
        }
      ),
      /* @__PURE__ */ jsxs116(Link28, { to: "/", className: "text-accent flex items-center gap-6 whitespace-nowrap font-satoshi-black", children: [
        /* @__PURE__ */ jsx133(Svg, { src: icons.logoIcon, width: 37, height: 36 }),
        "KOTMY-PARTNER"
      ] })
    ] }),
    /* @__PURE__ */ jsx133(FormControl, { as: "input", type: "search", className: "min-w-[280px] bg-white", placeholder: "Search..." }),
    /* @__PURE__ */ jsx133(PartnerToolbar, {})
  ] });
}
...
function UserMobileHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs117("div", { className: "flex sm:hidden items-center gap-4 p-4 border-b", children: [
    /* @__PURE__ */ jsxs117(Link29, { to: "/", className: "text-accent flex items-center gap-3 sm:gap-6 whitespace-nowrap font-satoshi-black", children: [
    ...
    /* @__PURE__ */ jsx134(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx134(Svg, { src: icons.adminHamburgerIcon, width: 30, height: 24 })
      }
    )
  ] });
}
...
var Accordion = AccordionPrimitive.Root, AccordionItem = React13.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx135(
...
var AccordionTrigger = React13.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx135(AccordionPrimitive.Header, { className: "flex", children: /* @__PURE__ */ jsxs118(
  AccordionPrimitive.Trigger,
  {
    ...
    children: [
      children,
      /* @__PURE__ */ jsx135(Svg, { src: icons.arrowDownIcon, className: "shrink-0 transition-transform duration-200" })
    ]
  }
) }));
AccordionTrigger.displayName = AccordionPrimitive.Trigger.displayName;
var AccordionContent = React13.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx135(
  AccordionPrimitive.Content,
  {
    ref,
    className: "overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down",
    ...props,
    children: /* @__PURE__ */ jsx135("div", { className: cn("", className), children })
  }
));
...
function PartnerMobileNavigation({ show, onClose }) {
  let mobileNav = useRef14(null), [user, setUser] = useState44(null), navigate = useNavigate26(), { getUserStoreManager } = useUserManager(), location = useLocation9(), path = `${location.pathname}${location.search}${location.hash}`;
  useEffect34(() => {
    let currentUser = getUserStoreManager();
  ...
  let mainComponent = /* @__PURE__ */ jsxs119("div", { className: "flex justify-between items-center border rounded-lg p-2 text-sm cursor-pointer line-clamp-1 hover:outline outline-1 outline-primary", children: [
    "System default",
    /* @__PURE__ */ jsx136(Svg, { src: icons.arrowDownIcon })
  ] });
  return /* @__PURE__ */ jsxs119(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs119("div", { className: "flex justify-between items-center py-4 px-6 border-b", children: [
          /* @__PURE__ */ jsx136("span", { className: "font-satoshi-bold", children: "NAVIGATION MENU" }),
          /* @__PURE__ */ jsx136(
            "button",
            {
              onClick: onClose,
              title: "open Menu",
              className: "flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
              children: /* @__PURE__ */ jsx136(Svg, { src: icons.closeIcon })
            }
          )
        ] }),
        /* @__PURE__ */ jsxs119("div", { className: "flex flex-col justify-between grow", children: [
          /* @__PURE__ */ jsxs119("header", { children: [
            /* @__PURE__ */ jsxs119("nav", { "aria-label": "primary navigation", children: [
              /* @__PURE__ */ jsxs119("div", { className: "flex gap-3 items-center bg-white px-6 py-2 border-b", children: [
                /* @__PURE__ */ jsx136("span", { className: "p-2 border border-disabled rounded-full", children: /* @__PURE__ */ jsx136("img", { src: admin_avatar_default, alt: "cartoon head", width: 24, height: 24 }) }),
                /* @__PURE__ */ jsxs119("span", { className: "grid", children: [
                  /* @__PURE__ */ jsx136("span", { className: "block text-sm font-satoshi-bold", children: user?.fullName }),
                  /* @__PURE__ */ jsx136("span", { className: "block text-xs font-satoshi-medium", children: user?.email })
                ] })
              ] }),
              /* @__PURE__ */ jsx136(Accordion, { type: "single", collapsible: !0, className: "w-full py-2 border-b", children: /* @__PURE__ */ jsx136("ul", { className: "grid gap-2 font-bold", children: primaryNavs.map((navItem) => navItem.subitems ? /* @__PURE__ */ jsxs119(AccordionItem, { value: navItem.label, className: "group", children: [
                /* @__PURE__ */ jsx136(
                  AccordionTrigger,
                  {
                    ...
                    children: /* @__PURE__ */ jsxs119("span", { className: "flex gap-3 items-center", children: [
                      /* @__PURE__ */ jsx136(Svg, { src: navItem.icon }),
                      navItem.label
                    ] })
                  }
                ),
                /* @__PURE__ */ jsx136(AccordionContent, { children: /* @__PURE__ */ jsx136("ul", { className: "list-disc list-inside p-3 font-normal", children: navItem.subitems.map((subitem) => /* @__PURE__ */ jsx136("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx136(
                  NavLink,
                  {
                    to: subitem.url,
                    onClick: onClose,
              ...
              ] }, navItem.label) : /* @__PURE__ */ jsx136("li", { children: /* @__PURE__ */ jsxs119(
                NavLink,
                {
            ...
            /* @__PURE__ */ jsx136("nav", { className: "my-1", "aria-label": "secondary navigation", children: /* @__PURE__ */ jsx136("ul", { className: "grid font-bold", children: secondaryNavs.map((navItem) => /* @__PURE__ */ jsx136("li", { children: /* @__PURE__ */ jsxs119(
              NavLink,
              {
          ...
          /* @__PURE__ */ jsxs119("aside", { className: "border-t px-6 py-4", children: [
            /* @__PURE__ */ jsxs119("span", { className: "flex items-center gap-1 mb-4 font-satoshi-bold", children: [
              /* @__PURE__ */ jsx136(Svg, { src: icons.themeIcon }),
              "Theme"
            ] }),
            /* @__PURE__ */ jsxs119(
              Toggletip,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx136("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "System default" }),
                  /* @__PURE__ */ jsx136("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Light" }),
                  /* @__PURE__ */ jsx136("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Dark" })
                ]
              }
            )
          ] })
...
function PartnerNavigation({ show }) {
  ...
  return show ? /* @__PURE__ */ jsxs120("header", { className: "bg-secondary border-r hidden sm:flex flex-col justify-between min-w-[280px] h-full", children: [
    /* @__PURE__ */ jsxs120("nav", { className: "py-6", children: [
      /* @__PURE__ */ jsx137("span", { className: "inline-block mb-2 px-6 py-3 font-satoshi-bold", children: "Navigation Menu" }),
      /* @__PURE__ */ jsx137("ul", { className: "grid gap-2 font-bold", children: navs.map((navItem) => /* @__PURE__ */ jsx137("li", { children: /* @__PURE__ */ jsxs120(
        NavLink2,
        {
          to: navItem.url,
      ...
      /* @__PURE__ */ jsx137(Accordion2, { type: "single", collapsible: !0, className: "w-full mt-2", children: navsWSubs.map((item) => /* @__PURE__ */ jsxs120(AccordionItem2, { value: item.label, className: "group", children: [
        /* @__PURE__ */ jsxs120(
          AccordionTrigger2,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs120("span", { className: "flex gap-3 items-center", children: [
                /* @__PURE__ */ jsx137(Svg, { src: item.icon }),
                item.label
              ] }),
              /* @__PURE__ */ jsx137(Svg, { src: icons.arrowDownIcon, className: "group-[[data-state=open]]:rotate-180 transition-transform duration-200" })
            ]
          }
        ),
        /* @__PURE__ */ jsx137(AccordionContent2, { children: /* @__PURE__ */ jsx137("ul", { className: "list-disc list-inside p-3", children: item.subitems.map((subitem) => /* @__PURE__ */ jsx137("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx137(
          NavLink2,
          {
            to: subitem.url,
            className: ({ isActive }) => `${isActive ? "active" : ""}`,
    ...
    /* @__PURE__ */ jsxs120("aside", { className: "border-t  px-6 py-3", children: [
      /* @__PURE__ */ jsxs120("span", { className: "flex items-center gap-1 mb-2 font-satoshi-bold", children: [
...
function Layout({ children }) {
  ...
  }, []), /* @__PURE__ */ jsxs121("div", { className: "bg-tertiary text-admin-pry", children: [
    /* @__PURE__ */ jsx138(PartnerPrimaryHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx138(UserMobileHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx138(PartnerMobileNavigation, { onClose: () => {
      setShowNav(!1);
    }, show: showNav }),
    /* @__PURE__ */ jsxs121("div", { className: "sm:flex sm:h-[calc(100vh-85px)]", children: [
      /* @__PURE__ */ jsx138(PartnerNavigation, { show: showNav }),
      /* @__PURE__ */ jsx138("div", { className: "flex-grow overflow-y-auto", children })
    ] })
  ] });
}
function PartnerLayout() {
  return /* @__PURE__ */ jsx138(Layout, { children: /* @__PURE__ */ jsx138(Outlet3, {}) });
}
function ErrorBoundary2() {
  let { pathname } = useLocation11();
  return /* @__PURE__ */ jsx138(Layout, { children: /* @__PURE__ */ jsxs121("div", { className: "w-full max-sm:h-[calc(100dvh-73px)] p-5 m-auto lg:max-w-3xl grid place-content-center text-center gap-5", children: [
    /* @__PURE__ */ jsx138("h2", { className: "text-xl font-bold text-red-500", children: "Something went wrong" }),
    /* @__PURE__ */ jsx138("p", { children: "Apologies, something went wrong on our end. Please try again." }),
    /* @__PURE__ */ jsx138(Cta_default, { element: "link", to: pathname, className: "px-4 py-1 rounded-md", children: "Reload page" }),
    /* @__PURE__ */ jsx138(Cta_default, { element: "link", to: "/partner/overview", className: "px-4 py-1 rounded-md", children: "Back to Partner Home" })
  ] }) });
}
...
function Footer() {
  return /* @__PURE__ */ jsx139("footer", { className: "border-t border-primary py-8", children: /* @__PURE__ */ jsxs122("div", { className: "wrapper flex flex-wrap gap-6 gap-x-12 justify-between font-bold", children: [
    /* @__PURE__ */ jsx139("nav", { className: "flex gap-6 items-center", children: /* @__PURE__ */ jsxs122("ul", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsx139("li", { children: /* @__PURE__ */ jsx139(Link30, { to: "/contests", children: "Contests" }) }),
      /* @__PURE__ */ jsx139("li", { children: /* @__PURE__ */ jsx139(Link30, { to: "/#contact", children: "Contact" }) }),
      /* @__PURE__ */ jsx139("li", { children: /* @__PURE__ */ jsx139(Link30, { to: "/winners", children: "Winners" }) }),
      /* @__PURE__ */ jsx139("li", { children: /* @__PURE__ */ jsx139(Link30, { to: "/results", children: "Results" }) })
    ] }) }),
    /* @__PURE__ */ jsx139("span", { children: "Privacy Policy" }),
    /* @__PURE__ */ jsx139("span", { className: "md:order-first", children: "KOTMY \xA9 2023  All rights reserved" })
  ] }) });
}

// app/components/public/Navigation.tsx
import { useEffect as useEffect37, useState as useState47 } from "react";
import { Link as Link32, NavLink as NavLink4, useLocation as useLocation13 } from "@remix-run/react";

// app/components/public/MobileNavigation.tsx
import { Link as Link31, NavLink as NavLink3, useLocation as useLocation12 } from "@remix-run/react";
...
function MobileNavigation({ show, onClose }) {
  let { pathname } = useLocation12(), [user, setUser] = useState46(null), mobileNav = useRef15(null);
  ...
  return useEffect36(() => {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs123("header", { className: "wrapper py-5", children: [
          /* @__PURE__ */ jsxs123("div", { className: "flex justify-between items-center", children: [
            /* @__PURE__ */ jsx140(Link31, { to: "/", onClick: onClose, "aria-label": "home", children: /* @__PURE__ */ jsx140(Svg, { src: icons.logoIcon, width: 37, height: 36 }) }),
            /* @__PURE__ */ jsx140("button", { onClick: onClose, title: "close menu", className: "flex gap-1 items-center rounded p-2 hover:outline outline-primary", children: /* @__PURE__ */ jsx140(Svg, { src: icons.closeIcon, width: 24, height: 24, className: "sm:hidden" }) })
          ] }),
          /* @__PURE__ */ jsxs123("nav", { className: "", children: [
            /* @__PURE__ */ jsxs123("ul", { className: "grid gap-6 my-12 text-xl font-bold", children: [
              /* @__PURE__ */ jsx140("li", { children: /* @__PURE__ */ jsxs123(NavLink3, { onClick: onClose, to: "/partner/account", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/partner/account") ? /* @__PURE__ */ jsx140(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Partner"
              ] }) }),
              /* @__PURE__ */ jsx140("li", { children: /* @__PURE__ */ jsxs123(NavLink3, { onClick: onClose, to: "/contests", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/contests") ? /* @__PURE__ */ jsx140(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Contests"
              ] }) }),
              /* @__PURE__ */ jsx140("li", { children: /* @__PURE__ */ jsxs123(NavLink3, { onClick: onClose, to: "/winners", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/winners") ? /* @__PURE__ */ jsx140(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Winners"
              ] }) }),
              /* @__PURE__ */ jsx140("li", { children: /* @__PURE__ */ jsxs123(NavLink3, { onClick: onClose, to: "/results", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/results") ? /* @__PURE__ */ jsx140(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Results"
              ] }) }),
              /* @__PURE__ */ jsx140("li", { children: /* @__PURE__ */ jsxs123(NavLink3, { onClick: onClose, to: "/marketplace", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/marketplace") ? /* @__PURE__ */ jsx140(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Shop"
              ] }) }),
              /* @__PURE__ */ jsx140("li", { children: /* @__PURE__ */ jsx140(NavLink3, { onClick: onClose, to: "/login", className: "", children: user ? "My Profile" : "Sign In" }) })
            ] }),
            /* @__PURE__ */ jsx140(Button, { element: "a", onClick: onClose, href: "/signup", className: "block w-full sm:w-auto", children: "Join Now" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs123("aside", { className: "wrapper py-5", children: [
          /* @__PURE__ */ jsxs123("div", { className: "mb-12", children: [
            /* @__PURE__ */ jsx140("span", { className: "block font-satoshi-black mb-2", children: "Follow Us" }),
            /* @__PURE__ */ jsxs123("span", { className: "flex gap-4", children: [
              /* @__PURE__ */ jsx140(Svg, { src: icons.twitterXIcon, width: "24px", height: "24px" }),
              /* @__PURE__ */ jsx140(Svg, { src: icons.instagramIcon, width: "24px", height: "24px" }),
              /* @__PURE__ */ jsx140(Svg, { src: icons.facebookIcon, width: "24px", height: "24px" }),
              /* @__PURE__ */ jsx140(Svg, { src: icons.youtubeIcon, width: "24px", height: "24px" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs123("div", { className: "flex gap-6 justify-between items-end font-satoshi-bold", children: [
            /* @__PURE__ */ jsx140("span", { className: "text-sm whitespace-nowrap", children: "KOTMY \xA9 2023  All rights reserved" }),
            /* @__PURE__ */ jsx140("span", { className: "text-xs whitespace-nowrap", children: "Privacy Policy" })
          ] })
        ] })
      ]
    }
...
function Navigation() {
  let { getUserStoreManager } = useUserManager(), [showNav, setShowNav] = useState47(!1), { pathname } = useLocation13(), [user, setUser] = useState47(null);
  return useEffect37(() => {
    let user2 = getUserStoreManager();
    setUser(user2);
  }, []), /* @__PURE__ */ jsxs124("header", { className: "flex justify-between items-center wrapper py-5", children: [
    /* @__PURE__ */ jsx141(Link32, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx141(Svg, { src: icons.logoIcon, className: "w-9 h-9 sm:w-16 sm:h-16" }) }),
    /* @__PURE__ */ jsxs124("nav", { className: "hidden md:flex gap-16 items-center", children: [
      /* @__PURE__ */ jsxs124("ul", { className: "flex gap-6 text-xl font-bold", children: [
        /* @__PURE__ */ jsx141("li", { children: /* @__PURE__ */ jsxs124(NavLink4, { to: "/partner/account", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/partner/account") ? /* @__PURE__ */ jsx141(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Partner"
        ] }) }),
        /* @__PURE__ */ jsx141("li", { children: /* @__PURE__ */ jsxs124(NavLink4, { to: "/contests", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/contests") ? /* @__PURE__ */ jsx141(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Contests"
        ] }) }),
        /* @__PURE__ */ jsx141("li", { children: /* @__PURE__ */ jsxs124(NavLink4, { to: "/winners", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/winners") ? /* @__PURE__ */ jsx141(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Winners"
        ] }) }),
        /* @__PURE__ */ jsx141("li", { children: /* @__PURE__ */ jsxs124(NavLink4, { to: "/results", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/results") ? /* @__PURE__ */ jsx141(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Results"
        ] }) }),
        /* @__PURE__ */ jsx141("li", { children: /* @__PURE__ */ jsxs124(NavLink4, { to: "/marketplace", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/marketplace") ? /* @__PURE__ */ jsx141(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Shop"
        ] }) }),
        /* @__PURE__ */ jsx141("li", { children: /* @__PURE__ */ jsx141(NavLink4, { to: "/login", className: "", children: user ? "My Profile" : "Sign In" }) })
      ] }),
      /* @__PURE__ */ jsx141(Button, { element: "a", href: "/signup", children: "Join Now" })
    ] }),
    /* @__PURE__ */ jsx141(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx141(Svg, { src: icons.hamburgerIcon, width: 40, height: 24 })
      }
    ),
    /* @__PURE__ */ jsx141(MobileNavigation, { onClose: () => {
      setShowNav(!1);
    }, show: showNav })
  ] });
}
...
function Index() {
  return /* @__PURE__ */ jsxs125("div", { className: "min-h-screen bg-primary flex flex-col", children: [
    /* @__PURE__ */ jsx142(Navigation, {}),
    /* @__PURE__ */ jsx142(Outlet4, {}),
    /* @__PURE__ */ jsx142(Footer, {})
  ] });
}
...
import { Link as Link33, useSearchParams as useSearchParams4 } from "@remix-run/react";
...
function Logout() {
  return useLogoutController(), /* @__PURE__ */ jsxs126("main", { className: "h-dvh bg-secondary p-4 flex flex-col", children: [
    /* @__PURE__ */ jsx143(Link33, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx143(Svg, { src: icons.logoIcon, className: "w-14 h-14 sm:w-16 sm:h-16 cursor-pointer" }) }),
    /* @__PURE__ */ jsxs126("main", { className: "h-dvh bg-secondary p-4 flex flex-col justify-center items-center", children: [
      /* @__PURE__ */ jsx143("h1", { className: "text-2xl font-satoshi-bold text-center", children: "You have been logged out" }),
      /* @__PURE__ */ jsx143(Link33, { to: "/login", className: "mt-4 text-center underline", children: "Login again" })
    ] })
  ] });
}
...
import { Form as Form38, Link as Link34, useActionData as useActionData17, useNavigate as useNavigate27, useSearchParams as useSearchParams5 } from "@remix-run/react";
import { json as json50 } from "@remix-run/node";
...
async function action30({ request }) {
  ...
  return error ? { error: error.detail?.toString() || "An error occurred during login.", data: null } : headers?.["Set-Cookie"] ? (responseHeaders = { "Set-Cookie": headers?.["Set-Cookie"] }, json50({ data, error: null }, {
    headers: responseHeaders
  })) : json50({ error, data, headers });
}
...
function Signup() {
  ...
  return /* @__PURE__ */ jsxs127("main", { className: "bg-secondary p-4 flex flex-col", children: [
    /* @__PURE__ */ jsx144(Link34, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx144(Svg, { src: icons.logoIcon, className: "w-14 h-14 sm:w-16 sm:h-16" }) }),
    /* @__PURE__ */ jsx144("section", { className: "grow flex flex-col justify-center items-center", children: /* @__PURE__ */ jsxs127(Form38, { method: "POST", encType: "multipart/form-data", className: "w-full max-w-md p-4 sm:p-8 bg-white border rounded-3xl flex flex-col gap-3", children: [
      /* @__PURE__ */ jsx144("div", { className: "w-max mx-auto p-4 border border-disabled rounded-full bg-gradient-to-b from-slate-200 to-white", children: /* @__PURE__ */ jsx144("div", { className: "w-max p-4 border border-disabled rounded-full bg-white", children: /* @__PURE__ */ jsx144("img", { src: admin_avatar_default, alt: "person silhouette", width: 24, height: 24 }) }) }),
      /* @__PURE__ */ jsx144("h1", { className: "text-2xl font-satoshi-bold text-center", children: "Create your account" }),
      /* @__PURE__ */ jsx144("hr", {}),
      /* @__PURE__ */ jsxs127("p", { className: "text-center text-sm mt-2", children: [
        "Already have an account? ",
        /* @__PURE__ */ jsx144(Link34, { to: "/login", className: "text-primary underline", children: "Login" })
      ] }),
      /* @__PURE__ */ jsxs127("div", { className: "my-2 flex flex-col gap-3", children: [
        /* @__PURE__ */ jsx144(FormControl, { as: "input", id: "first_name", name: "first_name", placeholder: "First Name", labelText: "First Name", icon: icons.avatarIcon, required: !0 }),
        /* @__PURE__ */ jsx144(FormControl, { as: "input", id: "last_name", name: "last_name", placeholder: "Last Name", labelText: "Last Name", icon: icons.avatarIcon, required: !0 }),
        /* @__PURE__ */ jsx144(FormControl, { as: "input", id: "email", name: "email", placeholder: "Enter your email address", labelText: "Email", icon: icons.avatarIcon, required: !0 }),
        /* @__PURE__ */ jsx144(FormControl, { as: "input", id: "password", name: "password", placeholder: "Enter your password", labelText: "Password", type: "password", icon: icons.lockIcon, required: !0 }),
        /* @__PURE__ */ jsx144(FormControl, { as: "input", id: "status", name: "status", placeholder: "Status (optional)", labelText: "Status", icon: icons.avatarIcon }),
        /* @__PURE__ */ jsxs127("label", { htmlFor: "image", className: "flex items-center gap-2 text-sm font-medium text-gray-700", children: [
          /* @__PURE__ */ jsx144(Svg, { src: icons.avatarIcon, className: "w-4 h-4" }),
          "Profile Image"
        ] }),
        /* @__PURE__ */ jsx144(DragnDrop, { className: "sm:col-span-2", name: "image", multiple: !1, labelText: "Upload profile photo" })
      ] }),
      /* @__PURE__ */ jsx144(Cta_default, { element: "button", type: "submit", className: "rounded-lg p-3", children: "Sign Up" })
    ] }) })
  ] });
}
...
import { useEffect as useEffect40, useRef as useRef16, useState as useState48 } from "react";
...
function AdminMobileNavigation({ show, onClose }) {
  ...
  let { getUserStoreManager, hasAcceptedRole } = useUserManager(), userRoles = getUserStoreManager()?.roles.map((r) => r.toLowerCase()) ?? [], [user, setUser] = useState48(null);
  useEffect40(() => {
    setUser(getUserStoreManager());
  }, [getUserStoreManager]);
  let mainComponent = /* @__PURE__ */ jsxs128("div", { className: "flex justify-between items-center border rounded-lg p-2 text-sm cursor-pointer line-clamp-1 hover:outline outline-1 outline-primary", children: [
    "System default",
    /* @__PURE__ */ jsx145(Svg, { src: icons.arrowDownIcon })
  ] });
  return /* @__PURE__ */ jsxs128(
    "div",
    {
      ...
      className: "mobileNav sm:hidden flex flex-col fixed w-full h-dvh top-0 z-10 data-[show=true]:animate-slide-in-left data-[show=false]:left-full data-[show=false]:animate-slide-out-left bg-secondary overflow-y-auto",
      children: [
        /* @__PURE__ */ jsxs128("div", { className: "flex justify-between items-center py-4 px-6 border-b", children: [
          /* @__PURE__ */ jsx145("span", { className: "font-satoshi-bold", children: "NAVIGATION MENU" }),
          /* @__PURE__ */ jsx145(
            "button",
            {
              onClick: onClose,
              title: "open Menu",
              className: "flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
              children: /* @__PURE__ */ jsx145(Svg, { src: icons.closeIcon })
            }
          )
        ] }),
        /* @__PURE__ */ jsxs128("div", { className: "flex flex-col justify-between grow", children: [
          /* @__PURE__ */ jsxs128("header", { children: [
            /* @__PURE__ */ jsxs128("nav", { "aria-label": "primary navigation", children: [
              /* @__PURE__ */ jsxs128("div", { className: "flex gap-3 items-center bg-white px-6 py-2 border-b", children: [
                /* @__PURE__ */ jsx145("span", { className: "p-2 border border-disabled rounded-full", children: /* @__PURE__ */ jsx145("img", { src: admin_avatar_default, alt: "cartoon head", width: 24, height: 24 }) }),
                /* @__PURE__ */ jsxs128("span", { className: "grid", children: [
                  /* @__PURE__ */ jsx145("span", { className: "block text-sm font-satoshi-bold", children: user?.fullName }),
                  /* @__PURE__ */ jsx145("span", { className: "block text-xs font-satoshi-medium", children: user?.email })
                ] })
              ] }),
              /* @__PURE__ */ jsx145(Accordion, { type: "single", collapsible: !0, className: "w-full py-2 border-b", children: /* @__PURE__ */ jsx145("ul", { className: "grid gap-2 font-bold", children: primaryNavs2.map((navItem) => navItem.subitems ? /* @__PURE__ */ jsxs128(AccordionItem, { value: navItem.label, className: "group", children: [
                /* @__PURE__ */ jsx145(
                  AccordionTrigger,
                  {
                    className: cn("border-l-4 border-transparent px-6 py-3 font-semibold hover:bg-[#EEF0FF]", {
                    ...
                    children: /* @__PURE__ */ jsxs128("span", { className: "flex gap-3 items-center", children: [
                      /* @__PURE__ */ jsx145(Svg, { src: navItem.icon }),
                      navItem.label
                    ] })
                  }
                ),
                /* @__PURE__ */ jsx145(AccordionContent, { children: /* @__PURE__ */ jsx145("ul", { className: "list-disc list-inside p-3 font-normal", children: navItem.subitems.map((subitem) => /* @__PURE__ */ jsx145("li", { className: `py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]${hasAcceptedRole(user, subitem.acceptedRoles ?? []) ? "" : " hidden "}`, children: /* @__PURE__ */ jsx145(
                  NavLink5,
                  {
                    to: subitem.url,
                    onClick: onClose,
              ...
              ] }, navItem.label) : /* @__PURE__ */ jsx145("li", { children: /* @__PURE__ */ jsxs128(
                NavLink5,
                {
            ...
            /* @__PURE__ */ jsx145("nav", { className: "my-1", "aria-label": "secondary navigation", children: /* @__PURE__ */ jsx145("ul", { className: "grid font-bold", children: secondaryNavs2.map((navItem) => /* @__PURE__ */ jsx145("li", { children: /* @__PURE__ */ jsxs128(
              NavLink5,
              {
                className: "flex gap-3 items-center px-6 py-3 font-semibold border-l-4 hover:bg-[#EEF0FF] border-transparent",
                to: navItem.url,
          ...
          /* @__PURE__ */ jsxs128("aside", { className: "border-t px-6 py-4", children: [
            /* @__PURE__ */ jsxs128("span", { className: "flex items-center gap-1 mb-4 font-satoshi-bold", children: [
              /* @__PURE__ */ jsx145(Svg, { src: icons.themeIcon }),
              "Theme"
            ] }),
            /* @__PURE__ */ jsxs128(
              Toggletip,
              {
                ...
                childContainerClass: "bottom-[110%] left-0 bg-tertiary p-2 border text-sm whitespace-nowrap",
                children: [
                  /* @__PURE__ */ jsx145("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "System default" }),
                  /* @__PURE__ */ jsx145("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Light" }),
                  /* @__PURE__ */ jsx145("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Dark" })
                ]
              }
            )
          ] })
...
function MobileHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs129("div", { className: "flex sm:hidden items-center gap-4 p-4 border-b", children: [
    /* @__PURE__ */ jsxs129(Link35, { to: "/", className: "text-accent flex items-center gap-3 sm:gap-6 whitespace-nowrap font-satoshi-black", children: [
...
function AdminNavigation({ show }) {
  let { getUserStoreManager, hasAcceptedRole } = useUserManager(), userRoles = getUserStoreManager()?.roles.map((r) => r.toLowerCase()) ?? [], [user, setUser] = useState49(null), userRolesSet = new Set(userRoles);
  useEffect41(() => {
    setUser(getUserStoreManager());
  }, [getUserStoreManager]);
  ...
  let mainComponent = /* @__PURE__ */ jsxs130("div", { className: "flex justify-between items-center border  rounded-lg p-2 text-sm cursor-pointer line-clamp-1 hover:outline outline-1 outline-primary", children: [
    "System default",
    /* @__PURE__ */ jsx147(Svg, { src: icons.arrowDownIcon })
  ] });
  return show ? /* @__PURE__ */ jsxs130("header", { className: "bg-secondary border-r hidden sm:flex flex-col justify-between min-w-[280px]", children: [
    /* @__PURE__ */ jsxs130("nav", { className: "py-6", children: [
      ...
      /* @__PURE__ */ jsx147("ul", { className: "grid gap-2 font-bold", children: navs2.map((navItem) => /* @__PURE__ */ jsx147("li", { children: /* @__PURE__ */ jsxs130(
        NavLink6,
        {
          to: navItem.url,
      ...
      /* @__PURE__ */ jsx147(Accordion3, { type: "single", collapsible: !0, className: "w-full mt-2", children: navsWSubs2.map((item) => /* @__PURE__ */ jsxs130(AccordionItem3, { value: item.label, className: "group", children: [
        /* @__PURE__ */ jsxs130(
          AccordionTrigger3,
          {
            className: cn("border-l-4 border-transparent group w-full flex gap-3 items-center justify-between px-6 py-3 font-semibold hover:bg-[#EEF0FF]", {
        ...
        /* @__PURE__ */ jsx147(AccordionContent3, { children: /* @__PURE__ */ jsx147("ul", { className: "list-disc list-inside p-3", children: item.subitems.map((subitem) => /* @__PURE__ */ jsx147("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx147(
          NavLink6,
          {
            to: subitem.url,
    ...
    /* @__PURE__ */ jsxs130("aside", { className: "border-t  px-6 py-3", children: [
      ...
      /* @__PURE__ */ jsxs130(
        Toggletip,
        {
          ...
          childContainerClass: "bottom-[110%] left-0 bg-tertiary p-2 border  text-xs whitespace-nowrap",
          children: [
            /* @__PURE__ */ jsx147("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "System default" }),
            /* @__PURE__ */ jsx147("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Light" }),
            /* @__PURE__ */ jsx147("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Dark" })
          ]
        }
      )
    ] })
...
function AdminToolbar() {
  let mainComponent = /* @__PURE__ */ jsxs131(
    "div",
    {
      tabIndex: 0,
      className: "relative p-2 rounded-full border flex items-center gap-4 cursor-pointer bg-tertiary hover:bg-[#EEF0FF]",
      children: [
        /* @__PURE__ */ jsxs131("div", { className: "flex gap-3 items-center", children: [
          ...
          /* @__PURE__ */ jsxs131("span", { className: "grid", children: [
            /* @__PURE__ */ jsx148("span", { className: "block text-sm font-satoshi-bold", children: "Admin" }),
            /* @__PURE__ */ jsx148("span", { className: "block text-xs font-satoshi-medium", children: "admin@kotmy.com" })
          ] })
        ] }),
  ...
  return /* @__PURE__ */ jsxs131(
    Toggletip,
    {
      ...
      childContainerClass: "top-[110%] right-0 bg-tertiary p-2 border  text-xs whitespace-nowrap",
      children: [
        /* @__PURE__ */ jsxs131(Link36, { to: "/user/profile", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx148(Svg, { src: icons.profileIcon }),
          " Profile"
        ] }),
        /* @__PURE__ */ jsxs131(Link36, { to: "/logout", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx148(Svg, { src: icons.signoutIcon }),
          " Sign Out"
        ] })
      ]
    }
...
function PrimaryHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs132("header", { className: "h-[85px] hidden sm:flex justify-between items-center gap-4 px-6 py-3 bg-secondary border-b", children: [
    /* @__PURE__ */ jsxs132("div", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsx149(
        "button",
        {
          onClick: toggleNav,
          title: "Toggle Menu",
          className: "flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
          children: /* @__PURE__ */ jsx149(Svg, { src: icons.adminHamburgerIcon, width: 40, height: 24 })
        }
      ),
      /* @__PURE__ */ jsxs132(Link37, { to: "/", className: "text-accent flex items-center gap-6 whitespace-nowrap font-satoshi-black", children: [
        /* @__PURE__ */ jsx149(Svg, { src: icons.logoIcon, width: 37, height: 36 }),
        "KOTMY-ADMIN"
      ] })
    ] }),
    /* @__PURE__ */ jsx149(FormControl, { as: "input", type: "search", className: "min-w-[280px] bg-white", placeholder: "Search..." }),
    /* @__PURE__ */ jsx149(AdminToolbar, {})
  ] });
}
...
function Layout2({ children }) {
  let [showNav, setShowNav] = useState50(!1);
  return useEffect42(() => {
    setShowNav(window.innerWidth >= 640);
  }, []), /* @__PURE__ */ jsxs133("div", { className: "bg-tertiary text-admin-pry", children: [
    /* @__PURE__ */ jsx150(PrimaryHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx150(MobileHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx150(AdminMobileNavigation, { onClose: () => {
      setShowNav(!1);
    }, show: showNav }),
    /* @__PURE__ */ jsxs133("div", { className: "sm:flex sm:h-[calc(100vh-85px)]", children: [
      /* @__PURE__ */ jsx150(AdminNavigation, { show: showNav }),
      children
    ] })
  ] });
}
function AdminLayout() {
  return /* @__PURE__ */ jsx150(Layout2, { children: /* @__PURE__ */ jsx150(Outlet5, {}) });
}
function ErrorBoundary3() {
  let { pathname } = useLocation16();
  return /* @__PURE__ */ jsx150(Layout2, { children: /* @__PURE__ */ jsxs133("div", { className: "w-full max-sm:h-[calc(100dvh-73px)] p-5 m-auto lg:max-w-3xl grid place-content-center text-center gap-5", children: [
    ...
    /* @__PURE__ */ jsx150(Cta_default, { element: "link", to: "/admin/overview", className: "px-4 py-1 rounded-md", children: "Back to Admin Home" })
  ] }) });
}
...
import { Form as Form39, Link as Link38, useActionData as useActionData18, useNavigate as useNavigate28, useSearchParams as useSearchParams6 } from "@remix-run/react";
...
async function action31({ request }) {
  ...
  let responseHeaders = {};
  return headers?.["Set-Cookie"] ? (responseHeaders = { "Set-Cookie": headers?.["Set-Cookie"] }, json51({ data, error: null }, {
    headers: responseHeaders
  })) : json51({ data, error: null });
}
...
function Login() {
  ...
  return /* @__PURE__ */ jsxs134("main", { className: "h-dvh bg-secondary p-4 flex flex-col", children: [
    /* @__PURE__ */ jsx151(Link38, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx151(Svg, { src: icons.logoIcon, className: "w-14 h-14 sm:w-16 sm:h-16" }) }),
    /* @__PURE__ */ jsx151("section", { className: "grow flex flex-col justify-center items-center", children: /* @__PURE__ */ jsxs134(Form39, { method: "POST", className: "w-full max-w-md p-4 sm:p-8 bg-white border rounded-3xl flex flex-col gap-3", children: [
      /* @__PURE__ */ jsx151("div", { className: "w-max mx-auto p-4 border border-disabled rounded-full bg-gradient-to-b from-slate-200 to-white", children: /* @__PURE__ */ jsx151("div", { className: "w-max p-4 border border-disabled rounded-full bg-white", children: /* @__PURE__ */ jsx151("img", { src: admin_avatar_default, alt: "person silhouette", width: 24, height: 24 }) }) }),
      /* @__PURE__ */ jsx151("h1", { className: "text-2xl font-satoshi-bold text-center", children: "Enter your details to login" }),
      /* @__PURE__ */ jsx151("hr", {}),
      /* @__PURE__ */ jsxs134("p", { className: "text-center text-sm mt-2", children: [
        "Don't have an account yet? ",
        /* @__PURE__ */ jsx151(Link38, { to: "/signup", className: "text-primary underline", children: "Register" })
      ] }),
      /* @__PURE__ */ jsxs134("div", { className: "my-2 flex flex-col gap-3", children: [
        /* @__PURE__ */ jsx151(
          FormControl,
          {
            as: "input",
      ...
      /* @__PURE__ */ jsx151(Cta_default, { element: "button", type: "submit", className: "rounded-lg p-3", children: "Login" })
    ] }) })
  ] });
}
...
import { Link as Link39, useNavigate as useNavigate29 } from "@remix-run/react";
...
function UserToolbar() {
  let [user, setUser] = useState51(null), { getUserStoreManager } = useUserManager(), navigate = useNavigate29();
  useEffect44(() => {
    let currentUser = getUserStoreManager();
    currentUser || navigate("/login"), setUser(currentUser);
  }, []);
  let mainComponent = /* @__PURE__ */ jsxs135(
    "div",
    {
      tabIndex: 0,
      className: "relative p-2 rounded-full border flex items-center gap-4 cursor-pointer bg-tertiary hover:bg-[#EEF0FF]",
      children: [
        /* @__PURE__ */ jsxs135("div", { className: "flex gap-3 items-center", children: [
          /* @__PURE__ */ jsx152("span", { className: "p-2 border border-disabled rounded-full", children: /* @__PURE__ */ jsx152("img", { src: admin_avatar_default, alt: "cartoon head", width: 24, height: 24 }) }),
          /* @__PURE__ */ jsxs135("span", { className: "grid", children: [
            /* @__PURE__ */ jsx152("span", { className: "block text-sm font-satoshi-bold", children: user?.fullName }),
            /* @__PURE__ */ jsx152("span", { className: "block text-xs font-satoshi-medium", children: user?.email })
          ] })
        ] }),
        /* @__PURE__ */ jsx152(Svg, { src: icons.arrowDownIcon })
      ]
    }
  );
  return /* @__PURE__ */ jsxs135(
    Toggletip,
    {
      ...
      childContainerClass: "top-[110%] right-0 bg-tertiary p-2 border  text-xs whitespace-nowrap",
      children: [
        /* @__PURE__ */ jsxs135(Link39, { to: "/user/profile", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx152(Svg, { src: icons.profileIcon }),
          " Profile"
        ] }),
        /* @__PURE__ */ jsxs135(Link39, { to: "/logout", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx152(Svg, { src: icons.signoutIcon }),
          " Sign Out"
        ] })
      ]
    }
...
function UserPrimaryHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs136("header", { className: "h-[85px] hidden sm:flex justify-between items-center gap-4 px-6 py-3 bg-secondary border-b", children: [
    /* @__PURE__ */ jsxs136("div", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsx153(
        "button",
        {
          onClick: toggleNav,
          title: "Toggle Menu",
          className: "flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
          children: /* @__PURE__ */ jsx153(Svg, { src: icons.adminHamburgerIcon, width: 40, height: 24 })
        }
      ),
      /* @__PURE__ */ jsxs136(Link40, { to: "/", className: "text-accent flex items-center gap-6 whitespace-nowrap font-satoshi-black", children: [
        /* @__PURE__ */ jsx153(Svg, { src: icons.logoIcon, width: 37, height: 36 }),
        "KOTMY-USER"
      ] })
    ] }),
    /* @__PURE__ */ jsx153(FormControl, { as: "input", type: "search", className: "min-w-[280px] bg-white", placeholder: "Search..." }),
    /* @__PURE__ */ jsx153(UserToolbar, {})
  ] });
}
...
function UserMobileHeader2({ toggleNav }) {
  return /* @__PURE__ */ jsxs137("div", { className: "flex sm:hidden items-center gap-4 p-4 border-b", children: [
    /* @__PURE__ */ jsxs137(Link41, { to: "/", className: "text-accent flex items-center gap-3 sm:gap-6 whitespace-nowrap font-satoshi-black", children: [
    ...
    /* @__PURE__ */ jsx154(
      "button",
      {
        ...
        title: "open Menu",
        className: "ml-auto flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
        children: /* @__PURE__ */ jsx154(Svg, { src: icons.adminHamburgerIcon, width: 30, height: 24 })
      }
    )
  ] });
}
...
import { useEffect as useEffect45, useRef as useRef17, useState as useState52 } from "react";
...
function UserMobileNavigation({ show, onClose }) {
  let mobileNav = useRef17(null), [user, setUser] = useState52(null), navigate = useNavigate30(), { getUserStoreManager } = useUserManager();
  useEffect45(() => {
    let currentUser = getUserStoreManager();
        ...
        /* @__PURE__ */ jsxs138("div", { className: "flex flex-col justify-between grow", children: [
          /* @__PURE__ */ jsxs138("header", { children: [
            /* @__PURE__ */ jsxs138("nav", { "aria-label": "primary navigation", children: [
              ...
              /* @__PURE__ */ jsx155(Accordion, { type: "single", collapsible: !0, className: "w-full py-2 border-b", children: /* @__PURE__ */ jsx155("ul", { className: "grid gap-2 font-bold", children: primaryNavs3.map((navItem) => navItem.subitems ? /* @__PURE__ */ jsxs138(AccordionItem, { value: navItem.label, className: "group", children: [
                /* @__PURE__ */ jsx155(
                  AccordionTrigger,
                  {
                    className: cn("border-l-4 border-transparent px-6 py-3 font-semibold hover:bg-[#EEF0FF]", {
                ...
                /* @__PURE__ */ jsx155(AccordionContent, { children: /* @__PURE__ */ jsx155("ul", { className: "list-disc list-inside p-3 font-normal", children: navItem.subitems.map((subitem) => /* @__PURE__ */ jsx155("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx155(
                  NavLink7,
                  {
                    to: subitem.url,
                    onClick: onClose,
            ...
            /* @__PURE__ */ jsx155("nav", { className: "my-1", "aria-label": "secondary navigation", children: /* @__PURE__ */ jsx155("ul", { className: "grid font-bold", children: secondaryNavs3.map((navItem) => /* @__PURE__ */ jsx155("li", { children: /* @__PURE__ */ jsxs138(
              NavLink7,
              {
                className: "flex gap-3 items-center px-6 py-3 font-semibold border-l-4 hover:bg-[#EEF0FF] border-transparent",
                to: navItem.url,
...
function UserNavigation({ show }) {
  ...
  return show ? /* @__PURE__ */ jsxs139("header", { className: "bg-secondary border-r hidden sm:flex flex-col justify-between min-w-[280px] h-full", children: [
    /* @__PURE__ */ jsxs139("nav", { className: "py-6", children: [
      /* @__PURE__ */ jsx156("span", { className: "inline-block mb-2 px-6 py-3 font-satoshi-bold", children: "Navigation Menu" }),
      /* @__PURE__ */ jsx156("ul", { className: "grid gap-2 font-bold", children: navs3.map((navItem) => /* @__PURE__ */ jsx156("li", { children: /* @__PURE__ */ jsxs139(
        NavLink8,
        {
          to: navItem.url,
          className: ({ isActive }) => `${isActive ? "text-accent bg-[#EEF0FF] border-accent" : "border-transparent"} flex gap-3 items-center px-6 py-3 font-semibold border-l-4 hover:bg-[#EEF0FF]`,
      ...
      /* @__PURE__ */ jsx156(Accordion4, { type: "single", collapsible: !0, className: "w-full mt-2", children: navsWSubs3.map((item) => /* @__PURE__ */ jsxs139(AccordionItem4, { value: item.label, className: "group", children: [
        /* @__PURE__ */ jsxs139(
          AccordionTrigger4,
          {
            className: cn("border-l-4 border-transparent group w-full flex gap-3 items-center justify-between px-6 py-3 font-semibold hover:bg-[#EEF0FF]", {
            ...
            children: [
              /* @__PURE__ */ jsxs139("span", { className: "flex gap-3 items-center", children: [
                /* @__PURE__ */ jsx156(Svg, { src: item.icon }),
                item.label
              ] }),
              /* @__PURE__ */ jsx156(Svg, { src: icons.arrowDownIcon, className: "group-[[data-state=open]]:rotate-180 transition-transform duration-200" })
            ]
          }
        ),
        /* @__PURE__ */ jsx156(AccordionContent4, { children: /* @__PURE__ */ jsx156("ul", { className: "list-disc list-inside p-3", children: item.subitems.map((subitem) => /* @__PURE__ */ jsx156("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx156(
          NavLink8,
          {
            to: subitem.url,
            className: ({ isActive }) => `${isActive ? "active" : ""}`,
    ...
    /* @__PURE__ */ jsxs139("aside", { className: "border-t  px-6 py-3", children: [
      /* @__PURE__ */ jsxs139("span", { className: "flex items-center gap-1 mb-2 font-satoshi-bold", children: [
