...
// app/global.css
var global_default = "/build/_assets/global-ALACBWHB.css";
...
function useContestContestantController() {
  let [enrichedContestants, setEnrichedcontestants] = useState8([]), [contestantDetailsForActiveStage, setContestantDetailsForActiveStage] = useState8(null), { data, error, url } = useLoaderData3(), location = useLocation2(), [isToastFired, setIsToastFired] = useState8(!1);
  useEffect7(() => {
...
import { Form as Form12, useLoaderData as useLoaderData24, useNavigate as useNavigate8 } from "@remix-run/react";
...
function AddAdminUser() {
  let { permissions: permissions2 } = useLoaderData24(), navigate = useNavigate8();
...
import { useLoaderData as useLoaderData25, useNavigate as useNavigate9 } from "@remix-run/react";
...
function AddContest() {
  let { tournaments } = useLoaderData25(), navigate = useNavigate9();
...
import { Form as Form14, useLoaderData as useLoaderData28, useActionData as useActionData3, useNavigate as useNavigate10 } from "@remix-run/react";
...
function useUserProfileController() {
  let { toast: toast5 } = useToast(), loaderData = useLoaderData28(), actionData = useActionData3(), navigate = useNavigate10(), [profile, setProfile] = useState22(loaderData?.data?.user_profile || null), [email, setEmail] = useState22(loaderData?.data?.email || ""), [imagePreview, setImagePreview] = useState22(profile?.image_url), fileInputRef = useRef8(null);
  return useEffect13(() => {
...
function MobileNavigation({ show, onClose }) {
  let { pathname } = useLocation3(), mobileNav = useRef9(null);
        ...
        /* @__PURE__ */ jsxDEV114("header", { className: "wrapper py-5", children: [
          ...
          /* @__PURE__ */ jsxDEV114("nav", { className: "", children: [
            /* @__PURE__ */ jsxDEV114("ul", { className: "grid gap-6 my-12 text-xl font-bold", children: [
              ...
              /* @__PURE__ */ jsxDEV114("li", { children: /* @__PURE__ */ jsxDEV114(NavLink, { onClick: onClose, to: "/#contact", className: "", children: "Contact" }, void 0, !1, {
                fileName: "app/components/public/MobileNavigation.tsx",
                lineNumber: 31,
                columnNumber: 25
              }, this) }, void 0, !1, {
            ...
            /* @__PURE__ */ jsxDEV114(Button, { element: "a", onClick: onClose, href: "/login", className: "block w-full sm:w-auto", children: "Join Now" }, void 0, !1, {
              fileName: "app/components/public/MobileNavigation.tsx",
              lineNumber: 33,
              columnNumber: 17
            }, this)
...
function Navigation() {
  let [showNav, setShowNav] = useState23(!1), { pathname } = useLocation4();
...
function Logout() {
  return useLogoutController(), /* @__PURE__ */ jsxDEV117("main", { className: "h-dvh bg-secondary p-4 flex flex-col justify-center items-center", children: [
...
import { Form as Form15, Link as Link16, useActionData as useActionData4, useNavigate as useNavigate11, useSearchParams as useSearchParams5 } from "@remix-run/react";
...
function useSignupController() {
  let actionData = useActionData4(), [searchQuery] = useSearchParams5(), { setUserStoreManager } = useUserManager(), { toast: toast5 } = useToast(), navigate = useNavigate11();
  return useEffect15(() => {
    actionData?.error && (toast5({
      variant: "destructive",
    ...
    if (actionData?.data) {
      setUserStoreManager(actionData.data, !0), navigate(searchQuery.get("redirectTo") || "/user/all-tournaments");
      return;
    }
...
function AdminToolbar() {
  ...
  return /* @__PURE__ */ jsxDEV123(
    Toggletip,
    {
      ...
      children: [
        /* @__PURE__ */ jsxDEV123(Link18, { to: ".", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
...
import { Form as Form16, Link as Link20, useActionData as useActionData5, useNavigate as useNavigate12, useSearchParams as useSearchParams6 } from "@remix-run/react";
...
function useLoginController() {
  let actionData = useActionData5(), [searchQuery] = useSearchParams6(), { setUserStoreManager, getUserStoreManager } = useUserManager(), { toast: toast5 } = useToast(), navigate = useNavigate12();
  return useEffect18(() => {
    getUserStoreManager() && navigate(searchQuery.get("redirectTo") || "/user/all-tournaments");
  }, []), useEffect18(() => {
    actionData?.error && (toast5({
      variant: "destructive",
      title: "Login Failed",
...
import { Link as Link21, useNavigate as useNavigate13 } from "@remix-run/react";
...
function UserToolbar() {
  let [user, setUser] = useState25(null), { getUserStoreManager } = useUserManager(), navigate = useNavigate13();
  useEffect19(() => {
  ...
  return /* @__PURE__ */ jsxDEV127(
    Toggletip,
    {
      ...
      childContainerClass: "top-[110%] right-0 bg-tertiary p-2 border  text-xs whitespace-nowrap",
      children: [
        /* @__PURE__ */ jsxDEV127(Link21, { to: ".", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
...
import { NavLink as NavLink5, useLocation as useLocation8, useNavigate as useNavigate14 } from "@remix-run/react";
...
function UserMobileNavigation({ show, onClose }) {
  let mobileNav = useRef11(null), [user, setUser] = useState26(null), navigate = useNavigate14(), { getUserStoreManager } = useUserManager();
  useEffect20(() => {
    let currentUser = getUserStoreManager();
