...
// app/global.css
var global_default = "/build/_assets/global-G5BBJ4ID.css";
...
}, reducer = (state, action27) => {
  switch (action27.type) {
    case "ADD_TOAST":
      return {
        ...state,
        toasts: [action27.toast, ...state.toasts].slice(0, TOAST_LIMIT)
      };
    case "UPDATE_TOAST":
      return {
        ...state,
        toasts: state.toasts.map(
          (t) => t.id === action27.toast.id ? { ...t, ...action27.toast } : t
        )
      };
    case "DISMISS_TOAST": {
      let { toastId } = action27;
    ...
    case "REMOVE_TOAST":
      return action27.toastId === void 0 ? {
        ...state,
        toasts: []
      } : {
        ...state,
        toasts: state.toasts.filter((t) => t.id !== action27.toastId)
      };
  }
}, listeners = [], memoryState = { toasts: [] };
function dispatch(action27) {
  memoryState = reducer(memoryState, action27), listeners.forEach((listener) => {
...
function Toaster() {
  ...
  return /* @__PURE__ */ jsxs(ToastProvider, { children: [
    toasts.map(function({ id, title, description, action: action27, ...props }) {
...
function reducer2(stages, action27) {
  return action27.type === "add" ? [...stages, {
    stage: (stages.at(-1)?.stage ?? 0) + 1,
    weight: 0,
    rates: { social_media: { type: "facebook", amount: 0 }, tally: 0, judge: 0, givaah: 0 }
  }] : action27.type === "remove" ? stages.filter((stage) => stage.stage !== action27.stageNumber || stage._id !== action27.value) : action27.type === "edit_sm_type" ? stages.map((stage) => stage.stage === action27.stageNumber ? { ...stage, rates: { ...stage.rates, social_media: { ...stage.rates.social_media, type: action27.value } } } : stage) : action27.type === "edit_stage_number" && !stages.some((stage) => stage.stage === action27.value) ? stages.map((stage) => stage.stage === action27.stageNumber ? { ...stage, stage: action27.value } : stage) : action27.type === "edit_stage_weight" ? stages.map((stage) => stage.stage === action27.stageNumber ? { ...stage, weight: action27.value } : stage) : stages;
}
...
function ContestResult() {
  ...
  return contest?.final_result_scores && (headings = contest.final_result_headings, table_results = contest.final_result_scores.map((res) => res.table_data)), /* @__PURE__ */ jsxs65("main", { className: "grow", children: [
    /* @__PURE__ */ jsxs65("header", { className: "wrapper my-16", children: [
      /* @__PURE__ */ jsxs65("h1", { className: "text-accent text-2xl lg:text-4xl lg:leading-snug font-satoshi-bold max-w-3xl uppercase mb-10", children: [
        contest.name,
        " Result Table"
      ] }),
      /* @__PURE__ */ jsxs65("div", { className: "grid gap-6 max-w-2xl", children: [
        /* @__PURE__ */ jsxs65("div", { className: "", children: [
          /* @__PURE__ */ jsx78("span", { className: "block font-satoshi-bold mb-1", children: "Status" }),
          /* @__PURE__ */ jsx78(StatusTag, { status: contest.status, color })
        ] }),
        /* @__PURE__ */ jsxs65("div", { className: "grid grid-cols-2 gap-14", children: [
          /* @__PURE__ */ jsxs65("div", { className: "", children: [
            /* @__PURE__ */ jsx78("span", { className: "block font-satoshi-bold mb-1", children: "Categories" }),
            /* @__PURE__ */ jsx78("span", { className: "block", children: contest.categories.join(", ") })
          ] }),
          /* @__PURE__ */ jsxs65("div", { className: "", children: [
            /* @__PURE__ */ jsx78("span", { className: "block font-satoshi-bold mb-1", children: "Stages" }),
            /* @__PURE__ */ jsx78("span", { className: "block", children: contest.no_of_stages ?? 0 })
          ] })
        ] }),
        /* @__PURE__ */ jsxs65("div", { className: "grid grid-cols-2 gap-14", children: [
          /* @__PURE__ */ jsxs65("div", { className: "", children: [
            /* @__PURE__ */ jsx78("span", { className: "block font-satoshi-bold mb-1", children: "Duration" }),
            /* @__PURE__ */ jsx78("span", { className: "block", children: "From May 23 to June 20" })
          ] }),
          /* @__PURE__ */ jsxs65("div", { className: "", children: [
            /* @__PURE__ */ jsx78("span", { className: "block font-satoshi-bold mb-1", children: "Prizes" }),
            /* @__PURE__ */ jsx78("span", { className: "block", children: contest.prizes })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx78("section", { className: "bg-white my-16", children: /* @__PURE__ */ jsxs65("div", { className: "wrapper py-6", children: [
      /* @__PURE__ */ jsxs65("div", { className: "flex flex-col md:flex-row-reverse gap-6 md:gap-8 justify-between md:items-center py-6", children: [
        /* @__PURE__ */ jsxs65("fieldset", { className: "flex gap-4 flex-wrap sm:justify-end", children: [
          /* @__PURE__ */ jsx78(Select2, { name: "stage", id: "stage", containerClass: "bg-secondary", children: /* @__PURE__ */ jsxs65("option", { value: "1", children: [
            contest.name.toUpperCase(),
            " - ",
            "FINAL RESULT TABLE"
          ] }) }),
          /* @__PURE__ */ jsx78(Select2, { name: "category", id: "category", containerClass: "bg-secondary", children: /* @__PURE__ */ jsx78("option", { value: "", children: "Sort by category" }) })
        ] }),
        /* @__PURE__ */ jsx78("span", { className: "whitespace-nowrap font-satoshi-bold", children: "SMV: SOCIAL MEDIA VOTES" })
      ] }),
      /* @__PURE__ */ jsx78("div", { className: "w-full overflow-x-auto", children: /* @__PURE__ */ jsxs65("table", { className: "w-full table-auto border border-secondary", children: [
        /* @__PURE__ */ jsx78("thead", { children: /* @__PURE__ */ jsxs65("tr", { children: [
          /* @__PURE__ */ jsx78("th", { className: "text-left uppercase font-satoshi-black border border-secondary px-6 py-4", children: "S/N" }),
          headings.map((heading) => /* @__PURE__ */ jsx78("th", { className: "text-left uppercase font-satoshi-black border border-secondary px-6 py-4", children: heading }, heading))
        ] }) }),
        /* @__PURE__ */ jsx78("tbody", { children: table_results.map((contestant, index) => /* @__PURE__ */ jsxs65("tr", { children: [
          /* @__PURE__ */ jsx78("td", { className: "border border-secondary px-6 py-4", children: index + 1 }),
          headings.map((heading) => /* @__PURE__ */ jsx78("td", { className: "border border-secondary px-6 py-4", children: contestant[heading] }, heading))
        ] }, index)) })
      ] }) }),
      /* @__PURE__ */ jsx78(Pagination, { className: "p-6" })
    ] }) })
  ] });
}
...
import { useLoaderData as useLoaderData17, useNavigate as useNavigate13 } from "@remix-run/react";
...
function EditTournamentForm({ tournament }) {
  let [fileList, setFileList] = useState28(null), { filePreview, clearFilePreview, fileName } = useFilePreview(fileList);
  return /* @__PURE__ */ jsxs66(Form14, { className: "max-w-xl mx-auto grid gap-6 sm:gap-12 text-sm", method: "post", encType: "multipart/form-data", children: [
    /* @__PURE__ */ jsx79("h1", { className: "text-xl xs:text-2xl font-bold text-primary", children: "Edit Tournament" }),
    /* @__PURE__ */ jsxs66("div", { className: "grid gap-3 sm:gap-6", children: [
      /* @__PURE__ */ jsxs66("div", { className: "flex items-center gap-x-5", children: [
        filePreview ? /* @__PURE__ */ jsx79("img", { className: "w-20 h-20 rounded-lg object-cover", src: filePreview, alt: "chosen image" }) : /* @__PURE__ */ jsx79("img", { className: "w-20 h-20 rounded-lg object-cover", src: tournament.image || no_image_default, alt: "Tournament banner" }),
        /* @__PURE__ */ jsxs66("div", { className: "flex flex-col items-start gap-2 max-xs:text-xs", children: [
          /* @__PURE__ */ jsxs66("label", { htmlFor: "image", className: "border-2 border-secondary text-primary cursor-pointer font-semibold py-2 px-4 rounded-lg", children: [
            "Change Photo",
            /* @__PURE__ */ jsx79("input", { id: "image", name: "image", type: "file", onChange: (e) => {
              setFileList(e.currentTarget.files);
            }, className: "hidden" })
          ] }),
          /* @__PURE__ */ jsxs66("span", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx79("span", { children: fileName || "PNG, JPG (max. 1440x900px)" }),
            fileName ? /* @__PURE__ */ jsx79(Svg, { src: icons.closeIcon, onClick: clearFilePreview, className: "text-red-600 cursor-pointer" }) : null
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx79(FormControl, { as: "input", labelText: "Tournament Name", placeholder: "Enter tournament name", id: "name", name: "name", defaultValue: tournament.name, required: !0 }),
      /* @__PURE__ */ jsx79(FormControl, { as: "input", labelText: "Tournament Unique ID", placeholder: "Enter unique ID", id: "uniqueId", name: "uniqueId", defaultValue: tournament.id, required: !0 }),
      /* @__PURE__ */ jsx79(FormControl, { as: "textarea", rows: 3, labelText: "Tournament Description", placeholder: "Enter tournament description", id: "description", name: "description", defaultValue: tournament.description, required: !0 })
    ] }),
    /* @__PURE__ */ jsxs66("div", { className: "flex max-sm:flex-col justify-end gap-3 sm:gap-6", children: [
      /* @__PURE__ */ jsx79(Cta_default, { element: "button", onClick: clearFilePreview, type: "reset", className: "px-8 py-2 rounded-lg font-medium border-secondary active:border-accent sm:hover:border-accent", variant: "outline", children: "Reset" }),
      /* @__PURE__ */ jsx79(Cta_default, { element: "button", type: "submit", name: "tournamentId", value: tournament._id, className: "px-8 py-2 rounded-lg font-medium", children: "Edit Tournament" })
    ] })
  ] });
}
...
async function action12({ request }) {
  ...
  if (data) {
    ...
    return redirect18("/admin/tournaments", { headers: headers2 });
  } else if (error) {
    let { headers: headers2 } = await setToast({ request, toast: `error::${error.detail}::${Date.now()}` });
...
function EditTournament() {
  let { tournament } = useLoaderData17(), navigate = useNavigate13();
  return /* @__PURE__ */ jsxs67("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs67("div", { className: "flex items-center mb-8 sm:mb-16 gap-4", children: [
      /* @__PURE__ */ jsx80(RoundCta_default, { icon: icons.arrowPrevIcon, className: "hover:bg-[#F7F7F8] text-primary", onClick: () => navigate(-1) }),
      /* @__PURE__ */ jsx80("span", { className: "font-black text-primary", children: "Edit Tournament" })
    ] }),
    /* @__PURE__ */ jsx80(EditTournamentForm, { tournament })
  ] });
}
...
function WinnerDetailsPage() {
  let { winner, error } = useLoaderData18(), description = `We Are Thrilled To Announce The Triumphant Winner Of Our Recent '${winner?.contest_name}'! Let's Take A Moment To Applaud The Outstanding Creativity And Talent That Graced Our Contest.`;
  return /* @__PURE__ */ jsx81("div", { className: "min-h-screen bg-[#EFEFFF] flex items-center justify-center p-4 sm:p-6 lg:p-8", children: /* @__PURE__ */ jsx81("div", { className: "max-w-6xl mx-auto bg-transparent", children: /* @__PURE__ */ jsxs68("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16", children: [
    /* @__PURE__ */ jsx81("div", { className: "w-full aspect-[3/4] overflow-hidden rounded-2xl shadow-xl order-2 md:order-1", children: /* @__PURE__ */ jsx81(
      "img",
      {
    ...
    /* @__PURE__ */ jsxs68("div", { className: "space-y-4 md:space-y-6 order-1 md:order-2", children: [
      /* @__PURE__ */ jsxs68("h1", { className: "text-3xl sm:text-4xl lg:text-4xl font-extrabold text-[#5B50FB] leading-tight", children: [
        winner?.contest_name,
        " Winner"
      ] }),
      /* @__PURE__ */ jsx81("p", { className: "text-base sm:text-lg text-gray-700 leading-relaxed", children: description }),
      /* @__PURE__ */ jsxs68("p", { className: "text-lg sm:text-xl font-bold text-gray-900", children: [
        "Grand Winner:",
        " ",
        /* @__PURE__ */ jsx81("span", { className: "text-gray-900", children: winner?.full_name }),
        " (",
        winner?.contest_name,
        ")"
      ] }),
      /* @__PURE__ */ jsxs68("p", { className: "text-sm italic text-gray-600 pt-2", children: [
        `Winner's Note: "`,
        winner?.remark,
        '"'
      ] })
...
import { json as json21, redirect as redirect19 } from "@remix-run/node";
...
function DeleteTournamentDialog({ tournament, disabled }) {
  ...
  return /* @__PURE__ */ jsxs69(Dialog, { children: [
    /* @__PURE__ */ jsx82(
      DialogTrigger,
      {
        disabled,
    ...
    /* @__PURE__ */ jsxs69(DialogContent, { className: "bg-secondary p-0 gap-0", children: [
      /* @__PURE__ */ jsxs69(DialogHeader, { children: [
        /* @__PURE__ */ jsxs69(DialogTitle, { className: "p-4 flex gap-3", children: [
          /* @__PURE__ */ jsx82("div", { className: "size-11 rounded-full bg-orange-100 flex items-center justify-center", children: /* @__PURE__ */ jsx82(Svg, { src: icons.questionIcon }) }),
          /* @__PURE__ */ jsxs69("p", { children: [
            /* @__PURE__ */ jsx82("span", { className: "block", children: "Delete tournament" }),
            /* @__PURE__ */ jsx82("span", { className: "font-normal text-base text-admin-pry", children: "Confirm the deletion of this tournament" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs69(DialogDescription, { className: "border-y p-4", children: [
          /* @__PURE__ */ jsxs69("span", { className: "text-primary mb-2 block", children: [
            "Are you sure you want to delete ",
            tournament.name,
            " tournament?"
          ] }),
          /* @__PURE__ */ jsx82("span", { className: "text-admin-pry", children: "This action is irreversible and will permanently delete this tournament." })
        ] })
      ] }),
      /* @__PURE__ */ jsx82(DialogFooter, { className: "flex justify-end gap-6 p-4", children: /* @__PURE__ */ jsxs69(fetcher.Form, { method: "post", children: [
        /* @__PURE__ */ jsx82("input", { type: "hidden", name: "tournamentId", value: tournament._id }),
        /* @__PURE__ */ jsx82(DialogClose, { type: "submit", name: "intent", value: "delete", className: "bg-red-500 px-10 py-2 rounded-md font-bold min-w-[90px] text-white", children: "Proceed" })
      ] }) })
    ] })
  ] });
}
...
function LayeredImages({ images, length = 5 }) {
  let remaining = images.length - length, lastLayer = remaining > 0 ? /* @__PURE__ */ jsxs70("div", { className: "w-8 aspect-square inline-flex justify-center items-center -ml-2 rounded-full ring-2 ring-white bg-tertiary text-accent font-semibold text-sm", children: [
    "+",
    remaining
  ] }) : null;
  return /* @__PURE__ */ jsxs70("div", { children: [
    images.slice(0, length).map((image, index) => typeof image == "string" ? /* @__PURE__ */ jsx83("img", { src: image || no_image_default, alt: "people smiling", className: "w-8 aspect-square inline-block -ml-2 first:ml-0 rounded-full object-cover ring-2 ring-white" }, index) : /* @__PURE__ */ jsx83("img", { src: image?.image || no_image_default, alt: "people smiling", className: "w-8 aspect-square inline-block -ml-2 first:ml-0 rounded-full object-cover ring-2 ring-white" }, index)),
    lastLayer
  ] });
}
...
function TournamentCard({ tournament, className }) {
  let mainComponent = /* @__PURE__ */ jsx84(RoundCta_default, { icon: icons.optionsIcon, className: "border-transparent hover:border-disabled" });
  return /* @__PURE__ */ jsxs71("aside", { className: cn("p-6 border border-disabled rounded-xl bg-white shadow overflow-hidden", className), children: [
    /* @__PURE__ */ jsxs71("div", { className: "flex gap-3 items-start justify-between max-xs:flex-wrap", children: [
      /* @__PURE__ */ jsx84("img", { src: tournament.image || no_image_default, alt: "children smiling", className: "w-24 aspect-square rounded-md object-cover" }),
      /* @__PURE__ */ jsxs71("div", { className: "self-center grow max-xs:order-1", children: [
        /* @__PURE__ */ jsx84("h3", { className: "text-primary font-satoshi-black uppercase line-clamp-1", children: tournament.name }),
        /* @__PURE__ */ jsx84("p", { className: "font-medium text-xs line-clamp-2", children: tournament.description })
      ] }),
      /* @__PURE__ */ jsxs71(
        Toggletip,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx84(DeleteTournamentDialog, { tournament })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsx84("hr", { className: "mt-4 mb-1" }),
    /* @__PURE__ */ jsxs71("span", { className: "text-primary text-sm font-satoshi-bold mb-3", children: [
      tournament.contests.length,
      " contests created"
    ] }),
    /* @__PURE__ */ jsxs71("div", { className: "grid gap-2 xs:flex justify-between items-center", children: [
      /* @__PURE__ */ jsx84(LayeredImages, { images: tournament.contests }),
      /* @__PURE__ */ jsxs71(Link13, { to: `/admin/tournaments/${tournament.id}`, className: "flex gap-2 items-center font-semibold hover:text-accent", children: [
        "View Contests ",
        /* @__PURE__ */ jsx84(Svg, { src: icons.arrowNextIcon })
      ] })
    ] })
  ] });
}
...
async function action13({ request }) {
  ...
  if (intent === "delete") {
    ...
    if (error) {
      ...
      return json21(error, { headers: headers2 });
    }
    let { headers } = await setToast({ request, toast: `success::The tournament has been deleted::${Date.now()}` });
    return json21(data, { headers });
  }
  return json21(null);
}
function Tournaments() {
  let { tournaments } = useLoaderData19(), numberOfContests = tournaments.reduce((total, tournament) => total + tournament.contests.length, 0);
  return /* @__PURE__ */ jsxs72("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs72("section", { className: "flex justify-between items-center mb-8 sm:mb-16", children: [
      /* @__PURE__ */ jsx85("h1", { className: "text-2xl font-black text-primary", children: "Tournaments" }),
      /* @__PURE__ */ jsxs72(Cta_default, { element: "link", to: "add", className: "hidden sm:flex gap-2 items-center rounded-lg px-3 py-2", children: [
        /* @__PURE__ */ jsx85(Svg, { src: icons.addIcon, width: ".9em" }),
        "Create Tournament"
      ] })
    ] }),
    /* @__PURE__ */ jsxs72("aside", { className: "sm:flex justify-evenly max-w-xl mx-auto gap-2 p-3 border rounded-md my-4 bg-[#F6F8FA] text-sm", children: [
      /* @__PURE__ */ jsxs72("div", { className: "flex gap-3 items-center", children: [
        /* @__PURE__ */ jsx85("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx85(Svg, { src: icons.adminTournamentIcon, className: "text-primary" }) }),
        /* @__PURE__ */ jsxs72("span", { className: "grid", children: [
          /* @__PURE__ */ jsx85("span", { className: "text-primary font-satoshi-black", children: tournaments.length }),
          /* @__PURE__ */ jsx85("span", { className: "", children: "Tournaments Created" })
        ] })
      ] }),
      /* @__PURE__ */ jsx85("div", { className: "max-sm:my-2 max-sm:border-t sm:border-r sm:h-10" }),
      /* @__PURE__ */ jsxs72("div", { className: "flex gap-3 items-center", children: [
        /* @__PURE__ */ jsx85("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx85(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
        /* @__PURE__ */ jsxs72("span", { className: "grid", children: [
          /* @__PURE__ */ jsx85("span", { className: "text-primary font-satoshi-black", children: numberOfContests }),
          /* @__PURE__ */ jsx85("span", { className: "", children: "Contests Created" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs72(Cta_default, { element: "link", to: "add", className: "flex sm:hidden gap-2 justify-center items-center rounded-lg px-3 py-2", children: [
      /* @__PURE__ */ jsx85(Svg, { src: icons.addIcon, width: ".9em" }),
      "Create Tournament"
    ] }),
    /* @__PURE__ */ jsx85("section", { className: "my-8 grid sm:grid-cols-2 gap-6", children: tournaments.map((tournament) => /* @__PURE__ */ jsx85(TournamentCard, { tournament }, tournament.id)) })
  ] });
}
...
async function loader22() {
  ...
  if (error)
    throw new Error(error.detail);
  return json22({ tournaments });
}
function Contests() {
  let { tournaments } = useLoaderData20();
  return /* @__PURE__ */ jsxs73("main", { className: "grow", children: [
    /* @__PURE__ */ jsx86("header", { className: "wrapper my-16", children: /* @__PURE__ */ jsx86("h1", { className: "text-2xl lg:text-4xl font-satoshi-medium max-w-3xl", children: "From Artistic Marvels to Captivating Moments. Unleash Your Talent and Win Big in Our Monthly and Yearly Contests!" }) }),
    /* @__PURE__ */ jsx86("section", { className: "wrapper my-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-12 justify-items-center", children: tournaments.map((tournament) => /* @__PURE__ */ jsx86(ContestCard, { contest: tournament, to: `/contests/${tournament.id}` }, tournament.id)) })
  ] });
}
...
function ToggleBtn({ onClick, on }) {
  return /* @__PURE__ */ jsx87("button", { onClick, className: cn8("rounded-xl p-0.5 w-[34px] flex items-center", {
    "bg-accent justify-end": on,
    "bg-[#DAE0E6]": !on
  }), children: /* @__PURE__ */ jsx87("div", { className: "bg-secondary w-4 h-4 rounded-full" }) });
}
...
function AdminUserCard({ user, className }) {
  let mainComponent = /* @__PURE__ */ jsx88("span", { className: "", children: /* @__PURE__ */ jsx88(Svg, { src: icons.optionsIcon }) });
  return /* @__PURE__ */ jsxs74("article", { className: cn("border rounded-lg shadow-sm p-3 text-xs font-satoshi-medium", className), children: [
    /* @__PURE__ */ jsxs74("div", { className: "flex gap-4 mb-3", children: [
      /* @__PURE__ */ jsxs74("p", { children: [
        /* @__PURE__ */ jsx88("span", { children: user.roles?.join(", ") }),
        " | ",
        /* @__PURE__ */ jsx88("span", { children: user.username })
      ] }),
      /* @__PURE__ */ jsxs74(
        Toggletip,
        {
          ...
          children: [
            /* @__PURE__ */ jsx88(RoundCta_default, { icon: icons.editIcon, element: "link", to: `/admin/accounts/${user._id}`, className: "border-[#262626] bg-[#F7F7F8] text-primary" }),
            /* @__PURE__ */ jsx88(RoundCta_default, { icon: icons.trashIcon, className: "border-red-500 bg-red-50 text-red-500" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxs74("div", { className: "flex gap-4 justify-between", children: [
      /* @__PURE__ */ jsxs74("div", { className: "flex gap-3 items-center", children: [
        /* @__PURE__ */ jsx88("span", { className: "p-1.5 border border-disabled rounded-full", children: /* @__PURE__ */ jsx88("img", { src: admin_avatar_default, alt: "cartoon head", width: 24, height: 24 }) }),
        /* @__PURE__ */ jsxs74("span", { className: "grid", children: [
          /* @__PURE__ */ jsx88("span", { className: "text-primary line-clamp-1", children: user.full_name }),
          /* @__PURE__ */ jsx88("span", { className: "line-clamp-1", children: user.email })
        ] })
      ] }),
      /* @__PURE__ */ jsxs74("span", { className: "flex gap-3 items-center", children: [
        /* @__PURE__ */ jsx88("span", { className: "max-xs:hidden", children: user.is_active ? "Enabled" : "Disabled" }),
...
async function loader23({ request }) {
  ...
  return pagedUsersRes.authRequired ? redirect20("/login") : json23({ headings, tableData: adminUsers, pagedUserData: pagedUsersRes.data, query });
}
function Accounts() {
  let { headings, tableData, pagedUserData, query } = useLoaderData21(), navigation = useNavigation5();
  return console.log(pagedUserData), /* @__PURE__ */ jsxs75("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs75("div", { className: "flex justify-between items-center mb-8 sm:mb-16", children: [
      /* @__PURE__ */ jsx89("h1", { className: "text-2xl font-black text-primary", children: "Admin Accounts" }),
      /* @__PURE__ */ jsxs75(Cta_default, { element: "link", to: "/admin/accounts/add", className: "hidden sm:flex gap-2 items-center rounded-lg px-3 py-2", children: [
        /* @__PURE__ */ jsx89(Svg, { src: icons.addIcon, width: ".9em" }),
        "Add User"
      ] })
    ] }),
    /* @__PURE__ */ jsxs75("div", { className: "flex flex-col gap-3 sm:flex-row justify-between sm:items-center my-8", children: [
      /* @__PURE__ */ jsx89("p", { className: "font-semibold", children: "Registered Admin Users" }),
      /* @__PURE__ */ jsxs75(Form15, { method: "get", className: "flex items-center gap-3", onSubmit: (e) => {
        try {
        ...
        /* @__PURE__ */ jsx89(FormControl, { as: "input", name: "searchUser", type: "search", placeholder: "Search user...", className: "text-sm xs:min-w-[280px]", defaultValue: query?.wild_card ?? "" }),
        /* @__PURE__ */ jsx89("input", { type: "hidden", name: "wild_card", defaultValue: query?.wild_card ?? "" }),
        /* @__PURE__ */ jsx89("button", { type: "submit", disabled: navigation.state === "submitting", className: "px-3 py-2 bg-[#312E81] text-white rounded-md text-sm", children: navigation.state === "submitting" ? "Searching..." : "Search" })
      ] }),
      /* @__PURE__ */ jsxs75(Cta_default, { element: "link", to: "add", className: "sm:hidden flex gap-2 items-center justify-center rounded-lg px-3 py-2", children: [
        /* @__PURE__ */ jsx89(Svg, { src: icons.addIcon, width: ".9em" }),
        "Add User"
      ] })
    ] }),
    /* @__PURE__ */ jsxs75("div", { className: "sm:hidden grid gap-4 my-6", children: [
      pagedUserData?.items.map((user) => /* @__PURE__ */ jsx89(AdminUserCard, { user }, user._id)),
      /* @__PURE__ */ jsx89(Pagination, { lastKey: pagedUserData?.last_key_id, pageSize: pagedUserData?.items_per_page, firstKey: pagedUserData?.first_key_id })
    ] }),
    /* @__PURE__ */ jsx89("div", { className: "hidden sm:block w-full overflow-x-auto", children: /* @__PURE__ */ jsxs75("table", { className: "w-full table-auto", children: [
      /* @__PURE__ */ jsx89("thead", { children: /* @__PURE__ */ jsxs75("tr", { className: "border-b border-secondary", children: [
        headings.map((heading) => /* @__PURE__ */ jsx89("th", { className: "text-left capitalize font-satoshi-black p-3", children: heading }, heading)),
        /* @__PURE__ */ jsx89("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Actions" })
      ] }) }),
      /* @__PURE__ */ jsx89("tbody", { children: pagedUserData?.items.map((user, index) => /* @__PURE__ */ jsxs75("tr", { className: "border-b border-secondary", children: [
        headings.map((heading) => heading === "access" ? /* @__PURE__ */ jsx89("td", { className: "p-3", children: /* @__PURE__ */ jsxs75("span", { className: "grid grid-cols-[76px_36px] items-center w-min", children: [
          user.is_active ? "Enabled" : "Disabled",
          /* @__PURE__ */ jsx89(ToggleBtn, { on: user.is_active })
        ] }) }, heading) : /* @__PURE__ */ jsx89("td", { className: "p-3", children: Array.isArray(user[heading]) ? user[heading].join(", ") : user[heading] }, heading)),
        /* @__PURE__ */ jsx89("td", { className: "p-3", children: /* @__PURE__ */ jsxs75("div", { className: "flex gap-4 items-center", children: [
          /* @__PURE__ */ jsx89(RoundCta_default, { icon: icons.editIcon, element: "link", to: user._id, className: "border-[#262626] bg-[#F7F7F8] text-primary" }),
          /* @__PURE__ */ jsx89(RoundCta_default, { icon: icons.trashIcon, className: "border-red-500 bg-red-50 text-red-500" })
        ] }) })
      ] }, index)) })
    ] }) }),
    /* @__PURE__ */ jsx89("div", { className: "hidden sm:flex justify-between items-center my-4", children: /* @__PURE__ */ jsx89(Pagination, { lastKey: pagedUserData?.last_key_id, pageSize: pagedUserData?.items_per_page, firstKey: pagedUserData?.first_key_id }) })
  ] });
}
...
async function loader24({ request, params }) {
  let cookieHeader = request.headers.get("Cookie") ?? "";
  console.log({ cookieHeader }), cookieHeader || redirect21("/login");
  let walletid = params.walletid;
  if (!walletid)
  ...
  if (wallet.authRequired && redirect21("/login"), !wallet.data)
    return redirect21("/user/wallet");
...
function AddWithdrawalAccountPage2() {
  ...
  let inputClasses = `
    ...
    focus:border-slate-800 focus:ring-1 focus:ring-slate-800
  `;
  return /* @__PURE__ */ jsx90("div", { className: "min-h-screen bg-white flex flex-col items-center pt-16 px-4", children: /* @__PURE__ */ jsxs76("div", { className: "max-w-md w-full flex flex-col items-center", children: [
    /* @__PURE__ */ jsxs76("div", { className: "flex flex-col items-center mb-10 text-center", children: [
      /* @__PURE__ */ jsx90("div", { className: "w-24 h-24 rounded-full bg-slate-50 flex items-center justify-center mb-4 border border-slate-100", children: /* @__PURE__ */ jsx90("div", { className: "w-12 h-12 bg-slate-900 rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsx90(Svg, { src: icons.avatarIcon, className: "w-6 h-6 text-white" }) }) }),
      /* @__PURE__ */ jsx90("h1", { className: "text-2xl font-bold text-gray-900", children: "Withdraw " }),
      /* @__PURE__ */ jsx90("p", { className: "text-gray-500 mt-1 text-sm", children: "Enter details below" })
    ] }),
    withdrawalCharges ? /* @__PURE__ */ jsxs76(Form16, { method: "POST", className: "w-full flex flex-col max-w-md mx-auto", children: [
      /* @__PURE__ */ jsxs76("div", { className: "mb-6", children: [
        /* @__PURE__ */ jsx90("label", { className: "text-sm font-medium text-gray-500 mb-2 block", children: "You withdraw exactly" }),
        /* @__PURE__ */ jsxs76("div", { className: "flex items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsx90("div", { className: "flex items-center gap-2 px-4 py-2 bg-gray-50 border border-gray-200 rounded-full", children: /* @__PURE__ */ jsx90("span", { className: "font-bold text-gray-900", children: wallet?.wallet_currency || "USD" }) }),
          /* @__PURE__ */ jsx90(
            "input",
            {
              id: "amount",
        ...
        /* @__PURE__ */ jsxs76("p", { className: "text-sm text-gray-400 mt-2", children: [
          "Bal: ",
          wallet?.withdrawable_balance.toLocaleString() || "0.00"
        ] })
      ] }),
      /* @__PURE__ */ jsxs76("div", { className: "bg-[#F8F9FB] rounded-3xl p-6 border border-gray-100 flex flex-col gap-3", children: [
        /* @__PURE__ */ jsxs76("div", { className: "flex justify-between items-center text-sm", children: [
          /* @__PURE__ */ jsx90("span", { className: "text-gray-500", children: "Processing Fee:" }),
          /* @__PURE__ */ jsxs76("span", { className: "font-medium text-gray-900", children: [
            "- ",
            wallet?.wallet_currency,
            " ",
        ...
        /* @__PURE__ */ jsxs76("div", { className: "flex justify-between items-center text-sm", children: [
          /* @__PURE__ */ jsx90("span", { className: "text-gray-500", children: "Destination Account:" }),
          /* @__PURE__ */ jsx90("span", { className: "font-medium text-gray-900 text-right", children: withdrawalAccount?.bankname })
        ] }),
        /* @__PURE__ */ jsxs76("div", { className: "pt-3 mt-1 border-t border-gray-200 flex justify-between items-center", children: [
          /* @__PURE__ */ jsx90("span", { className: "text-sm text-gray-500 font-medium", children: "Total:" }),
          /* @__PURE__ */ jsxs76("span", { className: "text-lg font-bold text-gray-900", children: [
            wallet?.wallet_currency,
            " ",
            ((withdrawalCharges?.total_charge ?? 0) + amount).toLocaleString()
          ] })
        ] }),
        withdrawalCharges?.remark && /* @__PURE__ */ jsxs76("div", { className: "mt-2 bg-white/50 border border-gray-200 rounded-xl px-4 py-3 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs76("div", { className: "flex items-center gap-2 text-xs text-gray-500", children: [
            /* @__PURE__ */ jsx90("span", { className: "opacity-60", children: "\u2139\uFE0F" }),
            /* @__PURE__ */ jsx90("span", { children: withdrawalCharges.remark })
          ] }),
          /* @__PURE__ */ jsx90(ChevronDownIcon3, {}),
          " "
        ] })
      ] }),
      /* @__PURE__ */ jsxs76("div", { className: "mt-8 mb-6", children: [
        /* @__PURE__ */ jsx90("label", { className: "text-sm font-medium text-gray-500 mb-2 block", children: "Recipient details" }),
        /* @__PURE__ */ jsx90("div", { className: "flex justify-between items-end", children: /* @__PURE__ */ jsxs76("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ jsx90("span", { className: "text-lg font-bold text-gray-900 uppercase", children: withdrawalAccount?.name }),
          /* @__PURE__ */ jsx90("span", { className: "text-gray-500 text-sm", children: withdrawalAccount?.acct_number })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxs76("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs76("label", { className: "mb-2 block text-[15px] font-medium text-[#1A1A1A]", children: [
          "Withdrawal PIN",
          /* @__PURE__ */ jsx90("span", { className: "ml-0.5 text-red-500", children: "*" })
        ] }),
        /* @__PURE__ */ jsx90("div", { className: "relative", children: /* @__PURE__ */ jsx90(
          "input",
          {
            id: "withdrawal_pin",
            name: "withdrawal_pin",
        ...
        /* @__PURE__ */ jsxs76("div", { className: "flex flex-col gap-3", children: [
          /* @__PURE__ */ jsx90(
            Cta_default,
            {
              element: "button",
      ...
      /* @__PURE__ */ jsx90("input", { type: "hidden", name: "intent", value: "requestWithdrawal" }),
      /* @__PURE__ */ jsx90("input", { type: "hidden", name: "withdrawal_account_id", value: withdrawalAccount?._id || "" }),
      /* @__PURE__ */ jsx90("input", { type: "hidden", name: "wallet_id", value: `${wallet?._id}` })
    ] }) : /* @__PURE__ */ jsxs76(Form16, { method: "POST", className: "w-full flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxs76("div", { className: "relative", ref: dropdownRef, children: [
        /* @__PURE__ */ jsxs76("label", { className: "mb-2 block text-[15px] font-medium text-[#1A1A1A]", children: [
          "Select beneficiary",
          /* @__PURE__ */ jsx90("span", { className: "ml-0.5 text-red-500", children: "*" })
        ] }),
        ...
        /* @__PURE__ */ jsx90("div", { className: "absolute right-5 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400", children: /* @__PURE__ */ jsx90(ChevronDownIcon3, {}) }),
        isOpen && /* @__PURE__ */ jsx90("div", { className: "absolute z-50 w-full mt-2 bg-white border border-gray-200 rounded-2xl shadow-xl max-h-60 overflow-y-auto overflow-x-hidden", children: withdrawalAccounts ?? [].length > 0 ? (withdrawalAccounts ?? []).map((acct) => /* @__PURE__ */ jsxs76(
          "div",
          {
            className: "px-5 py-4 hover:bg-slate-50 cursor-pointer text-gray-900 border-b border-gray-50 last:border-none transition-colors",
            onClick: () => {
          ...
          acct._id
        )) : /* @__PURE__ */ jsx90("div", { className: "px-5 py-4 text-gray-400 italic", children: "No withdrawal account. Please add a withdrawal account to conitnue" }) })
      ] }),
      /* @__PURE__ */ jsx90("div", { className: "relative", children: /* @__PURE__ */ jsx90(
        "input",
        {
      ...
      /* @__PURE__ */ jsx90("input", { type: "hidden", name: "intent", value: "getCharge" }),
      /* @__PURE__ */ jsx90("input", { type: "hidden", name: "withdrawal_account_id", value: withdrawalAccount?._id || "", required: !0 }),
      /* @__PURE__ */ jsx90("input", { type: "hidden", name: "wallet_id", value: `${wallet?._id}` }),
      /* @__PURE__ */ jsx90(
        Cta_default,
        {
...
var ChevronDownIcon3 = () => /* @__PURE__ */ jsx90("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsx90("path", { d: "m6 9 6 6 6-6" }) });
...
function Results() {
  ...
  return /* @__PURE__ */ jsxs77("main", { className: "grow", children: [
    /* @__PURE__ */ jsx91("header", { className: "wrapper my-16", children: /* @__PURE__ */ jsx91("h1", { className: "text-accent text-2xl lg:text-4xl lg:leading-snug font-satoshi-bold max-w-3xl", children: "Congratulating the Extraordinary Talents That Stole the Spotlight!" }) }),
    /* @__PURE__ */ jsx91("section", { className: "wrapper", children: /* @__PURE__ */ jsxs77("div", { className: "p-2 rounded-full bg-secondary flex w-fit", children: [
      /* @__PURE__ */ jsx91("span", { className: "whitespace-nowrap text-xs sm:text-base p-3 sm:px-6 sm:py-4 rounded-full font-satoshi-medium bg-accent text-white", children: "All Contests" }),
      /* @__PURE__ */ jsx91("span", { className: "whitespace-nowrap text-xs sm:text-base p-3 sm:px-6 sm:py-4 rounded-full font-satoshi-medium", children: "Ongoing Contests" }),
      /* @__PURE__ */ jsx91("span", { className: "whitespace-nowrap text-xs sm:text-base p-3 sm:px-6 sm:py-4 rounded-full font-satoshi-medium", children: "Completed Contests" })
    ] }) }),
    /* @__PURE__ */ jsx91("section", { className: "wrapper my-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-12 justify-items-center", children: contests2.map((contest) => /* @__PURE__ */ jsx91(ContestCard, { contest, to: `/results/${contest.id}`, withTag: !0, withCategory: !0 }, contest.id)) }),
    /* @__PURE__ */ jsx91("div", { className: "wrapper my-20 flex justify-center", children: /* @__PURE__ */ jsx91(Button, { element: "button", variant: "outline", children: "See more results" }) })
  ] });
}
...
function RolesFormControl({ roles, defaultRoles, ...props }) {
  ...
  return /* @__PURE__ */ jsxs78("fieldset", { ref: fieldset, ...props, className: "p-2 sm:p-4 rounded-lg bg-transparent border hover:border-primary sm:col-span-2", children: [
    /* @__PURE__ */ jsxs78("div", { "data-open": open, className: "flex justify-between data-[open=true]:pb-2 sm:data-[open=true]:pb-3 data-[open=true]:border-b", children: [
      /* @__PURE__ */ jsxs78("span", { className: "flex gap-2 items-center font-bold cursor-pointer grow", onClick: () => setOpen((prev) => !prev), children: [
        /* @__PURE__ */ jsx92(Svg, { src: icons.arrowDownIcon, className: open ? "" : "-rotate-90" }),
        "Roles"
      ] }),
      /* @__PURE__ */ jsxs78(
        Cta_default,
        {
          ...
          children: [
            /* @__PURE__ */ jsx92(Restore, { className: "text-inherit sm:hidden" }),
            /* @__PURE__ */ jsx92("span", { className: "hidden sm:inline", children: "Restore defaults" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsx92("div", { className: cn9("grid sm:grid-cols-3 gap-6 mt-4 sm:mx-3", { hidden: !open }), children: roles.map((role) => /* @__PURE__ */ jsx92(
      FormControl,
      {
        as: "input",
        type: "checkbox",
...
async function loader26({ params, request }) {
  ...
  if (!user || !user.data) {
    ...
    return redirect22("/admin/accounts", { headers });
  }
...
function EditAdminUser() {
  ...
  return /* @__PURE__ */ jsxs79("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs79("div", { className: "flex items-center mb-10 sm:mb-16 gap-4", children: [
      /* @__PURE__ */ jsx93(RoundCta_default, { icon: icons.arrowPrevIcon, className: "hover:bg-[#F7F7F8] text-primary", onClick: () => navigate(-1) }),
      /* @__PURE__ */ jsx93("h1", { className: "text-2xl font-black text-primary", children: "Edit User" })
    ] }),
    /* @__PURE__ */ jsxs79(Form17, { className: "sm:wrapper grid sm:grid-cols-2 gap-3 sm:gap-6 text-sm", method: "post", children: [
      /* @__PURE__ */ jsx93(FormControl, { as: "input", labelText: "First Name", className: "", placeholder: "Enter first name", id: "firstName", name: "firstName", defaultValue: user.full_name.split(" ")[0], required: !0 }),
      /* @__PURE__ */ jsx93(FormControl, { as: "input", labelText: "Last Name", className: "", placeholder: "Enter last name", id: "lastName", name: "lastName", defaultValue: user.full_name.split(" ")[1], required: !0 }),
      /* @__PURE__ */ jsx93(FormControl, { as: "input", labelText: "Email Address", className: "", placeholder: "Enter email address", id: "email", name: "email", defaultValue: user.email, required: !0 }),
      /* @__PURE__ */ jsx93(FormControl, { as: "input", labelText: "Username", className: "", placeholder: "Enter username", id: "username", name: "username", defaultValue: user.username, required: !0 }),
      /* @__PURE__ */ jsxs79(Select2, { label: "Assigned as Staff", id: "is_staff", name: "is_staff", defaultValue: user.is_staff ? "1" : "0", required: !0, children: [
        /* @__PURE__ */ jsx93("option", { value: "0", children: "False" }),
        /* @__PURE__ */ jsx93("option", { value: "1", children: "True" })
      ] }),
      /* @__PURE__ */ jsxs79(Select2, { label: "Set Active", id: "is_active", name: "is_active", defaultValue: user.is_active ? "1" : "0", required: !0, children: [
        /* @__PURE__ */ jsx93("option", { value: "0", children: "De-activate" }),
        /* @__PURE__ */ jsx93("option", { value: "1", children: "Activate" })
      ] }),
      /* @__PURE__ */ jsxs79(Select2, { label: "Has Admin Access", id: "has_admin_access", name: "has_admin_access", defaultValue: user.has_admin_access ? "1" : "0", required: !0, children: [
        /* @__PURE__ */ jsx93("option", { value: "0", children: "False" }),
        /* @__PURE__ */ jsx93("option", { value: "1", children: "True" })
      ] }),
      /* @__PURE__ */ jsx93(RolesFormControl, { roles: rolesNames, defaultRoles: user.roles }),
      /* @__PURE__ */ jsxs79("div", { className: "grid grid-cols-2 sm:flex justify-end gap-3 sm:gap-6 sm:col-span-2 mt-4", children: [
        /* @__PURE__ */ jsx93(Cta_default, { element: "button", type: "reset", className: "px-4 sm:px-8 py-2 rounded-lg font-medium border-secondary active:border-accent", variant: "outline", children: "Reset" }),
        /* @__PURE__ */ jsx93(Cta_default, { disabled: isSubmitting, element: "button", type: "submit", className: "px-4 sm:px-8 py-2 rounded-lg font-medium", children: isSubmitting ? "Updating admin user" : "Update admin user" })
      ] })
    ] })
  ] });
}
...
async function loader27({ request }) {
  ...
  let pagedUsersRes = await adminRepo.queryUsers(cookieHeader, query);
  return pagedUsersRes.authRequired ? redirect23("/login") : json26({ headings, tableData: adminUsers, pagedUserData: pagedUsersRes.data, query });
}
function Accounts2() {
  ...
  return console.log(pagedUserData), /* @__PURE__ */ jsxs80("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs80("div", { className: "flex justify-between items-center mb-8 sm:mb-16", children: [
      ...
      /* @__PURE__ */ jsxs80(Cta_default, { element: "link", to: "add", className: "hidden sm:flex gap-2 items-center rounded-lg px-3 py-2", children: [
    ...
    /* @__PURE__ */ jsxs80("div", { className: "flex flex-col gap-3 sm:flex-row justify-between sm:items-center my-8", children: [
      ...
      /* @__PURE__ */ jsxs80(Form18, { method: "get", className: "flex items-center gap-3", onSubmit: (e) => {
        try {
          let form = e.currentTarget, searchInput = form.elements.namedItem("searchUser"), hidden = form.elements.namedItem("wild_card");
          searchInput && hidden && (hidden.value = searchInput.value || "");
        } catch {
...
function Contests2() {
  ...
  return /* @__PURE__ */ jsxs81("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs81("section", { className: "flex max-sm:flex-col gap-10 justify-between sm:items-center mb-6 sm:mb-16", children: [
      /* @__PURE__ */ jsx95("h1", { className: "text-2xl font-black text-primary", children: "Contests" }),
      /* @__PURE__ */ jsxs81(Cta_default, { element: "link", to: "add", className: "flex gap-2 items-center justify-center rounded-lg px-3 py-2", children: [
        /* @__PURE__ */ jsx95(Svg, { src: icons.addIcon, width: ".9em" }),
        "Create Contest"
      ] })
    ] }),
    /* @__PURE__ */ jsx95("section", { className: "my-6 sm:my-12", children: /* @__PURE__ */ jsx95(ContestTable, { data: contests2 }) })
  ] });
}
...
function PartnersIndex() {
  ...
  return /* @__PURE__ */ jsxs82("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsx96("div", { className: "flex justify-between items-center mb-8 sm:mb-16", children: /* @__PURE__ */ jsx96("h1", { className: "text-2xl font-black text-primary", children: "Partners" }) }),
    /* @__PURE__ */ jsx96("div", { className: "flex flex-col gap-3 sm:flex-row justify-between sm:items-center my-8", children: /* @__PURE__ */ jsx96(Form19, { method: "get", className: "w-full bg-white border border-gray-100 rounded-xl p-4 shadow-sm", children: /* @__PURE__ */ jsxs82("div", { className: "grid grid-cols-1 sm:grid-cols-4 gap-3 items-end", children: [
      /* @__PURE__ */ jsxs82("div", { children: [
        /* @__PURE__ */ jsx96("label", { className: "block text-xs font-semibold mb-1", children: "Business Name" }),
        /* @__PURE__ */ jsx96(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsx96("div", { className: "sm:col-span-1 flex gap-2 mt-2 sm:mt-0", children: /* @__PURE__ */ jsx96("button", { type: "submit", className: "bg-[#4B4870] text-white px-4 py-2 rounded-lg font-semibold", children: "Search" }) })
    ] }) }) }),
    /* @__PURE__ */ jsx96("div", { className: "sm:hidden grid gap-4 my-6", children: partnersRes.items && partnersRes.items.length > 0 ? partnersRes.items.map((partner) => /* @__PURE__ */ jsxs82("div", { className: "rounded-xl border border-gray-100 bg-white shadow-sm p-4 flex flex-col gap-2", children: [
      /* @__PURE__ */ jsxs82("div", { className: "flex justify-between items-center mb-1", children: [
        /* @__PURE__ */ jsx96("span", { className: "font-bold text-base text-primary", children: partner.legal_business_name }),
        /* @__PURE__ */ jsx96("span", { className: `inline-block px-2 py-1 rounded-lg border text-xs font-semibold ${statusColors[partner.status] || "text-gray-600 bg-gray-100 border-gray-200"}`, children: partner.status })
      ] }),
      /* @__PURE__ */ jsx96("div", { className: "text-xs text-gray-500", children: partner.industry }),
      /* @__PURE__ */ jsxs82("div", { className: "flex flex-col gap-1 mt-2", children: [
        /* @__PURE__ */ jsxs82("div", { children: [
          /* @__PURE__ */ jsx96("span", { className: "font-semibold", children: "Country:" }),
          " ",
          partner.country_of_incorporation
        ] }),
        /* @__PURE__ */ jsxs82("div", { children: [
          /* @__PURE__ */ jsx96("span", { className: "font-semibold", children: "Phone:" }),
          " ",
          partner.phone_number
        ] }),
        /* @__PURE__ */ jsxs82("div", { children: [
          /* @__PURE__ */ jsx96("span", { className: "font-semibold", children: "Contact:" }),
          " ",
      ...
      /* @__PURE__ */ jsxs82("div", { className: "flex gap-2 mt-3", children: [
        /* @__PURE__ */ jsx96("button", { className: "bg-green-600 text-white px-3 py-1 rounded-lg text-xs font-semibold flex-1", children: "Approve" }),
        /* @__PURE__ */ jsx96("button", { className: "bg-red-500 text-white px-3 py-1 rounded-lg text-xs font-semibold flex-1", children: "Reject" })
      ] })
    ] }, partner._id)) : /* @__PURE__ */ jsx96("div", { className: "text-center py-8 text-gray-400", children: "No partners found." }) }),
    /* @__PURE__ */ jsx96("div", { className: "hidden sm:block w-full overflow-x-auto", children: /* @__PURE__ */ jsxs82("table", { className: "w-full table-auto border rounded-xl overflow-hidden", children: [
      /* @__PURE__ */ jsx96("thead", { children: /* @__PURE__ */ jsxs82("tr", { className: "bg-gray-50 text-xs text-gray-500", children: [
        /* @__PURE__ */ jsx96("th", { className: "px-4 py-2 text-left", children: "Business Name" }),
        /* @__PURE__ */ jsx96("th", { className: "px-4 py-2 text-left", children: "Country" }),
        /* @__PURE__ */ jsx96("th", { className: "px-4 py-2 text-left", children: "Phone" }),
        /* @__PURE__ */ jsx96("th", { className: "px-4 py-2 text-left", children: "Industry" }),
        /* @__PURE__ */ jsx96("th", { className: "px-4 py-2 text-left", children: "Status" }),
        /* @__PURE__ */ jsx96("th", { className: "px-4 py-2 text-left", children: "Contact Person" }),
        /* @__PURE__ */ jsx96("th", { className: "px-4 py-2 text-left", children: "Actions" })
      ] }) }),
      /* @__PURE__ */ jsx96("tbody", { children: partnersRes.items && partnersRes.items.length > 0 ? partnersRes.items.map((partner) => /* @__PURE__ */ jsxs82("tr", { className: "border-b last:border-b-0 hover:bg-gray-50", children: [
        /* @__PURE__ */ jsx96("td", { className: "px-4 py-3 font-semibold", children: partner.legal_business_name }),
        /* @__PURE__ */ jsx96("td", { className: "px-4 py-3", children: partner.country_of_incorporation }),
        /* @__PURE__ */ jsx96("td", { className: "px-4 py-3", children: partner.phone_number }),
        /* @__PURE__ */ jsx96("td", { className: "px-4 py-3", children: partner.industry }),
        /* @__PURE__ */ jsx96("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsx96("span", { className: `inline-block px-2 py-1 rounded-lg border text-xs font-semibold ${statusColors[partner.status] || "text-gray-600 bg-gray-100 border-gray-200"}`, children: partner.status }) }),
        /* @__PURE__ */ jsx96("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxs82("div", { className: "text-xs", children: [
          /* @__PURE__ */ jsx96("div", { className: "font-semibold", children: partner.contact_person?.name }),
          /* @__PURE__ */ jsx96("div", { children: partner.contact_person?.email }),
          /* @__PURE__ */ jsx96("div", { children: partner.contact_person?.phone })
        ] }) }),
        /* @__PURE__ */ jsxs82("td", { className: "px-4 py-3", children: [
          /* @__PURE__ */ jsx96("button", { className: "bg-green-600 text-white px-3 py-1 rounded-lg text-xs font-semibold mr-2", children: "Approve" }),
          /* @__PURE__ */ jsx96("button", { className: "bg-red-500 text-white px-3 py-1 rounded-lg text-xs font-semibold", children: "Reject" })
        ] })
      ] }, partner._id)) : /* @__PURE__ */ jsx96("tr", { children: /* @__PURE__ */ jsx96("td", { colSpan: 7, className: "text-center py-8 text-gray-400", children: "No partners found." }) }) })
    ] }) }),
    /* @__PURE__ */ jsx96("div", { className: "sm:block w-full", children: /* @__PURE__ */ jsx96(Pagination, { lastKey: partnersRes?.last_key_id, pageSize: partnersRes?.items_per_page, firstKey: partnersRes?.first_key_id }) })
  ] });
}
...
function CreateTournamentForm() {
  return /* @__PURE__ */ jsxs83(Form20, { className: "max-w-xl mx-auto grid gap-6 sm:gap-12", method: "post", encType: "multipart/form-data", children: [
    /* @__PURE__ */ jsx97("h1", { className: "text-xl xs:text-2xl font-bold text-primary", children: "Create New Tournament" }),
    /* @__PURE__ */ jsxs83("div", { className: "grid gap-3 sm:gap-6", children: [
      /* @__PURE__ */ jsx97(FormControl, { as: "input", labelText: "Tournament Name", placeholder: "Enter tournament name", id: "name", name: "name", required: !0 }),
      /* @__PURE__ */ jsx97(FormControl, { as: "input", labelText: "Tournament Unique ID", placeholder: "Enter unique ID", id: "uniqueId", name: "uniqueId", required: !0 }),
      /* @__PURE__ */ jsx97(FormControl, { as: "textarea", rows: 3, labelText: "Tournament Description", placeholder: "Enter tournament description", id: "description", name: "description", required: !0 }),
      /* @__PURE__ */ jsx97(DragnDrop, { labelText: "Tournament Image", name: "image" })
    ] }),
    /* @__PURE__ */ jsx97("div", { className: "flex justify-end gap-6", children: /* @__PURE__ */ jsx97(Cta_default, { element: "button", type: "submit", className: "px-8 py-2 rounded-lg font-medium max-sm:grow", children: "Create Tournament" }) })
  ] });
}
...
async function action17({ request }) {
  ...
  return redirect24("/admin/tournaments", { headers });
}
function AddTournament() {
  let navigate = useNavigate16();
  return /* @__PURE__ */ jsxs84("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs84("div", { className: "flex items-center mb-8 sm:mb-16 gap-4", children: [
      /* @__PURE__ */ jsx98(RoundCta_default, { icon: icons.arrowPrevIcon, className: "hover:bg-[#F7F7F8] text-primary", onClick: () => navigate(-1) }),
      /* @__PURE__ */ jsx98("span", { className: "font-black text-primary", children: "Create Tournament" })
    ] }),
    /* @__PURE__ */ jsx98(CreateTournamentForm, {})
  ] });
}
...
import { json as json30, redirect as redirect25 } from "@remix-run/node";
...
function SetWithdrawalPin() {
  ...
  }, [actionData]), /* @__PURE__ */ jsxs85("div", { className: "flex min-h-screen items-center justify-center bg-white p-6 font-sans relative", children: [
    /* @__PURE__ */ jsx99(Link15, { to: "/user/wallet", className: "absolute top-4 right-4 text-gray-500 hover:text-gray-800", children: /* @__PURE__ */ jsx99(X, { size: 24 }) }),
    /* @__PURE__ */ jsxs85(Form21, { className: "w-full max-w-lg text-center", method: "POST", children: [
      /* @__PURE__ */ jsx99("input", { type: "hidden", name: "intent", value: "create-withdrawal-pin" }),
      /* @__PURE__ */ jsx99("div", { className: "mb-8 flex justify-center", children: /* @__PURE__ */ jsxs85("div", { className: "relative flex h-16 w-16 items-center justify-center rounded-full bg-[#E5E5EF]", children: [
        /* @__PURE__ */ jsx99("div", { className: "absolute h-24 w-24 rounded-full border border-slate-100" }),
        /* @__PURE__ */ jsx99("div", { className: "absolute h-32 w-32 rounded-full border border-slate-50/50" }),
        /* @__PURE__ */ jsx99(User, { className: "h-8 w-8 text-[#1A1A1A]", fill: "currentColor" })
      ] }) }),
      /* @__PURE__ */ jsx99("h1", { className: "mb-2 text-2xl font-bold tracking-tight text-[#1A1A1A]", children: "Set withdrawal PIN" }),
      /* @__PURE__ */ jsx99("p", { className: "mb-10 text-[15px] text-gray-500", children: "We sent a token to your email address. Please enter it below along with your desired withdrawal PIN." }),
      /* @__PURE__ */ jsxs85("div", { className: "text-left", children: [
        /* @__PURE__ */ jsxs85("label", { className: "mb-2 block text-[15px] font-medium text-[#1A1A1A]", children: [
          "token",
          /* @__PURE__ */ jsx99("span", { className: "ml-0.5 text-red-500", children: "*" })
        ] }),
        /* @__PURE__ */ jsx99("div", { className: "relative", children: /* @__PURE__ */ jsx99(
          "input",
          {
            type: "text",
            maxLength: 4,
...
function AllTournaments() {
  ...
  return /* @__PURE__ */ jsxs86("main", { className: "grow", children: [
    /* @__PURE__ */ jsx100("header", { className: "wrapper my-16", children: /* @__PURE__ */ jsx100("h1", { className: "text-2xl lg:text-4xl font-satoshi-medium max-w-3xl", children: "From Artistic Marvels to Captivating Moments. Unleash Your Talent and Win Big in Our Monthly and Yearly Contests!" }) }),
    /* @__PURE__ */ jsx100("section", { className: "wrapper my-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-12 justify-items-center", children: tournaments.map((tournament) => /* @__PURE__ */ jsx100(ContestCard, { contest: tournament, to: `/contests/${tournament.id}` }, tournament.id)) })
  ] });
}
...
async function loader32({ request }) {
  ...
  return console.log({ data, error }), authRequired ? redirect26("/login") : json32({ data, error, authRequired });
}
var PendingUploadCard = ({
  ...
  full_name,
  contestantId
}) => /* @__PURE__ */ jsx101(Link16, { to: `/user/contestant/${contestantId}`, className: "block transition-shadow", children: /* @__PURE__ */ jsxs87("article", { children: [
  /* @__PURE__ */ jsx101(
    "img",
    {
  ...
  /* @__PURE__ */ jsxs87("div", { className: "pt-4", children: [
    /* @__PURE__ */ jsxs87("p", { className: "text-xs font-semibold uppercase tracking-wide text-gray-500", children: [
      contest_name,
      /* @__PURE__ */ jsx101("br", {}),
      "stage ",
      stage
    ] }),
    /* @__PURE__ */ jsx101("h3", { className: "mt-1 text-lg font-bold text-gray-900", children: full_name })
  ] })
] }) });
...
function UserPendingsUpload() {
  ...
  return /* @__PURE__ */ jsx101("div", { className: "min-h-screen", children: /* @__PURE__ */ jsxs87("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8", children: [
    /* @__PURE__ */ jsx101("header", { className: "bg-[#817EFB] overflow-hidden rounded-3xl py-8 md:py-12 lg:py-16 px-5", children: /* @__PURE__ */ jsxs87("div", { className: "max-w-3xl mx-auto text-center", children: [
      /* @__PURE__ */ jsx101("h1", { className: "text-3xl md:text-4xl lg:text-5xl font-bold text-white", children: "Pending uploads" }),
      /* @__PURE__ */ jsx101("p", { className: "mt-4 text-base md:text-lg text-purple-100", children: "Please, we are expecting your uploads for the following stages" })
    ] }) }),
    /* @__PURE__ */ jsx101("main", { className: "py-12 md:py-16", children: /* @__PURE__ */ jsx101("div", { className: "grid grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-3", children: pendingUploads.map((pendingUpload, idx) => /* @__PURE__ */ jsx101(
      PendingUploadCard,
      {
...
async function loader33({ request }) {
  ...
  let rolesResponse = await adminRepo.getAllRoles(cookieHeader);
  return rolesResponse.authRequired ? redirect27("/login") : { roles: rolesResponse.data, permissions };
}
...
function AddAdminUser() {
  ...
  return /* @__PURE__ */ jsxs88("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs88("div", { className: "flex items-center mb-10 sm:mb-16 gap-4", children: [
      ...
      /* @__PURE__ */ jsx102("h1", { className: "text-2xl font-black text-primary", children: "Add User" })
    ] }),
    /* @__PURE__ */ jsxs88(Form22, { className: "sm:wrapper grid sm:grid-cols-2 gap-3 sm:gap-6 text-sm", method: "post", children: [
      /* @__PURE__ */ jsx102(FormControl, { as: "input", labelText: "First Name", className: "", placeholder: "Enter first name", id: "firstName", name: "firstName", required: !0 }),
      /* @__PURE__ */ jsx102(FormControl, { as: "input", labelText: "Last Name", className: "", placeholder: "Enter last name", id: "lastName", name: "lastName", required: !0 }),
      /* @__PURE__ */ jsx102(FormControl, { as: "input", labelText: "Email Address", className: "", placeholder: "Enter email address", id: "email", name: "email", required: !0 }),
      /* @__PURE__ */ jsx102(FormControl, { as: "input", labelText: "Username", className: "", placeholder: "Enter username", id: "username", name: "username", required: !0 }),
      /* @__PURE__ */ jsx102(FormControl, { as: "input", labelText: "Password", className: "", placeholder: "Enter username", id: "password", name: "password", required: !0 }),
      /* @__PURE__ */ jsxs88(Select2, { label: "Assign Staff", id: "is_staff", name: "is_staff", defaultValue: "1", required: !0, children: [
        /* @__PURE__ */ jsx102("option", { value: "0", children: "Disable" }),
        /* @__PURE__ */ jsx102("option", { value: "1", children: "Enable" })
      ] }),
      /* @__PURE__ */ jsxs88(Select2, { label: "Set Active", id: "is_active", name: "is_active", defaultValue: "1", required: !0, children: [
        /* @__PURE__ */ jsx102("option", { value: "0", children: "De-activate" }),
        /* @__PURE__ */ jsx102("option", { value: "1", children: "Activate" })
      ] }),
      /* @__PURE__ */ jsxs88(Select2, { label: "Has Admin access", id: "has_admin_access", name: "has_admin_access", defaultValue: "1", required: !0, children: [
        /* @__PURE__ */ jsx102("option", { value: "0", children: "False" }),
        /* @__PURE__ */ jsx102("option", { value: "1", children: "True" })
      ] }),
      /* @__PURE__ */ jsx102(RolesFormControl, { roles: rolesNames }),
      /* @__PURE__ */ jsxs88("div", { className: "grid grid-cols-2 sm:flex justify-end gap-3 sm:gap-6 sm:col-span-2 mt-4", children: [
        /* @__PURE__ */ jsx102(Cta_default, { element: "button", type: "reset", className: "px-4 sm:px-8 py-2 rounded-lg font-medium border-secondary active:border-accent", variant: "outline", children: "Reset" }),
        /* @__PURE__ */ jsx102(Cta_default, { disabled: isSubmitting, element: "button", type: "submit", className: "px-4 sm:px-8 py-2 rounded-lg font-medium", children: isSubmitting ? "Creating admin user" : "Create admin user" })
      ] })
    ] })
  ] });
}
...
function CreateContestForm({ tournaments }) {
  ...
  return /* @__PURE__ */ jsxs89(Form23, { className: "max-w-[700px] mx-auto my-8 grid gap-6 sm:gap-12 text-sm", method: "post", encType: "multipart/form-data", children: [
    /* @__PURE__ */ jsx103("h1", { className: "text-2xl font-bold text-primary", children: "Contest Details" }),
    /* @__PURE__ */ jsxs89("fieldset", { className: "grid gap-3 sm:gap-6 sm:grid-cols-2", children: [
      /* @__PURE__ */ jsxs89(Select2, { name: "tournament", id: "tournament", label: "Tournament", className: "uppercase", defaultValue: defaultTournament, required: !0, children: [
        /* @__PURE__ */ jsx103("option", { value: "", children: "Select a tournament" }),
        tournaments.map((tournament) => /* @__PURE__ */ jsx103("option", { value: tournament.id, children: tournament.id }, tournament.id))
      ] }),
      /* @__PURE__ */ jsx103(FormControl, { as: "input", labelText: "Contest Name", placeholder: "Enter contest name", id: "name", name: "name", required: !0 }),
      /* @__PURE__ */ jsx103(FormControl, { as: "textarea", rows: 3, labelClassNames: "sm:col-span-2", labelText: "Contest Description", placeholder: "Enter contest description", id: "description", name: "description", required: !0 }),
      /* @__PURE__ */ jsx103(FormControl, { as: "input", labelText: "Unique Contest ID", placeholder: "Enter unique ID", id: "uniqueId", name: "uniqueId", required: !0 }),
      /* @__PURE__ */ jsx103(FormControl, { as: "input", type: "datetime-local", labelText: "Registration Deadline", id: "reg_deadline", name: "reg_deadline", required: !0 }),
      /* @__PURE__ */ jsx103(FormControl, { as: "input", type: "datetime-local", labelText: "Contest Start Date", id: "start_date", name: "start_date", required: !0 }),
      /* @__PURE__ */ jsx103(FormControl, { as: "input", type: "datetime-local", labelText: "Contest End Date", id: "end_date", name: "end_date", required: !0 }),
      /* @__PURE__ */ jsx103(FormControl, { as: "textarea", rows: 2, labelText: "Contest Prizes", labelClassNames: "sm:col-span-2", placeholder: "Enter contest prizes", id: "prizes", name: "prizes", required: !0 }),
      /* @__PURE__ */ jsx103(DragnDrop, { className: "sm:col-span-2", name: "image", multiple: !1 })
    ] }),
    /* @__PURE__ */ jsx103(CategoryInputs, {}),
    /* @__PURE__ */ jsx103(StageInputs, {}),
    /* @__PURE__ */ jsxs89("fieldset", { className: "grid gap-3 sm:gap-6 sm:grid-cols-2", children: [
      /* @__PURE__ */ jsx103("legend", { className: "text-lg mb-4 font-bold", children: "Contestants and Referrals Earnings" }),
      /* @__PURE__ */ jsx103(FormControl, { as: "input", type: "number", step: 1, max: 100, min: 0, labelText: "Contestant Share Percentage", id: "contestant_share_percent", name: "contestant_share_percent", defaultValue: 50, required: !0 }),
      /* @__PURE__ */ jsx103(FormControl, { as: "input", type: "number", labelText: "Minimum amount for affiliate to earn", id: "min_for_referral_earning", name: "min_for_referral_earning", defaultValue: 3e3, required: !0 }),
      /* @__PURE__ */ jsx103(FormControl, { as: "input", type: "number", labelText: "Amount affiliate would earn from minimum", id: "referral_bonus_from_min", name: "referral_bonus_from_min", defaultValue: 500, required: !0 }),
      /* @__PURE__ */ jsx103(FormControl, { as: "input", type: "number", step: 1, max: 100, min: 0, labelText: "Affiliate percentage earnings after minimum", id: "referral_percent_after_min", name: "referral_percent_after_min", defaultValue: 1, required: !0 })
    ] }),
    /* @__PURE__ */ jsxs89("fieldset", { className: "grid gap-3 sm:gap-6", children: [
      /* @__PURE__ */ jsx103("legend", { className: "text-lg mb-4 font-bold", children: "Submission Guidelines" }),
      /* @__PURE__ */ jsx103(FormControl, { as: "textarea", rows: 4, labelText: "Submission Requirements", placeholder: "Enter text here...", id: "sub_req", name: "sub_req", required: !0 }),
      /* @__PURE__ */ jsx103(FormControl, { as: "textarea", rows: 4, labelText: "Terms & Conditions", placeholder: "Enter text here...", id: "tnc", name: "tnc", required: !0 }),
      /* @__PURE__ */ jsx103(FormControl, { as: "textarea", rows: 4, labelText: "Additional Information", placeholder: "Enter text here...", id: "add_info", name: "add_info", required: !0 })
    ] }),
    /* @__PURE__ */ jsx103("div", { className: "flex justify-end gap-6", children: /* @__PURE__ */ jsx103(Cta_default, { element: "button", type: "submit", className: "px-8 py-2 rounded-lg font-medium max-sm:grow", children: "Create Contest" }) })
  ] });
}
...
async function action20({ request }) {
  ...
  if (data) {
    ...
    return redirect28("/admin/contests", { headers: headers2 });
  }
  let { headers } = await setToast({ request, toast: `error::${error.detail}::${Date.now()}` });
...
function AddContest() {
  ...
  return /* @__PURE__ */ jsxs90("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs90("div", { className: "flex items-center mb-10 sm:mb-16 gap-4", children: [
      /* @__PURE__ */ jsx104(RoundCta_default, { icon: icons.arrowPrevIcon, className: "hover:bg-[#F7F7F8] text-primary", onClick: () => navigate(-1) }),
      /* @__PURE__ */ jsx104("span", { className: "font-black text-primary", children: "Create Contest" })
    ] }),
    /* @__PURE__ */ jsx104(CreateContestForm, { tournaments })
  ] });
}
...
import { useLoaderData as useLoaderData33, Form as Form24, useNavigation as useNavigation11 } from "@remix-run/react";
...
async function loader35({ request }) {
  ...
  return pagedUsersRes.authRequired ? redirect29("/login") : (console.log(pagedUsersRes), json34({ data: pagedUsersRes.data, query }));
}
function PartnerProducts() {
  let { data, query } = useLoaderData33(), navigation = useNavigation11();
  return console.log(data), /* @__PURE__ */ jsxs91("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs91("div", { className: "flex justify-between items-center mb-8 sm:mb-16", children: [
      /* @__PURE__ */ jsx105("h1", { className: "text-2xl font-black text-primary", children: "Products" }),
      /* @__PURE__ */ jsxs91(Cta_default, { element: "link", to: "/partners/add", className: "hidden sm:flex gap-2 items-center rounded-lg px-3 py-2", children: [
        /* @__PURE__ */ jsx105(Svg, { src: icons.addIcon, width: ".9em" }),
        "Add Product"
      ] })
    ] }),
    /* @__PURE__ */ jsx105("div", { className: "flex flex-col gap-3 sm:flex-row justify-between sm:items-center my-8", children: /* @__PURE__ */ jsx105(Form24, { method: "get", className: "w-full bg-white border border-gray-100 rounded-xl p-4 shadow-sm", children: /* @__PURE__ */ jsxs91("div", { className: "grid grid-cols-1 sm:grid-cols-4 gap-3 items-end", children: [
      /* @__PURE__ */ jsxs91("div", { children: [
        /* @__PURE__ */ jsx105("label", { className: "block text-xs font-semibold mb-1", children: "Product Price" }),
        /* @__PURE__ */ jsx105(
          "input",
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxs91("div", { children: [
        /* @__PURE__ */ jsx105("label", { className: "block text-xs font-semibold mb-1", children: "Name, Description or tag" }),
        /* @__PURE__ */ jsx105(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxs91("div", { children: [
        /* @__PURE__ */ jsx105("label", { className: "block text-xs font-semibold mb-1", children: "Status" }),
        /* @__PURE__ */ jsxs91(
          "select",
          {
            name: "status",
            className: "w-full border rounded-lg px-3 py-2",
            children: [
              /* @__PURE__ */ jsx105("option", { value: "available", children: "Available" }),
              /* @__PURE__ */ jsx105("option", { value: "out_of_stock", children: "Out of Stock" }),
              /* @__PURE__ */ jsx105("option", { value: "suspended", children: "Suspended" })
            ]
          }
        )
      ] }),
    ...
    /* @__PURE__ */ jsx105("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-8", children: data?.items && data.items.length > 0 ? data.items.map((product) => {
      let imgSrc = no_image_default;
      return /* @__PURE__ */ jsxs91("div", { className: "my-2 p-2 bg-slate-50 rounded-lg border border-slate-100", children: [
        /* @__PURE__ */ jsxs91("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx105("div", { className: "mt-1 text-indigo-500", children: /* @__PURE__ */ jsxs91("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: [
            /* @__PURE__ */ jsx105("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" }),
            /* @__PURE__ */ jsx105("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M15 11a3 3 0 11-6 0 3 3 0 016 0z" })
          ] }) }),
          /* @__PURE__ */ jsxs91("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsx105("span", { className: "text-xs font-bold text-gray-700", children: product.name }),
            /* @__PURE__ */ jsxs91("span", { className: "text-[11px] text-gray-500", children: [
              product.city,
              ", ",
              product.state_name
            ] })
    ...
    }) : /* @__PURE__ */ jsx105("div", { className: "col-span-full text-center text-gray-400 py-12", children: "No products found." }) }),
    /* @__PURE__ */ jsx105("div", { className: " sm:flex justify-between items-center my-4", children: /* @__PURE__ */ jsx105(Pagination, { lastKey: query?.last_key_id, pageSize: query?.items_per_page, firstKey: query?.first_key_id }) })
  ] });
}
...
import { Link as Link17, useLoaderData as useLoaderData34 } from "@remix-run/react";
...
var WinnerCard = ({
  ...
  full_name,
  id
}) => /* @__PURE__ */ jsx106(Link17, { to: `/winner/${id}`, className: "block transition-shadow", children: /* @__PURE__ */ jsxs92("article", { children: [
  /* @__PURE__ */ jsx106(
    "img",
    {
      src: image_url,
  ...
  /* @__PURE__ */ jsxs92("div", { className: "pt-4", children: [
    /* @__PURE__ */ jsx106("p", { className: "text-xs font-semibold uppercase tracking-wide text-gray-500", children: contest_name }),
    /* @__PURE__ */ jsx106("h3", { className: "mt-1 text-lg font-bold text-gray-900", children: full_name })
  ] })
] }) }), SearchIcon = (props) => /* @__PURE__ */ jsx106(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
function Winners() {
  let { winners, error } = useLoaderData34(), [searchWinners, setSearchWinners] = useState34(""), [winnersFiltered, setWinnersFiltered] = useState34(winners ?? []);
  return useEffect24(() => {
  ...
  }, [searchWinners, winners]), error ? /* @__PURE__ */ jsx106("h1", { className: "font-satoshi-bold text-4xl text-center", children: error.detail }) : /* @__PURE__ */ jsx106("div", { className: "min-h-screen", children: /* @__PURE__ */ jsxs92("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8", children: [
    /* @__PURE__ */ jsx106("header", { className: "bg-[#817EFB] overflow-hidden rounded-3xl py-8 md:py-12 lg:py-16 px-5", children: /* @__PURE__ */ jsxs92("div", { className: "max-w-3xl mx-auto text-center", children: [
      /* @__PURE__ */ jsx106("h1", { className: "text-3xl md:text-4xl lg:text-5xl font-bold text-white", children: "Meet Our Talented Contest Winners" }),
      /* @__PURE__ */ jsx106("p", { className: "mt-4 text-base md:text-lg text-purple-100", children: "A Glimpse of the Extraordinary Creations That Stole the Show" }),
      /* @__PURE__ */ jsxs92("div", { className: "mt-8 relative max-w-lg mx-auto", children: [
        /* @__PURE__ */ jsx106(
          "input",
          {
            type: "text",
        ...
        /* @__PURE__ */ jsx106("div", { className: "absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-auto", children: /* @__PURE__ */ jsx106(SearchIcon, { className: "h-5 w-5 text-gray-400" }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs92("main", { className: "py-12 md:py-16", children: [
      /* @__PURE__ */ jsx106("div", { className: "grid grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-3", children: winnersFiltered.map((winner, idx) => /* @__PURE__ */ jsx106(
        WinnerCard,
        {
      ...
      /* @__PURE__ */ jsx106("div", { className: "mt-12 md:mt-16 text-center", children: /* @__PURE__ */ jsx106(
        "button",
        {
          type: "button",
...
function PartnerLoginOrRequestPartnerShip() {
  ...
  if (!user || !user.is_partner_account)
    return /* @__PURE__ */ jsxs93("main", { className: "h-dvh bg-secondary p-4 flex flex-col", children: [
      /* @__PURE__ */ jsx107(Link18, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx107(Svg, { src: icons.logoIcon, className: "w-14 h-14 sm:w-16 sm:h-16" }) }),
      /* @__PURE__ */ jsxs93("div", { className: "flex flex-col md:flex-row gap-6 p-8  rounded-2xl border border-gray-100", children: [
        /* @__PURE__ */ jsxs93("div", { className: "flex-1 flex flex-col items-start gap-4", children: [
          /* @__PURE__ */ jsx107("div", { className: "p-3 rounded-lg shadow-sm" }),
          /* @__PURE__ */ jsxs93("div", { children: [
            /* @__PURE__ */ jsx107("h3", { className: "font-satoshi-black text-xl text-gray-900", children: "Welcome Back" }),
            /* @__PURE__ */ jsx107("p", { className: "text-gray-500 text-sm mt-1", children: "Access your partner dashboard and manage your account." })
          ] }),
          /* @__PURE__ */ jsx107(
            Link18,
            {
        ...
        /* @__PURE__ */ jsx107("div", { className: "w-px bg-gray-200 hidden md:block" }),
        /* @__PURE__ */ jsxs93("div", { className: "flex-1 flex flex-col items-start gap-4", children: [
          /* @__PURE__ */ jsx107("div", { className: "bg-accent/10 p-3 rounded-lg" }),
          /* @__PURE__ */ jsxs93("div", { children: [
            /* @__PURE__ */ jsx107("h3", { className: "font-satoshi-black text-xl text-gray-900", children: "New Here?" }),
            /* @__PURE__ */ jsx107("p", { className: "text-gray-500 text-sm mt-1", children: "Join our network and start growing your business with us." })
          ] }),
          /* @__PURE__ */ jsx107(
            Link18,
            {
...
import { useActionData as useActionData12, Form as Form26, useNavigate as useNavigate21, useNavigation as useNavigation12 } from "@remix-run/react";
...
function Stepper({ currentStep }) {
  ...
  return /* @__PURE__ */ jsx108("div", { className: "flex flex-wrap items-center justify-center gap-x-2 gap-y-2 text-xs sm:text-sm font-medium text-gray-400 mb-8 sm:mb-12", children: steps.map((step, i) => /* @__PURE__ */ jsxs94("div", { className: "flex items-center gap-x-1 sm:gap-x-2", children: [
    /* @__PURE__ */ jsx108("span", { className: `flex h-6 w-6 items-center justify-center rounded-full text-xs ${i === currentStep ? "bg-black text-white" : "bg-gray-200 text-gray-500"}`, children: i + 1 }),
    /* @__PURE__ */ jsx108("span", { className: i === currentStep ? "text-black" : "", children: step }),
    i < steps.length - 1 && /* @__PURE__ */ jsx108("span", { className: "hidden sm:inline", children: ">" })
  ] }, step)) });
}
var Label2 = ({ children, required }) => /* @__PURE__ */ jsxs94("label", { className: "block text-sm font-semibold text-gray-700 mb-2 mt-5", children: [
  children,
  " ",
  required && /* @__PURE__ */ jsx108("span", { className: "text-red-500", children: "*" })
...
function usePartnerOnboardingController() {
  let navigation = useNavigation12(), [section, setSection] = useState36(0), [form, setForm] = useState36({
    estimated_weekly_volume_currency: "USD",
    referral_percentage: 0,
    country_of_incorporation: "Nigeria"
  }), actionData = useActionData12(), isSuccess = !!actionData?.data && !actionData?.error, businessName = form.legal_business_name ?? "Partner", navigate = useNavigate21();
  return useEffect26(() => {
    actionData?.error && (console.log(actionData.error), toast({
      variant: "destructive",
...
function PartnerOnboarding() {
  ...
  return isSuccess ? /* @__PURE__ */ jsx108("main", { className: "min-h-screen bg-white font-sans text-slate-900 flex items-center justify-center", children: /* @__PURE__ */ jsxs94("div", { className: "max-w-xl w-full mx-auto px-4 py-16 text-center", children: [
    /* @__PURE__ */ jsxs94("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxs94("svg", { className: "mx-auto mb-4 text-green-500", width: "48", height: "48", fill: "none", viewBox: "0 0 24 24", children: [
        /* @__PURE__ */ jsx108("circle", { cx: "12", cy: "12", r: "12", fill: "#22C55E", opacity: "0.1" }),
        /* @__PURE__ */ jsx108("path", { d: "M7 13l3 3 7-7", stroke: "#22C55E", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })
      ] }),
      /* @__PURE__ */ jsxs94("h1", { className: "text-2xl sm:text-3xl font-bold mb-2", children: [
        "Thank you, ",
        businessName,
        "!"
      ] }),
      /* @__PURE__ */ jsxs94("p", { className: "text-gray-700 text-base sm:text-lg mb-6", children: [
  ...
  ] }) }) : /* @__PURE__ */ jsx108("main", { className: "min-h-screen bg-white font-sans text-slate-900 pb-20", children: /* @__PURE__ */ jsxs94("div", { className: "max-w-3xl mx-auto px-2 sm:px-6 pt-8 sm:pt-12", children: [
    /* @__PURE__ */ jsx108(Stepper, { currentStep: section }),
    /* @__PURE__ */ jsx108("div", { className: "text-center mb-8 sm:mb-10", children: /* @__PURE__ */ jsx108("h1", { className: "text-2xl sm:text-4xl font-bold tracking-tight text-gray-900", children: section === 0 ? "Tell us about your business" : section === 1 ? "Enter your business's legal address" : "Enter contact info details" }) }),
    /* @__PURE__ */ jsx108("div", { className: "w-full max-w-xl mx-auto", children: /* @__PURE__ */ jsxs94(Form26, { method: "post", className: "space-y-6", children: [
      /* @__PURE__ */ jsxs94("div", { className: section === 0 ? "" : "hidden", children: [
        /* @__PURE__ */ jsxs94("div", { className: "bg-gray-50 rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 border border-gray-100", children: [
          /* @__PURE__ */ jsx108("h3", { className: "text-xs sm:text-sm font-bold text-gray-500 uppercase tracking-wider mb-3 sm:mb-4", children: "Company information" }),
          /* @__PURE__ */ jsxs94("div", { className: "space-y-2 text-xs sm:text-sm", children: [
            /* @__PURE__ */ jsxs94("div", { className: "flex justify-between flex-wrap", children: [
              /* @__PURE__ */ jsx108("span", { className: "text-gray-500", children: "Company name:" }),
              " ",
              /* @__PURE__ */ jsxs94("span", { className: "font-semibold", children: [
                form.legal_business_name,
                " ",
                /* @__PURE__ */ jsx108("span", { className: "text-green-500", children: "\u25CF" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs94("div", { className: "flex justify-between flex-wrap", children: [
              /* @__PURE__ */ jsx108("span", { className: "text-gray-500", children: "Phone Number:" }),
              " ",
              /* @__PURE__ */ jsx108("span", { className: "font-semibold", children: form.phone_number })
            ] }),
            /* @__PURE__ */ jsxs94("div", { className: "flex justify-between flex-wrap", children: [
              /* @__PURE__ */ jsx108("span", { className: "text-gray-500", children: "Status:" }),
              " ",
              /* @__PURE__ */ jsx108("span", { className: "text-blue-600 font-semibold inline-flex items-center gap-1", children: "\u2713 Active" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Legal business name" }),
          /* @__PURE__ */ jsx108("input", { name: "legal_business_name", required: !0, className: inputClass, value: form.legal_business_name || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Country of incorporation" }),
          /* @__PURE__ */ jsxs94("select", { name: "country_of_incorporation", className: inputClass, value: form.country_of_incorporation, onChange: handleChange, children: [
            /* @__PURE__ */ jsx108("option", { value: "Nigeria", children: "\u{1F1F3}\u{1F1EC} Nigeria" }),
            /* @__PURE__ */ jsx108("option", { value: "Kenya", children: "\u{1F1F0}\u{1F1EA} Kenya" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Business Email" }),
          /* @__PURE__ */ jsx108(
            "input",
            {
              name: "business_email",
        ...
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Phone number" }),
          /* @__PURE__ */ jsxs94("div", { className: "flex flex-col sm:flex-row gap-2 items-stretch", children: [
            /* @__PURE__ */ jsxs94("div", { className: "relative w-full sm:w-32", children: [
              /* @__PURE__ */ jsx108(
                "select",
                {
                  ...
                  children: /* @__PURE__ */ jsx108("option", { value: "+234", children: "\u{1F1F3}\u{1F1EC} +234" })
                }
              ),
              /* @__PURE__ */ jsx108("span", { className: "pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 text-lg", children: "\u25BC" })
            ] }),
            /* @__PURE__ */ jsx108(
              "input",
              {
        ...
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "ROC / CAC Number" }),
          /* @__PURE__ */ jsx108("input", { name: "roc_cac_number", required: !0, className: inputClass, value: form.roc_cac_number || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Tax ID (TIN)" }),
          /* @__PURE__ */ jsx108("input", { name: "tax_id", required: !0, className: inputClass, value: form.tax_id || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Estimated Weekly Volume Currency" }),
          /* @__PURE__ */ jsxs94(
            "select",
            {
              ...
              required: !0,
              children: [
                /* @__PURE__ */ jsx108("option", { value: "", children: "Select currency" }),
                /* @__PURE__ */ jsx108("option", { value: "NGN", children: "NGN" }),
                /* @__PURE__ */ jsx108("option", { value: "USD", children: "USD" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Estimated weekly volume" }),
          /* @__PURE__ */ jsxs94("div", { className: "flex flex-col sm:flex-row gap-2 sm:gap-4", children: [
            /* @__PURE__ */ jsxs94("div", { className: "relative flex-1", children: [
              /* @__PURE__ */ jsx108("span", { className: "absolute left-4 top-1/2 -translate-y-1/2 text-gray-400", children: form.estimated_weekly_volume_currency }),
              /* @__PURE__ */ jsx108("input", { name: "estimated_weekly_volume_min", type: "number", placeholder: "Min", className: `${inputClass} pl-16`, value: form.estimated_weekly_volume_min || "", onChange: handleChange })
            ] }),
            /* @__PURE__ */ jsxs94("div", { className: "relative flex-1", children: [
              /* @__PURE__ */ jsx108("span", { className: "absolute left-4 top-1/2 -translate-y-1/2 text-gray-400", children: form.estimated_weekly_volume_currency }),
              /* @__PURE__ */ jsx108("input", { name: "estimated_weekly_volume_max", type: "number", placeholder: "Max", className: `${inputClass} pl-16`, value: form.estimated_weekly_volume_max || "", onChange: handleChange })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Business description" }),
          /* @__PURE__ */ jsxs94("div", { className: "relative", children: [
            /* @__PURE__ */ jsx108("textarea", { name: "business_description", required: !0, className: `${inputClass} h-32 resize-none`, value: form.business_description || "", onChange: handleChange }),
            /* @__PURE__ */ jsx108("span", { className: "absolute bottom-3 right-3 text-xs text-gray-400", children: "0/5000" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { children: "Website (Optional)" }),
          /* @__PURE__ */ jsx108("input", { name: "website", className: inputClass, placeholder: "https://www.acmetrading.com", value: form.website || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Industry" }),
          /* @__PURE__ */ jsxs94(
            "select",
            {
              name: "industry",
              ...
              required: !0,
              children: [
                /* @__PURE__ */ jsx108("option", { value: "", children: "Select industry" }),
                /* @__PURE__ */ jsx108("option", { value: "Services", children: "Services" }),
                /* @__PURE__ */ jsx108("option", { value: "Manufacturing", children: "Manufacturing" }),
                /* @__PURE__ */ jsx108("option", { value: "Hospitality", children: "Hospitality" }),
                /* @__PURE__ */ jsx108("option", { value: "Financial Industry", children: "Financial Industry" }),
                /* @__PURE__ */ jsx108("option", { value: "Technology", children: "Technology" }),
                /* @__PURE__ */ jsx108("option", { value: "Education", children: "Education" }),
                /* @__PURE__ */ jsx108("option", { value: "Healthcare", children: "Healthcare" }),
                /* @__PURE__ */ jsx108("option", { value: "Retail", children: "Retail" }),
                /* @__PURE__ */ jsx108("option", { value: "Agriculture", children: "Agriculture" }),
                /* @__PURE__ */ jsx108("option", { value: "Construction", children: "Construction" }),
                /* @__PURE__ */ jsx108("option", { value: "Transportation", children: "Transportation" }),
                /* @__PURE__ */ jsx108("option", { value: "Other", children: "Other" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsx108("button", { type: "button", className: "w-full bg-[#4B4870] hover:bg-[#3d3a5c] text-white font-semibold py-3 sm:py-4 rounded-xl shadow-lg transition-all mt-4 text-base sm:text-lg", onClick: () => setSection(1), children: "Next" })
      ] }),
      /* @__PURE__ */ jsxs94("div", { className: section === 1 ? "" : "hidden", children: [
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Country of territory" }),
          /* @__PURE__ */ jsxs94("select", { name: "location_country", required: !0, className: inputClass, value: form.location_country || "", onChange: handleChange, children: [
            /* @__PURE__ */ jsx108("option", { value: "", children: "Select your country" }),
            /* @__PURE__ */ jsx108("option", { value: "Nigeria", children: "Nigeria" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Street Address" }),
          /* @__PURE__ */ jsx108("input", { name: "location_street", required: !0, placeholder: "123 Main Street", className: inputClass, value: form.location_street || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "State" }),
          /* @__PURE__ */ jsxs94("select", { name: "location_state", required: !0, className: inputClass, value: form.location_state || "", onChange: handleChange, children: [
            /* @__PURE__ */ jsx108("option", { value: "", children: "Select state" }),
            /* @__PURE__ */ jsx108("option", { value: "Lagos", children: "Lagos" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "City" }),
          /* @__PURE__ */ jsx108("input", { name: "location_city", required: !0, className: inputClass, value: form.location_city || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Postal Code" }),
          /* @__PURE__ */ jsx108("input", { name: "location_postal", className: inputClass, value: form.location_postal || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs94("div", { className: "flex flex-col sm:flex-row gap-3 pt-4 mt-5", children: [
          /* @__PURE__ */ jsx108("button", { type: "button", className: "w-full sm:flex-1 bg-gray-100 text-gray-600 font-semibold py-3 sm:py-4 rounded-xl", onClick: () => setSection(0), children: "Back" }),
          /* @__PURE__ */ jsx108("button", { type: "button", className: "w-full sm:flex-[2] bg-[#4B4870] text-white font-semibold py-3 sm:py-4 rounded-xl shadow-lg", onClick: () => setSection(2), children: "Next" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs94("div", { className: section === 2 ? "" : "hidden", children: [
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Country of territory" }),
          /* @__PURE__ */ jsxs94("select", { name: "contact_country", required: !0, className: inputClass, value: form.contact_country || "", onChange: handleChange, children: [
            /* @__PURE__ */ jsx108("option", { value: "", children: "Select your country" }),
            /* @__PURE__ */ jsx108("option", { value: "Nigeria", children: "Nigeria" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Contact Name" }),
          /* @__PURE__ */ jsx108("input", { name: "contact_name", required: !0, placeholder: "John Doe", className: inputClass, value: form.contact_name || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Contact Email" }),
          /* @__PURE__ */ jsx108("input", { name: "contact_email", required: !0, className: inputClass, value: form.contact_email || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs94("div", { children: [
          /* @__PURE__ */ jsx108(Label2, { required: !0, children: "Contact Phone" }),
          /* @__PURE__ */ jsx108("input", { name: "contact_phone", className: inputClass, value: form.contact_phone || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs94("div", { className: "flex flex-col sm:flex-row gap-3 pt-4", children: [
          /* @__PURE__ */ jsx108("button", { type: "button", className: "w-full sm:flex-1 bg-gray-100 text-gray-600 font-semibold py-3 sm:py-4 rounded-xl", onClick: () => setSection(1), children: "Back" }),
          /* @__PURE__ */ jsx108("button", { type: "submit", className: "w-full sm:flex-[2] bg-[#4B4870] text-white font-semibold py-3 sm:py-4 rounded-xl shadow-lg", children: navigation.state === "submitting" ? "Submitting..." : "Submit" })
        ] })
      ] })
    ] }) })
  ] }) });
...
function ContactForm() {
  return /* @__PURE__ */ jsxs95("form", { className: "wrapper flex flex-col gap-6", children: [
    /* @__PURE__ */ jsxs95("div", { className: "grid gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsx109(
        FormControl,
        {
          as: "input",
    ...
    /* @__PURE__ */ jsx109(Button, { element: "button", className: "md:self-end", children: "Submit" })
  ] });
}
...
function WhyCard(props) {
  return /* @__PURE__ */ jsxs96("article", { className: `block p-8 text-white rounded-3xl ${props.backgroundColor}`, children: [
    /* @__PURE__ */ jsx110("div", { className: "p-6 mb-8 rounded-3xl bg-[#FFFFFF29] w-fit", children: /* @__PURE__ */ jsx110(Svg, { src: props.icon, width: 24, height: 24 }) }),
    /* @__PURE__ */ jsx110("h3", { className: "mb-4 text-2xl font-black", children: props.title }),
    /* @__PURE__ */ jsx110("p", { className: "font-bold", children: props.subtext })
  ] });
}
...
function SponsorsSlider() {
  return /* @__PURE__ */ jsx111(AutoplayCarousel, { children: /* @__PURE__ */ jsx111(CarouselItem, { children: /* @__PURE__ */ jsx111("img", { src: sponsor_logo_default, alt: "Zendesk" }) }) });
}

// app/routes/_public._index.tsx
import { jsx as jsx112, jsxs as jsxs97 } from "react/jsx-runtime";
function LandingPage() {
  return /* @__PURE__ */ jsxs97("main", { className: "snap-y", children: [
    /* @__PURE__ */ jsxs97("section", { className: "wrapper flex flex-col md:flex-row gap-16 xl:gap-24 md:items-center py-8 md:py-16", children: [
      /* @__PURE__ */ jsxs97("div", { className: "flex flex-col gap-6 sm:gap-8", children: [
        /* @__PURE__ */ jsxs97("h1", { className: "font-black text-4xl sm:text-5xl xl:text-[64px] leading-tight sm:leading-snug whitespace-nowrap", children: [
          "Capturing Moments",
          /* @__PURE__ */ jsx112("br", {}),
          "Creating ",
          /* @__PURE__ */ jsx112("span", { className: "text-accent", children: "Memories." })
        ] }),
        /* @__PURE__ */ jsx112("p", { className: "text-xl", children: "Join our monthly/yearly photo contests open to kids, both male and female aged 0-14 years and discover a world of imagination and inspiration." }),
        /* @__PURE__ */ jsxs97("div", { className: "flex gap-4 flex-wrap", children: [
          /* @__PURE__ */ jsx112(Button, { element: "button", className: "w-full sm:w-auto", children: "Join Now" }),
          /* @__PURE__ */ jsx112(Button, { element: "a", href: "/contests", className: "w-full sm:w-auto", variant: "outline", children: "Explore Contests" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs97("div", { className: "grid grid-cols-3 gap-8 xl:gap-9 w-full", children: [
        /* @__PURE__ */ jsxs97("div", { className: "flex flex-col gap-8 xl:gap-9", children: [
          /* @__PURE__ */ jsx112("img", { className: "aspect-3/7 object-cover rounded-full outline-dashed outline-offset-4 w-full", src: hero_1_default, alt: "kid smiling" }),
          /* @__PURE__ */ jsx112("img", { className: "aspect-3/4 rounded-full outline-dashed outline-offset-4 object-cover w-full", src: hero_2_default, alt: "kid smiling" })
        ] }),
        /* @__PURE__ */ jsxs97("div", { className: "flex flex-col gap-8 xl:gap-9 justify-center", children: [
          /* @__PURE__ */ jsx112("img", { className: "aspect-square rounded-full outline-dashed outline-offset-4 object-cover w-full", src: hero_3_default, alt: "kid smiling" }),
          /* @__PURE__ */ jsx112("img", { className: "aspect-3/7 rounded-full outline-dashed outline-offset-4 object-cover w-full", src: hero_4_default, alt: "kid smiling" })
        ] }),
        /* @__PURE__ */ jsx112("div", { className: "flex flex-col justify-center", children: /* @__PURE__ */ jsx112("img", { className: "aspect-3/7 rounded-full outline-dashed outline-offset-4 object-cover w-full", src: hero_5_default, alt: "kid smiling" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxs97("section", { className: "wrapper py-8 md:py-16", children: [
      /* @__PURE__ */ jsx112("h2", { className: "font-bold text-xl mb-4", children: "Who supports us" }),
      /* @__PURE__ */ jsx112(SponsorsSlider, {})
    ] }),
    /* @__PURE__ */ jsx112("section", { className: "py-8 md:py-16", children: /* @__PURE__ */ jsxs97("div", { className: "sm:wrapper bg-secondary md:px-24 py-16 md:py-28 flex flex-col md:flex-row justify-between items-center gap-16 sm:rounded-3xl", children: [
      /* @__PURE__ */ jsxs97("div", { className: "wrapper", children: [
        /* @__PURE__ */ jsxs97("div", { className: "mb-8", children: [
          /* @__PURE__ */ jsx112("p", { className: "font-black text-xl", children: "Our Vision" }),
          /* @__PURE__ */ jsx112("img", { className: "object-cover object-center", src: underline_default, alt: "underline", width: 100 })
        ] }),
        /* @__PURE__ */ jsxs97("h2", { className: "text-2xl sm:text-3xl font-black mb-6 leading-snug", children: [
          "Crafting ",
          /* @__PURE__ */ jsx112("span", { className: "text-accent", children: "Unforgettable" }),
          " Moments for Every Child's Special Day."
        ] }),
        /* @__PURE__ */ jsx112("p", { className: "font-medium", children: "To create uniquely memorable and exciting kid's birthdays, we strive to be entertaining, transparent, innovative, creative, exciting, efficient, and reliable in every aspect of our service." })
      ] }),
      /* @__PURE__ */ jsx112("div", { className: "wrapper", children: /* @__PURE__ */ jsx112("img", { className: "object-cover object-center w-full", src: birthday_present_default, alt: "wrapped gift" }) })
    ] }) }),
    /* @__PURE__ */ jsxs97("section", { className: "py-8 md:py-16 wrapper flex flex-col items-center", children: [
      /* @__PURE__ */ jsxs97("div", { className: "mb-6 sm:mb-16", children: [
        /* @__PURE__ */ jsx112("h2", { className: "font-satoshi-black text-2xl", children: "Why KOTMY?" }),
        /* @__PURE__ */ jsx112("img", { className: "object-fill w-[159px] h-5", src: underline_default, alt: "underline" })
      ] }),
      /* @__PURE__ */ jsx112("div", { className: "grid gap-6 lg:gap-12 sm:grid-cols-2 max-w-5xl", children: whyUsData.map((item) => /* @__PURE__ */ jsx112(WhyCard, { backgroundColor: item.bg, icon: item.icon, title: item.title, subtext: item.subtext }, item.title)) })
    ] }),
    /* @__PURE__ */ jsx112("section", { className: "py-8 md:py-16", children: /* @__PURE__ */ jsx112(ContestantSlider, { contestants: [{ id: "sdjc", image: hero_1_default }, { id: "adcn", image: hero_2_default }, { id: "kjsd", image: hero_3_default }] }) }),
    /* @__PURE__ */ jsx112("section", { className: "pt-4 sm:py-8 md:py-16", children: /* @__PURE__ */ jsxs97("div", { className: "sm:wrapper bg-[#817EFB] bg-pattern bg-cover bg-left text-secondary md:px-24 py-16 md:py-28 flex flex-col md:flex-row justify-between items-center gap-16 sm:rounded-3xl", children: [
      /* @__PURE__ */ jsxs97("div", { className: "wrapper", children: [
        /* @__PURE__ */ jsx112("h2", { className: "text-2xl sm:text-[40px] font-satoshi-black mb-6 leading-snug", children: "Refer A Friend And Earn Rewards" }),
        /* @__PURE__ */ jsx112("p", { className: "font-satoshi-medium mb-8", children: "Lorem ipsum dolor sit amet consectetur. Velit egestas auctor in amet dis sed sit egestas. Viverra morbi eget consectetur accumsan integer. Mi et etiam amet est egestas tellus quis." }),
        /* @__PURE__ */ jsx112("span", { className: "inline-block bg-[#E7E7E7] text-primary py-4 px-8 text-lg rounded-md font-black whitespace-nowrap", children: "COMING SOON" })
      ] }),
      /* @__PURE__ */ jsx112("div", { className: "wrapper bg-[#E7E7E7] rounded-3xl w-full aspect-square" })
    ] }) }),
    /* @__PURE__ */ jsx112("section", { id: "contact", className: "sm:py-8 md:py-16 sm:-scroll-m-4 md:-scroll-m-8 snap-start", children: /* @__PURE__ */ jsxs97("div", { className: "sm:wrapper bg-secondary md:px-24 py-16 md:py-28 flex flex-col md:flex-row justify-between gap-16 sm:rounded-3xl", children: [
      /* @__PURE__ */ jsxs97("div", { className: "wrapper flex flex-col gap-12", children: [
        /* @__PURE__ */ jsx112("h2", { className: "text-2xl sm:text-[40px] font-satoshi-black leading-tight", children: "Do you want to know more about the way we work?" }),
        /* @__PURE__ */ jsxs97("div", { className: "flex flex-col lg:flex-row gap-6", children: [
          /* @__PURE__ */ jsxs97("p", { children: [
            /* @__PURE__ */ jsx112("span", { className: "block font-satoshi-black mb-3", children: "Phone Us" }),
            /* @__PURE__ */ jsx112("span", { className: "font-satoshi-medium whitespace-nowrap", children: "+234 703 515 9093" })
          ] }),
          /* @__PURE__ */ jsxs97("p", { children: [
            /* @__PURE__ */ jsx112("span", { className: "block font-satoshi-black mb-3", children: "Email Us" }),
            /* @__PURE__ */ jsx112("span", { className: "font-satoshi-medium", children: "kidmonthyear@gmail.com" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs97("div", { children: [
          /* @__PURE__ */ jsx112("span", { className: "block font-satoshi-black mb-3", children: "Follow Us" }),
          /* @__PURE__ */ jsxs97("span", { className: "flex gap-4", children: [
            /* @__PURE__ */ jsx112(Svg, { src: icons.twitterXIcon, width: "24px", height: "24px" }),
            /* @__PURE__ */ jsx112(Svg, { src: icons.instagramIcon, width: "24px", height: "24px" }),
            /* @__PURE__ */ jsx112(Svg, { src: icons.facebookIcon, width: "24px", height: "24px" }),
            /* @__PURE__ */ jsx112(Svg, { src: icons.youtubeIcon, width: "24px", height: "24px" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx112(ContactForm, {})
    ] }) })
  ] });
}
...
import { useLoaderData as useLoaderData37 } from "@remix-run/react";

// app/components/admin/AdminSummary.tsx
import { jsx as jsx113, jsxs as jsxs98 } from "react/jsx-runtime";
function AdminSummary({ users }) {
  return /* @__PURE__ */ jsxs98("div", { className: "border rounded-xl overflow-hidden basis-3/5 max-w-xl", children: [
    /* @__PURE__ */ jsxs98("div", { className: "flex gap-2 xs:gap-4 justify-between items-center py-3 px-4 border-b", children: [
      /* @__PURE__ */ jsx113("h3", { className: "text-primary font-bold max-sm:text-xs", children: "Admin Accounts" }),
      /* @__PURE__ */ jsx113(
        Cta_default,
        {
          element: "link",
    ...
    /* @__PURE__ */ jsx113("div", { className: "px-4 grid", children: users.slice(0, 5).map((user) => /* @__PURE__ */ jsx113(AdminUserCard, { user, className: "border-0 shadow-none rounded-none border-b last:border-b-0" }, user._id)) })
  ] });
}
...
function ArticleSummary() {
  return /* @__PURE__ */ jsx114("div", { className: "basis-1/5 p-3" });
}

// app/components/admin/Aggregator.tsx
import { jsx as jsx115 } from "react/jsx-runtime";
function Aggregator({ className, children, ...props }) {
  return /* @__PURE__ */ jsx115("div", { className: "@container", children: /* @__PURE__ */ jsx115(
    "aside",
    {
      ...props,
      className: cn(
...
function AggregatorItem({ className, children, ...props }) {
  return /* @__PURE__ */ jsx115("div", { className: cn("flex gap-3 items-center text-nowrap min-w-48", className), ...props, children });
}
...
function ContestSummary({ contests: contests2 }) {
  ...
  return /* @__PURE__ */ jsxs99("div", { className: "border rounded-xl overflow-hidden grow", children: [
    /* @__PURE__ */ jsxs99("div", { className: "flex gap-2 xs:gap-4 justify-between items-center py-3 px-4 border-b", children: [
      /* @__PURE__ */ jsx116("h3", { className: "text-primary font-bold max-sm:text-xs", children: "Contests" }),
      /* @__PURE__ */ jsx116(
        Cta_default,
        {
          element: "link",
    ...
    /* @__PURE__ */ jsxs99("div", { className: "px-4", children: [
      /* @__PURE__ */ jsxs99(Aggregator, { className: "my-4", children: [
        /* @__PURE__ */ jsxs99(AggregatorItem, { children: [
          /* @__PURE__ */ jsx116("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx116(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs99("span", { className: "grid", children: [
            /* @__PURE__ */ jsx116("span", { className: "text-primary font-satoshi-black", children: contests2.length }),
            /* @__PURE__ */ jsx116("span", { className: "", children: "Contests Created" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs99(AggregatorItem, { className: "flex gap-3 items-center", children: [
          /* @__PURE__ */ jsx116("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx116(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs99("span", { className: "grid", children: [
            /* @__PURE__ */ jsx116("span", { className: "text-primary font-satoshi-black", children: ongoingCount }),
            /* @__PURE__ */ jsx116("span", { className: "", children: "Ongoing Contests" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs99(AggregatorItem, { className: "flex gap-3 items-center", children: [
          /* @__PURE__ */ jsx116("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx116(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs99("span", { className: "grid", children: [
            /* @__PURE__ */ jsx116("span", { className: "text-primary font-satoshi-black", children: yetToStartCount }),
            /* @__PURE__ */ jsx116("span", { className: "", children: "Yet To Start Contests" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs99(AggregatorItem, { className: "flex gap-3 items-center", children: [
          /* @__PURE__ */ jsx116("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx116(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs99("span", { className: "grid", children: [
            /* @__PURE__ */ jsx116("span", { className: "text-primary font-satoshi-black", children: closedCount }),
            /* @__PURE__ */ jsx116("span", { className: "", children: "Closed Contests" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx116(ContestTable, { data: contests2.slice(0, 5) })
    ] })
  ] });
}
...
function TournamentSummary({ tournaments }) {
  ...
  return /* @__PURE__ */ jsxs100("div", { className: "border rounded-xl overflow-hidden grow max-w-2xl", children: [
    /* @__PURE__ */ jsxs100("div", { className: "flex gap-2 xs:gap-4 justify-between items-center py-3 px-4 border-b", children: [
      /* @__PURE__ */ jsx117("h3", { className: "text-primary font-bold max-sm:text-xs", children: "Tournaments" }),
      /* @__PURE__ */ jsx117(
        Cta_default,
        {
          element: "link",
    ...
    /* @__PURE__ */ jsxs100("div", { className: "px-4 grid", children: [
      /* @__PURE__ */ jsxs100(Aggregator, { className: "mt-4", children: [
        /* @__PURE__ */ jsxs100(AggregatorItem, { children: [
          /* @__PURE__ */ jsx117("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx117(Svg, { src: icons.adminTournamentIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs100("span", { className: "grid", children: [
            /* @__PURE__ */ jsx117("span", { className: "text-primary font-satoshi-black", children: tournaments.length }),
            /* @__PURE__ */ jsx117("span", { className: "", children: "Tournaments Created" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs100(AggregatorItem, { className: "flex gap-3 items-center", children: [
          /* @__PURE__ */ jsx117("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx117(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs100("span", { className: "grid", children: [
            /* @__PURE__ */ jsx117("span", { className: "text-primary font-satoshi-black", children: numberOfContests }),
            /* @__PURE__ */ jsx117("span", { className: "", children: "Contests Created" })
          ] })
        ] })
      ] }),
      tournaments.slice(0, 2).map((tournament) => /* @__PURE__ */ jsx117(TournamentCard, { tournament, className: "border-0 shadow-none bg-transparent rounded-none border-b last:border-b-0" }, tournament.id))
    ] })
  ] });
}
...
function Home() {
  let { adminUsers: adminUsers3, tournaments, contests: contests2, transactions } = useLoaderData37();
  return /* @__PURE__ */ jsxs101("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs101("h1", { className: "grid font-medium text-primary", children: [
      /* @__PURE__ */ jsx118("span", { className: "text-xl sm:text-2xl font-satoshi-bold line-clamp-1", children: "Hello Admin" }),
      /* @__PURE__ */ jsx118("span", { className: "line-clamp-1", children: "Welcome back to KOTMY \u{1F44B}" })
    ] }),
    /* @__PURE__ */ jsxs101("section", { className: "my-6 grid sm:flex flex-wrap items-start gap-6", children: [
      /* @__PURE__ */ jsx118(AdminSummary, { users: adminUsers3 }),
      /* @__PURE__ */ jsx118(ArticleSummary, {}),
      /* @__PURE__ */ jsx118(TournamentSummary, { tournaments }),
      /* @__PURE__ */ jsx118(ContestSummary, { contests: contests2 })
    ] })
  ] });
}
...
async function loader39({ request }) {
  ...
  return referralBoardRes.authRequired ? redirect31("/login") : json37({ wallets: walletsResponse.data, referralBoardRes: referralBoardRes.data, query });
}
function AffilliateLeaderBoard2() {
  let { wallets, referralBoardRes, query } = useLoaderData38(), navigation = useNavigation13();
  return console.log(referralBoardRes), /* @__PURE__ */ jsxs102("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsx119("p", { className: "font-semibold", children: "Affiliates leader board" }),
    /* @__PURE__ */ jsx119("div", { className: "flex flex-col gap-3 sm:flex-row justify-between sm:items-center my-8", children: /* @__PURE__ */ jsx119(Form27, { method: "get", onSubmit: (e) => {
      try {
      } catch {
      }
    }, className: "w-full bg-white border border-gray-100 rounded-xl p-4 shadow-sm", children: /* @__PURE__ */ jsxs102("div", { className: "grid grid-cols-1 sm:grid-cols-4 gap-3 items-end", children: [
      /* @__PURE__ */ jsxs102("label", { className: "flex flex-col text-xs text-gray-600", children: [
        /* @__PURE__ */ jsx119("span", { className: "mb-1", children: "From" }),
        /* @__PURE__ */ jsx119("input", { id: "min_created_at", name: "min_created_at", type: "date", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
      ] }),
      /* @__PURE__ */ jsxs102("label", { className: "flex flex-col text-xs text-gray-600", children: [
        /* @__PURE__ */ jsx119("span", { className: "mb-1", children: "To" }),
        /* @__PURE__ */ jsx119("input", { id: "max_created_at", name: "max_created_at", type: "date", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
      ] }),
      /* @__PURE__ */ jsxs102("label", { className: "flex flex-col text-xs text-gray-600", children: [
        /* @__PURE__ */ jsx119("span", { className: "mb-1", children: "Currency" }),
        /* @__PURE__ */ jsx119("select", { id: "wallet_id", name: "wallet_id", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: wallets.map((wallet) => /* @__PURE__ */ jsx119("option", { value: wallet.str_id, children: wallet.wallet_currency }, wallet.str_id)) })
      ] }),
      /* @__PURE__ */ jsx119("div", { className: "flex justify-end", children: /* @__PURE__ */ jsx119("button", { type: "submit", disabled: navigation.state === "submitting", className: "px-4 py-2 bg-[#312E81] text-white rounded-lg text-sm", children: navigation.state === "submitting" ? "Searching..." : "Search" }) })
    ] }) }) }),
    /* @__PURE__ */ jsx119("div", { className: "sm:block w-full overflow-x-auto", children: /* @__PURE__ */ jsxs102("table", { className: "w-full table-auto", children: [
      /* @__PURE__ */ jsx119("thead", { children: /* @__PURE__ */ jsxs102("tr", { className: "border-b border-secondary", children: [
        /* @__PURE__ */ jsx119("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Contestant Name" }),
        /* @__PURE__ */ jsx119("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Contestant Code" }),
        /* @__PURE__ */ jsx119("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Contest Name" }),
        /* @__PURE__ */ jsx119("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Reward Earned" })
      ] }) }),
      /* @__PURE__ */ jsx119("tbody", { children: referralBoardRes?.items.map((referrerBoard, index) => /* @__PURE__ */ jsxs102("tr", { className: "border-b border-secondary", children: [
        /* @__PURE__ */ jsx119("td", { className: "p-3", children: `${referrerBoard.contestant_biodata.first_name} ${referrerBoard.contestant_biodata.last_name}` }),
        /* @__PURE__ */ jsx119("td", { className: "p-3", children: referrerBoard.contestant_deets[0]?.code }),
        /* @__PURE__ */ jsx119("td", { className: "p-3", children: referrerBoard.current_contest.name }),
        /* @__PURE__ */ jsx119("td", { className: "p-3", children: `${referralBoardRes.summary?.currency} ${referrerBoard.total_earning.toLocaleString()}` })
      ] }, index)) })
    ] }) }),
    /* @__PURE__ */ jsx119("div", { className: "hidden sm:flex justify-between items-center my-4", children: /* @__PURE__ */ jsx119(Pagination, { lastKey: referralBoardRes?.last_key_id, pageSize: referralBoardRes?.items_per_page, firstKey: referralBoardRes?.first_key_id }) })
  ] });
}
...
import { json as json38, redirect as redirect32 } from "@remix-run/node";
import { useLoaderData as useLoaderData39, Form as Form28, useNavigation as useNavigation14 } from "@remix-run/react";
...
async function loader40({ request }) {
  ...
  return pagedUsersRes.authRequired ? redirect32("/login") : (console.log(pagedUsersRes), json38({ data: pagedUsersRes.data, query }));
}
function PartnerProducts2() {
  let { data, query } = useLoaderData39(), navigation = useNavigation14();
  return console.log(data), /* @__PURE__ */ jsxs103("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs103("div", { className: "flex justify-between items-center mb-8 sm:mb-16", children: [
      /* @__PURE__ */ jsx120("h1", { className: "text-2xl font-black text-primary", children: "Products" }),
      /* @__PURE__ */ jsx120(Cta_default, { element: "link", to: "/partners/add", className: " gap-2 items-center rounded-lg px-3 py-2", children: "Add Product" })
    ] }),
    /* @__PURE__ */ jsx120("div", { className: "flex flex-col gap-3 sm:flex-row justify-between sm:items-center my-8", children: /* @__PURE__ */ jsx120(Form28, { method: "get", className: "w-full bg-white border border-gray-100 rounded-xl p-4 shadow-sm", children: /* @__PURE__ */ jsxs103("div", { className: "grid grid-cols-1 sm:grid-cols-4 gap-3 items-end", children: [
      /* @__PURE__ */ jsxs103("div", { children: [
        /* @__PURE__ */ jsx120("label", { className: "block text-xs font-semibold mb-1", children: "Product Price" }),
        /* @__PURE__ */ jsx120(
          "input",
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxs103("div", { children: [
        /* @__PURE__ */ jsx120("label", { className: "block text-xs font-semibold mb-1", children: "Name, Description or tag" }),
        /* @__PURE__ */ jsx120(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxs103("div", { children: [
        /* @__PURE__ */ jsx120("label", { className: "block text-xs font-semibold mb-1", children: "Status" }),
        /* @__PURE__ */ jsxs103(
          "select",
          {
            name: "status",
            className: "w-full border rounded-lg px-3 py-2",
            children: [
              /* @__PURE__ */ jsx120("option", { value: "available", children: "Available" }),
              /* @__PURE__ */ jsx120("option", { value: "out_of_stock", children: "Out of Stock" }),
              /* @__PURE__ */ jsx120("option", { value: "suspended", children: "Suspended" })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsx120("div", { className: "sm:col-span-1 flex gap-2 mt-2 sm:mt-0", children: /* @__PURE__ */ jsx120("button", { type: "submit", className: "bg-[#4B4870] text-white px-4 py-2 rounded-lg font-semibold", children: "Search" }) })
    ] }) }) }),
    /* @__PURE__ */ jsx120("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-8", children: data?.items && data.items.length > 0 ? data.items.map((product) => {
      ...
      return /* @__PURE__ */ jsxs103(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx120("div", { className: "h-40 w-full bg-gray-100 flex items-center justify-center overflow-hidden", children: /* @__PURE__ */ jsx120(
              "img",
              {
                src: imgSrc,
                alt: product.name,
            ...
            /* @__PURE__ */ jsxs103("div", { className: "flex flex-col flex-1 p-4 gap-2", children: [
              /* @__PURE__ */ jsxs103("div", { className: "flex items-center justify-between gap-2", children: [
                /* @__PURE__ */ jsx120("span", { className: "font-bold text-base text-primary line-clamp-1", children: product.name }),
                /* @__PURE__ */ jsx120("span", { className: "text-xs px-2 py-1 rounded bg-gray-50 border border-gray-200 font-semibold capitalize", children: product.status.replace(/_/g, " ") })
              ] }),
              /* @__PURE__ */ jsx120("div", { className: "text-sm text-gray-500 line-clamp-2 mb-1", children: product.description }),
              /* @__PURE__ */ jsxs103("div", { className: "flex items-center gap-2 text-lg font-bold text-accent", children: [
                product.currency,
                " ",
                product.price_min,
                product.price_max && product.price_max !== product.price_min ? /* @__PURE__ */ jsxs103("span", { className: "text-gray-400 font-normal text-base", children: [
                  "- ",
                  product.currency,
                  " ",
                  product.price_max
              ...
              /* @__PURE__ */ jsx120("div", { className: "flex flex-wrap gap-1 mt-1", children: product.tags && product.tags.length > 0 && product.tags.map((tag) => /* @__PURE__ */ jsx120("span", { className: "bg-indigo-50 text-indigo-600 text-xs px-2 py-0.5 rounded-full", children: tag }, tag)) }),
              /* @__PURE__ */ jsxs103("div", { className: "mt-auto flex items-center justify-between pt-2", children: [
                /* @__PURE__ */ jsx120("span", { className: "text-xs text-gray-400", children: product.category }),
                /* @__PURE__ */ jsxs103("div", { className: "flex items-center gap-2", children: [
                  product.sku && /* @__PURE__ */ jsxs103("span", { className: "text-xs text-gray-400", children: [
                    "SKU: ",
                    product.sku
                  ] }),
                  /* @__PURE__ */ jsx120(Cta_default, { element: "link", to: `/partners/product/update/${product._id}`, className: "px-3 py-1 rounded-md text-xs font-semibold border-secondary", variant: "outline", children: "Edit" })
                ] })
              ] })
            ] })
          ]
    ...
    }) : /* @__PURE__ */ jsx120("div", { className: "col-span-full text-center text-gray-400 py-12", children: "No products found." }) }),
    /* @__PURE__ */ jsx120("div", { className: " sm:flex justify-between items-center my-4", children: /* @__PURE__ */ jsx120(Pagination, { lastKey: query?.last_key_id, pageSize: query?.items_per_page, firstKey: query?.first_key_id }) })
  ] });
}
...
function loader41() {
  return redirect33("/admin/overview");
}
...
import { Form as Form29, useActionData as useActionData13, useLoaderData as useLoaderData40, useNavigate as useNavigate22, useNavigation as useNavigation15 } from "@remix-run/react";
...
async function loader42({ request }) {
  ...
  return locationsRes.authRequired ? redirect34("/login") : json39({
    locations: locationsRes.data?.items ?? []
  });
}
...
function AddPartnerProduct() {
  let { locations } = useLoaderData40(), actionData = useActionData13(), isSubmitting = useNavigation15().state === "submitting", navigate = useNavigate22(), [tags, setTags] = useState37("");
  return useEffect27(() => {
    actionData?.error && (console.log(actionData.error), toast({
      variant: "destructive",
  ...
  }, [actionData, navigate]), /* @__PURE__ */ jsxs104("main", { className: "w-full overflow-y-auto p-6 max-w-2xl mx-auto", children: [
    /* @__PURE__ */ jsxs104("div", { className: "flex items-center mb-10 sm:mb-16 gap-4", children: [
      /* @__PURE__ */ jsx121(Cta_default, { element: "button", type: "button", onClick: () => navigate(-1), className: "hover:bg-[#F7F7F8] text-primary px-4 py-2 rounded-lg", variant: "outline", children: "Back" }),
      /* @__PURE__ */ jsx121("h1", { className: "text-2xl font-black text-primary", children: "Add Partner Product" })
    ] }),
    /* @__PURE__ */ jsxs104(Form29, { method: "post", encType: "multipart/form-data", className: "grid gap-4 text-sm bg-white p-6 rounded-xl border border-gray-100 shadow-sm", children: [
      /* @__PURE__ */ jsx121(FormControl, { as: "input", labelText: "Product Name", name: "name", id: "name", required: !0, placeholder: "Enter product name" }),
      /* @__PURE__ */ jsx121(FormControl, { as: "textarea", labelText: "Description", name: "description", id: "description", required: !0, placeholder: "Enter product description" }),
      /* @__PURE__ */ jsx121(FormControl, { as: "input", labelText: "Category", name: "category", id: "category", placeholder: "e.g. Shoes" }),
      /* @__PURE__ */ jsxs104("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsx121(FormControl, { as: "input", labelText: "Price Min", name: "price_min", id: "price_min", type: "number", min: 0, required: !0, placeholder: "0" }),
        /* @__PURE__ */ jsx121(FormControl, { as: "input", labelText: "Price Max", name: "price_max", id: "price_max", type: "number", min: 0, required: !0, placeholder: "0" })
      ] }),
      /* @__PURE__ */ jsxs104(Select2, { label: "Currency", id: "currency", name: "currency", defaultValue: "NGN", required: !0, children: [
        /* @__PURE__ */ jsx121("option", { value: "NGN", children: "NGN" }),
        /* @__PURE__ */ jsx121("option", { value: "USD", children: "USD" })
      ] }),
      /* @__PURE__ */ jsxs104(Select2, { label: "Status", id: "status", name: "status", defaultValue: "available", required: !0, children: [
        /* @__PURE__ */ jsx121("option", { value: "available", children: "Available" }),
        /* @__PURE__ */ jsx121("option", { value: "out_of_stock", children: "Out of Stock" }),
        /* @__PURE__ */ jsx121("option", { value: "suspended", children: "Suspended" })
      ] }),
      /* @__PURE__ */ jsx121(FormControl, { as: "input", labelText: "SKU", name: "sku", id: "sku", placeholder: "Stock Keeping Unit" }),
      /* @__PURE__ */ jsx121(FormControl, { as: "input", labelText: "Tags (comma separated)", name: "tags", id: "tags", value: tags, onChange: (e) => setTags(e.target.value), placeholder: "e.g. shoes, sports, men" }),
      /* @__PURE__ */ jsxs104("label", { className: "block font-bold text-sm", children: [
        "Locations",
        /* @__PURE__ */ jsx121("div", { className: "mt-2 rounded-lg border border-secondary bg-white p-3", children: /* @__PURE__ */ jsx121(
          "select",
          {
            name: "locations",
            id: "locations",
            multiple: !0,
            className: "w-full min-h-36 rounded-md border border-gray-200 bg-transparent p-3 text-sm outline-none focus:border-accent",
            children: locations.length > 0 ? locations.map((location) => /* @__PURE__ */ jsx121("option", { value: location.str_id, children: location.name }, location.str_id)) : /* @__PURE__ */ jsx121("option", { value: "", disabled: !0, children: "No locations available" })
          }
        ) }),
        /* @__PURE__ */ jsx121("span", { className: "mt-1 block text-xs font-normal text-gray-500", children: "Hold Ctrl or Cmd to select multiple locations." })
      ] }),
      /* @__PURE__ */ jsx121("div", { children: /* @__PURE__ */ jsx121(DragnDrop, { name: "image", labelText: "Product Image", multiple: !1, required: !1 }) }),
      /* @__PURE__ */ jsxs104("div", { className: "flex justify-end gap-4 mt-4", children: [
        /* @__PURE__ */ jsx121(Cta_default, { element: "button", type: "reset", className: "px-4 py-2 rounded-lg font-medium border-secondary active:border-accent", variant: "outline", children: "Reset" }),
        /* @__PURE__ */ jsx121(Cta_default, { disabled: isSubmitting, element: "button", type: "submit", className: "px-4 py-2 rounded-lg font-medium", children: isSubmitting ? "Adding product..." : "Add Product" })
      ] })
    ] })
  ] });
}
...
import { Form as Form30, useLoaderData as useLoaderData41, useActionData as useActionData14, useNavigate as useNavigate23 } from "@remix-run/react";
import { json as json40, redirect as redirect35 } from "@remix-run/node";
import { useEffect as useEffect28, useRef as useRef11, useState as useState38 } from "react";
import { Fragment as Fragment12, jsx as jsx122, jsxs as jsxs105 } from "react/jsx-runtime";
async function loader43({ request }) {
  let cookieHeader = request.headers.get("Cookie");
  if (!cookieHeader)
    return redirect35("/login");
  let { data, error, authRequired } = await authServer.getMe(cookieHeader || "");
  return authRequired ? redirect35("/login") : json40({ data, error });
}
async function action23({ request }) {
  ...
  return json40({ data, error });
}
function useUserProfileController() {
  let { toast: toast5 } = useToast(), loaderData = useLoaderData41(), actionData = useActionData14(), navigate = useNavigate23(), [profile, setProfile] = useState38(loaderData?.data?.user_profile || null), [email, setEmail] = useState38(loaderData?.data?.email || ""), [referralCode, setReferralCode] = useState38(loaderData?.data?.referral_code || ""), [imagePreview, setImagePreview] = useState38(profile?.image_url), fileInputRef = useRef11(null);
  return useEffect28(() => {
...
function UserProfilePage() {
  ...
  return /* @__PURE__ */ jsx122("div", { className: "min-h-screen text-gray-900 bg-secondary flex flex-col items-center pt-24 pb-16", children: /* @__PURE__ */ jsxs105("div", { className: "max-w-2xl w-full px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxs105("div", { className: "flex flex-col items-center mb-8", children: [
      /* @__PURE__ */ jsx122("div", { className: "w-32 h-32 rounded-full overflow-hidden border-4 border-indigo-200 mb-4", children: isLoading ? /* @__PURE__ */ jsx122("div", { className: "w-full h-full bg-gray-200 animate-pulse" }) : imagePreview ? /* @__PURE__ */ jsx122("img", { src: imagePreview, alt: "Profile", className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsx122(Svg, { src: icons.avatarIcon, className: "w-full h-full" }) }),
      isLoading ? /* @__PURE__ */ jsxs105(Fragment12, { children: [
        /* @__PURE__ */ jsx122("div", { className: "h-8 w-40 bg-gray-200 rounded animate-pulse mb-2" }),
        /* @__PURE__ */ jsx122("div", { className: "h-5 w-56 bg-gray-200 rounded animate-pulse" })
      ] }) : /* @__PURE__ */ jsxs105(Fragment12, { children: [
        /* @__PURE__ */ jsxs105("h1", { className: "text-3xl font-bold text-gray-900", children: [
          profile?.first_name,
          " ",
          profile?.last_name
        ] }),
        /* @__PURE__ */ jsx122("p", { className: "text-lg text-gray-600", children: email })
      ] })
    ] }),
    isLoading ? /* @__PURE__ */ jsxs105("div", { className: "bg-white border rounded-3xl p-8 flex flex-col gap-6", children: [
      /* @__PURE__ */ jsx122("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx122("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx122("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx122("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx122("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx122("div", { className: "h-12 bg-gray-200 rounded animate-pulse" })
    ] }) : /* @__PURE__ */ jsxs105(Form30, { method: "POST", encType: "multipart/form-data", className: "bg-white border rounded-3xl p-8 flex flex-col gap-6", children: [
      /* @__PURE__ */ jsx122(FormControl, { as: "input", id: "first_name", name: "first_name", labelText: "First Name", defaultValue: profile?.first_name, icon: icons.avatarIcon, required: !0 }),
      /* @__PURE__ */ jsx122(FormControl, { as: "input", id: "last_name", name: "last_name", labelText: "Last Name", defaultValue: profile?.last_name, icon: icons.avatarIcon, required: !0 }),
      /* @__PURE__ */ jsx122(FormControl, { as: "input", id: "email", name: "email", labelText: "Email", defaultValue: email, icon: icons.avatarIcon, required: !0, readOnly: !0 }),
      /* @__PURE__ */ jsx122(FormControl, { as: "input", id: "status", name: "status", labelText: "Status", defaultValue: profile?.status, icon: icons.avatarIcon }),
      /* @__PURE__ */ jsx122(FormControl, { as: "input", id: "", name: "", labelText: "Referral code", defaultValue: referralCode, icon: icons.lockIcon, required: !0, readOnly: !0 }),
      ...
      /* @__PURE__ */ jsx122(DragnDrop, { name: "image", labelText: "Upload Image", multiple: !1, required: !1 }),
      /* @__PURE__ */ jsx122(Cta_default, { element: "button", type: "submit", className: "rounded-lg p-3", children: "Update Profile" })
    ] })
  ] }) });
}
...
import { json as json41, redirect as redirect36 } from "@remix-run/node";
import { Link as Link19, useActionData as useActionData15, useLoaderData as useLoaderData42, useFetcher as useFetcher12 } from "@remix-run/react";
import { useState as useState39, useMemo as useMemo5, useEffect as useEffect29 } from "react";
...
async function action24({ request }) {
  ...
  let walletResp = await walletRepo.wallet_search(query, cookieHeader);
  if (walletResp.error)
    return json41({ error: walletResp.error }, { status: 400 });
  let ledgersResp = await walletRepo.getUserLedgersForWallet(cookieHeader, query);
  if (ledgersResp.error)
    return json41({ error: ledgersResp.error }, { status: 400 });
  ...
  return console.log("WALLET RESP", walletResp, wallets), json41({ wallets });
}
function useWalletController2() {
  let { wallets } = useLoaderData42(), { setUserStoreManager, getUserStoreManager } = useUserManager(), [user, setUser] = useState39(null), [activeWalletId, setActiveWalletId] = useState39(
    wallets.length > 0 ? wallets[0].wallet._id : null
  );
  useEffect29(() => {
    let _user = getUserStoreManager();
  ...
  let activeData = useMemo5(() => wallets.find((w) => w.wallet._id === activeWalletId) || null, [activeWalletId, wallets]), formatCurrency = (amount, currency) => new Intl.NumberFormat("en-US", {
    style: "currency",
    currency
  }).format(amount), [searchOpen, setSearchOpen] = useState39(!1), fetcher = useFetcher12(), isSubmitting = fetcher.state === "submitting", actionData = useActionData15(), [walletsState, setWalletsState] = useState39(wallets);
  return useEffect29(() => {
    (fetcher.data?.wallets ?? actionData?.wallets) || setWalletsState(wallets);
  }, [wallets, fetcher.data, actionData]), useEffect29(() => {
    let fw = fetcher.data?.wallets ?? actionData?.wallets;
    fw && Array.isArray(fw) && setWalletsState(fw);
  }, [fetcher.data, actionData]), {
    wallets,
...
function WalletPage2() {
  ...
  if (!activeData)
    return /* @__PURE__ */ jsx123("div", { className: "p-8", children: "No wallets found." });
  let activeDataLocal = walletsState.find((w) => w.wallet._id === activeData?.wallet._id) ?? activeData, { wallet, pagedLedgers } = activeDataLocal;
  return /* @__PURE__ */ jsxs106("div", { className: "p-8 max-w-7xl mx-auto bg-[#F9FAFB] min-h-screen", children: [
    /* @__PURE__ */ jsx123("h1", { className: "text-2xl font-semibold mb-6", children: "Wallet" }),
    /* @__PURE__ */ jsxs106("div", { className: "bg-white rounded-3xl p-8 border border-gray-100 shadow-sm mb-8", children: [
      /* @__PURE__ */ jsxs106("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxs106("div", { className: "flex items-center gap-2 text-gray-500", children: [
          /* @__PURE__ */ jsx123("span", { className: "text-sm", children: "Wallet balances" }),
          /* @__PURE__ */ jsx123("button", { className: "hover:bg-gray-100 p-1 rounded-full", children: "\u{1F441}\uFE0F" })
        ] }),
        /* @__PURE__ */ jsx123(
          "select",
          {
            ...
            value: wallet._id,
            onChange: (e) => setActiveWalletId(e.target.value),
            children: walletsState.map((w) => /* @__PURE__ */ jsxs106("option", { value: w.wallet._id, children: [
              w.wallet.wallet_currency,
              " - ",
              w.wallet.account_number
            ] }, w.wallet._id))
      ...
      /* @__PURE__ */ jsx123("div", { className: "flex justify-between items-start", children: /* @__PURE__ */ jsxs106("div", { children: [
        /* @__PURE__ */ jsx123("div", { className: "text-4xl font-bold mb-1", children: formatCurrency(wallet.withdrawable_balance, wallet.wallet_currency) }),
        /* @__PURE__ */ jsx123("div", { className: "text-gray-400 text-sm", children: wallet.wallet_name })
      ] }) }),
      /* @__PURE__ */ jsxs106("div", { className: "flex flex-col sm:flex-row gap-3 mt-8", children: [
        /* @__PURE__ */ jsx123(Link19, { to: `/user/withdraw/${wallet._id}`, children: /* @__PURE__ */ jsx123("button", { className: "bg-[#312E81] text-white px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:opacity-90 transition-opacity w-full sm:w-auto", children: "\u2197 Withdraw" }) }),
        user?.withdrawal_pin_set ? /* @__PURE__ */ jsx123(Link19, { to: `/user/addwithdrawalaccount/${wallet._id}`, children: /* @__PURE__ */ jsx123("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "Add withdrawal account" }) }) : /* @__PURE__ */ jsx123(Link19, { to: "/user/setwithdrawalpin", children: /* @__PURE__ */ jsx123("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "+ Set withdrawal PIN" }) }),
        /* @__PURE__ */ jsx123("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "\u21C4 Transfer to another wallet" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs106("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxs106("div", { className: "flex items-center justify-between mb-3", children: [
        /* @__PURE__ */ jsx123("h2", { className: "text-lg font-medium text-gray-700", children: "Search" }),
        /* @__PURE__ */ jsxs106(
          "button",
          {
            type: "button",
            ...
            "aria-expanded": searchOpen,
            children: [
              /* @__PURE__ */ jsx123("span", { children: searchOpen ? "Hide" : "Show" }),
              /* @__PURE__ */ jsx123(
                "svg",
                {
                  className: `w-4 h-4 transition-transform ${searchOpen ? "rotate-180" : ""}`,
                  ...
                  viewBox: "0 0 24 24",
                  xmlns: "http://www.w3.org/2000/svg",
                  children: /* @__PURE__ */ jsx123("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M19 9l-7 7-7-7" })
                }
              )
            ]
          }
      ...
      /* @__PURE__ */ jsx123("div", { className: `transition-all ${searchOpen ? "overflow-scroll max-h-96" : "overflow-hidden max-h-0"}`, children: /* @__PURE__ */ jsx123("div", { className: "bg-white border border-gray-100 rounded-xl p-4 shadow-sm", children: /* @__PURE__ */ jsxs106(fetcher.Form, { method: "post", className: "grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm", children: [
        /* @__PURE__ */ jsxs106("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx123("span", { className: "mb-1", children: "Transaction type" }),
          /* @__PURE__ */ jsxs106("select", { id: "transaction_type", name: "transaction_type", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx123("option", { value: "", children: "All transaction types" }),
            /* @__PURE__ */ jsx123("option", { value: "credit", children: "Credit" }),
            /* @__PURE__ */ jsx123("option", { value: "debit", children: "Debit" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs106("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx123("span", { className: "mb-1", children: "Status" }),
          /* @__PURE__ */ jsxs106("select", { id: "status", name: "status", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx123("option", { value: "", children: "Any status" }),
            /* @__PURE__ */ jsx123("option", { value: "pending", children: "Pending" }),
            /* @__PURE__ */ jsx123("option", { value: "completed", children: "Completed" }),
            /* @__PURE__ */ jsx123("option", { value: "void", children: "Void" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs106("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx123("span", { className: "mb-1", children: "Min amount" }),
          /* @__PURE__ */ jsx123("input", { id: "min_amount", name: "min_amount", type: "number", step: "0.01", placeholder: "Min amount", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs106("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx123("span", { className: "mb-1", children: "Max amount" }),
          /* @__PURE__ */ jsx123("input", { id: "max_amount", name: "max_amount", type: "number", step: "0.01", placeholder: "Max amount", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs106("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx123("span", { className: "mb-1", children: "From date" }),
          /* @__PURE__ */ jsx123("input", { id: "min_created_at", name: "min_created_at", type: "date", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs106("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx123("span", { className: "mb-1", children: "To date" }),
          /* @__PURE__ */ jsx123("input", { id: "max_created_at", name: "max_created_at", type: "date", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs106("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx123("span", { className: "mb-1", children: "Payment method" }),
          /* @__PURE__ */ jsxs106("select", { id: "payment_method", name: "payment_method", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx123("option", { value: "", children: "Any payment method" }),
            /* @__PURE__ */ jsx123("option", { value: "flutterwave", children: "Flutterwave" }),
            /* @__PURE__ */ jsx123("option", { value: "bank", children: "Bank" }),
            /* @__PURE__ */ jsx123("option", { value: "paystack", children: "Paystack" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs106("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx123("span", { className: "mb-1", children: "Contest code" }),
          /* @__PURE__ */ jsx123("input", { id: "contest_code", name: "contest_code", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsx123("input", { type: "hidden", name: "wallet_id", value: wallet._id }),
        /* @__PURE__ */ jsx123("div", { className: "sm:col-span-3 flex justify-end mt-2", children: /* @__PURE__ */ jsx123("button", { type: "submit", disabled: isSubmitting, className: "px-4 py-2 bg-[#312E81] text-white rounded-lg text-sm disabled:opacity-50", children: isSubmitting ? "Searching..." : "Search" }) })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxs106("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxs106("div", { className: "flex items-center gap-2 text-gray-600 mb-4", children: [
        /* @__PURE__ */ jsx123("span", { children: "\u{1F4C1}" }),
        /* @__PURE__ */ jsxs106("h2", { className: "font-medium", children: [
          "Recent wallet activity (",
          wallet.wallet_currency,
          ")"
        ] })
      ] }),
      /* @__PURE__ */ jsxs106("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-12 mb-8 border-b border-gray-100 pb-6", children: [
        /* @__PURE__ */ jsx123(
          MetricItem2,
          {
            label: "Net change this month",
      ...
      /* @__PURE__ */ jsx123("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs106("table", { className: "w-full text-left text-sm", children: [
        /* @__PURE__ */ jsx123("thead", { children: /* @__PURE__ */ jsxs106("tr", { className: "text-gray-400 border-b", children: [
          /* @__PURE__ */ jsx123("th", { className: "pb-4 font-medium", children: "S/N" }),
          /* @__PURE__ */ jsx123("th", { className: "pb-4 font-medium", children: "Date" }),
          /* @__PURE__ */ jsx123("th", { className: "pb-4 font-medium", children: "Ref ID" }),
          /* @__PURE__ */ jsx123("th", { className: "pb-4 font-medium", children: "Narration" }),
          /* @__PURE__ */ jsx123("th", { className: "pb-4 font-medium", children: "Beneficiary name" }),
          /* @__PURE__ */ jsx123("th", { className: "pb-4 font-medium", children: "Type" }),
          /* @__PURE__ */ jsx123("th", { className: "pb-4 font-medium", children: "Amount" })
        ] }) }),
        /* @__PURE__ */ jsx123("tbody", { className: "divide-y", children: pagedLedgers.items.map((item, idx) => /* @__PURE__ */ jsxs106("tr", { className: "hover:bg-gray-50/50 transition-colors", children: [
          /* @__PURE__ */ jsx123("td", { className: "py-4 text-gray-500", children: idx + 1 }),
          /* @__PURE__ */ jsxs106("td", { className: "py-4 text-gray-900 leading-tight", children: [
            new Date(item.completed_at || "").toLocaleDateString(),
            /* @__PURE__ */ jsx123("div", { className: "text-xs text-gray-400", children: new Date(item.completed_at || "").toLocaleTimeString() })
          ] }),
          /* @__PURE__ */ jsx123("td", { className: "py-4 text-gray-600 font-mono text-xs", children: item.payment_ref }),
          /* @__PURE__ */ jsx123("td", { className: "py-4 text-gray-600 max-w-xs", children: item.description }),
          /* @__PURE__ */ jsx123("td", { className: "py-4 text-gray-600 truncate", children: item.wallet_name }),
          /* @__PURE__ */ jsx123("td", { className: "py-4 uppercase text-xs font-semibold", children: item.entry_type }),
          /* @__PURE__ */ jsx123("td", { className: "py-4", children: /* @__PURE__ */ jsxs106("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx123("span", { className: `font-semibold ${item.entry_type === "credit" ? "text-green-600" : "text-gray-900"}`, children: formatCurrency(item.amount, item.currency) }),
            /* @__PURE__ */ jsx123(StatusBadge2, { status: item.status })
          ] }) })
        ] }, item._id)) })
      ] }) }),
      /* @__PURE__ */ jsxs106("div", { className: "mt-6 flex justify-between items-center text-sm text-gray-500", children: [
        ...
        /* @__PURE__ */ jsx123(Pagination, { lastKey: pagedLedgers.last_key_id, pageSize: pagedLedgers.items_per_page, firstKey: pagedLedgers.first_key_id })
      ] })
    ] })
  ] });
}
function MetricItem2({ label, value, tooltip = !1 }) {
  return /* @__PURE__ */ jsxs106("div", { children: [
    /* @__PURE__ */ jsxs106("div", { className: "text-xs text-gray-400 flex items-center gap-1 mb-1", children: [
      label,
      " ",
      tooltip && /* @__PURE__ */ jsx123("span", { className: "bg-gray-200 rounded-full w-3 h-3 text-[8px] flex items-center justify-center text-white", children: "i" })
    ] }),
    /* @__PURE__ */ jsx123("div", { className: "text-lg font-bold text-gray-800", children: value })
  ] });
}
function StatusBadge2({ status }) {
  ...
  return /* @__PURE__ */ jsxs106("span", { className: `px-2 py-0.5 rounded-full text-[10px] font-medium border flex items-center gap-1 ${styles[status] || ""}`, children: [
    icons2[status],
    " ",
    status
  ] });
...
import { Link as Link20, useNavigate as useNavigate24 } from "@remix-run/react";
...
function PartnerToolbar() {
  ...
  return /* @__PURE__ */ jsxs107(
    Toggletip,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs107(Link20, { to: "/user/profile", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx124(Svg, { src: icons.profileIcon }),
          " Profile"
        ] }),
        /* @__PURE__ */ jsxs107(Link20, { to: "/logout", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
...
function PartnerPrimaryHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs108("header", { className: "h-[85px] hidden sm:flex justify-between items-center gap-4 px-6 py-3 bg-secondary border-b", children: [
    /* @__PURE__ */ jsxs108("div", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsx125(
        "button",
        {
          onClick: toggleNav,
      ...
      /* @__PURE__ */ jsxs108(Link21, { to: "/", className: "text-accent flex items-center gap-6 whitespace-nowrap font-satoshi-black", children: [
    ...
    /* @__PURE__ */ jsx125(PartnerToolbar, {})
  ] });
}
...
function UserMobileHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs109("div", { className: "flex sm:hidden items-center gap-4 p-4 border-b", children: [
    /* @__PURE__ */ jsxs109(Link22, { to: "/", className: "text-accent flex items-center gap-3 sm:gap-6 whitespace-nowrap font-satoshi-black", children: [
    ...
    /* @__PURE__ */ jsx126(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx126(Svg, { src: icons.adminHamburgerIcon, width: 30, height: 24 })
      }
    )
  ] });
}
...
import { NavLink, useLocation as useLocation8, useNavigate as useNavigate25 } from "@remix-run/react";

// app/components/reusables/Accordion.tsx
import * as React13 from "react";
import * as AccordionPrimitive from "@radix-ui/react-accordion";
import { jsx as jsx127, jsxs as jsxs110 } from "react/jsx-runtime";
var Accordion = AccordionPrimitive.Root, AccordionItem = React13.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx127(
...
var AccordionTrigger = React13.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx127(AccordionPrimitive.Header, { className: "flex", children: /* @__PURE__ */ jsxs110(
  AccordionPrimitive.Trigger,
  {
    ...
    children: [
      children,
      /* @__PURE__ */ jsx127(Svg, { src: icons.arrowDownIcon, className: "shrink-0 transition-transform duration-200" })
    ]
  }
) }));
AccordionTrigger.displayName = AccordionPrimitive.Trigger.displayName;
var AccordionContent = React13.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx127(
  AccordionPrimitive.Content,
  {
    ref,
    className: "overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down",
    ...props,
    children: /* @__PURE__ */ jsx127("div", { className: cn("", className), children })
  }
));
AccordionContent.displayName = AccordionPrimitive.Content.displayName;

// app/components/partner/PartnerMobileNavigation.tsx
import { useEffect as useEffect31, useRef as useRef12, useState as useState41 } from "react";
...
function PartnerMobileNavigation({ show, onClose }) {
  let mobileNav = useRef12(null), [user, setUser] = useState41(null), navigate = useNavigate25(), { getUserStoreManager } = useUserManager(), location = useLocation8(), path = `${location.pathname}${location.search}${location.hash}`;
  useEffect31(() => {
    let currentUser = getUserStoreManager();
  ...
  let mainComponent = /* @__PURE__ */ jsxs111("div", { className: "flex justify-between items-center border rounded-lg p-2 text-sm cursor-pointer line-clamp-1 hover:outline outline-1 outline-primary", children: [
    "System default",
  ...
  return /* @__PURE__ */ jsxs111(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs111("div", { className: "flex justify-between items-center py-4 px-6 border-b", children: [
          /* @__PURE__ */ jsx128("span", { className: "font-satoshi-bold", children: "NAVIGATION MENU" }),
          /* @__PURE__ */ jsx128(
            "button",
            {
              onClick: onClose,
              title: "open Menu",
              className: "flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
              children: /* @__PURE__ */ jsx128(Svg, { src: icons.closeIcon })
            }
          )
        ] }),
        /* @__PURE__ */ jsxs111("div", { className: "flex flex-col justify-between grow", children: [
          /* @__PURE__ */ jsxs111("header", { children: [
            /* @__PURE__ */ jsxs111("nav", { "aria-label": "primary navigation", children: [
              /* @__PURE__ */ jsxs111("div", { className: "flex gap-3 items-center bg-white px-6 py-2 border-b", children: [
                ...
                /* @__PURE__ */ jsxs111("span", { className: "grid", children: [
              ...
              /* @__PURE__ */ jsx128(Accordion, { type: "single", collapsible: !0, className: "w-full py-2 border-b", children: /* @__PURE__ */ jsx128("ul", { className: "grid gap-2 font-bold", children: primaryNavs.map((navItem) => navItem.subitems ? /* @__PURE__ */ jsxs111(AccordionItem, { value: navItem.label, className: "group", children: [
                /* @__PURE__ */ jsx128(
                  AccordionTrigger,
                  {
                    ...
                    children: /* @__PURE__ */ jsxs111("span", { className: "flex gap-3 items-center", children: [
                      /* @__PURE__ */ jsx128(Svg, { src: navItem.icon }),
                      navItem.label
                    ] })
                  }
                ),
                /* @__PURE__ */ jsx128(AccordionContent, { children: /* @__PURE__ */ jsx128("ul", { className: "list-disc list-inside p-3 font-normal", children: navItem.subitems.map((subitem) => /* @__PURE__ */ jsx128("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx128(
                  NavLink,
                  {
                    to: subitem.url,
                    onClick: onClose,
              ...
              ] }, navItem.label) : /* @__PURE__ */ jsx128("li", { children: /* @__PURE__ */ jsxs111(
                NavLink,
                {
            ...
            /* @__PURE__ */ jsx128("nav", { className: "my-1", "aria-label": "secondary navigation", children: /* @__PURE__ */ jsx128("ul", { className: "grid font-bold", children: secondaryNavs.map((navItem) => /* @__PURE__ */ jsx128("li", { children: /* @__PURE__ */ jsxs111(
              NavLink,
              {
          ...
          /* @__PURE__ */ jsxs111("aside", { className: "border-t px-6 py-4", children: [
            /* @__PURE__ */ jsxs111("span", { className: "flex items-center gap-1 mb-4 font-satoshi-bold", children: [
              /* @__PURE__ */ jsx128(Svg, { src: icons.themeIcon }),
              "Theme"
            ] }),
            /* @__PURE__ */ jsxs111(
              Toggletip,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx128("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "System default" }),
                  /* @__PURE__ */ jsx128("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Light" }),
                  /* @__PURE__ */ jsx128("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Dark" })
                ]
              }
            )
          ] })
...
function PartnerNavigation({ show }) {
  ...
  return show ? /* @__PURE__ */ jsxs112("header", { className: "bg-secondary border-r hidden sm:flex flex-col justify-between min-w-[280px] h-full", children: [
    /* @__PURE__ */ jsxs112("nav", { className: "py-6", children: [
      /* @__PURE__ */ jsx129("span", { className: "inline-block mb-2 px-6 py-3 font-satoshi-bold", children: "Navigation Menu" }),
      /* @__PURE__ */ jsx129("ul", { className: "grid gap-2 font-bold", children: navs.map((navItem) => /* @__PURE__ */ jsx129("li", { children: /* @__PURE__ */ jsxs112(
        NavLink2,
        {
          to: navItem.url,
          ...
          children: [
            /* @__PURE__ */ jsx129(Svg, { src: navItem.icon }),
            navItem.label
          ]
        }
      ) }, navItem.label)) }),
      /* @__PURE__ */ jsx129(Accordion2, { type: "single", collapsible: !0, className: "w-full mt-2", children: navsWSubs.map((item) => /* @__PURE__ */ jsxs112(AccordionItem2, { value: item.label, className: "group", children: [
        /* @__PURE__ */ jsxs112(
          AccordionTrigger2,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs112("span", { className: "flex gap-3 items-center", children: [
                /* @__PURE__ */ jsx129(Svg, { src: item.icon }),
                item.label
              ] }),
              /* @__PURE__ */ jsx129(Svg, { src: icons.arrowDownIcon, className: "group-[[data-state=open]]:rotate-180 transition-transform duration-200" })
            ]
          }
        ),
        /* @__PURE__ */ jsx129(AccordionContent2, { children: /* @__PURE__ */ jsx129("ul", { className: "list-disc list-inside p-3", children: item.subitems.map((subitem) => /* @__PURE__ */ jsx129("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx129(
          NavLink2,
          {
            to: subitem.url,
            className: ({ isActive }) => `${isActive ? "active" : ""}`,
    ...
    /* @__PURE__ */ jsxs112("aside", { className: "border-t  px-6 py-3", children: [
      /* @__PURE__ */ jsxs112("span", { className: "flex items-center gap-1 mb-2 font-satoshi-bold", children: [
        /* @__PURE__ */ jsx129(Svg, { src: icons.themeIcon }),
        "Theme"
      ] }),
      /* @__PURE__ */ jsxs112(
        Toggletip,
        {
          ...
          children: [
            /* @__PURE__ */ jsx129("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "System default" }),
            /* @__PURE__ */ jsx129("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Light" }),
            /* @__PURE__ */ jsx129("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Dark" })
          ]
        }
      )
    ] })
...
function Layout({ children }) {
  ...
  }, []), /* @__PURE__ */ jsxs113("div", { className: "bg-tertiary text-admin-pry", children: [
    /* @__PURE__ */ jsx130(PartnerPrimaryHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx130(UserMobileHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx130(PartnerMobileNavigation, { onClose: () => {
      setShowNav(!1);
    }, show: showNav }),
    /* @__PURE__ */ jsxs113("div", { className: "sm:flex sm:h-[calc(100vh-85px)]", children: [
      /* @__PURE__ */ jsx130(PartnerNavigation, { show: showNav }),
      /* @__PURE__ */ jsx130("div", { className: "flex-grow overflow-y-auto", children })
    ] })
  ] });
}
function PartnerLayout() {
  return /* @__PURE__ */ jsx130(Layout, { children: /* @__PURE__ */ jsx130(Outlet3, {}) });
}
function ErrorBoundary2() {
  let { pathname } = useLocation10();
  return /* @__PURE__ */ jsx130(Layout, { children: /* @__PURE__ */ jsxs113("div", { className: "w-full max-sm:h-[calc(100dvh-73px)] p-5 m-auto lg:max-w-3xl grid place-content-center text-center gap-5", children: [
    /* @__PURE__ */ jsx130("h2", { className: "text-xl font-bold text-red-500", children: "Something went wrong" }),
    /* @__PURE__ */ jsx130("p", { children: "Apologies, something went wrong on our end. Please try again." }),
    /* @__PURE__ */ jsx130(Cta_default, { element: "link", to: pathname, className: "px-4 py-1 rounded-md", children: "Reload page" }),
    /* @__PURE__ */ jsx130(Cta_default, { element: "link", to: "/partner/overview", className: "px-4 py-1 rounded-md", children: "Back to Partner Home" })
  ] }) });
}
...
function Footer() {
  return /* @__PURE__ */ jsx131("footer", { className: "border-t border-primary py-8", children: /* @__PURE__ */ jsxs114("div", { className: "wrapper flex flex-wrap gap-6 gap-x-12 justify-between font-bold", children: [
    /* @__PURE__ */ jsx131("nav", { className: "flex gap-6 items-center", children: /* @__PURE__ */ jsxs114("ul", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsx131("li", { children: /* @__PURE__ */ jsx131(Link23, { to: "/contests", children: "Contests" }) }),
      /* @__PURE__ */ jsx131("li", { children: /* @__PURE__ */ jsx131(Link23, { to: "/#contact", children: "Contact" }) }),
      /* @__PURE__ */ jsx131("li", { children: /* @__PURE__ */ jsx131(Link23, { to: "/winners", children: "Winners" }) }),
      /* @__PURE__ */ jsx131("li", { children: /* @__PURE__ */ jsx131(Link23, { to: "/results", children: "Results" }) })
    ] }) }),
    /* @__PURE__ */ jsx131("span", { children: "Privacy Policy" }),
    /* @__PURE__ */ jsx131("span", { className: "md:order-first", children: "KOTMY \xA9 2023  All rights reserved" })
  ] }) });
}
...
function MobileNavigation({ show, onClose }) {
  let { pathname } = useLocation11(), [user, setUser] = useState43(null), mobileNav = useRef13(null);
  ...
  return useEffect33(() => {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs115("header", { className: "wrapper py-5", children: [
          /* @__PURE__ */ jsxs115("div", { className: "flex justify-between items-center", children: [
            /* @__PURE__ */ jsx132(Link24, { to: "/", onClick: onClose, "aria-label": "home", children: /* @__PURE__ */ jsx132(Svg, { src: icons.logoIcon, width: 37, height: 36 }) }),
            /* @__PURE__ */ jsx132("button", { onClick: onClose, title: "close menu", className: "flex gap-1 items-center rounded p-2 hover:outline outline-primary", children: /* @__PURE__ */ jsx132(Svg, { src: icons.closeIcon, width: 24, height: 24, className: "sm:hidden" }) })
          ] }),
          /* @__PURE__ */ jsxs115("nav", { className: "", children: [
            /* @__PURE__ */ jsxs115("ul", { className: "grid gap-6 my-12 text-xl font-bold", children: [
              /* @__PURE__ */ jsx132("li", { children: /* @__PURE__ */ jsxs115(NavLink3, { onClick: onClose, to: "/partner/account", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/partner/account") ? /* @__PURE__ */ jsx132(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Partner"
              ] }) }),
              /* @__PURE__ */ jsx132("li", { children: /* @__PURE__ */ jsxs115(NavLink3, { onClick: onClose, to: "/contests", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/contests") ? /* @__PURE__ */ jsx132(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Contests"
              ] }) }),
              /* @__PURE__ */ jsx132("li", { children: /* @__PURE__ */ jsxs115(NavLink3, { onClick: onClose, to: "/winners", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/winners") ? /* @__PURE__ */ jsx132(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Winners"
              ] }) }),
              /* @__PURE__ */ jsx132("li", { children: /* @__PURE__ */ jsxs115(NavLink3, { onClick: onClose, to: "/results", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/results") ? /* @__PURE__ */ jsx132(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Results"
              ] }) }),
              /* @__PURE__ */ jsx132("li", { children: /* @__PURE__ */ jsx132(NavLink3, { onClick: onClose, to: "/login", className: "", children: user ? "My Profile" : "Sign In" }) })
            ] }),
            /* @__PURE__ */ jsx132(Button, { element: "a", onClick: onClose, href: "/signup", className: "block w-full sm:w-auto", children: "Join Now" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs115("aside", { className: "wrapper py-5", children: [
          /* @__PURE__ */ jsxs115("div", { className: "mb-12", children: [
            /* @__PURE__ */ jsx132("span", { className: "block font-satoshi-black mb-2", children: "Follow Us" }),
            /* @__PURE__ */ jsxs115("span", { className: "flex gap-4", children: [
              /* @__PURE__ */ jsx132(Svg, { src: icons.twitterXIcon, width: "24px", height: "24px" }),
              /* @__PURE__ */ jsx132(Svg, { src: icons.instagramIcon, width: "24px", height: "24px" }),
              /* @__PURE__ */ jsx132(Svg, { src: icons.facebookIcon, width: "24px", height: "24px" }),
              /* @__PURE__ */ jsx132(Svg, { src: icons.youtubeIcon, width: "24px", height: "24px" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs115("div", { className: "flex gap-6 justify-between items-end font-satoshi-bold", children: [
            /* @__PURE__ */ jsx132("span", { className: "text-sm whitespace-nowrap", children: "KOTMY \xA9 2023  All rights reserved" }),
            /* @__PURE__ */ jsx132("span", { className: "text-xs whitespace-nowrap", children: "Privacy Policy" })
          ] })
        ] })
      ]
    }
...
function Navigation() {
  let { getUserStoreManager } = useUserManager(), [showNav, setShowNav] = useState44(!1), { pathname } = useLocation12(), [user, setUser] = useState44(null);
  return useEffect34(() => {
    let user2 = getUserStoreManager();
    setUser(user2);
  }, []), /* @__PURE__ */ jsxs116("header", { className: "flex justify-between items-center wrapper py-5", children: [
    /* @__PURE__ */ jsx133(Link25, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx133(Svg, { src: icons.logoIcon, className: "w-9 h-9 sm:w-16 sm:h-16" }) }),
    /* @__PURE__ */ jsxs116("nav", { className: "hidden md:flex gap-16 items-center", children: [
      /* @__PURE__ */ jsxs116("ul", { className: "flex gap-6 text-xl font-bold", children: [
        /* @__PURE__ */ jsx133("li", { children: /* @__PURE__ */ jsxs116(NavLink4, { to: "/partner/account", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/partner/account") ? /* @__PURE__ */ jsx133(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Partner"
        ] }) }),
        /* @__PURE__ */ jsx133("li", { children: /* @__PURE__ */ jsxs116(NavLink4, { to: "/contests", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/contests") ? /* @__PURE__ */ jsx133(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Contests"
        ] }) }),
        /* @__PURE__ */ jsx133("li", { children: /* @__PURE__ */ jsxs116(NavLink4, { to: "/winners", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/winners") ? /* @__PURE__ */ jsx133(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Winners"
        ] }) }),
        /* @__PURE__ */ jsx133("li", { children: /* @__PURE__ */ jsxs116(NavLink4, { to: "/results", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/results") ? /* @__PURE__ */ jsx133(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Results"
        ] }) }),
        /* @__PURE__ */ jsx133("li", { children: /* @__PURE__ */ jsx133(NavLink4, { to: "/login", className: "", children: user ? "My Profile" : "Sign In" }) })
      ] }),
      /* @__PURE__ */ jsx133(Button, { element: "a", href: "/signup", children: "Join Now" })
    ] }),
    /* @__PURE__ */ jsx133(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx133(Svg, { src: icons.hamburgerIcon, width: 40, height: 24 })
      }
    ),
    /* @__PURE__ */ jsx133(MobileNavigation, { onClose: () => {
      setShowNav(!1);
    }, show: showNav })
  ] });
}
...
function Index() {
  return /* @__PURE__ */ jsxs117("div", { className: "min-h-screen bg-primary flex flex-col", children: [
    /* @__PURE__ */ jsx134(Navigation, {}),
    /* @__PURE__ */ jsx134(Outlet4, {}),
    /* @__PURE__ */ jsx134(Footer, {})
  ] });
}
...
function Logout() {
  return useLogoutController(), /* @__PURE__ */ jsxs118("main", { className: "h-dvh bg-secondary p-4 flex flex-col", children: [
    /* @__PURE__ */ jsx135(Link26, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx135(Svg, { src: icons.logoIcon, className: "w-14 h-14 sm:w-16 sm:h-16 cursor-pointer" }) }),
    /* @__PURE__ */ jsxs118("main", { className: "h-dvh bg-secondary p-4 flex flex-col justify-center items-center", children: [
      /* @__PURE__ */ jsx135("h1", { className: "text-2xl font-satoshi-bold text-center", children: "You have been logged out" }),
      /* @__PURE__ */ jsx135(Link26, { to: "/login", className: "mt-4 text-center underline", children: "Login again" })
    ] })
  ] });
}
...
import { Form as Form32, Link as Link27, useActionData as useActionData16, useNavigate as useNavigate26, useSearchParams as useSearchParams5 } from "@remix-run/react";
...
async function action25({ request }) {
  ...
  return error ? { error: error.detail?.toString() || "An error occurred during login.", data: null } : headers?.["Set-Cookie"] ? (responseHeaders = { "Set-Cookie": headers?.["Set-Cookie"] }, json42({ data, error: null }, {
    headers: responseHeaders
  })) : json42({ error, data, headers });
}
function useSignupController() {
  let actionData = useActionData16(), [searchQuery] = useSearchParams5(), { setUserStoreManager } = useUserManager(), { toast: toast5 } = useToast(), navigate = useNavigate26();
  return useEffect36(() => {
    actionData?.error && (toast5({
      variant: "destructive",
...
function Signup() {
  ...
  return /* @__PURE__ */ jsxs119("main", { className: "bg-secondary p-4 flex flex-col", children: [
    /* @__PURE__ */ jsx136(Link27, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx136(Svg, { src: icons.logoIcon, className: "w-14 h-14 sm:w-16 sm:h-16" }) }),
    /* @__PURE__ */ jsx136("section", { className: "grow flex flex-col justify-center items-center", children: /* @__PURE__ */ jsxs119(Form32, { method: "POST", encType: "multipart/form-data", className: "w-full max-w-md p-4 sm:p-8 bg-white border rounded-3xl flex flex-col gap-3", children: [
      /* @__PURE__ */ jsx136("div", { className: "w-max mx-auto p-4 border border-disabled rounded-full bg-gradient-to-b from-slate-200 to-white", children: /* @__PURE__ */ jsx136("div", { className: "w-max p-4 border border-disabled rounded-full bg-white", children: /* @__PURE__ */ jsx136("img", { src: admin_avatar_default, alt: "person silhouette", width: 24, height: 24 }) }) }),
      /* @__PURE__ */ jsx136("h1", { className: "text-2xl font-satoshi-bold text-center", children: "Create your account" }),
      /* @__PURE__ */ jsx136("hr", {}),
      /* @__PURE__ */ jsxs119("p", { className: "text-center text-sm mt-2", children: [
        "Already have an account? ",
        /* @__PURE__ */ jsx136(Link27, { to: "/login", className: "text-primary underline", children: "Login" })
      ] }),
      /* @__PURE__ */ jsxs119("div", { className: "my-2 flex flex-col gap-3", children: [
        /* @__PURE__ */ jsx136(FormControl, { as: "input", id: "first_name", name: "first_name", placeholder: "First Name", labelText: "First Name", icon: icons.avatarIcon, required: !0 }),
        /* @__PURE__ */ jsx136(FormControl, { as: "input", id: "last_name", name: "last_name", placeholder: "Last Name", labelText: "Last Name", icon: icons.avatarIcon, required: !0 }),
        /* @__PURE__ */ jsx136(FormControl, { as: "input", id: "email", name: "email", placeholder: "Enter your email address", labelText: "Email", icon: icons.avatarIcon, required: !0 }),
        /* @__PURE__ */ jsx136(FormControl, { as: "input", id: "password", name: "password", placeholder: "Enter your password", labelText: "Password", type: "password", icon: icons.lockIcon, required: !0 }),
        /* @__PURE__ */ jsx136(FormControl, { as: "input", id: "status", name: "status", placeholder: "Status (optional)", labelText: "Status", icon: icons.avatarIcon }),
        /* @__PURE__ */ jsxs119("label", { htmlFor: "image", className: "flex items-center gap-2 text-sm font-medium text-gray-700", children: [
          /* @__PURE__ */ jsx136(Svg, { src: icons.avatarIcon, className: "w-4 h-4" }),
          "Profile Image"
        ] }),
        /* @__PURE__ */ jsx136(DragnDrop, { className: "sm:col-span-2", name: "image", multiple: !1, labelText: "Upload profile photo" })
      ] }),
      /* @__PURE__ */ jsx136(Cta_default, { element: "button", type: "submit", className: "rounded-lg p-3", children: "Sign Up" })
    ] }) })
  ] });
}
...
import { useEffect as useEffect37, useRef as useRef14, useState as useState45 } from "react";
...
function AdminMobileNavigation({ show, onClose }) {
  ...
  let { getUserStoreManager, hasAcceptedRole } = useUserManager(), userRoles = getUserStoreManager()?.roles.map((r) => r.toLowerCase()) ?? [], [user, setUser] = useState45(null);
  useEffect37(() => {
        ...
        /* @__PURE__ */ jsxs120("div", { className: "flex flex-col justify-between grow", children: [
          /* @__PURE__ */ jsxs120("header", { children: [
            /* @__PURE__ */ jsxs120("nav", { "aria-label": "primary navigation", children: [
              ...
              /* @__PURE__ */ jsx137(Accordion, { type: "single", collapsible: !0, className: "w-full py-2 border-b", children: /* @__PURE__ */ jsx137("ul", { className: "grid gap-2 font-bold", children: primaryNavs2.map((navItem) => navItem.subitems ? /* @__PURE__ */ jsxs120(AccordionItem, { value: navItem.label, className: "group", children: [
                /* @__PURE__ */ jsx137(
                  AccordionTrigger,
                  {
                    className: cn("border-l-4 border-transparent px-6 py-3 font-semibold hover:bg-[#EEF0FF]", {
                ...
                /* @__PURE__ */ jsx137(AccordionContent, { children: /* @__PURE__ */ jsx137("ul", { className: "list-disc list-inside p-3 font-normal", children: navItem.subitems.map((subitem) => /* @__PURE__ */ jsx137("li", { className: `py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]${hasAcceptedRole(user, subitem.acceptedRoles ?? []) ? "" : " hidden "}`, children: /* @__PURE__ */ jsx137(
                  NavLink5,
                  {
                    to: subitem.url,
                    onClick: onClose,
            ...
            /* @__PURE__ */ jsx137("nav", { className: "my-1", "aria-label": "secondary navigation", children: /* @__PURE__ */ jsx137("ul", { className: "grid font-bold", children: secondaryNavs2.map((navItem) => /* @__PURE__ */ jsx137("li", { children: /* @__PURE__ */ jsxs120(
              NavLink5,
              {
                className: "flex gap-3 items-center px-6 py-3 font-semibold border-l-4 hover:bg-[#EEF0FF] border-transparent",
                to: navItem.url,
...
function MobileHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs121("div", { className: "flex sm:hidden items-center gap-4 p-4 border-b", children: [
    /* @__PURE__ */ jsxs121(Link28, { to: "/", className: "text-accent flex items-center gap-3 sm:gap-6 whitespace-nowrap font-satoshi-black", children: [
      /* @__PURE__ */ jsx138(Svg, { src: icons.logoIcon, width: 37, height: 36 }),
      "KOTMY-ADMIN"
    ] }),
    /* @__PURE__ */ jsx138(
      "button",
      {
        ...
        title: "open Menu",
        className: "ml-auto flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
        children: /* @__PURE__ */ jsx138(Svg, { src: icons.adminHamburgerIcon, width: 30, height: 24 })
      }
    )
  ] });
}
...
function AdminNavigation({ show }) {
  let { getUserStoreManager, hasAcceptedRole } = useUserManager(), userRoles = getUserStoreManager()?.roles.map((r) => r.toLowerCase()) ?? [], [user, setUser] = useState46(null), userRolesSet = new Set(userRoles);
  useEffect38(() => {
    setUser(getUserStoreManager());
  }, [getUserStoreManager]);
  ...
  return show ? /* @__PURE__ */ jsxs122("header", { className: "bg-secondary border-r hidden sm:flex flex-col justify-between min-w-[280px]", children: [
    /* @__PURE__ */ jsxs122("nav", { className: "py-6", children: [
      /* @__PURE__ */ jsx139("span", { className: "inline-block mb-2 px-6 py-3 font-satoshi-bold", children: "Navigation Menu" }),
      /* @__PURE__ */ jsx139("ul", { className: "grid gap-2 font-bold", children: navs2.map((navItem) => /* @__PURE__ */ jsx139("li", { children: /* @__PURE__ */ jsxs122(
        NavLink6,
        {
          to: navItem.url,
      ...
      /* @__PURE__ */ jsx139(Accordion3, { type: "single", collapsible: !0, className: "w-full mt-2", children: navsWSubs2.map((item) => /* @__PURE__ */ jsxs122(AccordionItem3, { value: item.label, className: "group", children: [
        /* @__PURE__ */ jsxs122(
          AccordionTrigger3,
          {
            className: cn("border-l-4 border-transparent group w-full flex gap-3 items-center justify-between px-6 py-3 font-semibold hover:bg-[#EEF0FF]", {
            ...
            children: [
              /* @__PURE__ */ jsxs122("span", { className: "flex gap-3 items-center", children: [
                /* @__PURE__ */ jsx139(Svg, { src: item.icon }),
                item.label
              ] }),
              /* @__PURE__ */ jsx139(Svg, { src: icons.arrowDownIcon, className: "group-[[data-state=open]]:rotate-180 transition-transform duration-200" })
            ]
          }
        ),
        /* @__PURE__ */ jsx139(AccordionContent3, { children: /* @__PURE__ */ jsx139("ul", { className: "list-disc list-inside p-3", children: item.subitems.map((subitem) => /* @__PURE__ */ jsx139("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx139(
          NavLink6,
          {
            to: subitem.url,
    ...
    /* @__PURE__ */ jsxs122("aside", { className: "border-t  px-6 py-3", children: [
      /* @__PURE__ */ jsxs122("span", { className: "flex items-center gap-1 mb-2 font-satoshi-bold", children: [
...
function AdminToolbar() {
  let mainComponent = /* @__PURE__ */ jsxs123(
    "div",
    {
      tabIndex: 0,
      className: "relative p-2 rounded-full border flex items-center gap-4 cursor-pointer bg-tertiary hover:bg-[#EEF0FF]",
      children: [
        /* @__PURE__ */ jsxs123("div", { className: "flex gap-3 items-center", children: [
          ...
          /* @__PURE__ */ jsxs123("span", { className: "grid", children: [
            /* @__PURE__ */ jsx140("span", { className: "block text-sm font-satoshi-bold", children: "Admin" }),
            /* @__PURE__ */ jsx140("span", { className: "block text-xs font-satoshi-medium", children: "admin@kotmy.com" })
          ] })
        ] }),
  ...
  return /* @__PURE__ */ jsxs123(
    Toggletip,
    {
      ...
      childContainerClass: "top-[110%] right-0 bg-tertiary p-2 border  text-xs whitespace-nowrap",
      children: [
        /* @__PURE__ */ jsxs123(Link29, { to: "/user/profile", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx140(Svg, { src: icons.profileIcon }),
          " Profile"
        ] }),
        /* @__PURE__ */ jsxs123(Link29, { to: "/logout", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx140(Svg, { src: icons.signoutIcon }),
          " Sign Out"
        ] })
      ]
    }
...
function PrimaryHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs124("header", { className: "h-[85px] hidden sm:flex justify-between items-center gap-4 px-6 py-3 bg-secondary border-b", children: [
    /* @__PURE__ */ jsxs124("div", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsx141(
        "button",
        {
          onClick: toggleNav,
          title: "Toggle Menu",
          className: "flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
          children: /* @__PURE__ */ jsx141(Svg, { src: icons.adminHamburgerIcon, width: 40, height: 24 })
        }
      ),
      /* @__PURE__ */ jsxs124(Link30, { to: "/", className: "text-accent flex items-center gap-6 whitespace-nowrap font-satoshi-black", children: [
        /* @__PURE__ */ jsx141(Svg, { src: icons.logoIcon, width: 37, height: 36 }),
        "KOTMY-ADMIN"
      ] })
    ] }),
    /* @__PURE__ */ jsx141(FormControl, { as: "input", type: "search", className: "min-w-[280px] bg-white", placeholder: "Search..." }),
    /* @__PURE__ */ jsx141(AdminToolbar, {})
  ] });
}
...
function Layout2({ children }) {
  let [showNav, setShowNav] = useState47(!1);
  return useEffect39(() => {
    setShowNav(window.innerWidth >= 640);
  }, []), /* @__PURE__ */ jsxs125("div", { className: "bg-tertiary text-admin-pry", children: [
    /* @__PURE__ */ jsx142(PrimaryHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx142(MobileHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx142(AdminMobileNavigation, { onClose: () => {
      setShowNav(!1);
    }, show: showNav }),
    /* @__PURE__ */ jsxs125("div", { className: "sm:flex sm:h-[calc(100vh-85px)]", children: [
      /* @__PURE__ */ jsx142(AdminNavigation, { show: showNav }),
      children
    ] })
  ] });
}
function AdminLayout() {
  return /* @__PURE__ */ jsx142(Layout2, { children: /* @__PURE__ */ jsx142(Outlet5, {}) });
}
function ErrorBoundary3() {
  let { pathname } = useLocation15();
  return /* @__PURE__ */ jsx142(Layout2, { children: /* @__PURE__ */ jsxs125("div", { className: "w-full max-sm:h-[calc(100dvh-73px)] p-5 m-auto lg:max-w-3xl grid place-content-center text-center gap-5", children: [
    /* @__PURE__ */ jsx142("h2", { className: "text-xl font-bold text-red-500", children: "Something went wrong" }),
    /* @__PURE__ */ jsx142("p", { children: "Apologies, something went wrong on our end. Please try again." }),
    /* @__PURE__ */ jsx142(Cta_default, { element: "link", to: pathname, className: "px-4 py-1 rounded-md", children: "Reload page" }),
    /* @__PURE__ */ jsx142(Cta_default, { element: "link", to: "/admin/overview", className: "px-4 py-1 rounded-md", children: "Back to Admin Home" })
  ] }) });
}
...
import { Form as Form33, Link as Link31, useActionData as useActionData17, useNavigate as useNavigate27, useSearchParams as useSearchParams6 } from "@remix-run/react";
...
async function action26({ request }) {
  ...
  let responseHeaders = {};
  return headers?.["Set-Cookie"] ? (responseHeaders = { "Set-Cookie": headers?.["Set-Cookie"] }, json43({ data, error: null }, {
    headers: responseHeaders
  })) : json43({ data, error: null });
}
function useLoginController() {
  let actionData = useActionData17(), [searchQuery] = useSearchParams6(), { setUserStoreManager, getUserStoreManager } = useUserManager(), { toast: toast5 } = useToast(), navigate = useNavigate27();
  return useEffect40(() => {
...
function Login() {
  ...
  return /* @__PURE__ */ jsxs126("main", { className: "h-dvh bg-secondary p-4 flex flex-col", children: [
    /* @__PURE__ */ jsx143(Link31, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx143(Svg, { src: icons.logoIcon, className: "w-14 h-14 sm:w-16 sm:h-16" }) }),
    /* @__PURE__ */ jsx143("section", { className: "grow flex flex-col justify-center items-center", children: /* @__PURE__ */ jsxs126(Form33, { method: "POST", className: "w-full max-w-md p-4 sm:p-8 bg-white border rounded-3xl flex flex-col gap-3", children: [
      /* @__PURE__ */ jsx143("div", { className: "w-max mx-auto p-4 border border-disabled rounded-full bg-gradient-to-b from-slate-200 to-white", children: /* @__PURE__ */ jsx143("div", { className: "w-max p-4 border border-disabled rounded-full bg-white", children: /* @__PURE__ */ jsx143("img", { src: admin_avatar_default, alt: "person silhouette", width: 24, height: 24 }) }) }),
      /* @__PURE__ */ jsx143("h1", { className: "text-2xl font-satoshi-bold text-center", children: "Enter your details to login" }),
      /* @__PURE__ */ jsx143("hr", {}),
      /* @__PURE__ */ jsxs126("p", { className: "text-center text-sm mt-2", children: [
        "Don't have an account yet? ",
        /* @__PURE__ */ jsx143(Link31, { to: "/signup", className: "text-primary underline", children: "Register" })
      ] }),
      /* @__PURE__ */ jsxs126("div", { className: "my-2 flex flex-col gap-3", children: [
        /* @__PURE__ */ jsx143(
          FormControl,
          {
            as: "input",
      ...
      /* @__PURE__ */ jsx143(Cta_default, { element: "button", type: "submit", className: "rounded-lg p-3", children: "Login" })
    ] }) })
  ] });
}
...
import { Link as Link32, useNavigate as useNavigate28 } from "@remix-run/react";
...
function UserToolbar() {
  let [user, setUser] = useState48(null), { getUserStoreManager } = useUserManager(), navigate = useNavigate28();
  useEffect41(() => {
    let currentUser = getUserStoreManager();
    currentUser || navigate("/login"), setUser(currentUser);
  }, []);
  ...
  return /* @__PURE__ */ jsxs127(
    Toggletip,
    {
      ...
      childContainerClass: "top-[110%] right-0 bg-tertiary p-2 border  text-xs whitespace-nowrap",
      children: [
        /* @__PURE__ */ jsxs127(Link32, { to: "/user/profile", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx144(Svg, { src: icons.profileIcon }),
          " Profile"
        ] }),
        /* @__PURE__ */ jsxs127(Link32, { to: "/logout", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
...
function UserPrimaryHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs128("header", { className: "h-[85px] hidden sm:flex justify-between items-center gap-4 px-6 py-3 bg-secondary border-b", children: [
    /* @__PURE__ */ jsxs128("div", { className: "flex gap-6", children: [
      ...
      /* @__PURE__ */ jsxs128(Link33, { to: "/", className: "text-accent flex items-center gap-6 whitespace-nowrap font-satoshi-black", children: [
...
function UserMobileHeader2({ toggleNav }) {
  return /* @__PURE__ */ jsxs129("div", { className: "flex sm:hidden items-center gap-4 p-4 border-b", children: [
    /* @__PURE__ */ jsxs129(Link34, { to: "/", className: "text-accent flex items-center gap-3 sm:gap-6 whitespace-nowrap font-satoshi-black", children: [
...
import { NavLink as NavLink7, useLocation as useLocation16, useNavigate as useNavigate29 } from "@remix-run/react";
import { useEffect as useEffect42, useRef as useRef15, useState as useState49 } from "react";
...
function UserMobileNavigation({ show, onClose }) {
  let mobileNav = useRef15(null), [user, setUser] = useState49(null), navigate = useNavigate29(), { getUserStoreManager } = useUserManager();
  useEffect42(() => {
    let currentUser = getUserStoreManager();
  ...
  return /* @__PURE__ */ jsxs130(
    "div",
    {
      ...
      className: "mobileNav sm:hidden flex flex-col fixed w-full h-dvh top-0 z-10 data-[show=true]:animate-slide-in-left data-[show=false]:left-full data-[show=false]:animate-slide-out-left bg-secondary overflow-y-auto",
      children: [
        /* @__PURE__ */ jsxs130("div", { className: "flex justify-between items-center py-4 px-6 border-b", children: [
          /* @__PURE__ */ jsx147("span", { className: "font-satoshi-bold", children: "NAVIGATION MENU" }),
          /* @__PURE__ */ jsx147(
            "button",
            {
              onClick: onClose,
              title: "open Menu",
              className: "flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
              children: /* @__PURE__ */ jsx147(Svg, { src: icons.closeIcon })
            }
          )
        ] }),
        /* @__PURE__ */ jsxs130("div", { className: "flex flex-col justify-between grow", children: [
          /* @__PURE__ */ jsxs130("header", { children: [
            /* @__PURE__ */ jsxs130("nav", { "aria-label": "primary navigation", children: [
              /* @__PURE__ */ jsxs130("div", { className: "flex gap-3 items-center bg-white px-6 py-2 border-b", children: [
              ...
              /* @__PURE__ */ jsx147(Accordion, { type: "single", collapsible: !0, className: "w-full py-2 border-b", children: /* @__PURE__ */ jsx147("ul", { className: "grid gap-2 font-bold", children: primaryNavs3.map((navItem) => navItem.subitems ? /* @__PURE__ */ jsxs130(AccordionItem, { value: navItem.label, className: "group", children: [
                /* @__PURE__ */ jsx147(
                  AccordionTrigger,
                  {
                    className: cn("border-l-4 border-transparent px-6 py-3 font-semibold hover:bg-[#EEF0FF]", {
                    ...
                    children: /* @__PURE__ */ jsxs130("span", { className: "flex gap-3 items-center", children: [
                      /* @__PURE__ */ jsx147(Svg, { src: navItem.icon }),
                      navItem.label
                    ] })
                  }
                ),
                /* @__PURE__ */ jsx147(AccordionContent, { children: /* @__PURE__ */ jsx147("ul", { className: "list-disc list-inside p-3 font-normal", children: navItem.subitems.map((subitem) => /* @__PURE__ */ jsx147("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx147(
                  NavLink7,
                  {
                    to: subitem.url,
                    onClick: onClose,
              ...
              ] }, navItem.label) : /* @__PURE__ */ jsx147("li", { children: /* @__PURE__ */ jsxs130(
                NavLink7,
                {
                  className: ({ isActive }) => `flex gap-3 items-center px-6 py-3 font-semibold border-l-4 hover:bg-[#EEF0FF] ${isActive ? "text-accent bg-[#EEF0FF] border-accent" : "border-transparent"}`,
                  to: navItem.url,
            ...
            /* @__PURE__ */ jsx147("nav", { className: "my-1", "aria-label": "secondary navigation", children: /* @__PURE__ */ jsx147("ul", { className: "grid font-bold", children: secondaryNavs3.map((navItem) => /* @__PURE__ */ jsx147("li", { children: /* @__PURE__ */ jsxs130(
              NavLink7,
              {
                className: "flex gap-3 items-center px-6 py-3 font-semibold border-l-4 hover:bg-[#EEF0FF] border-transparent",
                to: navItem.url,
          ...
          /* @__PURE__ */ jsxs130("aside", { className: "border-t px-6 py-4", children: [
            /* @__PURE__ */ jsxs130("span", { className: "flex items-center gap-1 mb-4 font-satoshi-bold", children: [
...
function UserNavigation({ show }) {
  ...
  return show ? /* @__PURE__ */ jsxs131("header", { className: "bg-secondary border-r hidden sm:flex flex-col justify-between min-w-[280px] h-full", children: [
    /* @__PURE__ */ jsxs131("nav", { className: "py-6", children: [
      ...
      /* @__PURE__ */ jsx148("ul", { className: "grid gap-2 font-bold", children: navs3.map((navItem) => /* @__PURE__ */ jsx148("li", { children: /* @__PURE__ */ jsxs131(
        NavLink8,
        {
          to: navItem.url,
          className: ({ isActive }) => `${isActive ? "text-accent bg-[#EEF0FF] border-accent" : "border-transparent"} flex gap-3 items-center px-6 py-3 font-semibold border-l-4 hover:bg-[#EEF0FF]`,
      ...
      /* @__PURE__ */ jsx148(Accordion4, { type: "single", collapsible: !0, className: "w-full mt-2", children: navsWSubs3.map((item) => /* @__PURE__ */ jsxs131(AccordionItem4, { value: item.label, className: "group", children: [
        /* @__PURE__ */ jsxs131(
          AccordionTrigger4,
          {
            className: cn("border-l-4 border-transparent group w-full flex gap-3 items-center justify-between px-6 py-3 font-semibold hover:bg-[#EEF0FF]", {
        ...
        /* @__PURE__ */ jsx148(AccordionContent4, { children: /* @__PURE__ */ jsx148("ul", { className: "list-disc list-inside p-3", children: item.subitems.map((subitem) => /* @__PURE__ */ jsx148("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx148(
          NavLink8,
          {
            to: subitem.url,
            className: ({ isActive }) => `${isActive ? "active" : ""}`,
