...
// app/global.css
var global_default = "/build/_assets/global-XFUVGUQK.css";
...
function ProductCard({
  ...
  return /* @__PURE__ */ jsxs65("article", { className: "flex h-full flex-col overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-[0_10px_30px_rgba(15,23,42,0.06)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_18px_50px_rgba(15,23,42,0.1)]", children: [
    ...
    /* @__PURE__ */ jsxs65("div", { className: "flex-1 flex flex-col gap-4 p-5 min-h-0", children: [
      ...
      /* @__PURE__ */ jsxs65("div", { className: "mt-auto flex items-center justify-between gap-3 border-slate-100 pt-4", children: [
