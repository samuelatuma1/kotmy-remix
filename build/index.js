...
// app/global.css
var global_default = "/build/_assets/global-C4VFUOD4.css";
...
import { Form as Form26, useActionData as useActionData11, useLoaderData as useLoaderData36, useNavigate as useNavigate19, useNavigation as useNavigation15 } from "@remix-run/react";
import { redirect as redirect29 } from "@remix-run/node";
...
async function loader38({ request }) {
  ...
  let rolesResponse = await adminRepo.getAllRoles(cookieHeader);
  return rolesResponse.authRequired ? redirect29("/login") : { roles: rolesResponse.data, permissions };
}
...
function useAddAdminUser() {
  let { permissions: permissions2, roles } = useLoaderData36(), rolesNames = [];
  for (let roleName in roles)
    rolesNames.push(roleName);
  let isSubmitting = useNavigation15().state === "submitting", actionData = useActionData11();
  return useEffect25(() => {
    actionData?.error && (console.log(actionData.error), toast({
      variant: "destructive",
      title: "Create action failed",
...
function AddAdminUser() {
  ...
  return /* @__PURE__ */ jsxs93("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs93("div", { className: "flex items-center mb-10 sm:mb-16 gap-4", children: [
      ...
      /* @__PURE__ */ jsx107("h1", { className: "text-2xl font-black text-primary", children: "Add User" })
    ] }),
    /* @__PURE__ */ jsxs93(Form26, { className: "sm:wrapper grid sm:grid-cols-2 gap-3 sm:gap-6 text-sm", method: "post", children: [
      /* @__PURE__ */ jsx107(FormControl, { as: "input", labelText: "First Name", className: "", placeholder: "Enter first name", id: "firstName", name: "firstName", required: !0 }),
      /* @__PURE__ */ jsx107(FormControl, { as: "input", labelText: "Last Name", className: "", placeholder: "Enter last name", id: "lastName", name: "lastName", required: !0 }),
      /* @__PURE__ */ jsx107(FormControl, { as: "input", labelText: "Email Address", className: "", placeholder: "Enter email address", id: "email", name: "email", required: !0 }),
      /* @__PURE__ */ jsx107(FormControl, { as: "input", labelText: "Username", className: "", placeholder: "Enter username", id: "username", name: "username", required: !0 }),
      /* @__PURE__ */ jsx107(FormControl, { as: "input", labelText: "Password", className: "", placeholder: "Enter username", id: "password", name: "password", required: !0 }),
      /* @__PURE__ */ jsxs93(Select2, { label: "Assign Staff", id: "is_staff", name: "is_staff", defaultValue: "1", required: !0, children: [
        /* @__PURE__ */ jsx107("option", { value: "0", children: "Disable" }),
        /* @__PURE__ */ jsx107("option", { value: "1", children: "Enable" })
      ] }),
      /* @__PURE__ */ jsxs93(Select2, { label: "Set Active", id: "is_active", name: "is_active", defaultValue: "1", required: !0, children: [
        /* @__PURE__ */ jsx107("option", { value: "0", children: "De-activate" }),
        /* @__PURE__ */ jsx107("option", { value: "1", children: "Activate" })
      ] }),
      /* @__PURE__ */ jsxs93(Select2, { label: "Has Admin access", id: "has_admin_access", name: "has_admin_access", defaultValue: "1", required: !0, children: [
        /* @__PURE__ */ jsx107("option", { value: "0", children: "False" }),
        /* @__PURE__ */ jsx107("option", { value: "1", children: "True" })
      ] }),
      /* @__PURE__ */ jsx107(RolesFormControl, { roles: rolesNames }),
      /* @__PURE__ */ jsxs93("div", { className: "grid grid-cols-2 sm:flex justify-end gap-3 sm:gap-6 sm:col-span-2 mt-4", children: [
        /* @__PURE__ */ jsx107(Cta_default, { element: "button", type: "reset", className: "px-4 sm:px-8 py-2 rounded-lg font-medium border-secondary active:border-accent", variant: "outline", children: "Reset" }),
        /* @__PURE__ */ jsx107(Cta_default, { disabled: isSubmitting, element: "button", type: "submit", className: "px-4 sm:px-8 py-2 rounded-lg font-medium", children: isSubmitting ? "Creating admin user" : "Create admin user" })
      ] })
    ] })
  ] });
}
...
import { useLoaderData as useLoaderData37, useNavigate as useNavigate20 } from "@remix-run/react";

// app/components/admin/tournament/CreateContestForm.tsx
import { Form as Form27, useSearchParams as useSearchParams3 } from "@remix-run/react";
...
function CreateContestForm({ tournaments }) {
  ...
  return /* @__PURE__ */ jsxs94(Form27, { className: "max-w-[700px] mx-auto my-8 grid gap-6 sm:gap-12 text-sm", method: "post", encType: "multipart/form-data", children: [
    /* @__PURE__ */ jsx108("h1", { className: "text-2xl font-bold text-primary", children: "Contest Details" }),
    /* @__PURE__ */ jsxs94("fieldset", { className: "grid gap-3 sm:gap-6 sm:grid-cols-2", children: [
      /* @__PURE__ */ jsxs94(Select2, { name: "tournament", id: "tournament", label: "Tournament", className: "uppercase", defaultValue: defaultTournament, required: !0, children: [
        /* @__PURE__ */ jsx108("option", { value: "", children: "Select a tournament" }),
        tournaments.map((tournament) => /* @__PURE__ */ jsx108("option", { value: tournament.id, children: tournament.id }, tournament.id))
      ] }),
      /* @__PURE__ */ jsx108(FormControl, { as: "input", labelText: "Contest Name", placeholder: "Enter contest name", id: "name", name: "name", required: !0 }),
      /* @__PURE__ */ jsx108(FormControl, { as: "textarea", rows: 3, labelClassNames: "sm:col-span-2", labelText: "Contest Description", placeholder: "Enter contest description", id: "description", name: "description", required: !0 }),
      /* @__PURE__ */ jsx108(FormControl, { as: "input", labelText: "Unique Contest ID", placeholder: "Enter unique ID", id: "uniqueId", name: "uniqueId", required: !0 }),
      /* @__PURE__ */ jsx108(FormControl, { as: "input", type: "datetime-local", labelText: "Registration Deadline", id: "reg_deadline", name: "reg_deadline", required: !0 }),
      /* @__PURE__ */ jsx108(FormControl, { as: "input", type: "datetime-local", labelText: "Contest Start Date", id: "start_date", name: "start_date", required: !0 }),
      /* @__PURE__ */ jsx108(FormControl, { as: "input", type: "datetime-local", labelText: "Contest End Date", id: "end_date", name: "end_date", required: !0 }),
      /* @__PURE__ */ jsx108(FormControl, { as: "textarea", rows: 2, labelText: "Contest Prizes", labelClassNames: "sm:col-span-2", placeholder: "Enter contest prizes", id: "prizes", name: "prizes", required: !0 }),
      /* @__PURE__ */ jsx108(DragnDrop, { className: "sm:col-span-2", name: "image", multiple: !1 })
    ] }),
    /* @__PURE__ */ jsx108(CategoryInputs, {}),
    /* @__PURE__ */ jsx108(StageInputs, {}),
    /* @__PURE__ */ jsxs94("fieldset", { className: "grid gap-3 sm:gap-6 sm:grid-cols-2", children: [
      /* @__PURE__ */ jsx108("legend", { className: "text-lg mb-4 font-bold", children: "Contestants and Referrals Earnings" }),
      /* @__PURE__ */ jsx108(FormControl, { as: "input", type: "number", step: 1, max: 100, min: 0, labelText: "Contestant Share Percentage", id: "contestant_share_percent", name: "contestant_share_percent", defaultValue: 50, required: !0 }),
      /* @__PURE__ */ jsx108(FormControl, { as: "input", type: "number", labelText: "Minimum amount for affiliate to earn", id: "min_for_referral_earning", name: "min_for_referral_earning", defaultValue: 3e3, required: !0 }),
      /* @__PURE__ */ jsx108(FormControl, { as: "input", type: "number", labelText: "Amount affiliate would earn from minimum", id: "referral_bonus_from_min", name: "referral_bonus_from_min", defaultValue: 500, required: !0 }),
      /* @__PURE__ */ jsx108(FormControl, { as: "input", type: "number", step: 1, max: 100, min: 0, labelText: "Affiliate percentage earnings after minimum", id: "referral_percent_after_min", name: "referral_percent_after_min", defaultValue: 1, required: !0 })
    ] }),
    /* @__PURE__ */ jsxs94("fieldset", { className: "grid gap-3 sm:gap-6", children: [
      /* @__PURE__ */ jsx108("legend", { className: "text-lg mb-4 font-bold", children: "Submission Guidelines" }),
      /* @__PURE__ */ jsx108(FormControl, { as: "textarea", rows: 4, labelText: "Submission Requirements", placeholder: "Enter text here...", id: "sub_req", name: "sub_req", required: !0 }),
      /* @__PURE__ */ jsx108(FormControl, { as: "textarea", rows: 4, labelText: "Terms & Conditions", placeholder: "Enter text here...", id: "tnc", name: "tnc", required: !0 }),
      /* @__PURE__ */ jsx108(FormControl, { as: "textarea", rows: 4, labelText: "Additional Information", placeholder: "Enter text here...", id: "add_info", name: "add_info", required: !0 })
    ] }),
    /* @__PURE__ */ jsx108("div", { className: "flex justify-end gap-6", children: /* @__PURE__ */ jsx108(Cta_default, { element: "button", type: "submit", className: "px-8 py-2 rounded-lg font-medium max-sm:grow", children: "Create Contest" }) })
  ] });
}
...
async function action24({ request }) {
  ...
  if (data) {
    ...
    return redirect30("/admin/contests", { headers: headers2 });
  }
  let { headers } = await setToast({ request, toast: `error::${error.detail}::${Date.now()}` });
  return json38(null, { headers });
}
function AddContest() {
  let { tournaments } = useLoaderData37(), navigate = useNavigate20();
  return /* @__PURE__ */ jsxs95("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs95("div", { className: "flex items-center mb-10 sm:mb-16 gap-4", children: [
      /* @__PURE__ */ jsx109(RoundCta_default, { icon: icons.arrowPrevIcon, className: "hover:bg-[#F7F7F8] text-primary", onClick: () => navigate(-1) }),
      /* @__PURE__ */ jsx109("span", { className: "font-black text-primary", children: "Create Contest" })
    ] }),
    /* @__PURE__ */ jsx109(CreateContestForm, { tournaments })
  ] });
}
...
import { useLoaderData as useLoaderData38, Form as Form28, useNavigation as useNavigation16 } from "@remix-run/react";
...
async function loader40({ request }) {
  ...
  return pagedUsersRes.authRequired ? redirect31("/login") : (console.log(pagedUsersRes), json39({ data: pagedUsersRes.data, query }));
}
function PartnerProducts() {
  let { data, query } = useLoaderData38(), navigation = useNavigation16();
  return console.log(data), /* @__PURE__ */ jsxs96("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs96("div", { className: "flex justify-between items-center mb-8 sm:mb-16", children: [
      /* @__PURE__ */ jsx110("h1", { className: "text-2xl font-black text-primary", children: "Products" }),
      /* @__PURE__ */ jsxs96(Cta_default, { element: "link", to: "/partners/add", className: "hidden sm:flex gap-2 items-center rounded-lg px-3 py-2", children: [
        /* @__PURE__ */ jsx110(Svg, { src: icons.addIcon, width: ".9em" }),
        "Add Product"
      ] })
    ] }),
    /* @__PURE__ */ jsx110("div", { className: "flex flex-col gap-3 sm:flex-row justify-between sm:items-center my-8", children: /* @__PURE__ */ jsx110(Form28, { method: "get", className: "w-full bg-white border border-gray-100 rounded-xl p-4 shadow-sm", children: /* @__PURE__ */ jsxs96("div", { className: "grid grid-cols-1 sm:grid-cols-4 gap-3 items-end", children: [
      /* @__PURE__ */ jsxs96("div", { children: [
        /* @__PURE__ */ jsx110("label", { className: "block text-xs font-semibold mb-1", children: "Product Price" }),
        /* @__PURE__ */ jsx110(
          "input",
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxs96("div", { children: [
        /* @__PURE__ */ jsx110("label", { className: "block text-xs font-semibold mb-1", children: "Name, Description or tag" }),
        /* @__PURE__ */ jsx110(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxs96("div", { children: [
        /* @__PURE__ */ jsx110("label", { className: "block text-xs font-semibold mb-1", children: "Status" }),
        /* @__PURE__ */ jsxs96(
          "select",
          {
            name: "status",
            className: "w-full border rounded-lg px-3 py-2",
            children: [
              /* @__PURE__ */ jsx110("option", { value: "available", children: "Available" }),
              /* @__PURE__ */ jsx110("option", { value: "out_of_stock", children: "Out of Stock" }),
              /* @__PURE__ */ jsx110("option", { value: "suspended", children: "Suspended" })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsx110("div", { className: "sm:col-span-1 flex gap-2 mt-2 sm:mt-0", children: /* @__PURE__ */ jsx110("button", { type: "submit", className: "bg-[#4B4870] text-white px-4 py-2 rounded-lg font-semibold", children: "Search" }) })
    ] }) }) }),
    /* @__PURE__ */ jsx110("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-8", children: data?.items && data.items.length > 0 ? data.items.map((product) => {
      let imgSrc = no_image_default;
      return /* @__PURE__ */ jsxs96("div", { className: "my-2 p-2 bg-slate-50 rounded-lg border border-slate-100", children: [
        /* @__PURE__ */ jsxs96("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx110("div", { className: "mt-1 text-indigo-500", children: /* @__PURE__ */ jsxs96("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-4 w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: [
            /* @__PURE__ */ jsx110("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" }),
            /* @__PURE__ */ jsx110("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M15 11a3 3 0 11-6 0 3 3 0 016 0z" })
          ] }) }),
          /* @__PURE__ */ jsxs96("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsx110("span", { className: "text-xs font-bold text-gray-700", children: product.name }),
            /* @__PURE__ */ jsxs96("span", { className: "text-[11px] text-gray-500", children: [
              product.city,
              ", ",
              product.state_name
            ] })
    ...
    }) : /* @__PURE__ */ jsx110("div", { className: "col-span-full text-center text-gray-400 py-12", children: "No products found." }) }),
    /* @__PURE__ */ jsx110("div", { className: " sm:flex justify-between items-center my-4", children: /* @__PURE__ */ jsx110(Pagination, { lastKey: query?.last_key_id, pageSize: query?.items_per_page, firstKey: query?.first_key_id }) })
  ] });
}
...
import { Link as Link21, useLoaderData as useLoaderData39 } from "@remix-run/react";
...
var WinnerCard = ({
  ...
  full_name,
  id
}) => /* @__PURE__ */ jsx111(Link21, { to: `/winner/${id}`, className: "block transition-shadow", children: /* @__PURE__ */ jsxs97("article", { children: [
  /* @__PURE__ */ jsx111(
    "img",
    {
      src: image_url,
  ...
  /* @__PURE__ */ jsxs97("div", { className: "pt-4", children: [
    /* @__PURE__ */ jsx111("p", { className: "text-xs font-semibold uppercase tracking-wide text-gray-500", children: contest_name }),
    /* @__PURE__ */ jsx111("h3", { className: "mt-1 text-lg font-bold text-gray-900", children: full_name })
  ] })
] }) }), SearchIcon = (props) => /* @__PURE__ */ jsx111(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
function Winners() {
  let { winners, error } = useLoaderData39(), [searchWinners, setSearchWinners] = useState36(""), [winnersFiltered, setWinnersFiltered] = useState36(winners ?? []);
  return useEffect26(() => {
  ...
  }, [searchWinners, winners]), error ? /* @__PURE__ */ jsx111("h1", { className: "font-satoshi-bold text-4xl text-center", children: error.detail }) : /* @__PURE__ */ jsx111("div", { className: "min-h-screen", children: /* @__PURE__ */ jsxs97("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8", children: [
    /* @__PURE__ */ jsx111("header", { className: "bg-[#817EFB] overflow-hidden rounded-3xl py-8 md:py-12 lg:py-16 px-5", children: /* @__PURE__ */ jsxs97("div", { className: "max-w-3xl mx-auto text-center", children: [
      /* @__PURE__ */ jsx111("h1", { className: "text-3xl md:text-4xl lg:text-5xl font-bold text-white", children: "Meet Our Talented Contest Winners" }),
      /* @__PURE__ */ jsx111("p", { className: "mt-4 text-base md:text-lg text-purple-100", children: "A Glimpse of the Extraordinary Creations That Stole the Show" }),
      /* @__PURE__ */ jsxs97("div", { className: "mt-8 relative max-w-lg mx-auto", children: [
        /* @__PURE__ */ jsx111(
          "input",
          {
            type: "text",
        ...
        /* @__PURE__ */ jsx111("div", { className: "absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-auto", children: /* @__PURE__ */ jsx111(SearchIcon, { className: "h-5 w-5 text-gray-400" }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs97("main", { className: "py-12 md:py-16", children: [
      /* @__PURE__ */ jsx111("div", { className: "grid grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-3", children: winnersFiltered.map((winner, idx) => /* @__PURE__ */ jsx111(
        WinnerCard,
        {
      ...
      /* @__PURE__ */ jsx111("div", { className: "mt-12 md:mt-16 text-center", children: /* @__PURE__ */ jsx111(
        "button",
        {
          type: "button",
...
import { Link as Link22, useLocation as useLocation7 } from "@remix-run/react";
...
function PartnerLoginOrRequestPartnerShip() {
  ...
  if (!user || !user.is_partner_account)
    return /* @__PURE__ */ jsxs98("main", { className: "h-dvh bg-secondary p-4 flex flex-col", children: [
      /* @__PURE__ */ jsx112(Link22, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx112(Svg, { src: icons.logoIcon, className: "w-14 h-14 sm:w-16 sm:h-16" }) }),
      /* @__PURE__ */ jsxs98("div", { className: "flex flex-col md:flex-row gap-6 p-8  rounded-2xl border border-gray-100", children: [
        /* @__PURE__ */ jsxs98("div", { className: "flex-1 flex flex-col items-start gap-4", children: [
          /* @__PURE__ */ jsx112("div", { className: "p-3 rounded-lg shadow-sm" }),
          /* @__PURE__ */ jsxs98("div", { children: [
            /* @__PURE__ */ jsx112("h3", { className: "font-satoshi-black text-xl text-gray-900", children: "Welcome Back" }),
            /* @__PURE__ */ jsx112("p", { className: "text-gray-500 text-sm mt-1", children: "Access your partner dashboard and manage your account." })
          ] }),
          /* @__PURE__ */ jsx112(
            Link22,
            {
        ...
        /* @__PURE__ */ jsx112("div", { className: "w-px bg-gray-200 hidden md:block" }),
        /* @__PURE__ */ jsxs98("div", { className: "flex-1 flex flex-col items-start gap-4", children: [
          /* @__PURE__ */ jsx112("div", { className: "bg-accent/10 p-3 rounded-lg" }),
          /* @__PURE__ */ jsxs98("div", { children: [
            /* @__PURE__ */ jsx112("h3", { className: "font-satoshi-black text-xl text-gray-900", children: "New Here?" }),
            /* @__PURE__ */ jsx112("p", { className: "text-gray-500 text-sm mt-1", children: "Join our network and start growing your business with us." })
          ] }),
          /* @__PURE__ */ jsx112(
            Link22,
            {
...
import { useActionData as useActionData13, Form as Form30, useNavigate as useNavigate22, useNavigation as useNavigation17 } from "@remix-run/react";
...
function Stepper({ currentStep }) {
  ...
  return /* @__PURE__ */ jsx113("div", { className: "flex flex-wrap items-center justify-center gap-x-2 gap-y-2 text-xs sm:text-sm font-medium text-gray-400 mb-8 sm:mb-12", children: steps.map((step, i) => /* @__PURE__ */ jsxs99("div", { className: "flex items-center gap-x-1 sm:gap-x-2", children: [
    /* @__PURE__ */ jsx113("span", { className: `flex h-6 w-6 items-center justify-center rounded-full text-xs ${i === currentStep ? "bg-black text-white" : "bg-gray-200 text-gray-500"}`, children: i + 1 }),
    /* @__PURE__ */ jsx113("span", { className: i === currentStep ? "text-black" : "", children: step }),
    i < steps.length - 1 && /* @__PURE__ */ jsx113("span", { className: "hidden sm:inline", children: ">" })
  ] }, step)) });
}
var Label2 = ({ children, required }) => /* @__PURE__ */ jsxs99("label", { className: "block text-sm font-semibold text-gray-700 mb-2 mt-5", children: [
  children,
  " ",
  required && /* @__PURE__ */ jsx113("span", { className: "text-red-500", children: "*" })
...
function usePartnerOnboardingController() {
  let navigation = useNavigation17(), [section, setSection] = useState38(0), [form, setForm] = useState38({
...
function PartnerOnboarding() {
  ...
  return isSuccess ? /* @__PURE__ */ jsx113("main", { className: "min-h-screen bg-white font-sans text-slate-900 flex items-center justify-center", children: /* @__PURE__ */ jsxs99("div", { className: "max-w-xl w-full mx-auto px-4 py-16 text-center", children: [
    /* @__PURE__ */ jsxs99("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxs99("svg", { className: "mx-auto mb-4 text-green-500", width: "48", height: "48", fill: "none", viewBox: "0 0 24 24", children: [
        /* @__PURE__ */ jsx113("circle", { cx: "12", cy: "12", r: "12", fill: "#22C55E", opacity: "0.1" }),
        /* @__PURE__ */ jsx113("path", { d: "M7 13l3 3 7-7", stroke: "#22C55E", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })
      ] }),
      /* @__PURE__ */ jsxs99("h1", { className: "text-2xl sm:text-3xl font-bold mb-2", children: [
        "Thank you, ",
        businessName,
        "!"
      ] }),
      /* @__PURE__ */ jsxs99("p", { className: "text-gray-700 text-base sm:text-lg mb-6", children: [
  ...
  ] }) }) : /* @__PURE__ */ jsx113("main", { className: "min-h-screen bg-white font-sans text-slate-900 pb-20", children: /* @__PURE__ */ jsxs99("div", { className: "max-w-3xl mx-auto px-2 sm:px-6 pt-8 sm:pt-12", children: [
    /* @__PURE__ */ jsx113(Stepper, { currentStep: section }),
    /* @__PURE__ */ jsx113("div", { className: "text-center mb-8 sm:mb-10", children: /* @__PURE__ */ jsx113("h1", { className: "text-2xl sm:text-4xl font-bold tracking-tight text-gray-900", children: section === 0 ? "Tell us about your business" : section === 1 ? "Enter your business's legal address" : "Enter contact info details" }) }),
    /* @__PURE__ */ jsx113("div", { className: "w-full max-w-xl mx-auto", children: /* @__PURE__ */ jsxs99(Form30, { method: "post", className: "space-y-6", children: [
      /* @__PURE__ */ jsxs99("div", { className: section === 0 ? "" : "hidden", children: [
        /* @__PURE__ */ jsxs99("div", { className: "bg-gray-50 rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 border border-gray-100", children: [
          /* @__PURE__ */ jsx113("h3", { className: "text-xs sm:text-sm font-bold text-gray-500 uppercase tracking-wider mb-3 sm:mb-4", children: "Company information" }),
          /* @__PURE__ */ jsxs99("div", { className: "space-y-2 text-xs sm:text-sm", children: [
            /* @__PURE__ */ jsxs99("div", { className: "flex justify-between flex-wrap", children: [
              /* @__PURE__ */ jsx113("span", { className: "text-gray-500", children: "Company name:" }),
              " ",
              /* @__PURE__ */ jsxs99("span", { className: "font-semibold", children: [
                form.legal_business_name,
                " ",
                /* @__PURE__ */ jsx113("span", { className: "text-green-500", children: "\u25CF" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs99("div", { className: "flex justify-between flex-wrap", children: [
              /* @__PURE__ */ jsx113("span", { className: "text-gray-500", children: "Phone Number:" }),
              " ",
              /* @__PURE__ */ jsx113("span", { className: "font-semibold", children: form.phone_number })
            ] }),
            /* @__PURE__ */ jsxs99("div", { className: "flex justify-between flex-wrap", children: [
              /* @__PURE__ */ jsx113("span", { className: "text-gray-500", children: "Status:" }),
              " ",
              /* @__PURE__ */ jsx113("span", { className: "text-blue-600 font-semibold inline-flex items-center gap-1", children: "\u2713 Active" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Legal business name" }),
          /* @__PURE__ */ jsx113("input", { name: "legal_business_name", required: !0, className: inputClass, value: form.legal_business_name || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Country of incorporation" }),
          /* @__PURE__ */ jsxs99("select", { name: "country_of_incorporation", className: inputClass, value: form.country_of_incorporation, onChange: handleChange, children: [
            /* @__PURE__ */ jsx113("option", { value: "Nigeria", children: "\u{1F1F3}\u{1F1EC} Nigeria" }),
            /* @__PURE__ */ jsx113("option", { value: "Kenya", children: "\u{1F1F0}\u{1F1EA} Kenya" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Business Email" }),
          /* @__PURE__ */ jsx113(
            "input",
            {
              name: "business_email",
        ...
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Partner commision support (%)" }),
          /* @__PURE__ */ jsx113("p", { className: "text-xs sm:text-sm  text-gray-500  tracking-wider mb-3 sm:mb-1", children: "We connect you to paying customers. What percentage of each sale are you willing to contribute as a partnership commission?" }),
          /* @__PURE__ */ jsx113(
            "input",
            {
        ...
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Phone number" }),
          /* @__PURE__ */ jsxs99("div", { className: "flex flex-col sm:flex-row gap-2 items-stretch", children: [
            /* @__PURE__ */ jsxs99("div", { className: "relative w-full sm:w-32", children: [
              /* @__PURE__ */ jsx113(
                "select",
                {
                  ...
                  children: /* @__PURE__ */ jsx113("option", { value: "+234", children: "\u{1F1F3}\u{1F1EC} +234" })
                }
              ),
              /* @__PURE__ */ jsx113("span", { className: "pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 text-lg", children: "\u25BC" })
            ] }),
            /* @__PURE__ */ jsx113(
              "input",
              {
        ...
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { children: "ROC / CAC Number" }),
          /* @__PURE__ */ jsx113("input", { name: "roc_cac_number", className: inputClass, value: form.roc_cac_number || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { children: "Tax ID (TIN)" }),
          /* @__PURE__ */ jsx113("input", { name: "tax_id", className: inputClass, value: form.tax_id || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Estimated Weekly Volume Currency" }),
          /* @__PURE__ */ jsxs99(
            "select",
            {
              ...
              required: !0,
              children: [
                /* @__PURE__ */ jsx113("option", { value: "", children: "Select currency" }),
                /* @__PURE__ */ jsx113("option", { value: "NGN", children: "NGN" }),
                /* @__PURE__ */ jsx113("option", { value: "USD", children: "USD" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Estimated weekly volume" }),
          /* @__PURE__ */ jsxs99("div", { className: "flex flex-col sm:flex-row gap-2 sm:gap-4", children: [
            /* @__PURE__ */ jsxs99("div", { className: "relative flex-1", children: [
              /* @__PURE__ */ jsx113("span", { className: "absolute left-4 top-1/2 -translate-y-1/2 text-gray-400", children: form.estimated_weekly_volume_currency }),
              /* @__PURE__ */ jsx113("input", { name: "estimated_weekly_volume_min", type: "number", placeholder: "Min", className: `${inputClass} pl-16`, value: form.estimated_weekly_volume_min || "", onChange: handleChange })
            ] }),
            /* @__PURE__ */ jsxs99("div", { className: "relative flex-1", children: [
              /* @__PURE__ */ jsx113("span", { className: "absolute left-4 top-1/2 -translate-y-1/2 text-gray-400", children: form.estimated_weekly_volume_currency }),
              /* @__PURE__ */ jsx113("input", { name: "estimated_weekly_volume_max", type: "number", placeholder: "Max", className: `${inputClass} pl-16`, value: form.estimated_weekly_volume_max || "", onChange: handleChange })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Business description" }),
          /* @__PURE__ */ jsxs99("div", { className: "relative", children: [
            /* @__PURE__ */ jsx113("textarea", { name: "business_description", required: !0, className: `${inputClass} h-32 resize-none`, value: form.business_description || "", onChange: handleChange }),
            /* @__PURE__ */ jsx113("span", { className: "absolute bottom-3 right-3 text-xs text-gray-400", children: "0/5000" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { children: "Website (Optional)" }),
          /* @__PURE__ */ jsx113("input", { name: "website", className: inputClass, placeholder: "https://www.acmetrading.com", value: form.website || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Industry" }),
          /* @__PURE__ */ jsxs99(
            "select",
            {
              name: "industry",
              ...
              required: !0,
              children: [
                /* @__PURE__ */ jsx113("option", { value: "", children: "Select industry" }),
                /* @__PURE__ */ jsx113("option", { value: "Services", children: "Services" }),
                /* @__PURE__ */ jsx113("option", { value: "Manufacturing", children: "Manufacturing" }),
                /* @__PURE__ */ jsx113("option", { value: "Hospitality", children: "Hospitality" }),
                /* @__PURE__ */ jsx113("option", { value: "Financial Industry", children: "Financial Industry" }),
                /* @__PURE__ */ jsx113("option", { value: "Technology", children: "Technology" }),
                /* @__PURE__ */ jsx113("option", { value: "Education", children: "Education" }),
                /* @__PURE__ */ jsx113("option", { value: "Healthcare", children: "Healthcare" }),
                /* @__PURE__ */ jsx113("option", { value: "Retail", children: "Retail" }),
                /* @__PURE__ */ jsx113("option", { value: "Agriculture", children: "Agriculture" }),
                /* @__PURE__ */ jsx113("option", { value: "Construction", children: "Construction" }),
                /* @__PURE__ */ jsx113("option", { value: "Transportation", children: "Transportation" }),
                /* @__PURE__ */ jsx113("option", { value: "Other", children: "Other" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsx113("button", { type: "button", className: "w-full bg-[#4B4870] hover:bg-[#3d3a5c] text-white font-semibold py-3 sm:py-4 rounded-xl shadow-lg transition-all mt-4 text-base sm:text-lg", onClick: () => setSection(1), children: "Next" })
      ] }),
      /* @__PURE__ */ jsxs99("div", { className: section === 1 ? "" : "hidden", children: [
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Country of territory" }),
          /* @__PURE__ */ jsxs99("select", { name: "location_country", required: !0, className: inputClass, value: form.location_country || "", onChange: handleChange, children: [
            /* @__PURE__ */ jsx113("option", { value: "", children: "Select your country" }),
            /* @__PURE__ */ jsx113("option", { value: "Nigeria", children: "Nigeria" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Street Address" }),
          /* @__PURE__ */ jsx113("input", { name: "location_street", required: !0, placeholder: "123 Main Street", className: inputClass, value: form.location_street || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "State" }),
          /* @__PURE__ */ jsxs99("select", { name: "location_state", required: !0, className: inputClass, value: form.location_state || "", onChange: handleChange, children: [
            /* @__PURE__ */ jsx113("option", { value: "", children: "Select state" }),
            /* @__PURE__ */ jsx113("option", { value: "Lagos", children: "Lagos" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "City" }),
          /* @__PURE__ */ jsx113("input", { name: "location_city", required: !0, className: inputClass, value: form.location_city || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Postal Code" }),
          /* @__PURE__ */ jsx113("input", { name: "location_postal", className: inputClass, value: form.location_postal || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs99("div", { className: "flex flex-col sm:flex-row gap-3 pt-4 mt-5", children: [
          /* @__PURE__ */ jsx113("button", { type: "button", className: "w-full sm:flex-1 bg-gray-100 text-gray-600 font-semibold py-3 sm:py-4 rounded-xl", onClick: () => setSection(0), children: "Back" }),
          /* @__PURE__ */ jsx113("button", { type: "button", className: "w-full sm:flex-[2] bg-[#4B4870] text-white font-semibold py-3 sm:py-4 rounded-xl shadow-lg", onClick: () => setSection(2), children: "Next" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs99("div", { className: section === 2 ? "" : "hidden", children: [
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Country of territory" }),
          /* @__PURE__ */ jsxs99("select", { name: "contact_country", required: !0, className: inputClass, value: form.contact_country || "", onChange: handleChange, children: [
            /* @__PURE__ */ jsx113("option", { value: "", children: "Select your country" }),
            /* @__PURE__ */ jsx113("option", { value: "Nigeria", children: "Nigeria" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Contact Name" }),
          /* @__PURE__ */ jsx113("input", { name: "contact_name", required: !0, placeholder: "John Doe", className: inputClass, value: form.contact_name || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Contact Email" }),
          /* @__PURE__ */ jsx113("input", { name: "contact_email", required: !0, className: inputClass, value: form.contact_email || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs99("div", { children: [
          /* @__PURE__ */ jsx113(Label2, { required: !0, children: "Contact Phone" }),
          /* @__PURE__ */ jsx113("input", { name: "contact_phone", className: inputClass, value: form.contact_phone || "", onChange: handleChange })
        ] }),
        /* @__PURE__ */ jsxs99("div", { className: "flex flex-col sm:flex-row gap-3 pt-4", children: [
          /* @__PURE__ */ jsx113("button", { type: "button", className: "w-full sm:flex-1 bg-gray-100 text-gray-600 font-semibold py-3 sm:py-4 rounded-xl", onClick: () => setSection(1), children: "Back" }),
          /* @__PURE__ */ jsx113("button", { type: "submit", className: "w-full sm:flex-[2] bg-[#4B4870] text-white font-semibold py-3 sm:py-4 rounded-xl shadow-lg", children: navigation.state === "submitting" ? "Submitting..." : "Submit" })
        ] })
      ] })
    ] }) })
  ] }) });
...
function ContactForm() {
  return /* @__PURE__ */ jsxs100("form", { className: "wrapper flex flex-col gap-6", children: [
    /* @__PURE__ */ jsxs100("div", { className: "grid gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsx114(
        FormControl,
        {
          as: "input",
    ...
    /* @__PURE__ */ jsx114(Button, { element: "button", className: "md:self-end", children: "Submit" })
  ] });
}
...
function WhyCard(props) {
  return /* @__PURE__ */ jsxs101("article", { className: `block p-8 text-white rounded-3xl ${props.backgroundColor}`, children: [
    /* @__PURE__ */ jsx115("div", { className: "p-6 mb-8 rounded-3xl bg-[#FFFFFF29] w-fit", children: /* @__PURE__ */ jsx115(Svg, { src: props.icon, width: 24, height: 24 }) }),
    /* @__PURE__ */ jsx115("h3", { className: "mb-4 text-2xl font-black", children: props.title }),
    /* @__PURE__ */ jsx115("p", { className: "font-bold", children: props.subtext })
  ] });
}
...
function SponsorsSlider() {
  return /* @__PURE__ */ jsx116(AutoplayCarousel, { children: /* @__PURE__ */ jsx116(CarouselItem, { children: /* @__PURE__ */ jsx116("img", { src: sponsor_logo_default, alt: "Zendesk" }) }) });
}

// app/routes/_public._index.tsx
import { jsx as jsx117, jsxs as jsxs102 } from "react/jsx-runtime";
function LandingPage() {
  return /* @__PURE__ */ jsxs102("main", { className: "snap-y", children: [
    /* @__PURE__ */ jsxs102("section", { className: "wrapper flex flex-col md:flex-row gap-16 xl:gap-24 md:items-center py-8 md:py-16", children: [
      /* @__PURE__ */ jsxs102("div", { className: "flex flex-col gap-6 sm:gap-8", children: [
        /* @__PURE__ */ jsxs102("h1", { className: "font-black text-4xl sm:text-5xl xl:text-[64px] leading-tight sm:leading-snug whitespace-nowrap", children: [
          "Capturing Moments",
          /* @__PURE__ */ jsx117("br", {}),
          "Creating ",
          /* @__PURE__ */ jsx117("span", { className: "text-accent", children: "Memories." })
        ] }),
        /* @__PURE__ */ jsx117("p", { className: "text-xl", children: "Join our monthly/yearly photo contests open to kids, both male and female aged 0-14 years and discover a world of imagination and inspiration." }),
        /* @__PURE__ */ jsxs102("div", { className: "flex gap-4 flex-wrap", children: [
          /* @__PURE__ */ jsx117(Button, { element: "button", className: "w-full sm:w-auto", children: "Join Now" }),
          /* @__PURE__ */ jsx117(Button, { element: "a", href: "/contests", className: "w-full sm:w-auto", variant: "outline", children: "Explore Contests" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs102("div", { className: "grid grid-cols-3 gap-8 xl:gap-9 w-full", children: [
        /* @__PURE__ */ jsxs102("div", { className: "flex flex-col gap-8 xl:gap-9", children: [
          /* @__PURE__ */ jsx117("img", { className: "aspect-3/7 object-cover rounded-full outline-dashed outline-offset-4 w-full", src: hero_1_default, alt: "kid smiling" }),
          /* @__PURE__ */ jsx117("img", { className: "aspect-3/4 rounded-full outline-dashed outline-offset-4 object-cover w-full", src: hero_2_default, alt: "kid smiling" })
        ] }),
        /* @__PURE__ */ jsxs102("div", { className: "flex flex-col gap-8 xl:gap-9 justify-center", children: [
          /* @__PURE__ */ jsx117("img", { className: "aspect-square rounded-full outline-dashed outline-offset-4 object-cover w-full", src: hero_3_default, alt: "kid smiling" }),
          /* @__PURE__ */ jsx117("img", { className: "aspect-3/7 rounded-full outline-dashed outline-offset-4 object-cover w-full", src: hero_4_default, alt: "kid smiling" })
        ] }),
        /* @__PURE__ */ jsx117("div", { className: "flex flex-col justify-center", children: /* @__PURE__ */ jsx117("img", { className: "aspect-3/7 rounded-full outline-dashed outline-offset-4 object-cover w-full", src: hero_5_default, alt: "kid smiling" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxs102("section", { className: "wrapper py-8 md:py-16", children: [
      /* @__PURE__ */ jsx117("h2", { className: "font-bold text-xl mb-4", children: "Who supports us" }),
      /* @__PURE__ */ jsx117(SponsorsSlider, {})
    ] }),
    /* @__PURE__ */ jsx117("section", { className: "py-8 md:py-16", children: /* @__PURE__ */ jsxs102("div", { className: "sm:wrapper bg-secondary md:px-24 py-16 md:py-28 flex flex-col md:flex-row justify-between items-center gap-16 sm:rounded-3xl", children: [
      /* @__PURE__ */ jsxs102("div", { className: "wrapper", children: [
        /* @__PURE__ */ jsxs102("div", { className: "mb-8", children: [
          /* @__PURE__ */ jsx117("p", { className: "font-black text-xl", children: "Our Vision" }),
          /* @__PURE__ */ jsx117("img", { className: "object-cover object-center", src: underline_default, alt: "underline", width: 100 })
        ] }),
        /* @__PURE__ */ jsxs102("h2", { className: "text-2xl sm:text-3xl font-black mb-6 leading-snug", children: [
          "Crafting ",
          /* @__PURE__ */ jsx117("span", { className: "text-accent", children: "Unforgettable" }),
          " Moments for Every Child's Special Day."
        ] }),
        /* @__PURE__ */ jsx117("p", { className: "font-medium", children: "To create uniquely memorable and exciting kid's birthdays, we strive to be entertaining, transparent, innovative, creative, exciting, efficient, and reliable in every aspect of our service." })
      ] }),
      /* @__PURE__ */ jsx117("div", { className: "wrapper", children: /* @__PURE__ */ jsx117("img", { className: "object-cover object-center w-full", src: birthday_present_default, alt: "wrapped gift" }) })
    ] }) }),
    /* @__PURE__ */ jsxs102("section", { className: "py-8 md:py-16 wrapper flex flex-col items-center", children: [
      /* @__PURE__ */ jsxs102("div", { className: "mb-6 sm:mb-16", children: [
        /* @__PURE__ */ jsx117("h2", { className: "font-satoshi-black text-2xl", children: "Why KOTMY?" }),
        /* @__PURE__ */ jsx117("img", { className: "object-fill w-[159px] h-5", src: underline_default, alt: "underline" })
      ] }),
      /* @__PURE__ */ jsx117("div", { className: "grid gap-6 lg:gap-12 sm:grid-cols-2 max-w-5xl", children: whyUsData.map((item) => /* @__PURE__ */ jsx117(WhyCard, { backgroundColor: item.bg, icon: item.icon, title: item.title, subtext: item.subtext }, item.title)) })
    ] }),
    /* @__PURE__ */ jsx117("section", { className: "py-8 md:py-16", children: /* @__PURE__ */ jsx117(ContestantSlider, { contestants: [{ id: "sdjc", image: hero_1_default }, { id: "adcn", image: hero_2_default }, { id: "kjsd", image: hero_3_default }] }) }),
    /* @__PURE__ */ jsx117("section", { className: "pt-4 sm:py-8 md:py-16", children: /* @__PURE__ */ jsxs102("div", { className: "sm:wrapper bg-[#817EFB] bg-pattern bg-cover bg-left text-secondary md:px-24 py-16 md:py-28 flex flex-col md:flex-row justify-between items-center gap-16 sm:rounded-3xl", children: [
      /* @__PURE__ */ jsxs102("div", { className: "wrapper", children: [
        /* @__PURE__ */ jsx117("h2", { className: "text-2xl sm:text-[40px] font-satoshi-black mb-6 leading-snug", children: "Refer A Friend And Earn Rewards" }),
        /* @__PURE__ */ jsx117("p", { className: "font-satoshi-medium mb-8", children: "Lorem ipsum dolor sit amet consectetur. Velit egestas auctor in amet dis sed sit egestas. Viverra morbi eget consectetur accumsan integer. Mi et etiam amet est egestas tellus quis." }),
        /* @__PURE__ */ jsx117("span", { className: "inline-block bg-[#E7E7E7] text-primary py-4 px-8 text-lg rounded-md font-black whitespace-nowrap", children: "COMING SOON" })
      ] }),
      /* @__PURE__ */ jsx117("div", { className: "wrapper bg-[#E7E7E7] rounded-3xl w-full aspect-square" })
    ] }) }),
    /* @__PURE__ */ jsx117("section", { id: "contact", className: "sm:py-8 md:py-16 sm:-scroll-m-4 md:-scroll-m-8 snap-start", children: /* @__PURE__ */ jsxs102("div", { className: "sm:wrapper bg-secondary md:px-24 py-16 md:py-28 flex flex-col md:flex-row justify-between gap-16 sm:rounded-3xl", children: [
      /* @__PURE__ */ jsxs102("div", { className: "wrapper flex flex-col gap-12", children: [
        /* @__PURE__ */ jsx117("h2", { className: "text-2xl sm:text-[40px] font-satoshi-black leading-tight", children: "Do you want to know more about the way we work?" }),
        /* @__PURE__ */ jsxs102("div", { className: "flex flex-col lg:flex-row gap-6", children: [
          /* @__PURE__ */ jsxs102("p", { children: [
            /* @__PURE__ */ jsx117("span", { className: "block font-satoshi-black mb-3", children: "Phone Us" }),
            /* @__PURE__ */ jsx117("span", { className: "font-satoshi-medium whitespace-nowrap", children: "+234 703 515 9093" })
          ] }),
          /* @__PURE__ */ jsxs102("p", { children: [
            /* @__PURE__ */ jsx117("span", { className: "block font-satoshi-black mb-3", children: "Email Us" }),
            /* @__PURE__ */ jsx117("span", { className: "font-satoshi-medium", children: "kidmonthyear@gmail.com" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs102("div", { children: [
          /* @__PURE__ */ jsx117("span", { className: "block font-satoshi-black mb-3", children: "Follow Us" }),
          /* @__PURE__ */ jsxs102("span", { className: "flex gap-4", children: [
            /* @__PURE__ */ jsx117(Svg, { src: icons.twitterXIcon, width: "24px", height: "24px" }),
            /* @__PURE__ */ jsx117(Svg, { src: icons.instagramIcon, width: "24px", height: "24px" }),
            /* @__PURE__ */ jsx117(Svg, { src: icons.facebookIcon, width: "24px", height: "24px" }),
            /* @__PURE__ */ jsx117(Svg, { src: icons.youtubeIcon, width: "24px", height: "24px" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx117(ContactForm, {})
    ] }) })
  ] });
}
...
import { useLoaderData as useLoaderData42 } from "@remix-run/react";
...
function AdminSummary({ users }) {
  return /* @__PURE__ */ jsxs103("div", { className: "border rounded-xl overflow-hidden basis-3/5 max-w-xl", children: [
    /* @__PURE__ */ jsxs103("div", { className: "flex gap-2 xs:gap-4 justify-between items-center py-3 px-4 border-b", children: [
      /* @__PURE__ */ jsx118("h3", { className: "text-primary font-bold max-sm:text-xs", children: "Admin Accounts" }),
      /* @__PURE__ */ jsx118(
        Cta_default,
        {
          element: "link",
    ...
    /* @__PURE__ */ jsx118("div", { className: "px-4 grid", children: users.slice(0, 5).map((user) => /* @__PURE__ */ jsx118(AdminUserCard, { user, className: "border-0 shadow-none rounded-none border-b last:border-b-0" }, user._id)) })
  ] });
}
...
function ArticleSummary() {
  return /* @__PURE__ */ jsx119("div", { className: "basis-1/5 p-3" });
}

// app/components/admin/Aggregator.tsx
import { jsx as jsx120 } from "react/jsx-runtime";
function Aggregator({ className, children, ...props }) {
  return /* @__PURE__ */ jsx120("div", { className: "@container", children: /* @__PURE__ */ jsx120(
    "aside",
    {
      ...props,
      className: cn(
...
function AggregatorItem({ className, children, ...props }) {
  return /* @__PURE__ */ jsx120("div", { className: cn("flex gap-3 items-center text-nowrap min-w-48", className), ...props, children });
}
...
function ContestSummary({ contests: contests2 }) {
  ...
  return /* @__PURE__ */ jsxs104("div", { className: "border rounded-xl overflow-hidden grow", children: [
    /* @__PURE__ */ jsxs104("div", { className: "flex gap-2 xs:gap-4 justify-between items-center py-3 px-4 border-b", children: [
      /* @__PURE__ */ jsx121("h3", { className: "text-primary font-bold max-sm:text-xs", children: "Contests" }),
      /* @__PURE__ */ jsx121(
        Cta_default,
        {
          element: "link",
    ...
    /* @__PURE__ */ jsxs104("div", { className: "px-4", children: [
      /* @__PURE__ */ jsxs104(Aggregator, { className: "my-4", children: [
        /* @__PURE__ */ jsxs104(AggregatorItem, { children: [
          /* @__PURE__ */ jsx121("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx121(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs104("span", { className: "grid", children: [
            /* @__PURE__ */ jsx121("span", { className: "text-primary font-satoshi-black", children: contests2.length }),
            /* @__PURE__ */ jsx121("span", { className: "", children: "Contests Created" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs104(AggregatorItem, { className: "flex gap-3 items-center", children: [
          /* @__PURE__ */ jsx121("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx121(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs104("span", { className: "grid", children: [
            /* @__PURE__ */ jsx121("span", { className: "text-primary font-satoshi-black", children: ongoingCount }),
            /* @__PURE__ */ jsx121("span", { className: "", children: "Ongoing Contests" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs104(AggregatorItem, { className: "flex gap-3 items-center", children: [
          /* @__PURE__ */ jsx121("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx121(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs104("span", { className: "grid", children: [
            /* @__PURE__ */ jsx121("span", { className: "text-primary font-satoshi-black", children: yetToStartCount }),
            /* @__PURE__ */ jsx121("span", { className: "", children: "Yet To Start Contests" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs104(AggregatorItem, { className: "flex gap-3 items-center", children: [
          /* @__PURE__ */ jsx121("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx121(Svg, { src: icons.adminContestIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs104("span", { className: "grid", children: [
            /* @__PURE__ */ jsx121("span", { className: "text-primary font-satoshi-black", children: closedCount }),
            /* @__PURE__ */ jsx121("span", { className: "", children: "Closed Contests" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx121(ContestTable, { data: contests2.slice(0, 5) })
    ] })
  ] });
}
...
function TournamentSummary({ tournaments }) {
  ...
  return /* @__PURE__ */ jsxs105("div", { className: "border rounded-xl overflow-hidden grow max-w-2xl", children: [
    /* @__PURE__ */ jsxs105("div", { className: "flex gap-2 xs:gap-4 justify-between items-center py-3 px-4 border-b", children: [
      /* @__PURE__ */ jsx122("h3", { className: "text-primary font-bold max-sm:text-xs", children: "Tournaments" }),
      /* @__PURE__ */ jsx122(
        Cta_default,
        {
          element: "link",
    ...
    /* @__PURE__ */ jsxs105("div", { className: "px-4 grid", children: [
      /* @__PURE__ */ jsxs105(Aggregator, { className: "mt-4", children: [
        /* @__PURE__ */ jsxs105(AggregatorItem, { children: [
          /* @__PURE__ */ jsx122("span", { className: "bg-tertiary p-2 rounded-full border", children: /* @__PURE__ */ jsx122(Svg, { src: icons.adminTournamentIcon, className: "text-primary" }) }),
          /* @__PURE__ */ jsxs105("span", { className: "grid", children: [
            /* @__PURE__ */ jsx122("span", { className: "text-primary font-satoshi-black", children: tournaments.length }),
            /* @__PURE__ */ jsx122("span", { className: "", children: "Tournaments Created" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs105(AggregatorItem, { className: "flex gap-3 items-center", children: [
          ...
          /* @__PURE__ */ jsxs105("span", { className: "grid", children: [
            /* @__PURE__ */ jsx122("span", { className: "text-primary font-satoshi-black", children: numberOfContests }),
            /* @__PURE__ */ jsx122("span", { className: "", children: "Contests Created" })
          ] })
        ] })
      ] }),
      tournaments.slice(0, 2).map((tournament) => /* @__PURE__ */ jsx122(TournamentCard, { tournament, className: "border-0 shadow-none bg-transparent rounded-none border-b last:border-b-0" }, tournament.id))
    ] })
  ] });
}
...
function Home() {
  let { adminUsers: adminUsers3, tournaments, contests: contests2, transactions } = useLoaderData42();
  return /* @__PURE__ */ jsxs106("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs106("h1", { className: "grid font-medium text-primary", children: [
      /* @__PURE__ */ jsx123("span", { className: "text-xl sm:text-2xl font-satoshi-bold line-clamp-1", children: "Hello Admin" }),
      /* @__PURE__ */ jsx123("span", { className: "line-clamp-1", children: "Welcome back to KOTMY \u{1F44B}" })
    ] }),
    /* @__PURE__ */ jsxs106("section", { className: "my-6 grid sm:flex flex-wrap items-start gap-6", children: [
      /* @__PURE__ */ jsx123(AdminSummary, { users: adminUsers3 }),
      /* @__PURE__ */ jsx123(ArticleSummary, {}),
      /* @__PURE__ */ jsx123(TournamentSummary, { tournaments }),
      /* @__PURE__ */ jsx123(ContestSummary, { contests: contests2 })
    ] })
  ] });
}
...
import { useLoaderData as useLoaderData43, Form as Form31, useNavigation as useNavigation18 } from "@remix-run/react";
...
async function loader44({ request }) {
  ...
  return referralBoardRes.authRequired ? redirect33("/login") : json42({ wallets: walletsResponse.data, referralBoardRes: referralBoardRes.data, query });
}
function AffilliateLeaderBoard2() {
  let { wallets, referralBoardRes, query } = useLoaderData43(), navigation = useNavigation18();
  return console.log(referralBoardRes), /* @__PURE__ */ jsxs107("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsx124("p", { className: "font-semibold", children: "Affiliates leader board" }),
    /* @__PURE__ */ jsx124("div", { className: "flex flex-col gap-3 sm:flex-row justify-between sm:items-center my-8", children: /* @__PURE__ */ jsx124(Form31, { method: "get", onSubmit: (e) => {
      try {
      } catch {
      }
    }, className: "w-full bg-white border border-gray-100 rounded-xl p-4 shadow-sm", children: /* @__PURE__ */ jsxs107("div", { className: "grid grid-cols-1 sm:grid-cols-4 gap-3 items-end", children: [
      /* @__PURE__ */ jsxs107("label", { className: "flex flex-col text-xs text-gray-600", children: [
        /* @__PURE__ */ jsx124("span", { className: "mb-1", children: "From" }),
        /* @__PURE__ */ jsx124("input", { id: "min_created_at", name: "min_created_at", type: "date", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
      ] }),
      /* @__PURE__ */ jsxs107("label", { className: "flex flex-col text-xs text-gray-600", children: [
        /* @__PURE__ */ jsx124("span", { className: "mb-1", children: "To" }),
        /* @__PURE__ */ jsx124("input", { id: "max_created_at", name: "max_created_at", type: "date", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
      ] }),
      /* @__PURE__ */ jsxs107("label", { className: "flex flex-col text-xs text-gray-600", children: [
        /* @__PURE__ */ jsx124("span", { className: "mb-1", children: "Currency" }),
        /* @__PURE__ */ jsx124("select", { id: "wallet_id", name: "wallet_id", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: wallets.map((wallet) => /* @__PURE__ */ jsx124("option", { value: wallet.str_id, children: wallet.wallet_currency }, wallet.str_id)) })
      ] }),
      /* @__PURE__ */ jsx124("div", { className: "flex justify-end", children: /* @__PURE__ */ jsx124("button", { type: "submit", disabled: navigation.state === "submitting", className: "px-4 py-2 bg-[#312E81] text-white rounded-lg text-sm", children: navigation.state === "submitting" ? "Searching..." : "Search" }) })
    ] }) }) }),
    /* @__PURE__ */ jsx124("div", { className: "sm:block w-full overflow-x-auto", children: /* @__PURE__ */ jsxs107("table", { className: "w-full table-auto", children: [
      /* @__PURE__ */ jsx124("thead", { children: /* @__PURE__ */ jsxs107("tr", { className: "border-b border-secondary", children: [
        /* @__PURE__ */ jsx124("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Contestant Name" }),
        /* @__PURE__ */ jsx124("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Contestant Code" }),
        /* @__PURE__ */ jsx124("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Contest Name" }),
        /* @__PURE__ */ jsx124("th", { className: "text-left capitalize font-satoshi-black p-3", children: "Reward Earned" })
      ] }) }),
      /* @__PURE__ */ jsx124("tbody", { children: referralBoardRes?.items.map((referrerBoard, index) => /* @__PURE__ */ jsxs107("tr", { className: "border-b border-secondary", children: [
        /* @__PURE__ */ jsx124("td", { className: "p-3", children: `${referrerBoard.contestant_biodata.first_name} ${referrerBoard.contestant_biodata.last_name}` }),
        /* @__PURE__ */ jsx124("td", { className: "p-3", children: referrerBoard.contestant_deets[0]?.code }),
        /* @__PURE__ */ jsx124("td", { className: "p-3", children: referrerBoard.current_contest.name }),
        /* @__PURE__ */ jsx124("td", { className: "p-3", children: `${referralBoardRes.summary?.currency} ${referrerBoard.total_earning.toLocaleString()}` })
      ] }, index)) })
    ] }) }),
    /* @__PURE__ */ jsx124("div", { className: "hidden sm:flex justify-between items-center my-4", children: /* @__PURE__ */ jsx124(Pagination, { lastKey: referralBoardRes?.last_key_id, pageSize: referralBoardRes?.items_per_page, firstKey: referralBoardRes?.first_key_id }) })
  ] });
}
...
async function loader45({ request }) {
  ...
  return pagedUsersRes.authRequired ? redirect34("/login") : (console.log(pagedUsersRes), json43({ data: pagedUsersRes.data, query }));
}
function PartnerProducts2() {
  let { data, query } = useLoaderData44(), navigation = useNavigation19();
  return console.log(data), /* @__PURE__ */ jsxs108("main", { className: "w-full overflow-y-auto p-6", children: [
    /* @__PURE__ */ jsxs108("div", { className: "flex justify-between items-center mb-8 sm:mb-16", children: [
      /* @__PURE__ */ jsx125("h1", { className: "text-2xl font-black text-primary", children: "Products" }),
      /* @__PURE__ */ jsx125(Cta_default, { element: "link", to: "/partners/add", className: " gap-2 items-center rounded-lg px-3 py-2", children: "Add Product" })
    ] }),
    /* @__PURE__ */ jsx125("div", { className: "flex flex-col gap-3 sm:flex-row justify-between sm:items-center my-8", children: /* @__PURE__ */ jsx125(Form32, { method: "get", className: "w-full bg-white border border-gray-100 rounded-xl p-4 shadow-sm", children: /* @__PURE__ */ jsxs108("div", { className: "grid grid-cols-1 sm:grid-cols-4 gap-3 items-end", children: [
      /* @__PURE__ */ jsxs108("div", { children: [
        /* @__PURE__ */ jsx125("label", { className: "block text-xs font-semibold mb-1", children: "Product Price" }),
        /* @__PURE__ */ jsx125(
          "input",
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxs108("div", { children: [
        /* @__PURE__ */ jsx125("label", { className: "block text-xs font-semibold mb-1", children: "Name, Description or tag" }),
        /* @__PURE__ */ jsx125(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxs108("div", { children: [
        /* @__PURE__ */ jsx125("label", { className: "block text-xs font-semibold mb-1", children: "Status" }),
        /* @__PURE__ */ jsxs108(
          "select",
          {
            name: "status",
            className: "w-full border rounded-lg px-3 py-2",
            children: [
              /* @__PURE__ */ jsx125("option", { value: "available", children: "Available" }),
              /* @__PURE__ */ jsx125("option", { value: "out_of_stock", children: "Out of Stock" }),
              /* @__PURE__ */ jsx125("option", { value: "suspended", children: "Suspended" })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsx125("div", { className: "sm:col-span-1 flex gap-2 mt-2 sm:mt-0", children: /* @__PURE__ */ jsx125("button", { type: "submit", className: "bg-[#4B4870] text-white px-4 py-2 rounded-lg font-semibold", children: "Search" }) })
    ] }) }) }),
    /* @__PURE__ */ jsx125("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-8", children: data?.items && data.items.length > 0 ? data.items.map((product) => {
      ...
      return /* @__PURE__ */ jsxs108(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx125("div", { className: "h-40 w-full bg-gray-100 flex items-center justify-center overflow-hidden", children: /* @__PURE__ */ jsx125(
              "img",
              {
                src: imgSrc,
                alt: product.name,
            ...
            /* @__PURE__ */ jsxs108("div", { className: "flex flex-col flex-1 p-4 gap-2", children: [
              /* @__PURE__ */ jsxs108("div", { className: "flex items-center justify-between gap-2", children: [
                /* @__PURE__ */ jsx125("span", { className: "font-bold text-base text-primary line-clamp-1", children: product.name }),
                /* @__PURE__ */ jsx125("span", { className: "text-xs px-2 py-1 rounded bg-gray-50 border border-gray-200 font-semibold capitalize", children: product.status.replace(/_/g, " ") })
              ] }),
              /* @__PURE__ */ jsx125("div", { className: "text-sm text-gray-500 line-clamp-2 mb-1", children: product.description }),
              /* @__PURE__ */ jsxs108("div", { className: "flex items-center gap-2 text-lg font-bold text-accent", children: [
                product.currency,
                " ",
                product.price_min,
                product.price_max && product.price_max !== product.price_min ? /* @__PURE__ */ jsxs108("span", { className: "text-gray-400 font-normal text-base", children: [
                  "- ",
                  product.currency,
                  " ",
                  product.price_max
              ...
              /* @__PURE__ */ jsx125("div", { className: "flex flex-wrap gap-1 mt-1", children: product.tags && product.tags.length > 0 && product.tags.map((tag) => /* @__PURE__ */ jsx125("span", { className: "bg-indigo-50 text-indigo-600 text-xs px-2 py-0.5 rounded-full", children: tag }, tag)) }),
              /* @__PURE__ */ jsxs108("div", { className: "mt-auto flex items-center justify-between pt-2", children: [
                /* @__PURE__ */ jsx125("span", { className: "text-xs text-gray-400", children: product.category }),
                /* @__PURE__ */ jsxs108("div", { className: "flex items-center gap-2", children: [
                  product.sku && /* @__PURE__ */ jsxs108("span", { className: "text-xs text-gray-400", children: [
                    "SKU: ",
                    product.sku
                  ] }),
                  /* @__PURE__ */ jsx125(Cta_default, { element: "link", to: `/partners/product/update/${product._id}`, className: "px-3 py-1 rounded-md text-xs font-semibold border-secondary", variant: "outline", children: "Edit" })
                ] })
              ] })
            ] })
          ]
    ...
    }) : /* @__PURE__ */ jsx125("div", { className: "col-span-full text-center text-gray-400 py-12", children: "No products found." }) }),
    /* @__PURE__ */ jsx125("div", { className: " sm:flex justify-between items-center my-4", children: /* @__PURE__ */ jsx125(Pagination, { lastKey: query?.last_key_id, pageSize: query?.items_per_page, firstKey: query?.first_key_id }) })
  ] });
}
...
function loader46() {
  return redirect35("/admin/overview");
}
...
import { Form as Form33, useActionData as useActionData14, useLoaderData as useLoaderData45, useNavigate as useNavigate23, useNavigation as useNavigation20 } from "@remix-run/react";
...
async function loader47({ request }) {
  ...
  return locationsRes.authRequired ? redirect36("/login") : json44({
    locations: locationsRes.data?.items ?? []
  });
}
...
function AddPartnerProduct() {
  let { locations } = useLoaderData45(), actionData = useActionData14(), isSubmitting = useNavigation20().state === "submitting", navigate = useNavigate23(), [tags, setTags] = useState39("");
  return useEffect29(() => {
    actionData?.error && (console.log(actionData.error), toast({
      variant: "destructive",
  ...
  }, [actionData, navigate]), /* @__PURE__ */ jsxs109("main", { className: "w-full overflow-y-auto p-6 max-w-2xl mx-auto", children: [
    /* @__PURE__ */ jsxs109("div", { className: "flex items-center mb-10 sm:mb-16 gap-4", children: [
      /* @__PURE__ */ jsx126(Cta_default, { element: "button", type: "button", onClick: () => navigate(-1), className: "hover:bg-[#F7F7F8] text-primary px-4 py-2 rounded-lg", variant: "outline", children: "Back" }),
      /* @__PURE__ */ jsx126("h1", { className: "text-2xl font-black text-primary", children: "Add Partner Product" })
    ] }),
    /* @__PURE__ */ jsxs109(Form33, { method: "post", encType: "multipart/form-data", className: "grid gap-4 text-sm bg-white p-6 rounded-xl border border-gray-100 shadow-sm", children: [
      /* @__PURE__ */ jsx126(FormControl, { as: "input", labelText: "Product Name", name: "name", id: "name", required: !0, placeholder: "Enter product name" }),
      /* @__PURE__ */ jsx126(FormControl, { as: "textarea", labelText: "Description", name: "description", id: "description", required: !0, placeholder: "Enter product description" }),
      /* @__PURE__ */ jsx126(FormControl, { as: "input", labelText: "Category", name: "category", id: "category", placeholder: "e.g. Shoes" }),
      /* @__PURE__ */ jsxs109("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsx126(FormControl, { as: "input", labelText: "Price Min", name: "price_min", id: "price_min", type: "number", min: 0, required: !0, placeholder: "0" }),
        /* @__PURE__ */ jsx126(FormControl, { as: "input", labelText: "Price Max", name: "price_max", id: "price_max", type: "number", min: 0, required: !0, placeholder: "0" })
      ] }),
      /* @__PURE__ */ jsxs109(Select2, { label: "Currency", id: "currency", name: "currency", defaultValue: "NGN", required: !0, children: [
        /* @__PURE__ */ jsx126("option", { value: "NGN", children: "NGN" }),
        /* @__PURE__ */ jsx126("option", { value: "USD", children: "USD" })
      ] }),
      /* @__PURE__ */ jsxs109(Select2, { label: "Status", id: "status", name: "status", defaultValue: "available", required: !0, children: [
      ...
      /* @__PURE__ */ jsx126(FormControl, { as: "input", labelText: "SKU", name: "sku", id: "sku", placeholder: "Stock Keeping Unit" }),
      /* @__PURE__ */ jsx126(FormControl, { as: "input", labelText: "Tags (comma separated)", name: "tags", id: "tags", value: tags, onChange: (e) => setTags(e.target.value), placeholder: "e.g. shoes, sports, men" }),
      /* @__PURE__ */ jsxs109("label", { className: "block font-bold text-sm", children: [
        "Locations",
        /* @__PURE__ */ jsx126("div", { className: "mt-2 rounded-lg border border-secondary bg-white p-3", children: /* @__PURE__ */ jsx126(
          "select",
          {
            name: "locations",
            id: "locations",
            multiple: !0,
            className: "w-full min-h-36 rounded-md border border-gray-200 bg-transparent p-3 text-sm outline-none focus:border-accent",
            children: locations.length > 0 ? locations.map((location) => /* @__PURE__ */ jsx126("option", { value: location.str_id, children: location.name }, location.str_id)) : /* @__PURE__ */ jsx126("option", { value: "", disabled: !0, children: "No locations available" })
          }
        ) }),
        /* @__PURE__ */ jsx126("span", { className: "mt-1 block text-xs font-normal text-gray-500", children: "Hold Ctrl or Cmd to select multiple locations." })
      ] }),
      /* @__PURE__ */ jsx126("div", { children: /* @__PURE__ */ jsx126(DragnDrop, { name: "image", labelText: "Product Image", multiple: !1, required: !1 }) }),
      /* @__PURE__ */ jsxs109("div", { className: "flex justify-end gap-4 mt-4", children: [
        /* @__PURE__ */ jsx126(Cta_default, { element: "button", type: "reset", className: "px-4 py-2 rounded-lg font-medium border-secondary active:border-accent", variant: "outline", children: "Reset" }),
        /* @__PURE__ */ jsx126(Cta_default, { disabled: isSubmitting, element: "button", type: "submit", className: "px-4 py-2 rounded-lg font-medium", children: isSubmitting ? "Adding product..." : "Add Product" })
      ] })
    ] })
  ] });
}
...
import { Form as Form34, useLoaderData as useLoaderData46, useActionData as useActionData15, useNavigate as useNavigate24 } from "@remix-run/react";
...
import { Fragment as Fragment13, jsx as jsx127, jsxs as jsxs110 } from "react/jsx-runtime";
async function loader48({ request }) {
  let cookieHeader = request.headers.get("Cookie");
  if (!cookieHeader)
    return redirect37("/login");
  let { data, error, authRequired } = await authServer.getMe(cookieHeader || "");
  return authRequired ? redirect37("/login") : json45({ data, error });
}
...
function UserProfilePage() {
  ...
  return /* @__PURE__ */ jsx127("div", { className: "min-h-screen text-gray-900 bg-secondary flex flex-col items-center pt-24 pb-16", children: /* @__PURE__ */ jsxs110("div", { className: "max-w-2xl w-full px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxs110("div", { className: "flex flex-col items-center mb-8", children: [
      /* @__PURE__ */ jsx127("div", { className: "w-32 h-32 rounded-full overflow-hidden border-4 border-indigo-200 mb-4", children: isLoading ? /* @__PURE__ */ jsx127("div", { className: "w-full h-full bg-gray-200 animate-pulse" }) : imagePreview ? /* @__PURE__ */ jsx127("img", { src: imagePreview, alt: "Profile", className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsx127(Svg, { src: icons.avatarIcon, className: "w-full h-full" }) }),
      isLoading ? /* @__PURE__ */ jsxs110(Fragment13, { children: [
        /* @__PURE__ */ jsx127("div", { className: "h-8 w-40 bg-gray-200 rounded animate-pulse mb-2" }),
        /* @__PURE__ */ jsx127("div", { className: "h-5 w-56 bg-gray-200 rounded animate-pulse" })
      ] }) : /* @__PURE__ */ jsxs110(Fragment13, { children: [
        /* @__PURE__ */ jsxs110("h1", { className: "text-3xl font-bold text-gray-900", children: [
          profile?.first_name,
          " ",
          profile?.last_name
        ] }),
        /* @__PURE__ */ jsx127("p", { className: "text-lg text-gray-600", children: email })
      ] })
    ] }),
    isLoading ? /* @__PURE__ */ jsxs110("div", { className: "bg-white border rounded-3xl p-8 flex flex-col gap-6", children: [
      /* @__PURE__ */ jsx127("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx127("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx127("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx127("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx127("div", { className: "h-10 bg-gray-200 rounded animate-pulse" }),
      /* @__PURE__ */ jsx127("div", { className: "h-12 bg-gray-200 rounded animate-pulse" })
    ] }) : /* @__PURE__ */ jsxs110(Form34, { method: "POST", encType: "multipart/form-data", className: "bg-white border rounded-3xl p-8 flex flex-col gap-6", children: [
      /* @__PURE__ */ jsx127(FormControl, { as: "input", id: "first_name", name: "first_name", labelText: "First Name", defaultValue: profile?.first_name, icon: icons.avatarIcon, required: !0 }),
      /* @__PURE__ */ jsx127(FormControl, { as: "input", id: "last_name", name: "last_name", labelText: "Last Name", defaultValue: profile?.last_name, icon: icons.avatarIcon, required: !0 }),
      /* @__PURE__ */ jsx127(FormControl, { as: "input", id: "email", name: "email", labelText: "Email", defaultValue: email, icon: icons.avatarIcon, required: !0, readOnly: !0 }),
      /* @__PURE__ */ jsx127(FormControl, { as: "input", id: "status", name: "status", labelText: "Status", defaultValue: profile?.status, icon: icons.avatarIcon }),
      /* @__PURE__ */ jsx127(FormControl, { as: "input", id: "", name: "", labelText: "Referral code", defaultValue: referralCode, icon: icons.lockIcon, required: !0, readOnly: !0 }),
      /* @__PURE__ */ jsxs110("label", { htmlFor: "image", className: "flex items-center gap-2 text-sm font-medium text-gray-700", children: [
        /* @__PURE__ */ jsx127(Svg, { src: icons.avatarIcon, className: "w-4 h-4" }),
        "Profile Image"
      ] }),
      /* @__PURE__ */ jsx127(DragnDrop, { name: "image", labelText: "Upload Image", multiple: !1, required: !1 }),
      /* @__PURE__ */ jsx127(Cta_default, { element: "button", type: "submit", className: "rounded-lg p-3", children: "Update Profile" })
    ] })
  ] }) });
}
...
import { Link as Link23, useActionData as useActionData16, useLoaderData as useLoaderData47, useFetcher as useFetcher15 } from "@remix-run/react";
...
async function action28({ request }) {
  ...
  let walletResp = await walletRepo.wallet_search(query, cookieHeader);
  if (walletResp.error)
    return json46({ error: walletResp.error }, { status: 400 });
  let ledgersResp = await walletRepo.getUserLedgersForWallet(cookieHeader, query);
  if (ledgersResp.error)
    return json46({ error: ledgersResp.error }, { status: 400 });
  ...
  return console.log("WALLET RESP", walletResp, wallets), json46({ wallets });
}
function useWalletController2() {
  let { wallets } = useLoaderData47(), { setUserStoreManager, getUserStoreManager } = useUserManager(), [user, setUser] = useState41(null), [activeWalletId, setActiveWalletId] = useState41(
    wallets.length > 0 ? wallets[0].wallet._id : null
  );
  useEffect31(() => {
    let _user = getUserStoreManager();
...
function WalletPage2() {
  ...
  if (!activeData)
    return /* @__PURE__ */ jsx128("div", { className: "p-8", children: "No wallets found." });
  let activeDataLocal = walletsState.find((w) => w.wallet._id === activeData?.wallet._id) ?? activeData, { wallet, pagedLedgers } = activeDataLocal;
  return /* @__PURE__ */ jsxs111("div", { className: "p-8 max-w-7xl mx-auto bg-[#F9FAFB] min-h-screen", children: [
    /* @__PURE__ */ jsx128("h1", { className: "text-2xl font-semibold mb-6", children: "Wallet" }),
    /* @__PURE__ */ jsxs111("div", { className: "bg-white rounded-3xl p-8 border border-gray-100 shadow-sm mb-8", children: [
      /* @__PURE__ */ jsxs111("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxs111("div", { className: "flex items-center gap-2 text-gray-500", children: [
          /* @__PURE__ */ jsx128("span", { className: "text-sm", children: "Wallet balances" }),
          /* @__PURE__ */ jsx128("button", { className: "hover:bg-gray-100 p-1 rounded-full", children: "\u{1F441}\uFE0F" })
        ] }),
        /* @__PURE__ */ jsx128(
          "select",
          {
            ...
            value: wallet._id,
            onChange: (e) => setActiveWalletId(e.target.value),
            children: walletsState.map((w) => /* @__PURE__ */ jsxs111("option", { value: w.wallet._id, children: [
              w.wallet.wallet_currency,
              " - ",
              w.wallet.account_number
            ] }, w.wallet._id))
      ...
      /* @__PURE__ */ jsx128("div", { className: "flex justify-between items-start", children: /* @__PURE__ */ jsxs111("div", { children: [
        /* @__PURE__ */ jsx128("div", { className: "text-4xl font-bold mb-1", children: formatCurrency(wallet.withdrawable_balance, wallet.wallet_currency) }),
        /* @__PURE__ */ jsx128("div", { className: "text-gray-400 text-sm", children: wallet.wallet_name })
      ] }) }),
      /* @__PURE__ */ jsxs111("div", { className: "flex flex-col sm:flex-row gap-3 mt-8", children: [
        /* @__PURE__ */ jsx128(Link23, { to: `/user/withdraw/${wallet._id}`, children: /* @__PURE__ */ jsx128("button", { className: "bg-[#312E81] text-white px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:opacity-90 transition-opacity w-full sm:w-auto", children: "\u2197 Withdraw" }) }),
        user?.withdrawal_pin_set ? /* @__PURE__ */ jsx128(Link23, { to: `/user/addwithdrawalaccount/${wallet._id}`, children: /* @__PURE__ */ jsx128("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "Add withdrawal account" }) }) : /* @__PURE__ */ jsx128(Link23, { to: "/user/setwithdrawalpin", children: /* @__PURE__ */ jsx128("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "+ Set withdrawal PIN" }) }),
        /* @__PURE__ */ jsx128("button", { className: "bg-white border text-gray-700 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 text-sm font-medium hover:bg-gray-50 w-full sm:w-auto", children: "\u21C4 Transfer to another wallet" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs111("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxs111("div", { className: "flex items-center justify-between mb-3", children: [
        /* @__PURE__ */ jsx128("h2", { className: "text-lg font-medium text-gray-700", children: "Search" }),
        /* @__PURE__ */ jsxs111(
          "button",
          {
            type: "button",
            ...
            "aria-expanded": searchOpen,
            children: [
              /* @__PURE__ */ jsx128("span", { children: searchOpen ? "Hide" : "Show" }),
              /* @__PURE__ */ jsx128(
                "svg",
                {
                  className: `w-4 h-4 transition-transform ${searchOpen ? "rotate-180" : ""}`,
                  ...
                  viewBox: "0 0 24 24",
                  xmlns: "http://www.w3.org/2000/svg",
                  children: /* @__PURE__ */ jsx128("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M19 9l-7 7-7-7" })
                }
              )
            ]
          }
      ...
      /* @__PURE__ */ jsx128("div", { className: `transition-all ${searchOpen ? "overflow-scroll max-h-96" : "overflow-hidden max-h-0"}`, children: /* @__PURE__ */ jsx128("div", { className: "bg-white border border-gray-100 rounded-xl p-4 shadow-sm", children: /* @__PURE__ */ jsxs111(fetcher.Form, { method: "post", className: "grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm", children: [
        /* @__PURE__ */ jsxs111("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx128("span", { className: "mb-1", children: "Transaction type" }),
          /* @__PURE__ */ jsxs111("select", { id: "transaction_type", name: "transaction_type", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx128("option", { value: "", children: "All transaction types" }),
            /* @__PURE__ */ jsx128("option", { value: "credit", children: "Credit" }),
            /* @__PURE__ */ jsx128("option", { value: "debit", children: "Debit" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs111("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx128("span", { className: "mb-1", children: "Status" }),
          /* @__PURE__ */ jsxs111("select", { id: "status", name: "status", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx128("option", { value: "", children: "Any status" }),
            /* @__PURE__ */ jsx128("option", { value: "pending", children: "Pending" }),
            /* @__PURE__ */ jsx128("option", { value: "completed", children: "Completed" }),
            /* @__PURE__ */ jsx128("option", { value: "void", children: "Void" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs111("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx128("span", { className: "mb-1", children: "Min amount" }),
          /* @__PURE__ */ jsx128("input", { id: "min_amount", name: "min_amount", type: "number", step: "0.01", placeholder: "Min amount", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs111("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx128("span", { className: "mb-1", children: "Max amount" }),
          /* @__PURE__ */ jsx128("input", { id: "max_amount", name: "max_amount", type: "number", step: "0.01", placeholder: "Max amount", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs111("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx128("span", { className: "mb-1", children: "From date" }),
          /* @__PURE__ */ jsx128("input", { id: "min_created_at", name: "min_created_at", type: "date", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs111("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx128("span", { className: "mb-1", children: "To date" }),
          /* @__PURE__ */ jsx128("input", { id: "max_created_at", name: "max_created_at", type: "date", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsxs111("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx128("span", { className: "mb-1", children: "Payment method" }),
          /* @__PURE__ */ jsxs111("select", { id: "payment_method", name: "payment_method", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none", children: [
            /* @__PURE__ */ jsx128("option", { value: "", children: "Any payment method" }),
            /* @__PURE__ */ jsx128("option", { value: "flutterwave", children: "Flutterwave" }),
            /* @__PURE__ */ jsx128("option", { value: "bank", children: "Bank" }),
            /* @__PURE__ */ jsx128("option", { value: "paystack", children: "Paystack" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs111("label", { className: "flex flex-col text-xs text-gray-600", children: [
          /* @__PURE__ */ jsx128("span", { className: "mb-1", children: "Contest code" }),
          /* @__PURE__ */ jsx128("input", { id: "contest_code", name: "contest_code", className: "border rounded-md px-3 py-2 bg-gray-50 outline-none" })
        ] }),
        /* @__PURE__ */ jsx128("input", { type: "hidden", name: "wallet_id", value: wallet._id }),
        /* @__PURE__ */ jsx128("div", { className: "sm:col-span-3 flex justify-end mt-2", children: /* @__PURE__ */ jsx128("button", { type: "submit", disabled: isSubmitting, className: "px-4 py-2 bg-[#312E81] text-white rounded-lg text-sm disabled:opacity-50", children: isSubmitting ? "Searching..." : "Search" }) })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxs111("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxs111("div", { className: "flex items-center gap-2 text-gray-600 mb-4", children: [
        /* @__PURE__ */ jsx128("span", { children: "\u{1F4C1}" }),
        /* @__PURE__ */ jsxs111("h2", { className: "font-medium", children: [
          "Recent wallet activity (",
          wallet.wallet_currency,
          ")"
        ] })
      ] }),
      /* @__PURE__ */ jsxs111("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-12 mb-8 border-b border-gray-100 pb-6", children: [
        /* @__PURE__ */ jsx128(
          MetricItem2,
          {
            label: "Net change this month",
      ...
      /* @__PURE__ */ jsx128("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs111("table", { className: "w-full text-left text-sm", children: [
        /* @__PURE__ */ jsx128("thead", { children: /* @__PURE__ */ jsxs111("tr", { className: "text-gray-400 border-b", children: [
          /* @__PURE__ */ jsx128("th", { className: "pb-4 font-medium", children: "S/N" }),
          /* @__PURE__ */ jsx128("th", { className: "pb-4 font-medium", children: "Date" }),
          /* @__PURE__ */ jsx128("th", { className: "pb-4 font-medium", children: "Ref ID" }),
          /* @__PURE__ */ jsx128("th", { className: "pb-4 font-medium", children: "Narration" }),
          /* @__PURE__ */ jsx128("th", { className: "pb-4 font-medium", children: "Beneficiary name" }),
          /* @__PURE__ */ jsx128("th", { className: "pb-4 font-medium", children: "Type" }),
          /* @__PURE__ */ jsx128("th", { className: "pb-4 font-medium", children: "Amount" })
        ] }) }),
        /* @__PURE__ */ jsx128("tbody", { className: "divide-y", children: pagedLedgers.items.map((item, idx) => /* @__PURE__ */ jsxs111("tr", { className: "hover:bg-gray-50/50 transition-colors", children: [
          /* @__PURE__ */ jsx128("td", { className: "py-4 text-gray-500", children: idx + 1 }),
          /* @__PURE__ */ jsxs111("td", { className: "py-4 text-gray-900 leading-tight", children: [
            new Date(item.completed_at || "").toLocaleDateString(),
            /* @__PURE__ */ jsx128("div", { className: "text-xs text-gray-400", children: new Date(item.completed_at || "").toLocaleTimeString() })
          ] }),
          /* @__PURE__ */ jsx128("td", { className: "py-4 text-gray-600 font-mono text-xs", children: item.payment_ref }),
          /* @__PURE__ */ jsx128("td", { className: "py-4 text-gray-600 max-w-xs", children: item.description }),
          /* @__PURE__ */ jsx128("td", { className: "py-4 text-gray-600 truncate", children: item.wallet_name }),
          /* @__PURE__ */ jsx128("td", { className: "py-4 uppercase text-xs font-semibold", children: item.entry_type }),
          /* @__PURE__ */ jsx128("td", { className: "py-4", children: /* @__PURE__ */ jsxs111("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx128("span", { className: `font-semibold ${item.entry_type === "credit" ? "text-green-600" : "text-gray-900"}`, children: formatCurrency(item.amount, item.currency) }),
            /* @__PURE__ */ jsx128(StatusBadge2, { status: item.status })
          ] }) })
        ] }, item._id)) })
      ] }) }),
      /* @__PURE__ */ jsxs111("div", { className: "mt-6 flex justify-between items-center text-sm text-gray-500", children: [
        ...
        /* @__PURE__ */ jsx128(Pagination, { lastKey: pagedLedgers.last_key_id, pageSize: pagedLedgers.items_per_page, firstKey: pagedLedgers.first_key_id })
      ] })
    ] })
  ] });
}
function MetricItem2({ label, value, tooltip = !1 }) {
  return /* @__PURE__ */ jsxs111("div", { children: [
    /* @__PURE__ */ jsxs111("div", { className: "text-xs text-gray-400 flex items-center gap-1 mb-1", children: [
      label,
      " ",
      tooltip && /* @__PURE__ */ jsx128("span", { className: "bg-gray-200 rounded-full w-3 h-3 text-[8px] flex items-center justify-center text-white", children: "i" })
    ] }),
    /* @__PURE__ */ jsx128("div", { className: "text-lg font-bold text-gray-800", children: value })
  ] });
}
function StatusBadge2({ status }) {
  ...
  return /* @__PURE__ */ jsxs111("span", { className: `px-2 py-0.5 rounded-full text-[10px] font-medium border flex items-center gap-1 ${styles[status] || ""}`, children: [
    icons2[status],
    " ",
    status
  ] });
...
import { Link as Link24, useNavigate as useNavigate25 } from "@remix-run/react";
...
function PartnerToolbar() {
  ...
  return /* @__PURE__ */ jsxs112(
    Toggletip,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs112(Link24, { to: "/user/profile", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx129(Svg, { src: icons.profileIcon }),
          " Profile"
        ] }),
        /* @__PURE__ */ jsxs112(Link24, { to: "/logout", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
...
function PartnerPrimaryHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs113("header", { className: "h-[85px] hidden sm:flex justify-between items-center gap-4 px-6 py-3 bg-secondary border-b", children: [
    /* @__PURE__ */ jsxs113("div", { className: "flex gap-6", children: [
      ...
      /* @__PURE__ */ jsxs113(Link25, { to: "/", className: "text-accent flex items-center gap-6 whitespace-nowrap font-satoshi-black", children: [
    ...
    /* @__PURE__ */ jsx130(PartnerToolbar, {})
  ] });
}
...
function UserMobileHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs114("div", { className: "flex sm:hidden items-center gap-4 p-4 border-b", children: [
    /* @__PURE__ */ jsxs114(Link26, { to: "/", className: "text-accent flex items-center gap-3 sm:gap-6 whitespace-nowrap font-satoshi-black", children: [
...
var Accordion = AccordionPrimitive.Root, AccordionItem = React13.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx132(
...
var AccordionTrigger = React13.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx132(AccordionPrimitive.Header, { className: "flex", children: /* @__PURE__ */ jsxs115(
  AccordionPrimitive.Trigger,
  {
    ...
    children: [
      children,
      /* @__PURE__ */ jsx132(Svg, { src: icons.arrowDownIcon, className: "shrink-0 transition-transform duration-200" })
    ]
  }
) }));
AccordionTrigger.displayName = AccordionPrimitive.Trigger.displayName;
var AccordionContent = React13.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx132(
  AccordionPrimitive.Content,
  {
    ref,
    className: "overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down",
    ...props,
    children: /* @__PURE__ */ jsx132("div", { className: cn("", className), children })
  }
));
...
function PartnerMobileNavigation({ show, onClose }) {
  ...
  return /* @__PURE__ */ jsxs116(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs116("div", { className: "flex justify-between items-center py-4 px-6 border-b", children: [
          /* @__PURE__ */ jsx133("span", { className: "font-satoshi-bold", children: "NAVIGATION MENU" }),
          /* @__PURE__ */ jsx133(
            "button",
            {
              onClick: onClose,
              title: "open Menu",
              className: "flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
              children: /* @__PURE__ */ jsx133(Svg, { src: icons.closeIcon })
            }
          )
        ] }),
        /* @__PURE__ */ jsxs116("div", { className: "flex flex-col justify-between grow", children: [
          /* @__PURE__ */ jsxs116("header", { children: [
            /* @__PURE__ */ jsxs116("nav", { "aria-label": "primary navigation", children: [
              /* @__PURE__ */ jsxs116("div", { className: "flex gap-3 items-center bg-white px-6 py-2 border-b", children: [
              ...
              /* @__PURE__ */ jsx133(Accordion, { type: "single", collapsible: !0, className: "w-full py-2 border-b", children: /* @__PURE__ */ jsx133("ul", { className: "grid gap-2 font-bold", children: primaryNavs.map((navItem) => navItem.subitems ? /* @__PURE__ */ jsxs116(AccordionItem, { value: navItem.label, className: "group", children: [
                /* @__PURE__ */ jsx133(
                  AccordionTrigger,
                  {
                    ...
                    children: /* @__PURE__ */ jsxs116("span", { className: "flex gap-3 items-center", children: [
                      /* @__PURE__ */ jsx133(Svg, { src: navItem.icon }),
                      navItem.label
                    ] })
                  }
                ),
                /* @__PURE__ */ jsx133(AccordionContent, { children: /* @__PURE__ */ jsx133("ul", { className: "list-disc list-inside p-3 font-normal", children: navItem.subitems.map((subitem) => /* @__PURE__ */ jsx133("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx133(
                  NavLink,
                  {
                    to: subitem.url,
                    onClick: onClose,
              ...
              ] }, navItem.label) : /* @__PURE__ */ jsx133("li", { children: /* @__PURE__ */ jsxs116(
                NavLink,
                {
            ...
            /* @__PURE__ */ jsx133("nav", { className: "my-1", "aria-label": "secondary navigation", children: /* @__PURE__ */ jsx133("ul", { className: "grid font-bold", children: secondaryNavs.map((navItem) => /* @__PURE__ */ jsx133("li", { children: /* @__PURE__ */ jsxs116(
              NavLink,
              {
          ...
          /* @__PURE__ */ jsxs116("aside", { className: "border-t px-6 py-4", children: [
            /* @__PURE__ */ jsxs116("span", { className: "flex items-center gap-1 mb-4 font-satoshi-bold", children: [
...
function PartnerNavigation({ show }) {
  ...
  return show ? /* @__PURE__ */ jsxs117("header", { className: "bg-secondary border-r hidden sm:flex flex-col justify-between min-w-[280px] h-full", children: [
    /* @__PURE__ */ jsxs117("nav", { className: "py-6", children: [
      /* @__PURE__ */ jsx134("span", { className: "inline-block mb-2 px-6 py-3 font-satoshi-bold", children: "Navigation Menu" }),
      /* @__PURE__ */ jsx134("ul", { className: "grid gap-2 font-bold", children: navs.map((navItem) => /* @__PURE__ */ jsx134("li", { children: /* @__PURE__ */ jsxs117(
        NavLink2,
        {
          to: navItem.url,
      ...
      /* @__PURE__ */ jsx134(Accordion2, { type: "single", collapsible: !0, className: "w-full mt-2", children: navsWSubs.map((item) => /* @__PURE__ */ jsxs117(AccordionItem2, { value: item.label, className: "group", children: [
        /* @__PURE__ */ jsxs117(
          AccordionTrigger2,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs117("span", { className: "flex gap-3 items-center", children: [
                /* @__PURE__ */ jsx134(Svg, { src: item.icon }),
                item.label
              ] }),
              /* @__PURE__ */ jsx134(Svg, { src: icons.arrowDownIcon, className: "group-[[data-state=open]]:rotate-180 transition-transform duration-200" })
            ]
          }
        ),
        /* @__PURE__ */ jsx134(AccordionContent2, { children: /* @__PURE__ */ jsx134("ul", { className: "list-disc list-inside p-3", children: item.subitems.map((subitem) => /* @__PURE__ */ jsx134("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx134(
          NavLink2,
          {
            to: subitem.url,
            className: ({ isActive }) => `${isActive ? "active" : ""}`,
    ...
    /* @__PURE__ */ jsxs117("aside", { className: "border-t  px-6 py-3", children: [
      /* @__PURE__ */ jsxs117("span", { className: "flex items-center gap-1 mb-2 font-satoshi-bold", children: [
...
function Layout({ children }) {
  ...
  }, []), /* @__PURE__ */ jsxs118("div", { className: "bg-tertiary text-admin-pry", children: [
    /* @__PURE__ */ jsx135(PartnerPrimaryHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx135(UserMobileHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx135(PartnerMobileNavigation, { onClose: () => {
      setShowNav(!1);
    }, show: showNav }),
    /* @__PURE__ */ jsxs118("div", { className: "sm:flex sm:h-[calc(100vh-85px)]", children: [
      /* @__PURE__ */ jsx135(PartnerNavigation, { show: showNav }),
      /* @__PURE__ */ jsx135("div", { className: "flex-grow overflow-y-auto", children })
    ] })
  ] });
}
function PartnerLayout() {
  return /* @__PURE__ */ jsx135(Layout, { children: /* @__PURE__ */ jsx135(Outlet3, {}) });
}
function ErrorBoundary2() {
  let { pathname } = useLocation10();
  return /* @__PURE__ */ jsx135(Layout, { children: /* @__PURE__ */ jsxs118("div", { className: "w-full max-sm:h-[calc(100dvh-73px)] p-5 m-auto lg:max-w-3xl grid place-content-center text-center gap-5", children: [
    /* @__PURE__ */ jsx135("h2", { className: "text-xl font-bold text-red-500", children: "Something went wrong" }),
    /* @__PURE__ */ jsx135("p", { children: "Apologies, something went wrong on our end. Please try again." }),
    /* @__PURE__ */ jsx135(Cta_default, { element: "link", to: pathname, className: "px-4 py-1 rounded-md", children: "Reload page" }),
    /* @__PURE__ */ jsx135(Cta_default, { element: "link", to: "/partner/overview", className: "px-4 py-1 rounded-md", children: "Back to Partner Home" })
  ] }) });
}
...
function Footer() {
  return /* @__PURE__ */ jsx136("footer", { className: "border-t border-primary py-8", children: /* @__PURE__ */ jsxs119("div", { className: "wrapper flex flex-wrap gap-6 gap-x-12 justify-between font-bold", children: [
    /* @__PURE__ */ jsx136("nav", { className: "flex gap-6 items-center", children: /* @__PURE__ */ jsxs119("ul", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsx136("li", { children: /* @__PURE__ */ jsx136(Link27, { to: "/contests", children: "Contests" }) }),
      /* @__PURE__ */ jsx136("li", { children: /* @__PURE__ */ jsx136(Link27, { to: "/#contact", children: "Contact" }) }),
      /* @__PURE__ */ jsx136("li", { children: /* @__PURE__ */ jsx136(Link27, { to: "/winners", children: "Winners" }) }),
      /* @__PURE__ */ jsx136("li", { children: /* @__PURE__ */ jsx136(Link27, { to: "/results", children: "Results" }) })
    ] }) }),
    /* @__PURE__ */ jsx136("span", { children: "Privacy Policy" }),
    /* @__PURE__ */ jsx136("span", { className: "md:order-first", children: "KOTMY \xA9 2023  All rights reserved" })
  ] }) });
}

// app/components/public/Navigation.tsx
import { useEffect as useEffect36, useState as useState46 } from "react";
import { Link as Link29, NavLink as NavLink4, useLocation as useLocation12 } from "@remix-run/react";

// app/components/public/MobileNavigation.tsx
import { Link as Link28, NavLink as NavLink3, useLocation as useLocation11 } from "@remix-run/react";
...
function MobileNavigation({ show, onClose }) {
  ...
  return useEffect35(() => {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs120("header", { className: "wrapper py-5", children: [
          /* @__PURE__ */ jsxs120("div", { className: "flex justify-between items-center", children: [
            /* @__PURE__ */ jsx137(Link28, { to: "/", onClick: onClose, "aria-label": "home", children: /* @__PURE__ */ jsx137(Svg, { src: icons.logoIcon, width: 37, height: 36 }) }),
            /* @__PURE__ */ jsx137("button", { onClick: onClose, title: "close menu", className: "flex gap-1 items-center rounded p-2 hover:outline outline-primary", children: /* @__PURE__ */ jsx137(Svg, { src: icons.closeIcon, width: 24, height: 24, className: "sm:hidden" }) })
          ] }),
          /* @__PURE__ */ jsxs120("nav", { className: "", children: [
            /* @__PURE__ */ jsxs120("ul", { className: "grid gap-6 my-12 text-xl font-bold", children: [
              /* @__PURE__ */ jsx137("li", { children: /* @__PURE__ */ jsxs120(NavLink3, { onClick: onClose, to: "/partner/account", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/partner/account") ? /* @__PURE__ */ jsx137(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Partner"
              ] }) }),
              /* @__PURE__ */ jsx137("li", { children: /* @__PURE__ */ jsxs120(NavLink3, { onClick: onClose, to: "/contests", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/contests") ? /* @__PURE__ */ jsx137(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Contests"
              ] }) }),
              /* @__PURE__ */ jsx137("li", { children: /* @__PURE__ */ jsxs120(NavLink3, { onClick: onClose, to: "/winners", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/winners") ? /* @__PURE__ */ jsx137(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Winners"
              ] }) }),
              /* @__PURE__ */ jsx137("li", { children: /* @__PURE__ */ jsxs120(NavLink3, { onClick: onClose, to: "/results", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/results") ? /* @__PURE__ */ jsx137(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Results"
              ] }) }),
              /* @__PURE__ */ jsx137("li", { children: /* @__PURE__ */ jsxs120(NavLink3, { onClick: onClose, to: "/marketplace", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
                pathname.includes("/marketplace") ? /* @__PURE__ */ jsx137(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
                " Shop"
              ] }) }),
              /* @__PURE__ */ jsx137("li", { children: /* @__PURE__ */ jsx137(NavLink3, { onClick: onClose, to: "/login", className: "", children: user ? "My Profile" : "Sign In" }) })
            ] }),
            /* @__PURE__ */ jsx137(Button, { element: "a", onClick: onClose, href: "/signup", className: "block w-full sm:w-auto", children: "Join Now" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs120("aside", { className: "wrapper py-5", children: [
          /* @__PURE__ */ jsxs120("div", { className: "mb-12", children: [
            /* @__PURE__ */ jsx137("span", { className: "block font-satoshi-black mb-2", children: "Follow Us" }),
            /* @__PURE__ */ jsxs120("span", { className: "flex gap-4", children: [
              /* @__PURE__ */ jsx137(Svg, { src: icons.twitterXIcon, width: "24px", height: "24px" }),
              /* @__PURE__ */ jsx137(Svg, { src: icons.instagramIcon, width: "24px", height: "24px" }),
              /* @__PURE__ */ jsx137(Svg, { src: icons.facebookIcon, width: "24px", height: "24px" }),
              /* @__PURE__ */ jsx137(Svg, { src: icons.youtubeIcon, width: "24px", height: "24px" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs120("div", { className: "flex gap-6 justify-between items-end font-satoshi-bold", children: [
            /* @__PURE__ */ jsx137("span", { className: "text-sm whitespace-nowrap", children: "KOTMY \xA9 2023  All rights reserved" }),
            /* @__PURE__ */ jsx137("span", { className: "text-xs whitespace-nowrap", children: "Privacy Policy" })
          ] })
        ] })
      ]
    }
...
function Navigation() {
  ...
  return useEffect36(() => {
    let user2 = getUserStoreManager();
    setUser(user2);
  }, []), /* @__PURE__ */ jsxs121("header", { className: "flex justify-between items-center wrapper py-5", children: [
    /* @__PURE__ */ jsx138(Link29, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx138(Svg, { src: icons.logoIcon, className: "w-9 h-9 sm:w-16 sm:h-16" }) }),
    /* @__PURE__ */ jsxs121("nav", { className: "hidden md:flex gap-16 items-center", children: [
      /* @__PURE__ */ jsxs121("ul", { className: "flex gap-6 text-xl font-bold", children: [
        /* @__PURE__ */ jsx138("li", { children: /* @__PURE__ */ jsxs121(NavLink4, { to: "/partner/account", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/partner/account") ? /* @__PURE__ */ jsx138(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Partner"
        ] }) }),
        /* @__PURE__ */ jsx138("li", { children: /* @__PURE__ */ jsxs121(NavLink4, { to: "/contests", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/contests") ? /* @__PURE__ */ jsx138(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Contests"
        ] }) }),
        /* @__PURE__ */ jsx138("li", { children: /* @__PURE__ */ jsxs121(NavLink4, { to: "/winners", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/winners") ? /* @__PURE__ */ jsx138(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Winners"
        ] }) }),
        /* @__PURE__ */ jsx138("li", { children: /* @__PURE__ */ jsxs121(NavLink4, { to: "/results", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/results") ? /* @__PURE__ */ jsx138(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Results"
        ] }) }),
        /* @__PURE__ */ jsx138("li", { children: /* @__PURE__ */ jsxs121(NavLink4, { to: "/marketplace", className: ({ isActive }) => isActive ? "text-accent flex gap-2 items-center" : "", children: [
          pathname.includes("/marketplace") ? /* @__PURE__ */ jsx138(Svg, { src: icons.activeDotIcon, width: ".5em" }) : null,
          " Shop"
        ] }) }),
        /* @__PURE__ */ jsx138("li", { children: /* @__PURE__ */ jsx138(NavLink4, { to: "/login", className: "", children: user ? "My Profile" : "Sign In" }) })
      ] }),
      /* @__PURE__ */ jsx138(Button, { element: "a", href: "/signup", children: "Join Now" })
    ] }),
    /* @__PURE__ */ jsx138(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx138(Svg, { src: icons.hamburgerIcon, width: 40, height: 24 })
      }
    ),
    /* @__PURE__ */ jsx138(MobileNavigation, { onClose: () => {
      setShowNav(!1);
    }, show: showNav })
  ] });
}
...
function Index() {
  return /* @__PURE__ */ jsxs122("div", { className: "min-h-screen bg-primary flex flex-col", children: [
    /* @__PURE__ */ jsx139(Navigation, {}),
    /* @__PURE__ */ jsx139(Outlet4, {}),
    /* @__PURE__ */ jsx139(Footer, {})
  ] });
}
...
import { Link as Link30, useSearchParams as useSearchParams4 } from "@remix-run/react";
...
function Logout() {
  return useLogoutController(), /* @__PURE__ */ jsxs123("main", { className: "h-dvh bg-secondary p-4 flex flex-col", children: [
    /* @__PURE__ */ jsx140(Link30, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx140(Svg, { src: icons.logoIcon, className: "w-14 h-14 sm:w-16 sm:h-16 cursor-pointer" }) }),
    /* @__PURE__ */ jsxs123("main", { className: "h-dvh bg-secondary p-4 flex flex-col justify-center items-center", children: [
      /* @__PURE__ */ jsx140("h1", { className: "text-2xl font-satoshi-bold text-center", children: "You have been logged out" }),
      /* @__PURE__ */ jsx140(Link30, { to: "/login", className: "mt-4 text-center underline", children: "Login again" })
    ] })
  ] });
}
...
import { Form as Form36, Link as Link31, useActionData as useActionData17, useNavigate as useNavigate27, useSearchParams as useSearchParams5 } from "@remix-run/react";
import { json as json47 } from "@remix-run/node";
...
async function action29({ request }) {
  ...
  return error ? { error: error.detail?.toString() || "An error occurred during login.", data: null } : headers?.["Set-Cookie"] ? (responseHeaders = { "Set-Cookie": headers?.["Set-Cookie"] }, json47({ data, error: null }, {
    headers: responseHeaders
  })) : json47({ error, data, headers });
}
...
function Signup() {
  ...
  return /* @__PURE__ */ jsxs124("main", { className: "bg-secondary p-4 flex flex-col", children: [
    /* @__PURE__ */ jsx141(Link31, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx141(Svg, { src: icons.logoIcon, className: "w-14 h-14 sm:w-16 sm:h-16" }) }),
    /* @__PURE__ */ jsx141("section", { className: "grow flex flex-col justify-center items-center", children: /* @__PURE__ */ jsxs124(Form36, { method: "POST", encType: "multipart/form-data", className: "w-full max-w-md p-4 sm:p-8 bg-white border rounded-3xl flex flex-col gap-3", children: [
      /* @__PURE__ */ jsx141("div", { className: "w-max mx-auto p-4 border border-disabled rounded-full bg-gradient-to-b from-slate-200 to-white", children: /* @__PURE__ */ jsx141("div", { className: "w-max p-4 border border-disabled rounded-full bg-white", children: /* @__PURE__ */ jsx141("img", { src: admin_avatar_default, alt: "person silhouette", width: 24, height: 24 }) }) }),
      /* @__PURE__ */ jsx141("h1", { className: "text-2xl font-satoshi-bold text-center", children: "Create your account" }),
      /* @__PURE__ */ jsx141("hr", {}),
      /* @__PURE__ */ jsxs124("p", { className: "text-center text-sm mt-2", children: [
        "Already have an account? ",
        /* @__PURE__ */ jsx141(Link31, { to: "/login", className: "text-primary underline", children: "Login" })
      ] }),
      /* @__PURE__ */ jsxs124("div", { className: "my-2 flex flex-col gap-3", children: [
        /* @__PURE__ */ jsx141(FormControl, { as: "input", id: "first_name", name: "first_name", placeholder: "First Name", labelText: "First Name", icon: icons.avatarIcon, required: !0 }),
        /* @__PURE__ */ jsx141(FormControl, { as: "input", id: "last_name", name: "last_name", placeholder: "Last Name", labelText: "Last Name", icon: icons.avatarIcon, required: !0 }),
        /* @__PURE__ */ jsx141(FormControl, { as: "input", id: "email", name: "email", placeholder: "Enter your email address", labelText: "Email", icon: icons.avatarIcon, required: !0 }),
        /* @__PURE__ */ jsx141(FormControl, { as: "input", id: "password", name: "password", placeholder: "Enter your password", labelText: "Password", type: "password", icon: icons.lockIcon, required: !0 }),
        /* @__PURE__ */ jsx141(FormControl, { as: "input", id: "status", name: "status", placeholder: "Status (optional)", labelText: "Status", icon: icons.avatarIcon }),
        /* @__PURE__ */ jsxs124("label", { htmlFor: "image", className: "flex items-center gap-2 text-sm font-medium text-gray-700", children: [
          /* @__PURE__ */ jsx141(Svg, { src: icons.avatarIcon, className: "w-4 h-4" }),
          "Profile Image"
        ] }),
        /* @__PURE__ */ jsx141(DragnDrop, { className: "sm:col-span-2", name: "image", multiple: !1, labelText: "Upload profile photo" })
      ] }),
      /* @__PURE__ */ jsx141(Cta_default, { element: "button", type: "submit", className: "rounded-lg p-3", children: "Sign Up" })
    ] }) })
  ] });
}
...
function AdminMobileNavigation({ show, onClose }) {
  ...
  return /* @__PURE__ */ jsxs125(
    "div",
    {
      ...
      className: "mobileNav sm:hidden flex flex-col fixed w-full h-dvh top-0 z-10 data-[show=true]:animate-slide-in-left data-[show=false]:left-full data-[show=false]:animate-slide-out-left bg-secondary overflow-y-auto",
      children: [
        /* @__PURE__ */ jsxs125("div", { className: "flex justify-between items-center py-4 px-6 border-b", children: [
          /* @__PURE__ */ jsx142("span", { className: "font-satoshi-bold", children: "NAVIGATION MENU" }),
          /* @__PURE__ */ jsx142(
            "button",
            {
              onClick: onClose,
              title: "open Menu",
              className: "flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
              children: /* @__PURE__ */ jsx142(Svg, { src: icons.closeIcon })
            }
          )
        ] }),
        /* @__PURE__ */ jsxs125("div", { className: "flex flex-col justify-between grow", children: [
          /* @__PURE__ */ jsxs125("header", { children: [
            /* @__PURE__ */ jsxs125("nav", { "aria-label": "primary navigation", children: [
              /* @__PURE__ */ jsxs125("div", { className: "flex gap-3 items-center bg-white px-6 py-2 border-b", children: [
              ...
              /* @__PURE__ */ jsx142(Accordion, { type: "single", collapsible: !0, className: "w-full py-2 border-b", children: /* @__PURE__ */ jsx142("ul", { className: "grid gap-2 font-bold", children: primaryNavs2.map((navItem) => navItem.subitems ? /* @__PURE__ */ jsxs125(AccordionItem, { value: navItem.label, className: "group", children: [
                /* @__PURE__ */ jsx142(
                  AccordionTrigger,
                  {
                    className: cn("border-l-4 border-transparent px-6 py-3 font-semibold hover:bg-[#EEF0FF]", {
                    ...
                    children: /* @__PURE__ */ jsxs125("span", { className: "flex gap-3 items-center", children: [
                      /* @__PURE__ */ jsx142(Svg, { src: navItem.icon }),
                      navItem.label
                    ] })
                  }
                ),
                /* @__PURE__ */ jsx142(AccordionContent, { children: /* @__PURE__ */ jsx142("ul", { className: "list-disc list-inside p-3 font-normal", children: navItem.subitems.map((subitem) => /* @__PURE__ */ jsx142("li", { className: `py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]${hasAcceptedRole(user, subitem.acceptedRoles ?? []) ? "" : " hidden "}`, children: /* @__PURE__ */ jsx142(
                  NavLink5,
                  {
                    to: subitem.url,
                    onClick: onClose,
              ...
              ] }, navItem.label) : /* @__PURE__ */ jsx142("li", { children: /* @__PURE__ */ jsxs125(
                NavLink5,
                {
            ...
            /* @__PURE__ */ jsx142("nav", { className: "my-1", "aria-label": "secondary navigation", children: /* @__PURE__ */ jsx142("ul", { className: "grid font-bold", children: secondaryNavs2.map((navItem) => /* @__PURE__ */ jsx142("li", { children: /* @__PURE__ */ jsxs125(
              NavLink5,
              {
                className: "flex gap-3 items-center px-6 py-3 font-semibold border-l-4 hover:bg-[#EEF0FF] border-transparent",
                to: navItem.url,
          ...
          /* @__PURE__ */ jsxs125("aside", { className: "border-t px-6 py-4", children: [
            /* @__PURE__ */ jsxs125("span", { className: "flex items-center gap-1 mb-4 font-satoshi-bold", children: [
...
function MobileHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs126("div", { className: "flex sm:hidden items-center gap-4 p-4 border-b", children: [
    /* @__PURE__ */ jsxs126(Link32, { to: "/", className: "text-accent flex items-center gap-3 sm:gap-6 whitespace-nowrap font-satoshi-black", children: [
    ...
    /* @__PURE__ */ jsx143(
      "button",
      {
        ...
        title: "open Menu",
        className: "ml-auto flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
        children: /* @__PURE__ */ jsx143(Svg, { src: icons.adminHamburgerIcon, width: 30, height: 24 })
      }
    )
  ] });
}
...
function AdminNavigation({ show }) {
  ...
  let mainComponent = /* @__PURE__ */ jsxs127("div", { className: "flex justify-between items-center border  rounded-lg p-2 text-sm cursor-pointer line-clamp-1 hover:outline outline-1 outline-primary", children: [
    "System default",
    /* @__PURE__ */ jsx144(Svg, { src: icons.arrowDownIcon })
  ] });
  return show ? /* @__PURE__ */ jsxs127("header", { className: "bg-secondary border-r hidden sm:flex flex-col justify-between min-w-[280px]", children: [
    /* @__PURE__ */ jsxs127("nav", { className: "py-6", children: [
      /* @__PURE__ */ jsx144("span", { className: "inline-block mb-2 px-6 py-3 font-satoshi-bold", children: "Navigation Menu" }),
      /* @__PURE__ */ jsx144("ul", { className: "grid gap-2 font-bold", children: navs2.map((navItem) => /* @__PURE__ */ jsx144("li", { children: /* @__PURE__ */ jsxs127(
        NavLink6,
        {
          to: navItem.url,
          ...
          children: [
            /* @__PURE__ */ jsx144(Svg, { src: navItem.icon }),
            navItem.label
          ]
        }
      ) }, navItem.label)) }),
      /* @__PURE__ */ jsx144(Accordion3, { type: "single", collapsible: !0, className: "w-full mt-2", children: navsWSubs2.map((item) => /* @__PURE__ */ jsxs127(AccordionItem3, { value: item.label, className: "group", children: [
        /* @__PURE__ */ jsxs127(
          AccordionTrigger3,
          {
            className: cn("border-l-4 border-transparent group w-full flex gap-3 items-center justify-between px-6 py-3 font-semibold hover:bg-[#EEF0FF]", {
            ...
            children: [
              /* @__PURE__ */ jsxs127("span", { className: "flex gap-3 items-center", children: [
                /* @__PURE__ */ jsx144(Svg, { src: item.icon }),
                item.label
              ] }),
              /* @__PURE__ */ jsx144(Svg, { src: icons.arrowDownIcon, className: "group-[[data-state=open]]:rotate-180 transition-transform duration-200" })
            ]
          }
        ),
        /* @__PURE__ */ jsx144(AccordionContent3, { children: /* @__PURE__ */ jsx144("ul", { className: "list-disc list-inside p-3", children: item.subitems.map((subitem) => /* @__PURE__ */ jsx144("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx144(
          NavLink6,
          {
            to: subitem.url,
    ...
    /* @__PURE__ */ jsxs127("aside", { className: "border-t  px-6 py-3", children: [
      /* @__PURE__ */ jsxs127("span", { className: "flex items-center gap-1 mb-2 font-satoshi-bold", children: [
        /* @__PURE__ */ jsx144(Svg, { src: icons.themeIcon }),
        "Theme"
      ] }),
      /* @__PURE__ */ jsxs127(
        Toggletip,
        {
          ...
          childContainerClass: "bottom-[110%] left-0 bg-tertiary p-2 border  text-xs whitespace-nowrap",
          children: [
            /* @__PURE__ */ jsx144("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "System default" }),
            /* @__PURE__ */ jsx144("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Light" }),
            /* @__PURE__ */ jsx144("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Dark" })
          ]
        }
      )
    ] })
...
function AdminToolbar() {
  let mainComponent = /* @__PURE__ */ jsxs128(
    "div",
    {
      tabIndex: 0,
      className: "relative p-2 rounded-full border flex items-center gap-4 cursor-pointer bg-tertiary hover:bg-[#EEF0FF]",
      children: [
        /* @__PURE__ */ jsxs128("div", { className: "flex gap-3 items-center", children: [
          ...
          /* @__PURE__ */ jsxs128("span", { className: "grid", children: [
            /* @__PURE__ */ jsx145("span", { className: "block text-sm font-satoshi-bold", children: "Admin" }),
            /* @__PURE__ */ jsx145("span", { className: "block text-xs font-satoshi-medium", children: "admin@kotmy.com" })
          ] })
        ] }),
  ...
  return /* @__PURE__ */ jsxs128(
    Toggletip,
    {
      ...
      childContainerClass: "top-[110%] right-0 bg-tertiary p-2 border  text-xs whitespace-nowrap",
      children: [
        /* @__PURE__ */ jsxs128(Link33, { to: "/user/profile", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx145(Svg, { src: icons.profileIcon }),
          " Profile"
        ] }),
        /* @__PURE__ */ jsxs128(Link33, { to: "/logout", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx145(Svg, { src: icons.signoutIcon }),
          " Sign Out"
        ] })
      ]
    }
...
function PrimaryHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs129("header", { className: "h-[85px] hidden sm:flex justify-between items-center gap-4 px-6 py-3 bg-secondary border-b", children: [
    /* @__PURE__ */ jsxs129("div", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsx146(
        "button",
        {
          onClick: toggleNav,
          title: "Toggle Menu",
          className: "flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
          children: /* @__PURE__ */ jsx146(Svg, { src: icons.adminHamburgerIcon, width: 40, height: 24 })
        }
      ),
      /* @__PURE__ */ jsxs129(Link34, { to: "/", className: "text-accent flex items-center gap-6 whitespace-nowrap font-satoshi-black", children: [
        /* @__PURE__ */ jsx146(Svg, { src: icons.logoIcon, width: 37, height: 36 }),
        "KOTMY-ADMIN"
      ] })
    ] }),
    /* @__PURE__ */ jsx146(FormControl, { as: "input", type: "search", className: "min-w-[280px] bg-white", placeholder: "Search..." }),
    /* @__PURE__ */ jsx146(AdminToolbar, {})
  ] });
}
...
function Layout2({ children }) {
  ...
  return useEffect41(() => {
    setShowNav(window.innerWidth >= 640);
  }, []), /* @__PURE__ */ jsxs130("div", { className: "bg-tertiary text-admin-pry", children: [
    /* @__PURE__ */ jsx147(PrimaryHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx147(MobileHeader, { toggleNav: () => {
      setShowNav((prev) => !prev);
    } }),
    /* @__PURE__ */ jsx147(AdminMobileNavigation, { onClose: () => {
      setShowNav(!1);
    }, show: showNav }),
    /* @__PURE__ */ jsxs130("div", { className: "sm:flex sm:h-[calc(100vh-85px)]", children: [
      /* @__PURE__ */ jsx147(AdminNavigation, { show: showNav }),
      children
    ] })
  ] });
}
function AdminLayout() {
  return /* @__PURE__ */ jsx147(Layout2, { children: /* @__PURE__ */ jsx147(Outlet5, {}) });
}
function ErrorBoundary3() {
  let { pathname } = useLocation15();
  return /* @__PURE__ */ jsx147(Layout2, { children: /* @__PURE__ */ jsxs130("div", { className: "w-full max-sm:h-[calc(100dvh-73px)] p-5 m-auto lg:max-w-3xl grid place-content-center text-center gap-5", children: [
    /* @__PURE__ */ jsx147("h2", { className: "text-xl font-bold text-red-500", children: "Something went wrong" }),
    /* @__PURE__ */ jsx147("p", { children: "Apologies, something went wrong on our end. Please try again." }),
    /* @__PURE__ */ jsx147(Cta_default, { element: "link", to: pathname, className: "px-4 py-1 rounded-md", children: "Reload page" }),
    /* @__PURE__ */ jsx147(Cta_default, { element: "link", to: "/admin/overview", className: "px-4 py-1 rounded-md", children: "Back to Admin Home" })
  ] }) });
}
...
import { Form as Form37, Link as Link35, useActionData as useActionData18, useNavigate as useNavigate28, useSearchParams as useSearchParams6 } from "@remix-run/react";
...
async function action30({ request }) {
  ...
  let responseHeaders = {};
  return headers?.["Set-Cookie"] ? (responseHeaders = { "Set-Cookie": headers?.["Set-Cookie"] }, json48({ data, error: null }, {
    headers: responseHeaders
  })) : json48({ data, error: null });
}
...
function Login() {
  ...
  return /* @__PURE__ */ jsxs131("main", { className: "h-dvh bg-secondary p-4 flex flex-col", children: [
    /* @__PURE__ */ jsx148(Link35, { to: "/", "aria-label": "home", children: /* @__PURE__ */ jsx148(Svg, { src: icons.logoIcon, className: "w-14 h-14 sm:w-16 sm:h-16" }) }),
    /* @__PURE__ */ jsx148("section", { className: "grow flex flex-col justify-center items-center", children: /* @__PURE__ */ jsxs131(Form37, { method: "POST", className: "w-full max-w-md p-4 sm:p-8 bg-white border rounded-3xl flex flex-col gap-3", children: [
      /* @__PURE__ */ jsx148("div", { className: "w-max mx-auto p-4 border border-disabled rounded-full bg-gradient-to-b from-slate-200 to-white", children: /* @__PURE__ */ jsx148("div", { className: "w-max p-4 border border-disabled rounded-full bg-white", children: /* @__PURE__ */ jsx148("img", { src: admin_avatar_default, alt: "person silhouette", width: 24, height: 24 }) }) }),
      /* @__PURE__ */ jsx148("h1", { className: "text-2xl font-satoshi-bold text-center", children: "Enter your details to login" }),
      /* @__PURE__ */ jsx148("hr", {}),
      /* @__PURE__ */ jsxs131("p", { className: "text-center text-sm mt-2", children: [
        "Don't have an account yet? ",
        /* @__PURE__ */ jsx148(Link35, { to: "/signup", className: "text-primary underline", children: "Register" })
      ] }),
      /* @__PURE__ */ jsxs131("div", { className: "my-2 flex flex-col gap-3", children: [
        /* @__PURE__ */ jsx148(
          FormControl,
          {
            as: "input",
      ...
      /* @__PURE__ */ jsx148(Cta_default, { element: "button", type: "submit", className: "rounded-lg p-3", children: "Login" })
    ] }) })
  ] });
}
...
import { Link as Link36, useNavigate as useNavigate29 } from "@remix-run/react";
...
function UserToolbar() {
      ...
      children: [
        /* @__PURE__ */ jsxs132("div", { className: "flex gap-3 items-center", children: [
          ...
          /* @__PURE__ */ jsxs132("span", { className: "grid", children: [
            /* @__PURE__ */ jsx149("span", { className: "block text-sm font-satoshi-bold", children: user?.fullName }),
            /* @__PURE__ */ jsx149("span", { className: "block text-xs font-satoshi-medium", children: user?.email })
          ] })
        ] }),
  ...
  return /* @__PURE__ */ jsxs132(
    Toggletip,
    {
      ...
      childContainerClass: "top-[110%] right-0 bg-tertiary p-2 border  text-xs whitespace-nowrap",
      children: [
        /* @__PURE__ */ jsxs132(Link36, { to: "/user/profile", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
          /* @__PURE__ */ jsx149(Svg, { src: icons.profileIcon }),
          " Profile"
        ] }),
        /* @__PURE__ */ jsxs132(Link36, { to: "/logout", className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: [
...
function UserPrimaryHeader({ toggleNav }) {
  return /* @__PURE__ */ jsxs133("header", { className: "h-[85px] hidden sm:flex justify-between items-center gap-4 px-6 py-3 bg-secondary border-b", children: [
    /* @__PURE__ */ jsxs133("div", { className: "flex gap-6", children: [
      ...
      /* @__PURE__ */ jsxs133(Link37, { to: "/", className: "text-accent flex items-center gap-6 whitespace-nowrap font-satoshi-black", children: [
...
function UserMobileHeader2({ toggleNav }) {
  return /* @__PURE__ */ jsxs134("div", { className: "flex sm:hidden items-center gap-4 p-4 border-b", children: [
    /* @__PURE__ */ jsxs134(Link38, { to: "/", className: "text-accent flex items-center gap-3 sm:gap-6 whitespace-nowrap font-satoshi-black", children: [
    ...
    /* @__PURE__ */ jsx151(
      "button",
      {
        ...
        title: "open Menu",
        className: "ml-auto flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
        children: /* @__PURE__ */ jsx151(Svg, { src: icons.adminHamburgerIcon, width: 30, height: 24 })
      }
    )
  ] });
}
...
function UserMobileNavigation({ show, onClose }) {
  ...
  let mainComponent = /* @__PURE__ */ jsxs135("div", { className: "flex justify-between items-center border rounded-lg p-2 text-sm cursor-pointer line-clamp-1 hover:outline outline-1 outline-primary", children: [
    "System default",
  ...
  return /* @__PURE__ */ jsxs135(
    "div",
    {
      ...
      className: "mobileNav sm:hidden flex flex-col fixed w-full h-dvh top-0 z-10 data-[show=true]:animate-slide-in-left data-[show=false]:left-full data-[show=false]:animate-slide-out-left bg-secondary overflow-y-auto",
      children: [
        /* @__PURE__ */ jsxs135("div", { className: "flex justify-between items-center py-4 px-6 border-b", children: [
          /* @__PURE__ */ jsx152("span", { className: "font-satoshi-bold", children: "NAVIGATION MENU" }),
          /* @__PURE__ */ jsx152(
            "button",
            {
              onClick: onClose,
              title: "open Menu",
              className: "flex items-center justify-center rounded p-2 px-1 hover:outline outline-primary",
              children: /* @__PURE__ */ jsx152(Svg, { src: icons.closeIcon })
            }
          )
        ] }),
        /* @__PURE__ */ jsxs135("div", { className: "flex flex-col justify-between grow", children: [
          /* @__PURE__ */ jsxs135("header", { children: [
            /* @__PURE__ */ jsxs135("nav", { "aria-label": "primary navigation", children: [
              /* @__PURE__ */ jsxs135("div", { className: "flex gap-3 items-center bg-white px-6 py-2 border-b", children: [
              ...
              /* @__PURE__ */ jsx152(Accordion, { type: "single", collapsible: !0, className: "w-full py-2 border-b", children: /* @__PURE__ */ jsx152("ul", { className: "grid gap-2 font-bold", children: primaryNavs3.map((navItem) => navItem.subitems ? /* @__PURE__ */ jsxs135(AccordionItem, { value: navItem.label, className: "group", children: [
                /* @__PURE__ */ jsx152(
                  AccordionTrigger,
                  {
                    className: cn("border-l-4 border-transparent px-6 py-3 font-semibold hover:bg-[#EEF0FF]", {
                    ...
                    children: /* @__PURE__ */ jsxs135("span", { className: "flex gap-3 items-center", children: [
                      /* @__PURE__ */ jsx152(Svg, { src: navItem.icon }),
                      navItem.label
                    ] })
                  }
                ),
                /* @__PURE__ */ jsx152(AccordionContent, { children: /* @__PURE__ */ jsx152("ul", { className: "list-disc list-inside p-3 font-normal", children: navItem.subitems.map((subitem) => /* @__PURE__ */ jsx152("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx152(
                  NavLink7,
                  {
                    to: subitem.url,
                    onClick: onClose,
              ...
              ] }, navItem.label) : /* @__PURE__ */ jsx152("li", { children: /* @__PURE__ */ jsxs135(
                NavLink7,
                {
                  className: ({ isActive }) => `flex gap-3 items-center px-6 py-3 font-semibold border-l-4 hover:bg-[#EEF0FF] ${isActive ? "text-accent bg-[#EEF0FF] border-accent" : "border-transparent"}`,
                  to: navItem.url,
            ...
            /* @__PURE__ */ jsx152("nav", { className: "my-1", "aria-label": "secondary navigation", children: /* @__PURE__ */ jsx152("ul", { className: "grid font-bold", children: secondaryNavs3.map((navItem) => /* @__PURE__ */ jsx152("li", { children: /* @__PURE__ */ jsxs135(
              NavLink7,
              {
                className: "flex gap-3 items-center px-6 py-3 font-semibold border-l-4 hover:bg-[#EEF0FF] border-transparent",
                to: navItem.url,
          ...
          /* @__PURE__ */ jsxs135("aside", { className: "border-t px-6 py-4", children: [
            /* @__PURE__ */ jsxs135("span", { className: "flex items-center gap-1 mb-4 font-satoshi-bold", children: [
              /* @__PURE__ */ jsx152(Svg, { src: icons.themeIcon }),
              "Theme"
            ] }),
            /* @__PURE__ */ jsxs135(
              Toggletip,
              {
                ...
                childContainerClass: "bottom-[110%] left-0 bg-tertiary p-2 border text-sm whitespace-nowrap",
                children: [
                  /* @__PURE__ */ jsx152("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "System default" }),
                  /* @__PURE__ */ jsx152("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Light" }),
                  /* @__PURE__ */ jsx152("span", { className: "p-2 flex items-center gap-2 hover:bg-[#EEF0FF] rounded-lg font-satoshi-medium", children: "Dark" })
                ]
              }
            )
          ] })
...
function UserNavigation({ show }) {
  ...
  return show ? /* @__PURE__ */ jsxs136("header", { className: "bg-secondary border-r hidden sm:flex flex-col justify-between min-w-[280px] h-full", children: [
    /* @__PURE__ */ jsxs136("nav", { className: "py-6", children: [
      /* @__PURE__ */ jsx153("span", { className: "inline-block mb-2 px-6 py-3 font-satoshi-bold", children: "Navigation Menu" }),
      /* @__PURE__ */ jsx153("ul", { className: "grid gap-2 font-bold", children: navs3.map((navItem) => /* @__PURE__ */ jsx153("li", { children: /* @__PURE__ */ jsxs136(
        NavLink8,
        {
          to: navItem.url,
          className: ({ isActive }) => `${isActive ? "text-accent bg-[#EEF0FF] border-accent" : "border-transparent"} flex gap-3 items-center px-6 py-3 font-semibold border-l-4 hover:bg-[#EEF0FF]`,
      ...
      /* @__PURE__ */ jsx153(Accordion4, { type: "single", collapsible: !0, className: "w-full mt-2", children: navsWSubs3.map((item) => /* @__PURE__ */ jsxs136(AccordionItem4, { value: item.label, className: "group", children: [
        /* @__PURE__ */ jsxs136(
          AccordionTrigger4,
          {
            className: cn("border-l-4 border-transparent group w-full flex gap-3 items-center justify-between px-6 py-3 font-semibold hover:bg-[#EEF0FF]", {
            ...
            children: [
              /* @__PURE__ */ jsxs136("span", { className: "flex gap-3 items-center", children: [
                /* @__PURE__ */ jsx153(Svg, { src: item.icon }),
                item.label
              ] }),
              /* @__PURE__ */ jsx153(Svg, { src: icons.arrowDownIcon, className: "group-[[data-state=open]]:rotate-180 transition-transform duration-200" })
            ]
          }
        ),
        /* @__PURE__ */ jsx153(AccordionContent4, { children: /* @__PURE__ */ jsx153("ul", { className: "list-disc list-inside p-3", children: item.subitems.map((subitem) => /* @__PURE__ */ jsx153("li", { className: "py-2 px-6 hover:bg-[#EEF0FF] rounded-lg has-[.active]:font-semibold has-[.active]:bg-[#EEF0FF]", children: /* @__PURE__ */ jsx153(
          NavLink8,
          {
            to: subitem.url,
            className: ({ isActive }) => `${isActive ? "active" : ""}`,
    ...
    /* @__PURE__ */ jsxs136("aside", { className: "border-t  px-6 py-3", children: [
      /* @__PURE__ */ jsxs136("span", { className: "flex items-center gap-1 mb-2 font-satoshi-bold", children: [
